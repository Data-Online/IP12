...
// This file implements the code-behind class for Administration.aspx.
// Administration.Controls.vb contains the Table, Row and Record control classes
...
public partial class Administration
        : BaseApplicationPage
// Code-behind class for the Administration page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void LoginsButton_Click(object sender, ImageClickEventArgs args)
        {
          // Click handler for LoginsButton.
          // Customize by adding code before the call or replace the call to the Base function with your own code.
          LoginsButton_Click_Base(sender, args);
        ...
        public void SetLoginsButton()
        {
            SetLoginsButton_Base(); 
        }              
...
public void SetUserSummaryButton()
        {
            SetUserSummaryButton_Base(); 
        }              
public void UserSummaryButton_Click(object sender, ImageClickEventArgs args)
        {
          // Click handler for UserSummaryButton.
          // Customize by adding code before the call or replace the call to the Base function with your own code.
          UserSummaryButton_Click_Base(sender, args);
          // NOTE: If the Base function redirects to another page, any code here will not be executed.
        }
#endregion
...
#region "Section 2: Do not modify this section."
        ...
        public System.Web.UI.WebControls.ImageButton LoginsButton;
        
        public System.Web.UI.WebControls.Literal PageTitle;
        
        public System.Web.UI.WebControls.ImageButton UserSummaryButton;
      ...
      public void Page_InitializeEventHandlers_Base(object sender, System.EventArgs e)
      {
        ...
        if(!string.IsNullOrEmpty(this.Enctype)) this.Page.Form.Enctype = this.Enctype;
          ...
          // Setup the pagination events.
                    ...
                    this.LoginsButton.Click += LoginsButton_Click;
                        
                    this.UserSummaryButton.Click += UserSummaryButton_Click;
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLoginsButton_Base()                
        ...
        public void SetUserSummaryButton_Base()                
        ...
        public void LoginsButton_Click_Base(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Users/GroupByUsersTable.aspx";
      ...
      this.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public void UserSummaryButton_Click_Base(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../vUserRoleSummary/ShowVUserRoleSummaryTable.aspx";
