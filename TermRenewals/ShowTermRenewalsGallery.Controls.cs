...
// ShowTermRenewalsGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowTermRenewalsGallery
{
...
// Base class for the TermRenewalsTableControlRow control on the ShowTermRenewalsGallery page.
...
// Base class for the TermRenewalsTableControl control on the ShowTermRenewalsGallery page.
...
public class BaseTermRenewalsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return TermRenewalsTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual TermRenewalsRecord[] CopyArray(int index, TermRenewalsRecord[,] recs, int columns)
      {
        TermRenewalsRecord[] recsCopy = new TermRenewalsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            TermRenewalsRecord[,] recs = new TermRenewalsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            TermRenewalsRecord[] HColDataSource = new TermRenewalsRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              TermRenewalsRecord[] VColDataSource = new TermRenewalsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("TermRenewalsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              TermRenewalsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                TermRenewalsTableControlRow recControl = (TermRenewalsTableControlRow)innerRepItem.FindControl("TermRenewalsTableControlRow");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void TermRenewalsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowTermRenewalsGallery.TermRenewalsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermRenewals";
                // If ShowTermRenewalsGallery.TermRenewalsPDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  TermRenewalsTable.PropertyID.IsApplyDisplayAs){
                                     ...
                                     report.AddData("${PropertyID}", record.Format(TermRenewalsTable.PropertyID), ReportEnum.Align.Left, 100);
                                 }
                             }
                             report.AddData("${Description}", record.Format(TermRenewalsTable.Description), ReportEnum.Align.Left);
        ...
        public virtual void TermRenewalsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowTermRenewalsGallery.TermRenewalsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermRenewals";
                // If ShowTermRenewalsGallery.TermRenewalsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual TermRenewalsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TermRenewalsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowTermRenewalsGallery.TermRenewalsTableControlRow")));
