...
// ShowTermRenewals.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowTermRenewals
{
...
// Base class for the TermRenewalsRecordControl control on the ShowTermRenewals page.
...
public class BaseTermRenewalsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.TermRenewalsDialogEditButton.Click += TermRenewalsDialogEditButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetTermRenewalsDialogEditButton();
      ...
      // To customize, override this method in TermRenewalsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in ShowTermRenewals"] = recId;
        ...
        public virtual void SetTermRenewalsDialogEditButton()                
        ...
        public virtual void TermRenewalsDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={TermRenewalsRecordControl:FK:FK_TermRenewals_Properties}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton TermRenewalsDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermRenewalsDialogEditButton");
            }
        }
