...
// EditTermRenewals.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditTermRenewals
{
...
public class TermRenewalsRecordControl : BaseTermRenewalsRecordControl
{
      
        // The BaseTermRenewalsRecordControl implements the LoadData, DataBind and other
...
// Base class for the TermRenewalsRecordControl control on the EditTermRenewals page.
// Do not modify this class. Instead override any method in TermRenewalsRecordControl.
public class BaseTermRenewalsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        public BaseTermRenewalsRecordControl()
        {
        ...
        // To customize, override this method in TermRenewalsRecordControl.
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "TermRenewalsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            TermRenewalsRecord[] recList = TermRenewalsTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = TermRenewalsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in TermRenewalsRecordControl.
         ...
         
        {
            ...
            bool hasFiltersTermRenewalsRecordControl = false;
            hasFiltersTermRenewalsRecordControl = hasFiltersTermRenewalsRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["TermRenewals"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "TermRenewals"));
            }
            HttpContext.Current.Session["QueryString in EditTermRenewals"] = recId;
          ...
          wc.iAND(TermRenewalsTable.TermRenewalID, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(TermRenewalsTable.TermRenewalID));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(TermRenewalsTable.TermRenewalID, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseTermRenewalsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseTermRenewalsRecordControl_Rec"] = value;
            }
        }
