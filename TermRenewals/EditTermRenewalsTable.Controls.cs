...
// EditTermRenewalsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditTermRenewalsTable
{
...
// Base class for the TermRenewalsTableControlRow control on the EditTermRenewalsTable page.
...
public class BaseTermRenewalsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.TermRenewalsRowViewButton.Click += TermRenewalsRowViewButton_Click;
                        
              this.PropertyID.SelectedIndexChanged += PropertyID_SelectedIndexChanged;
            
              this.Description.TextChanged += Description_TextChanged;
            
              this.RenewalDate.TextChanged += RenewalDate_TextChanged;
        ...
        public virtual void SetDescription()
        {
            ...
            if (this.DataSource != null && this.DataSource.DescriptionSpecified) {
              ...
              this.Description.Text = TermRenewalsTable.Description.Format(TermRenewalsTable.Description.DefaultValue);
        ...
        public virtual void SetPropertyID()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = TermRenewalsTable.PropertyID.DefaultValue;
        ...
        public virtual void SetRenewalDate()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.RenewalDate.ID))
            {
            
                this.RenewalDate.Text = this.PreviousUIData[this.RenewalDate.ID].ToString();
              
                return;
            }
            
                    
            // Set the RenewalDate TextBox on the webpage with value from the
            // DatabaseMM_IP1%dbo.TermRenewals database record.

            // this.DataSource is the DatabaseMM_IP1%dbo.TermRenewals record retrieved from the database.
            // this.RenewalDate is the ASP:TextBox on the webpage.
        ...
        public virtual void GetDescription()
        {
            ...
            // save it into the Description field in DataSource DatabaseMM_IP1%dbo.TermRenewals record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.Description.Text, TermRenewalsTable.Description);							
        ...
        public virtual void GetPropertyID()
        {
         // Retrieve the value entered by the user on the PropertyID ASP:DropDownList, and
            // save it into the PropertyID field in DataSource DatabaseMM_IP1%dbo.TermRenewals record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.PropertyID), TermRenewalsTable.PropertyID);			
        ...
        public virtual void GetRenewalDate()
        {
            ...
            // Retrieve the value entered by the user on the RenewalDate ASP:TextBox, and
            // save it into the RenewalDate field in DataSource DatabaseMM_IP1%dbo.TermRenewals record.
            ...
            // Save the value to data source
            this.DataSource.Parse(this.RenewalDate.Text, TermRenewalsTable.RenewalDate);							
      ...
      // To customize, override this method in TermRenewalsTableControlRow.
        ...
        public virtual void SetTermRenewalsRowViewButton()                
                    ...
                    foreach (PropertiesRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.PropertyIDSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.PropertyID.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = TermRenewalsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(TermRenewalsTable.PropertyID);
                                if(_isExpandableNonCompositeForeignKey && TermRenewalsTable.PropertyID.IsApplyDisplayAs)
                                    fvalue = TermRenewalsTable.GetDFKA(itemValue, TermRenewalsTable.PropertyID);
        ...
        TermRenewalsTableControl tc= ((TermRenewalsTableControl)MiscUtils.GetParentControlObject(this, "TermRenewalsTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((TermRenewalsTableControlRow)this);
                    }
                    this.Visible = false;
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void TermRenewalsRowViewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../TermRenewals/ShowTermRenewals.aspx?TermRenewals={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void RenewalDate_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox RenewalDate {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RenewalDate");
            }
        }
        ...
        public System.Web.UI.WebControls.CheckBox TermRenewalsRecordRowSelection {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermRenewalsRecordRowSelection");
            }
        }              
        ...
        public System.Web.UI.WebControls.ImageButton TermRenewalsRowViewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermRenewalsRowViewButton");
            }
        }
...
// Base class for the TermRenewalsTableControl control on the EditTermRenewalsTable page.
...
public class BaseTermRenewalsTableControl : IPv5.UI.BaseApplicationTableControl
{
       ...
       public BaseTermRenewalsTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.RenewalDateFromFilter)) 				
                    initialVal = this.GetFromSession(this.RenewalDateFromFilter);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.RenewalDateFromFilter.Text = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.RenewalDateToFilter)) 				
                    initialVal = this.GetFromSession(this.RenewalDateToFilter);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.RenewalDateToFilter.Text = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.TermRenewalsSearch)) 				
                    initialVal = this.GetFromSession(this.TermRenewalsSearch);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.TermRenewalsSearch.Text = initialVal;
    ...
    // Setup default pagination settings.
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            SaveControlsToSession_Ajax();
              ...
              // Show confirmation message on Click
              this.TermRenewalsDeleteButton.Attributes.Add("onClick", "return (confirm(\"" + ((BaseApplicationPage)this.Page).GetResourceValue("DeleteConfirm", "IPv5") + "\"));");
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.TermRenewalsAddButton.Click += TermRenewalsAddButton_Click;
                        
                    this.TermRenewalsDeleteButton.Click += TermRenewalsDeleteButton_Click;
                        
                    this.TermRenewalsResetButton.Click += TermRenewalsResetButton_Click;
                        
                    this.TermRenewalsSaveButton.Click += TermRenewalsSaveButton_Click;
                        
                    this.TermRenewalsSearchButton.Click += TermRenewalsSearchButton_Click;
         ...
         //' Setup events for others
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "TermRenewalsSearchSearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + TermRenewalsSearch.ClientID + "\");", true);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetTermRenewalsSearch();
                
                
                
                
                SetTermRenewalsAddButton();
              
                SetTermRenewalsDeleteButton();
              
                SetTermRenewalsResetButton();
              
                SetTermRenewalsSaveButton();
              
                SetTermRenewalsSearchButton();
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(TermRenewalsTable.PropertyID, this.DataSource);
        }
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"TermRenewalsSaveButton"));
        ...
        public virtual void ResetControl()
        {
            ...
            this.RenewalDateFromFilter.Text = "";
            
            this.RenewalDateToFilter.Text = "";
            
            this.TermRenewalsSearch.Text = "";
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.PropertyIDFilter)) {
                ...
                wc.iAND(TermRenewalsTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.PropertyIDFilter, this.GetFromSession(this.PropertyIDFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.RenewalDateFromFilter)) {
                string val = MiscUtils.GetSelectedValue(this.RenewalDateFromFilter, this.GetFromSession(this.RenewalDateFromFilter));
            ...
            if (MiscUtils.IsValueSelected(this.RenewalDateToFilter)) {
                string val = MiscUtils.GetSelectedValue(this.RenewalDateToFilter, this.GetFromSession(this.RenewalDateToFilter));
                DateTime d = DateParser.ParseDate(val, DateColumn.DEFAULT_FORMAT);
            ...
            if (MiscUtils.IsValueSelected(this.TermRenewalsSearch)) {
                if (this.TermRenewalsSearch.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.TermRenewalsSearch.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.TermRenewalsSearch.Text.StartsWith("...")) {
                      this.TermRenewalsSearch.Text = this.TermRenewalsSearch.Text.Substring(3,this.TermRenewalsSearch.Text.Length-3);
                  }
                  if (this.TermRenewalsSearch.Text.EndsWith("...")) {
                      this.TermRenewalsSearch.Text = this.TermRenewalsSearch.Text.Substring(0,this.TermRenewalsSearch.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.TermRenewalsSearch.Text.Length - 1;
                      while (!Char.IsWhiteSpace(TermRenewalsSearch.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.TermRenewalsSearch.Text = this.TermRenewalsSearch.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.TermRenewalsSearch, this.GetFromSession(this.TermRenewalsSearch));
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.TermRenewalsSearch, this.GetFromSession(this.TermRenewalsSearch)), true, false);
      ...
      String PropertyIDFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "PropertyIDFilter_Ajax"];
            if (MiscUtils.IsValueSelected(PropertyIDFilterSelectedValue)) {
                ...
                wc.iAND(TermRenewalsTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, PropertyIDFilterSelectedValue, false, false);
                      
      }
                      
            string RenewalDateFromFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "RenewalDateFromFilter_Ajax"];
            if (MiscUtils.IsValueSelected(RenewalDateFromFilterSelectedValue)) {
                DateTime d = DateParser.ParseDate(RenewalDateFromFilterSelectedValue, DateColumn.DEFAULT_FORMAT);
                RenewalDateFromFilterSelectedValue = d.ToShortDateString() + " " + "00:00:00";
                    
                wc.iAND(TermRenewalsTable.RenewalDate, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, RenewalDateFromFilterSelectedValue, false, false);
                    
            }         
            string RenewalDateToFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "RenewalDateToFilter_Ajax"];
            if (MiscUtils.IsValueSelected(RenewalDateToFilterSelectedValue)) {
                DateTime d = DateParser.ParseDate(RenewalDateToFilterSelectedValue, DateColumn.DEFAULT_FORMAT);
                RenewalDateToFilterSelectedValue = d.ToShortDateString() + " " + "23:59:59";
                    
                wc.iAND(TermRenewalsTable.RenewalDate, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, RenewalDateToFilterSelectedValue, false, false);
                    
            }         
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "TermRenewalsSearch") {
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_TermRenewalsSearch(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"TermRenewalsSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
      ...
      TermRenewalsRecord rec = new TermRenewalsRecord();
                        ...
                        if (recControl.Description.Text != "") {
                            rec.Parse(recControl.Description.Text, TermRenewalsTable.Description);
                  }
                
                        if (MiscUtils.IsValueSelected(recControl.PropertyID)) {
                            rec.Parse(recControl.PropertyID.SelectedItem.Value, TermRenewalsTable.PropertyID);
                        }
        ...
        public virtual void SetTermRenewalsSearch()
        {
                                            
            this.TermRenewalsSearch.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.TermRenewalsSearch.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("TermRenewalsTableControlRepeater");
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.RenewalDateFromFilter, this.RenewalDateFromFilter.Text);
                  
            this.SaveToSession(this.RenewalDateToFilter, this.RenewalDateToFilter.Text);
                  
            this.SaveToSession(this.TermRenewalsSearch, this.TermRenewalsSearch.Text);
      ...
      this.SaveToSession("RenewalDateFromFilter_Ajax", this.RenewalDateFromFilter.Text);
              
      this.SaveToSession("RenewalDateToFilter_Ajax", this.RenewalDateToFilter.Text);
              
      this.SaveToSession("TermRenewalsSearch_Ajax", this.TermRenewalsSearch.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.RenewalDateFromFilter);
            this.RemoveFromSession(this.RenewalDateToFilter);
            this.RemoveFromSession(this.TermRenewalsSearch);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetTermRenewalsAddButton()                
        ...
        public virtual void SetTermRenewalsDeleteButton()                
        ...
        public virtual void SetTermRenewalsSaveButton()                
              
        {
        
                    this.TermRenewalsSaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.Page.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
                  
   
        }
            
        public virtual void SetTermRenewalsSearchButton()                
        ...
        public virtual void PropertyIDSortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(TermRenewalsTable.PropertyID);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(TermRenewalsTable.PropertyID, OrderByItem.OrderDir.Asc);
        ...
        // event handler for ImageButton
        public virtual void TermRenewalsAddButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void TermRenewalsDeleteButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void TermRenewalsSaveButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void TermRenewalsSearchButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox RenewalDateFromFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RenewalDateFromFilter");
            }
        }
        
        public System.Web.UI.WebControls.Literal RenewalDateLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RenewalDateLabel1");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox RenewalDateToFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RenewalDateToFilter");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton TermRenewalsAddButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermRenewalsAddButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton TermRenewalsDeleteButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermRenewalsDeleteButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton TermRenewalsSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermRenewalsSaveButton");
            }
        }
        
        public System.Web.UI.WebControls.TextBox TermRenewalsSearch {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermRenewalsSearch");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton TermRenewalsSearchButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermRenewalsSearchButton");
            }
        }
        ...
        public System.Web.UI.WebControls.CheckBox TermRenewalsToggleAll {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermRenewalsToggleAll");
            }
        }              
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (TermRenewalsTableControlRow recControl in this.GetRecordControls())
            {
                if (recControl.TermRenewalsRecordRowSelection.Checked) {
                    return counter;
                }
                counter += 1;
            }
        ...
        {
        TermRenewalsTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual TermRenewalsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            foreach (TermRenewalsTableControlRow recControl in this.GetRecordControls())
            {
                if (recControl.TermRenewalsRecordRowSelection != null && recControl.TermRenewalsRecordRowSelection.Checked) {
                    selectedList.Add(recControl);
                }
            }
            return (TermRenewalsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditTermRenewalsTable.TermRenewalsTableControlRow")));
        ...
        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            ...
            foreach (TermRenewalsTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    ...
                    recCtl.TermRenewalsRecordRowSelection.Checked = false;
