...
// GroupByTermRenewalsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByTermRenewalsTable
{
...
// Base class for the TermRenewalsTableControlRow control on the GroupByTermRenewalsTable page.
...
public class BaseTermRenewalsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPropertyID()
        {
            ...
            if (this.DataSource != null && this.DataSource.PropertyIDSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&TermRenewalsTable.PropertyID.IsApplyDisplayAs)
                     ...
                     formattedValue = TermRenewalsTable.GetDFKA(this.DataSource.PropertyID.ToString(),TermRenewalsTable.PropertyID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(TermRenewalsTable.PropertyID);
              ...
              this.PropertyID.Text = TermRenewalsTable.PropertyID.Format(TermRenewalsTable.PropertyID.DefaultValue);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={TermRenewalsTableControlRow:FK:FK_TermRenewals_Properties}";
...
// Base class for the TermRenewalsTableControl control on the GroupByTermRenewalsTable page.
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      TermRenewalsRecord rec = new TermRenewalsRecord();
                        ...
                        if (recControl.PropertyID.Text != "") {
                            rec.Parse(recControl.PropertyID.Text, TermRenewalsTable.PropertyID);
                  }
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             null};
              ...
              DataForExport data = new DataForExport(TermRenewalsTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(TermRenewalsTable.PropertyID, "Default"));
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void TermRenewalsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByTermRenewalsTable.TermRenewalsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermRenewals";
                // If GroupByTermRenewalsTable.TermRenewalsPDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(TermRenewalsTable.PropertyID.Name, ReportEnum.Align.Left, "${PropertyID}", ReportEnum.Align.Left, 28);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = TermRenewalsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(TermRenewalsTable.PropertyID);
                                 _DFKA = TermRenewalsTable.GetDFKA(record.PropertyID.ToString(), TermRenewalsTable.PropertyID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  TermRenewalsTable.PropertyID.IsApplyDisplayAs){
                                     report.AddData("${PropertyID}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${PropertyID}", record.Format(TermRenewalsTable.PropertyID), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void TermRenewalsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByTermRenewalsTable.TermRenewalsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermRenewals";
                // If GroupByTermRenewalsTable.TermRenewalsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual TermRenewalsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TermRenewalsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByTermRenewalsTable.TermRenewalsTableControlRow")));
