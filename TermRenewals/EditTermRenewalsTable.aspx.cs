...
// This file implements the code-behind class for EditTermRenewalsTable.aspx.
// EditTermRenewalsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditTermRenewalsTable
        : BaseApplicationPage
// Code-behind class for the EditTermRenewalsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditTermRenewalsTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_TermRenewalsSearch(string prefixText, int count)
        {
            // GetTermRenewalsSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_TermRenewalsSearch_Base()
            // or replace the call to GetAutoCompletionList_TermRenewalsSearch_Base().
            return GetAutoCompletionList_TermRenewalsSearch_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditTermRenewalsTable.TermRenewalsTableControl TermRenewalsTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Term Renewals");
      ...
      public void SaveData_Base()
      {
        ...
        this.TermRenewalsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_TermRenewalsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditTermRenewalsTable.TermRenewalsTableControl control = new IPv5.UI.Controls.EditTermRenewalsTable.TermRenewalsTableControl();
        
        return control.GetAutoCompletionList_TermRenewalsSearch(prefixText, count);
        ...
        SetTermRenewalsTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "TermRenewalsMenuItem";
                    }
                }
