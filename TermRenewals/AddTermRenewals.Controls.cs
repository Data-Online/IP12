...
// AddTermRenewals.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.AddTermRenewals
{
...
// Base class for the TermRenewalsRecordControl control on the AddTermRenewals page.
...
public class BaseTermRenewalsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (TermRenewalsRecord)TermRenewalsRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in TermRenewalsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in AddTermRenewals"] = recId;
