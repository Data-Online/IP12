...
// This file implements the code-behind class for AddTermRenewals.aspx.
// AddTermRenewals.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddTermRenewals
        : BaseApplicationPage
// Code-behind class for the AddTermRenewals page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public AddTermRenewals()
        {
            this.Initialize();
...
public void SetTermRenewalsRecordControl()
        {
            SetTermRenewalsRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddTermRenewals.TermRenewalsRecordControl TermRenewalsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Term Renewals");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "TermRenewalsRecordControl":
                 SetTermRenewalsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.TermRenewalsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetTermRenewalsRecordControl_Base()           
        
        {        
            if (TermRenewalsRecordControl.Visible)
            {
                TermRenewalsRecordControl.LoadData();
                TermRenewalsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.TermRenewalsRecordControl != null && this.TermRenewalsRecordControl.DataSource != null)
                  {
                        id = this.TermRenewalsRecordControl.DataSource.GetValue(this.TermRenewalsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.TermRenewalsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.TermRenewalsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.TermRenewalsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.TermRenewalsRecordControl.DataSource.GetValue(this.TermRenewalsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
