<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowTermRenewalsGallery" Assembly="IPv5" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowTermRenewalsGallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowTermRenewalsGallery" %>
...
</td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td></tr><tr><td class="popupTableCellLabel"><asp:Literal runat="server" id="RenewalDateLabel" Text="Renewal Date">	</asp:Literal></td><td colspan="2" class="popupTableCellValue"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("TermRenewalsFilterButton"))%>
<asp:TextBox runat="server" id="RenewalDateFromFilter" columns="15" cssclass="Filter_Input" onkeyup="DateFormat(this, this.value, event.keyCode, &#39;d/mm/yyyy&#39;)" timestring="&quot;00:00:00&quot;" AutoPostback="False" style="vertical-align:middle">	</asp:TextBox>
	...
	<Selectors:CalendarExtendarClass runat="server" ID="RenewalDateToFilterCalenderExtender" TargetControlID="RenewalDateToFilter" CssClass="MyCalendar" Format="d">
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="TermRenewalsTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="TermRenewalsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3">&nbsp;</th></tr><asp:Repeater runat="server" id="TermRenewalsTableControlRepeater">		<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="TermRenewalsTableControlCellRepeater">		<ITEMTEMPLATE>		<IPv5:TermRenewalsTableControlRow runat="server" id="TermRenewalsTableControlRow">
...
</td></IPv5:TermRenewalsTableControlRow>
</ITEMTEMPLATE>
