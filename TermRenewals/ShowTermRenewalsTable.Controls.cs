...
// ShowTermRenewalsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowTermRenewalsTable
{
...
// Base class for the TermRenewalsTableControlRow control on the ShowTermRenewalsTable page.
...
public class BaseTermRenewalsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.TermRenewalsRowExpandCollapseRowButton.Click += TermRenewalsRowExpandCollapseRowButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetTermRenewalsTabContainer();
                SetTermRenewalsRowDeleteButton();
              
                SetTermRenewalsRowEditButton();
              
                SetTermRenewalsRowExpandCollapseRowButton();
        ...
        public virtual void SetTermRenewalsTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "TermRenewalsTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "TermRenewalsTabContainer").Visible = false;
      ...
      // To customize, override this method in TermRenewalsTableControlRow.
        ...
        public virtual void SetTermRenewalsRowExpandCollapseRowButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void TermRenewalsRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                TermRenewalsTableControl panelControl = (MiscUtils.GetParentControlObject(this, "TermRenewalsTableControl") as TermRenewalsTableControl);

          TermRenewalsTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (TermRenewalsTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "TermRenewalsTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.TermRenewalsRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.TermRenewalsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.TermRenewalsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.TermRenewalsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.TermRenewalsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.TermRenewalsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.TermRenewalsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton TermRenewalsRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermRenewalsRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer TermRenewalsTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermRenewalsTabContainer");
            }
        }
...
// Base class for the TermRenewalsTableControl control on the ShowTermRenewalsTable page.
...
public class BaseTermRenewalsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        TermRenewalsTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "TermRenewalsTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].TermRenewalsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].TermRenewalsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].TermRenewalsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].TermRenewalsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].TermRenewalsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].TermRenewalsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void TermRenewalsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowTermRenewalsTable.TermRenewalsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermRenewals";
                // If ShowTermRenewalsTable.TermRenewalsPDFButton.report specifies a valid report template,
        ...
        public virtual void TermRenewalsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowTermRenewalsTable.TermRenewalsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermRenewals";
                // If ShowTermRenewalsTable.TermRenewalsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual TermRenewalsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TermRenewalsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowTermRenewalsTable.TermRenewalsTableControlRow")));
...
// Base class for the PropertiesRecordControl control on the ShowTermRenewalsTable page.
...
public class BasePropertiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          TermRenewalsTableControlRow parentCtrl;
      
            parentCtrl = (TermRenewalsTableControlRow)MiscUtils.GetParentControlObject(this, "TermRenewalsTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue termRenewalsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = termRenewalsRecordObj;
          termRenewalsRecordObj = tmp;
        TermRenewalsTableControlRow termRenewalsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "TermRenewalsTableControlRow") as TermRenewalsTableControlRow);
          
              if (termRenewalsTableControlObjRow != null && termRenewalsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertiesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, termRenewalsTableControlObjRow.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInTermRenewalsTableControl = HttpContext.Current.Session["PropertiesRecordControlWhereClause"] as string;
      
      if (selectedRecordInTermRenewalsTableControl != null && KeyValue.IsXmlKey(selectedRecordInTermRenewalsTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInTermRenewalsTableControl);
