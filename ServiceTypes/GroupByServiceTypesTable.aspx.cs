...
// This file implements the code-behind class for GroupByServiceTypesTable.aspx.
// GroupByServiceTypesTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByServiceTypesTable
        : BaseApplicationPage
// Code-behind class for the GroupByServiceTypesTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByServiceTypesTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_ServiceTypesSearch(string prefixText, int count)
        {
            // GetServiceTypesSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_ServiceTypesSearch_Base()
            // or replace the call to GetAutoCompletionList_ServiceTypesSearch_Base().
            return GetAutoCompletionList_ServiceTypesSearch_Base(prefixText, count);
        }
...
public void SetServiceTypesTableControl()
        {
            SetServiceTypesTableControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButtonWithArrow ServiceTypesButtonsButton;
                
        public System.Web.UI.WebControls.ImageButton ServiceTypesExportExcelButton;
        
        public ThemeButton ServiceTypesFilterButton;
                
        public ThemeButtonWithArrow ServiceTypesFiltersButton;
        ...
        public PaginationModern ServiceTypesPagination;
        ...
        public IPv5.UI.Controls.GroupByServiceTypesTable.ServiceTypesTableControl ServiceTypesTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "ServiceTypesTableControl":
                 SetServiceTypesTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.ServiceTypesTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_ServiceTypesSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByServiceTypesTable.ServiceTypesTableControl control = new IPv5.UI.Controls.GroupByServiceTypesTable.ServiceTypesTableControl();
        
        return control.GetAutoCompletionList_ServiceTypesSearch(prefixText, count);
        ...
        SetServiceTypesTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "ServiceTypesMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetServiceTypesTableControl_Base()           
        
        {        
            if (ServiceTypesTableControl.Visible)
            {
                ServiceTypesTableControl.LoadData();
                ServiceTypesTableControl.DataBind();
            }
        }
