...
// This file implements the code-behind class for EditServiceTypesTable.aspx.
// EditServiceTypesTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditServiceTypesTable
        : BaseApplicationPage
// Code-behind class for the EditServiceTypesTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditServiceTypesTable()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditServiceTypesTable.ServiceTypesTableControl ServiceTypesTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Service Types");
    ...
    public static string[] GetAutoCompletionList_ServiceTypesSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditServiceTypesTable.ServiceTypesTableControl control = new IPv5.UI.Controls.EditServiceTypesTable.ServiceTypesTableControl();
