...
// EditServiceTypes.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditServiceTypes
{
...
// Base class for the SuppliersTableControlRow control on the EditServiceTypes page.
...
// Base class for the SuppliersTableControl control on the EditServiceTypes page.
...
public class BaseSuppliersTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.EditServiceTypes.ServiceTypesRecordControl serviceTypesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ServiceTypesRecordControl") as IPv5.UI.Controls.EditServiceTypes.ServiceTypesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual SuppliersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SuppliersTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditServiceTypes.SuppliersTableControlRow")));
...
// Base class for the ServiceTypesRecordControl control on the EditServiceTypes page.
...
public class BaseServiceTypesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in ServiceTypesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditServiceTypes"] = recId;
