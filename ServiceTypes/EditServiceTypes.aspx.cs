...
// This file implements the code-behind class for EditServiceTypes.aspx.
// EditServiceTypes.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditServiceTypes
        : BaseApplicationPage
// Code-behind class for the EditServiceTypes page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditServiceTypes()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditServiceTypes.ServiceTypesRecordControl ServiceTypesRecordControl;
        ...
        public IPv5.UI.Controls.EditServiceTypes.SuppliersTableControl SuppliersTableControl;
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.ServiceTypesRecordControl.SaveData();
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ServiceTypesRecordControl != null && this.ServiceTypesRecordControl.DataSource != null)
                  {
                        id = this.ServiceTypesRecordControl.DataSource.GetValue(this.ServiceTypesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ServiceTypesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ServiceTypesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ServiceTypesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ServiceTypesRecordControl.DataSource.GetValue(this.ServiceTypesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
