...
// This file implements the code-behind class for GroupByTermExpiresTable.aspx.
// GroupByTermExpiresTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByTermExpiresTable
        : BaseApplicationPage
// Code-behind class for the GroupByTermExpiresTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByTermExpiresTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_TermExpiresSearch(string prefixText, int count)
        {
            // GetTermExpiresSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_TermExpiresSearch_Base()
            // or replace the call to GetAutoCompletionList_TermExpiresSearch_Base().
            return GetAutoCompletionList_TermExpiresSearch_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButton TermExpiresFilterButton;
        ...
        public IPv5.UI.Controls.GroupByTermExpiresTable.TermExpiresTableControl TermExpiresTableControl;
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.TermExpiresTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_TermExpiresSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByTermExpiresTable.TermExpiresTableControl control = new IPv5.UI.Controls.GroupByTermExpiresTable.TermExpiresTableControl();
        
        return control.GetAutoCompletionList_TermExpiresSearch(prefixText, count);
        ...
        SetTermExpiresTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "TermExpiresMenuItem";
                    }
                }
