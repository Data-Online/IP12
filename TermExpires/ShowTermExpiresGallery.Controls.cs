...
// ShowTermExpiresGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowTermExpiresGallery
{
...
// Base class for the TermExpiresTableControlRow control on the ShowTermExpiresGallery page.
...
public class BaseTermExpiresTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in TermExpiresTableControlRow.
        ...
        public virtual void Description_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../TermExpires/ShowTermExpires.aspx?TermExpires={PK}";
...
// Base class for the TermExpiresTableControl control on the ShowTermExpiresGallery page.
...
public class BaseTermExpiresTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return TermExpiresTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual TermExpiresRecord[] CopyArray(int index, TermExpiresRecord[,] recs, int columns)
      {
        TermExpiresRecord[] recsCopy = new TermExpiresRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            TermExpiresRecord[,] recs = new TermExpiresRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            TermExpiresRecord[] HColDataSource = new TermExpiresRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              TermExpiresRecord[] VColDataSource = new TermExpiresRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("TermExpiresTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              TermExpiresRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                TermExpiresTableControlRow recControl = (TermExpiresTableControlRow)innerRepItem.FindControl("TermExpiresTableControlRow");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void TermExpiresPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowTermExpiresGallery.TermExpiresPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermExpires";
                // If ShowTermExpiresGallery.TermExpiresPDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  TermExpiresTable.PropertyID.IsApplyDisplayAs){
                                     ...
                                     report.AddData("${PropertyID}", record.Format(TermExpiresTable.PropertyID), ReportEnum.Align.Left, 100);
                                 }
                             }
                             report.AddData("${Description}", record.Format(TermExpiresTable.Description), ReportEnum.Align.Left);
        ...
        public virtual void TermExpiresWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowTermExpiresGallery.TermExpiresWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermExpires";
                // If ShowTermExpiresGallery.TermExpiresWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual TermExpiresTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TermExpiresTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowTermExpiresGallery.TermExpiresTableControlRow")));
