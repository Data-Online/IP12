...
// GroupByTermExpiresTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByTermExpiresTable
{
...
// Base class for the TermExpiresTableControlRow control on the GroupByTermExpiresTable page.
...
public class BaseTermExpiresTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPropertyID()
        {
            ...
            if (this.DataSource != null && this.DataSource.PropertyIDSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&TermExpiresTable.PropertyID.IsApplyDisplayAs)
                     ...
                     formattedValue = TermExpiresTable.GetDFKA(this.DataSource.PropertyID.ToString(),TermExpiresTable.PropertyID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(TermExpiresTable.PropertyID);
              ...
              this.PropertyID.Text = TermExpiresTable.PropertyID.Format(TermExpiresTable.PropertyID.DefaultValue);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={TermExpiresTableControlRow:FK:FK_TermExpires_Properties}";
...
// Base class for the TermExpiresTableControl control on the GroupByTermExpiresTable page.
...
public class BaseTermExpiresTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(TermExpiresTable.PropertyID, this.DataSource);
        }
      ...
      TermExpiresRecord rec = new TermExpiresRecord();
                        ...
                        if (recControl.PropertyID.Text != "") {
                            rec.Parse(recControl.PropertyID.Text, TermExpiresTable.PropertyID);
                  }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PropertyIDSortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(TermExpiresTable.PropertyID);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(TermExpiresTable.PropertyID, OrderByItem.OrderDir.Asc);
        ...
        public virtual void TermExpiresExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             data.ColumnList.Add(new ExcelColumn(TermExpiresTable.PropertyID, "Default"));
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void TermExpiresPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByTermExpiresTable.TermExpiresPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermExpires";
                // If GroupByTermExpiresTable.TermExpiresPDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(TermExpiresTable.PropertyID.Name, ReportEnum.Align.Left, "${PropertyID}", ReportEnum.Align.Left, 28);
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.PropertyID)){
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = TermExpiresTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(TermExpiresTable.PropertyID);
                                 _DFKA = TermExpiresTable.GetDFKA(record.PropertyID.ToString(), TermExpiresTable.PropertyID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  TermExpiresTable.PropertyID.IsApplyDisplayAs){
                                     report.AddData("${PropertyID}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${PropertyID}", record.Format(TermExpiresTable.PropertyID), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void TermExpiresWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByTermExpiresTable.TermExpiresWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermExpires";
                // If GroupByTermExpiresTable.TermExpiresWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual TermExpiresTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TermExpiresTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByTermExpiresTable.TermExpiresTableControlRow")));
