...
// This file implements the code-behind class for AddTermExpires.aspx.
// AddTermExpires.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddTermExpires
        : BaseApplicationPage
// Code-behind class for the AddTermExpires page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public AddTermExpires()
        {
            this.Initialize();
...
public void SetTermExpiresRecordControl()
        {
            SetTermExpiresRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddTermExpires.TermExpiresRecordControl TermExpiresRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Term Expires");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "TermExpiresRecordControl":
                 SetTermExpiresRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.TermExpiresRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetTermExpiresRecordControl_Base()           
        
        {        
            if (TermExpiresRecordControl.Visible)
            {
                TermExpiresRecordControl.LoadData();
                TermExpiresRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.TermExpiresRecordControl != null && this.TermExpiresRecordControl.DataSource != null)
                  {
                        id = this.TermExpiresRecordControl.DataSource.GetValue(this.TermExpiresRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.TermExpiresRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.TermExpiresRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.TermExpiresRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.TermExpiresRecordControl.DataSource.GetValue(this.TermExpiresRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
