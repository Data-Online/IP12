...
// ShowTermExpires.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowTermExpires
{
...
public class TermExpiresRecordControl : BaseTermExpiresRecordControl
{
      
        // The BaseTermExpiresRecordControl implements the LoadData, DataBind and other
...
// Base class for the TermExpiresRecordControl control on the ShowTermExpires page.
// Do not modify this class. Instead override any method in TermExpiresRecordControl.
public class BaseTermExpiresRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        public BaseTermExpiresRecordControl()
        {
        ...
        // To customize, override this method in TermExpiresRecordControl.
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.TermExpiresDialogEditButton.Click += TermExpiresDialogEditButton_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "TermExpiresRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            TermExpiresRecord[] recList = TermExpiresTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = TermExpiresTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetTermExpiresDialogEditButton();
      ...
      // To customize, override this method in TermExpiresRecordControl.
         ...
         
        {
            ...
            bool hasFiltersTermExpiresRecordControl = false;
            hasFiltersTermExpiresRecordControl = hasFiltersTermExpiresRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["TermExpires"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "TermExpires"));
            }
            HttpContext.Current.Session["QueryString in ShowTermExpires"] = recId;
          ...
          wc.iAND(TermExpiresTable.TermExpireID, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(TermExpiresTable.TermExpireID));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(TermExpiresTable.TermExpireID, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public virtual void SetTermExpiresDialogEditButton()                
        ...
        public virtual void TermExpiresDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={TermExpiresRecordControl:FK:FK_TermExpires_Properties}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseTermExpiresRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseTermExpiresRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton TermExpiresDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresDialogEditButton");
            }
        }
