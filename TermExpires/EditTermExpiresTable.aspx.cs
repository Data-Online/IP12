...
// This file implements the code-behind class for EditTermExpiresTable.aspx.
// EditTermExpiresTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditTermExpiresTable
        : BaseApplicationPage
// Code-behind class for the EditTermExpiresTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditTermExpiresTable()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditTermExpiresTable.TermExpiresTableControl TermExpiresTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Term Expires");
    ...
    public static string[] GetAutoCompletionList_TermExpiresSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditTermExpiresTable.TermExpiresTableControl control = new IPv5.UI.Controls.EditTermExpiresTable.TermExpiresTableControl();
