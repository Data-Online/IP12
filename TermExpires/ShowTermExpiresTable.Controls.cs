...
// ShowTermExpiresTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowTermExpiresTable
{
...
// Base class for the TermExpiresTableControlRow control on the ShowTermExpiresTable page.
...
public class BaseTermExpiresTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.TermExpiresRowExpandCollapseRowButton.Click += TermExpiresRowExpandCollapseRowButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetTermExpiresTabContainer();
                SetTermExpiresRowDeleteButton();
              
                SetTermExpiresRowEditButton();
              
                SetTermExpiresRowExpandCollapseRowButton();
        ...
        public virtual void SetTermExpiresTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "TermExpiresTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "TermExpiresTabContainer").Visible = false;
      ...
      // To customize, override this method in TermExpiresTableControlRow.
        ...
        public virtual void SetTermExpiresRowExpandCollapseRowButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void TermExpiresRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                TermExpiresTableControl panelControl = (MiscUtils.GetParentControlObject(this, "TermExpiresTableControl") as TermExpiresTableControl);

          TermExpiresTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (TermExpiresTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "TermExpiresTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.TermExpiresRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.TermExpiresRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.TermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.TermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.TermExpiresRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.TermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.TermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton TermExpiresRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer TermExpiresTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresTabContainer");
            }
        }
...
// Base class for the TermExpiresTableControl control on the ShowTermExpiresTable page.
...
public class BaseTermExpiresTableControl : IPv5.UI.BaseApplicationTableControl
{
       ...
       public BaseTermExpiresTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.TermExpiresSearch)) 				
                    initialVal = this.GetFromSession(this.TermExpiresSearch);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.TermExpiresSearch.Text = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.TermExpiresResetButton.Click += TermExpiresResetButton_Click;
                        
                    this.TermExpiresSearchButton.Click += TermExpiresSearchButton_Click;
                    ...
                    this.TermExpiresFilterButton.Button.Click += TermExpiresFilterButton_Click;
         ...
         //' Setup events for others
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "TermExpiresSearchSearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + TermExpiresSearch.ClientID + "\");", true);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetTermExpiresResetButton();
              
                SetTermExpiresSearchButton();
              
                SetTermExpiresWordButton();
              
                SetTermExpiresButtonsButton();
              
                SetTermExpiresFilterButton();
        ...
        TermExpiresTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "TermExpiresTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].TermExpiresRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].TermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].TermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].TermExpiresRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].TermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].TermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.PropertyIDFilter)) {
                ...
                wc.iAND(TermExpiresTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.PropertyIDFilter, this.GetFromSession(this.PropertyIDFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.TermExpiresSearch)) {
                if (this.TermExpiresSearch.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.TermExpiresSearch.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.TermExpiresSearch.Text.StartsWith("...")) {
                      this.TermExpiresSearch.Text = this.TermExpiresSearch.Text.Substring(3,this.TermExpiresSearch.Text.Length-3);
                  }
                  if (this.TermExpiresSearch.Text.EndsWith("...")) {
                      this.TermExpiresSearch.Text = this.TermExpiresSearch.Text.Substring(0,this.TermExpiresSearch.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.TermExpiresSearch.Text.Length - 1;
                      while (!Char.IsWhiteSpace(TermExpiresSearch.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.TermExpiresSearch.Text = this.TermExpiresSearch.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.TermExpiresSearch, this.GetFromSession(this.TermExpiresSearch));
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.TermExpiresSearch, this.GetFromSession(this.TermExpiresSearch)), true, false);
      ...
      String PropertyIDFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "PropertyIDFilter_Ajax"];
            if (MiscUtils.IsValueSelected(PropertyIDFilterSelectedValue)) {
                ...
                wc.iAND(TermExpiresTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, PropertyIDFilterSelectedValue, false, false);
                      
      }
                      
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "TermExpiresSearch") {
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_TermExpiresSearch(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"TermExpiresSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
      ...
      TermExpiresRecord rec = new TermExpiresRecord();
        ...
        public virtual void SetTermExpiresSearch()
        {
                                            
            this.TermExpiresSearch.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.TermExpiresSearch.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
                    ...
                    foreach (PropertiesRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.PropertyIDSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.PropertyIDFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = TermExpiresTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(TermExpiresTable.PropertyID);
                                if(_isExpandableNonCompositeForeignKey && TermExpiresTable.PropertyID.IsApplyDisplayAs)
                                     fvalue = TermExpiresTable.GetDFKA(itemValue, TermExpiresTable.PropertyID);
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.TermExpiresSearch, this.TermExpiresSearch.Text);
      ...
      this.SaveToSession("TermExpiresSearch_Ajax", this.TermExpiresSearch.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.TermExpiresSearch);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetTermExpiresResetButton()                
        ...
        public virtual void SetTermExpiresSearchButton()                
        ...
        public virtual void SetTermExpiresFilterButton()                
              ...
              
        {
         ...
         themeButtonTermExpiresFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(PropertyIDFilter))
                themeButtonTermExpiresFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void TermExpiresPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowTermExpiresTable.TermExpiresPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermExpires";
                // If ShowTermExpiresTable.TermExpiresPDFButton.report specifies a valid report template,
        ...
        // event handler for ImageButton
        public virtual void TermExpiresResetButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void TermExpiresSearchButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        public virtual void TermExpiresWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowTermExpiresTable.TermExpiresWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermExpires";
                // If ShowTermExpiresTable.TermExpiresWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        // event handler for Button
        public virtual void TermExpiresFilterButton_Click(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public IPv5.UI.IThemeButton TermExpiresFilterButton {
            get {
                return (IPv5.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresFilterButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton TermExpiresResetButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresResetButton");
            }
        }
        
        public System.Web.UI.WebControls.TextBox TermExpiresSearch {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresSearch");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton TermExpiresSearchButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresSearchButton");
            }
        }
        
        public System.Web.UI.WebControls.Literal TermExpiresTitle {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresTitle");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual TermExpiresTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TermExpiresTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowTermExpiresTable.TermExpiresTableControlRow")));
...
// Base class for the PropertiesRecordControl control on the ShowTermExpiresTable page.
...
public class BasePropertiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          TermExpiresTableControlRow parentCtrl;
      
            parentCtrl = (TermExpiresTableControlRow)MiscUtils.GetParentControlObject(this, "TermExpiresTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue termExpiresRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = termExpiresRecordObj;
          termExpiresRecordObj = tmp;
        TermExpiresTableControlRow termExpiresTableControlObjRow = (MiscUtils.GetParentControlObject(this, "TermExpiresTableControlRow") as TermExpiresTableControlRow);
          
              if (termExpiresTableControlObjRow != null && termExpiresTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertiesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, termExpiresTableControlObjRow.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInTermExpiresTableControl = HttpContext.Current.Session["PropertiesRecordControlWhereClause"] as string;
      
      if (selectedRecordInTermExpiresTableControl != null && KeyValue.IsXmlKey(selectedRecordInTermExpiresTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInTermExpiresTableControl);
