...
// EditTermExpiresTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditTermExpiresTable
{
...
// Base class for the TermExpiresTableControlRow control on the EditTermExpiresTable page.
...
public class BaseTermExpiresTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.TermExpiresRowViewButton.Click += TermExpiresRowViewButton_Click;
        ...
        public virtual void SetPropertyID()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = TermExpiresTable.PropertyID.DefaultValue;
        ...
        public virtual void GetPropertyID()
        {
         // Retrieve the value entered by the user on the PropertyID ASP:DropDownList, and
            // save it into the PropertyID field in DataSource DatabaseMM_IP1%dbo.TermExpires record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.PropertyID), TermExpiresTable.PropertyID);			
      ...
      // To customize, override this method in TermExpiresTableControlRow.
        ...
        public virtual void SetTermExpiresRowViewButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void TermExpiresRowViewButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton TermExpiresRowViewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresRowViewButton");
            }
        }
...
// Base class for the TermExpiresTableControl control on the EditTermExpiresTable page.
...
public class BaseTermExpiresTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.TermExpiresSaveButton.Click += TermExpiresSaveButton_Click;
      ...
      public override void DataBind()
      {
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"TermExpiresSaveButton"));
      ...
      TermExpiresRecord rec = new TermExpiresRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.PropertyID)) {
                            rec.Parse(recControl.PropertyID.SelectedItem.Value, TermExpiresTable.PropertyID);
                        }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetTermExpiresSaveButton()                
              
        {
        
                    this.TermExpiresSaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.Page.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
        ...
        // event handler for ImageButton
        public virtual void TermExpiresSaveButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton TermExpiresSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresSaveButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual TermExpiresTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TermExpiresTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditTermExpiresTable.TermExpiresTableControlRow")));
