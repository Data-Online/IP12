...
// EditTermExpires.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditTermExpires
{
...
// Base class for the TermExpiresRecordControl control on the EditTermExpires page.
...
public class BaseTermExpiresRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in TermExpiresRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditTermExpires"] = recId;
