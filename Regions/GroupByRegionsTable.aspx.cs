...
// This file implements the code-behind class for GroupByRegionsTable.aspx.
// GroupByRegionsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByRegionsTable
        : BaseApplicationPage
// Code-behind class for the GroupByRegionsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByRegionsTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_RegionsSearch(string prefixText, int count)
        {
            // GetRegionsSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_RegionsSearch_Base()
            // or replace the call to GetAutoCompletionList_RegionsSearch_Base().
            return GetAutoCompletionList_RegionsSearch_Base(prefixText, count);
        }
...
public void SetRegionsTableControl()
        {
            SetRegionsTableControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButtonWithArrow RegionsButtonsButton;
                
        public System.Web.UI.WebControls.ImageButton RegionsExportExcelButton;
        
        public ThemeButton RegionsFilterButton;
                
        public ThemeButtonWithArrow RegionsFiltersButton;
        ...
        public PaginationModern RegionsPagination;
        ...
        public IPv5.UI.Controls.GroupByRegionsTable.RegionsTableControl RegionsTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "RegionsTableControl":
                 SetRegionsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.RegionsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_RegionsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByRegionsTable.RegionsTableControl control = new IPv5.UI.Controls.GroupByRegionsTable.RegionsTableControl();
        
        return control.GetAutoCompletionList_RegionsSearch(prefixText, count);
        ...
        SetRegionsTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "RegionsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRegionsTableControl_Base()           
        
        {        
            if (RegionsTableControl.Visible)
            {
                RegionsTableControl.LoadData();
                RegionsTableControl.DataBind();
            }
        }
