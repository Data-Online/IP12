...
// This file implements the code-behind class for AddRegions.aspx.
// AddRegions.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddRegions
        : BaseApplicationPage
// Code-behind class for the AddRegions page.
...
public void SetRegionsRecordControl()
        {
            SetRegionsRecordControl_Base(); 
        }
...
public void SetRegionsTabContainer()
        {
            SetRegionsTabContainer_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddRegions.ContactsTableControl ContactsTableControl;
        ...
        public IPv5.UI.Controls.AddRegions.PropertiesTableControl PropertiesTableControl;
        ...
        public IPv5.UI.Controls.AddRegions.PropertyContactsTableControl PropertyContactsTableControl;
        ...
        public IPv5.UI.Controls.AddRegions.RegionsRecordControl RegionsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Regions");
      ...
      public void SaveData_Base()
      {
        ...
        this.RegionsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRegionsTabContainer_Base()           
        ...
        public void SetRegionsRecordControl_Base()           
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.RegionsRecordControl != null && this.RegionsRecordControl.DataSource != null)
                  {
                        id = this.RegionsRecordControl.DataSource.GetValue(this.RegionsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.RegionsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.RegionsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.RegionsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.RegionsRecordControl.DataSource.GetValue(this.RegionsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
