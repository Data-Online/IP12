...
// ShowRegions.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowRegions
{
...
// Base class for the ContactsTableControlRow control on the ShowRegions page.
...
// Base class for the ContactsTableControl control on the ShowRegions page.
...
public class BaseContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.ShowRegions.RegionsRecordControl regionsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "RegionsRecordControl") as IPv5.UI.Controls.ShowRegions.RegionsRecordControl);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ContactsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRegions.ContactsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If ShowRegions.ContactsPDFButton.report specifies a valid report template,
        ...
        public virtual void ContactsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRegions.ContactsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If ShowRegions.ContactsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowRegions.ContactsTableControlRow")));
...
// Base class for the PropertiesTableControlRow control on the ShowRegions page.
...
// Base class for the PropertiesTableControl control on the ShowRegions page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertiesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRegions.PropertiesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Properties";
                // If ShowRegions.PropertiesPDFButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.   
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void PropertiesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRegions.PropertiesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Properties";
                // If ShowRegions.PropertiesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual PropertiesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertiesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowRegions.PropertiesTableControlRow")));
...
// Base class for the PropertyContactsTableControlRow control on the ShowRegions page.
...
// Base class for the PropertyContactsTableControl control on the ShowRegions page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyContactsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRegions.PropertyContactsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyContacts";
                // If ShowRegions.PropertyContactsPDFButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.   
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void PropertyContactsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRegions.PropertyContactsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyContacts";
                // If ShowRegions.PropertyContactsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowRegions.PropertyContactsTableControlRow")));
...
// Base class for the RegionsRecordControl control on the ShowRegions page.
...
public class BaseRegionsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.RegionsDialogEditButton.Click += RegionsDialogEditButton_Click;
      ...
      // To customize, override this method in RegionsRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Regions"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "Regions"));
            }
            HttpContext.Current.Session["QueryString in ShowRegions"] = recId;
        ...
        public virtual void SetRegionsDialogEditButton()                
        ...
        // event handler for ImageButton
        public virtual void RegionsDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton RegionsDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsDialogEditButton");
            }
        }
