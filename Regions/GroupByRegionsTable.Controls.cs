...
// GroupByRegionsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByRegionsTable
{
...
public class RegionsTableControlRow : BaseRegionsTableControlRow
{
      
        // The BaseRegionsTableControlRow implements code for a ROW within the
        // the RegionsTableControl table.  The BaseRegionsTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of RegionsTableControl.
...
public class RegionsTableControl : BaseRegionsTableControl
{
    // The BaseRegionsTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The RegionsTableControlRow class offers another place where you can customize
    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
...
// Base class for the ContactsTableControlRow control on the GroupByRegionsTable page.
...
public class BaseContactsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.CountryID2.Click += CountryID2_Click;
        ...
        public virtual void SetCountryID2()
        {
            ...
            // this.DataSource is the DatabaseMM_IP1%dbo.Contacts record retrieved from the database.
            // this.CountryID2 is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.CountryIDSpecified) {
               ...
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                ...
                this.CountryID2.Text = formattedValue;
                
                  this.CountryID2.ToolTip = "Go to " + this.CountryID2.Text.Replace("<wbr/>", "");
              ...
              this.CountryID2.Text = ContactsTable.CountryID.Format(ContactsTable.CountryID.DefaultValue);
        ...
        RegionsTableControlRow parentCtrl;
      
            parentCtrl = (RegionsTableControlRow)MiscUtils.GetParentControlObject(this, "RegionsTableControlRow");
      ...
      // To customize, override this method in ContactsTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersRegionsTableControl = false;
            hasFiltersRegionsTableControl = hasFiltersRegionsTableControl && false; // suppress warning
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for LinkButton
        public virtual void CountryID2_Click(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton CountryID2 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CountryID2");
            }
        }
...
// Base class for the ContactsTableControl control on the GroupByRegionsTable page.
...
public class BaseContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue regionsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = regionsRecordObj;
          regionsRecordObj = tmp;
        RegionsTableControlRow regionsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "RegionsTableControlRow") as RegionsTableControlRow);
          
              if (regionsTableControlObjRow != null && regionsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(ContactsTable.RegionID, BaseFilter.ComparisonOperator.EqualsTo, regionsTableControlObjRow.GetRecord().RegionID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInRegionsTableControl = HttpContext.Current.Session["ContactsTableControlWhereClause"] as string;
      
      if (selectedRecordInRegionsTableControl != null && KeyValue.IsXmlKey(selectedRecordInRegionsTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInRegionsTableControl);
      ...
      ContactsRecord rec = new ContactsRecord();
                        ...
                        if (recControl.CountryID2.Text != "") {
                            rec.Parse(recControl.CountryID2.Text, ContactsTable.CountryID);
                  }
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByRegionsTable.ContactsTableControlRow")));
...
// Base class for the PropertiesTableControlRow control on the GroupByRegionsTable page.
...
public class BasePropertiesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetCountryID1()
        {
            ...
            if (this.DataSource != null && this.DataSource.CountryIDSpecified) {
              ...
              this.CountryID1.Text = PropertiesTable.CountryID.Format(PropertiesTable.CountryID.DefaultValue);
...
// Base class for the PropertiesTableControl control on the GroupByRegionsTable page.
    ...
    // Setup default pagination settings.
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        RegionsTableControlRow regionsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "RegionsTableControlRow") as RegionsTableControlRow);
              ...
              if (regionsTableControlObjRow != null && regionsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertiesTable.RegionID, BaseFilter.ComparisonOperator.EqualsTo, regionsTableControlObjRow.GetRecord().RegionID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInRegionsTableControl = HttpContext.Current.Session["PropertiesTableControlWhereClause"] as string;
      ...
      PropertiesRecord rec = new PropertiesRecord();
                        ...
                        if (recControl.CountryID1.Text != "") {
                            rec.Parse(recControl.CountryID1.Text, PropertiesTable.CountryID);
                  }
...
#region "Helper Functions"
        ...
        public virtual PropertiesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertiesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByRegionsTable.PropertiesTableControlRow")));
...
// Base class for the PropertyContactsTableControlRow control on the GroupByRegionsTable page.
...
// Base class for the PropertyContactsTableControl control on the GroupByRegionsTable page.
    ...
    // Setup default pagination settings.
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        RegionsTableControlRow regionsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "RegionsTableControlRow") as RegionsTableControlRow);
              ...
              if (regionsTableControlObjRow != null && regionsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertyContactsTable.RegionID, BaseFilter.ComparisonOperator.EqualsTo, regionsTableControlObjRow.GetRecord().RegionID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInRegionsTableControl = HttpContext.Current.Session["PropertyContactsTableControlWhereClause"] as string;
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByRegionsTable.PropertyContactsTableControlRow")));
...
// Base class for the RegionsTableControlRow control on the GroupByRegionsTable page.
// Do not modify this class. Instead override any method in RegionsTableControlRow.
public class BaseRegionsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        public BaseRegionsTableControlRow()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in RegionsTableControlRow.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        {      
              ...
              // Show confirmation message on Click
              this.RegionsRowDeleteButton.Attributes.Add("onClick", "return (confirm(\"" + ((BaseApplicationPage)this.Page).GetResourceValue("DeleteRecordConfirm", "IPv5") + "\"));");            
        
              // Register the event handlers.

          
                    this.RegionsRowDeleteButton.Click += RegionsRowDeleteButton_Click;
                        
                    this.RegionsRowEditButton.Click += RegionsRowEditButton_Click;
                        
                    this.RegionsRowExpandCollapseRowButton.Click += RegionsRowExpandCollapseRowButton_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseRegionsTableControl when the data for the entire
            // table is loaded.
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetRegionsTabContainer();
                SetRegionsRowDeleteButton();
              
                SetRegionsRowEditButton();
              
                SetRegionsRowExpandCollapseRowButton();
        ...
        public virtual void SetRegionsTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "RegionsTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "RegionsTabContainer").Visible = false;
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                // Set the DataChanged flag to True for the for the related panels so they get refreshed as well.
                ((RegionsTableControl)MiscUtils.GetParentControlObject(this, "RegionsTableControl")).DataChanged = true;
                ((RegionsTableControl)MiscUtils.GetParentControlObject(this, "RegionsTableControl")).ResetData = true;
            }
      ...
      // To customize, override this method in RegionsTableControlRow.
        ...
        public virtual void SetRegionsRowDeleteButton()                
        ...
        public virtual void SetRegionsRowEditButton()                
        ...
        public virtual void SetRegionsRowExpandCollapseRowButton()                
        ...
        // event handler for ImageButton
        public virtual void RegionsRowDeleteButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.CommitTransaction(sender);
        ...
        // event handler for ImageButton
        public virtual void RegionsRowEditButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Regions/EditRegions.aspx?Regions={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void RegionsRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                RegionsTableControl panelControl = (MiscUtils.GetParentControlObject(this, "RegionsTableControl") as RegionsTableControl);

          RegionsTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (RegionsTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "RegionsTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.RegionsRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.RegionsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.RegionsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.RegionsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.RegionsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.RegionsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.RegionsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseRegionsTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseRegionsTableControlRow_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton RegionsRowDeleteButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsRowDeleteButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton RegionsRowEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsRowEditButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton RegionsRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer RegionsTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsTabContainer");
            }
        }
...
// Base class for the RegionsTableControl control on the GroupByRegionsTable page.
// Do not modify this class. Instead override any method in RegionsTableControl.
public class BaseRegionsTableControl : IPv5.UI.BaseApplicationTableControl
{
         
       public BaseRegionsTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.RegionFilter)) 				
                    initialVal = this.GetFromSession(this.RegionFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"Region\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.RegionFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.RegionFilter.SelectedValue = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.RegionsSearch)) 				
                    initialVal = this.GetFromSession(this.RegionsSearch);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.RegionsSearch.Text = initialVal;
    ...
    // Setup default pagination settings.
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            // Setup the pagination events.
                    ...
                    this.RegionsPagination.FirstPage.Click += RegionsPagination_FirstPage_Click;
                        
                    this.RegionsPagination.LastPage.Click += RegionsPagination_LastPage_Click;
                        
                    this.RegionsPagination.NextPage.Click += RegionsPagination_NextPage_Click;
                        
                    this.RegionsPagination.PageSizeButton.Click += RegionsPagination_PageSizeButton_Click;
                        
                    this.RegionsPagination.PreviousPage.Click += RegionsPagination_PreviousPage_Click;
       ...
       // Setup the sorting events.
              ...
              this.RegionSortLabel.Click += RegionSortLabel_Click;
            
            // Setup the button events.
          
                    this.RegionsExportExcelButton.Click += RegionsExportExcelButton_Click;
                        
                    this.RegionsImportButton.Click += RegionsImportButton_Click;
                        
                    this.RegionsNewButton.Click += RegionsNewButton_Click;
                        
                    this.RegionsPDFButton.Click += RegionsPDFButton_Click;
                        
                    this.RegionsResetButton.Click += RegionsResetButton_Click;
                        
                    this.RegionsSearchButton.Click += RegionsSearchButton_Click;
                        
                    this.RegionsWordButton.Click += RegionsWordButton_Click;
                        
                    this.RegionsButtonsButton.Button.Click += RegionsButtonsButton_Click;
                        
                    this.RegionsFilterButton.Button.Click += RegionsFilterButton_Click;
                        
                    this.RegionsFiltersButton.Button.Click += RegionsFiltersButton_Click;
                        
            this.RegionFilter.SelectedIndexChanged += new EventHandler(RegionFilter_SelectedIndexChanged);
                    
        
         //' Setup events for others
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "RegionsSearchSearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + RegionsSearch.ClientID + "\");", true);
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                        // Initialize an empty array of records
                      ArrayList alist = new ArrayList(0);
                      Type myrec = typeof(IPv5.Business.RegionsRecord);
                      this.DataSource = (RegionsRecord[])(alist.ToArray(myrec));
                      // Add records to the list if needed.
                      this.AddNewRecords();
                      this._TotalRecords = 0;
                      this._TotalPages = 0;
                ...
                if (this.AddNewRecord > 0) {
                    // Make sure to preserve the previously entered data on new rows.
                    ArrayList postdata = new ArrayList(0);
                    foreach (RegionsTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                            rc.DataSource = rc.GetRecord();
                            rc.GetUIData();
                            postdata.Add(rc.DataSource);
                    ...
                    Type myrec = typeof(IPv5.Business.RegionsRecord);
                    this.DataSource = (RegionsRecord[])(postdata.ToArray(myrec));
                } 
                else {
                    // Get the records from the database
        ...
        public virtual RegionsRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            // by default, Select * will be executed to get a list of records.  If you want to run Select Distinct with certain column only, add the column to selCols
            ColumnList selCols = new ColumnList();                 
            ...
            // However, if you don't specify PK, row button click might show an error message.
            // And make sure you write similar code in GetRecordCount as well
            // selCols.Add(RegionsTable.Column1, true);          
            // selCols.Add(RegionsTable.Column2, true);          
            // selCols.Add(RegionsTable.Column3, true);          
                  ...
                  
            {
                ...
                return RegionsTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                RegionsTable databaseTable = new RegionsTable();
                databaseTable.SelectedColumns.Clear();
                databaseTable.SelectedColumns.AddRange(selCols);
                ...
                orderBy.ExpandForeignKeyColums = false;
                recList = databaseTable.GetRecordList(join, where.GetFilter(), null, orderBy, pageIndex, pageSize);
                return (recList.ToArray(typeof(RegionsRecord)) as RegionsRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return RegionsTable.GetRecordCount(join, where);
            else
            {
                RegionsTable databaseTable = new RegionsTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsTableControlRepeater"));
        if (rep == null){return;}
        rep.DataSource = this.DataSource;
        rep.DataBind();
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Loop through all rows in the table, set its DataSource and call DataBind().
            RegionsTableControlRow recControl = (RegionsTableControlRow)(repItem.FindControl("RegionsTableControlRow"));
            recControl.DataSource = this.DataSource[index];            
            if (this.UIData.Count > index)
                recControl.PreviousUIData = this.UIData[index];
            recControl.DataBind();
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetRegionsExportExcelButton();
              
                SetRegionsImportButton();
              
                SetRegionsNewButton();
              
                SetRegionsPDFButton();
              
                SetRegionsResetButton();
              
                SetRegionsSearchButton();
              
                SetRegionsWordButton();
              
                SetRegionsButtonsButton();
              
                SetRegionsFilterButton();
              
                SetRegionsFiltersButton();
              
            // setting the state of expand or collapse alternative rows
      
            bool expandFirstRow = true;
        RegionsTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "RegionsTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].RegionsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].RegionsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].RegionsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].RegionsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].RegionsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].RegionsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        if (this.TotalRecords > 10000)
          this.RegionsExportExcelButton.Attributes.Add("onClick", "return (confirm('" + ((BaseApplicationPage)this.Page).GetResourceValue("ExportConfirm", "IPv5") + "'));");
        else
          this.RegionsExportExcelButton.Attributes.Remove("onClick");
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"RegionsExportExcelButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"RegionsPDFButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"RegionsWordButton"));
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            {
                this.RegionsPagination.CurrentPage.Text = (this.PageIndex + 1).ToString();
            } 
            else
            {
                this.RegionsPagination.CurrentPage.Text = "0";
            }
            this.RegionsPagination.PageSize.Text = this.PageSize.ToString();
    
            // Bind the buttons for RegionsTableControl pagination.
        
            this.RegionsPagination.FirstPage.Enabled = !(this.PageIndex == 0);
            if (this._TotalPages < 0)             // if the total pages is not determined yet, enable last and next buttons
                this.RegionsPagination.LastPage.Enabled = true;
            else if (this._TotalPages == 0)          // if the total pages is determined and it is 0, enable last and next buttons
                this.RegionsPagination.LastPage.Enabled = false;            
            else                                     // if the total pages is the last page, disable last and next buttons
                this.RegionsPagination.LastPage.Enabled = !(this.PageIndex == this.TotalPages - 1);            
          
            if (this._TotalPages < 0)             // if the total pages is not determined yet, enable last and next buttons
                this.RegionsPagination.NextPage.Enabled = true;
            else if (this._TotalPages == 0)          // if the total pages is determined and it is 0, enable last and next buttons
                this.RegionsPagination.NextPage.Enabled = false;            
            else                                     // if the total pages is the last page, disable last and next buttons
                this.RegionsPagination.NextPage.Enabled = !(this.PageIndex == this.TotalPages - 1);            
          
            this.RegionsPagination.PreviousPage.Enabled = !(this.PageIndex == 0);    
        }
        ...
        public virtual void SaveData()
        {
            ...
            foreach (RegionsTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.RegionFilter)) {
                        
                wc.iAND(RegionsTable.Region, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.RegionFilter, this.GetFromSession(this.RegionFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.RegionsSearch)) {
                if (this.RegionsSearch.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.RegionsSearch.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.RegionsSearch.Text.StartsWith("...")) {
                      this.RegionsSearch.Text = this.RegionsSearch.Text.Substring(3,this.RegionsSearch.Text.Length-3);
                  }
                  if (this.RegionsSearch.Text.EndsWith("...")) {
                      this.RegionsSearch.Text = this.RegionsSearch.Text.Substring(0,this.RegionsSearch.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.RegionsSearch.Text.Length - 1;
                      while (!Char.IsWhiteSpace(RegionsSearch.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.RegionsSearch.Text = this.RegionsSearch.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.RegionsSearch, this.GetFromSession(this.RegionsSearch));
      ...
      cols.Add(RegionsTable.Region, true);
      
      foreach(BaseColumn col in cols)
      {
      
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.RegionsSearch, this.GetFromSession(this.RegionsSearch)), true, false);
      ...
      String RegionFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "RegionFilter_Ajax"];
            if (MiscUtils.IsValueSelected(RegionFilterSelectedValue)) {

              
                wc.iAND(RegionsTable.Region, BaseFilter.ComparisonOperator.EqualsTo, RegionFilterSelectedValue, false, false);
                      
      }
                      
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "RegionsSearch") {
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_RegionsSearch(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"RegionsSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
            IPv5.Business.RegionsRecord[] recordList  = RegionsTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (RegionsRecord rec in recordList ){
                ...
                resultItem = rec.Format(RegionsTable.Region);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(RegionsTable.Region.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RegionsTable.Region.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void GetPageSize()
        {
            ...
            if (this.RegionsPagination.PageSize.Text.Length > 0) {
                try {
                    // this.PageSize = Convert.ToInt32(this.RegionsPagination.PageSize.Text);
                } catch (Exception ) {
                }
            }
        }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (recControl.Visible && recControl.IsNewRecord) {
      RegionsRecord rec = new RegionsRecord();
        
                        if (recControl.Region.Text != "") {
                            rec.Parse(recControl.Region.Text, RegionsTable.Region);
                  }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new RegionsRecord());
                newUIDataList.Insert(0, new Hashtable());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(IPv5.Business.RegionsRecord);
                this.DataSource = (RegionsRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(RegionsTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(RegionsTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual void SetRegionLabel1()
                  {
                  
                    
        }
                
        public virtual void SetRegionSortLabel()
                  {
                  
                    
        }
                
        public virtual void SetRegionFilter()
        {
            
            this.PopulateRegionFilter(MiscUtils.GetSelectedValue(this.RegionFilter,  GetFromSession(this.RegionFilter)), 500);					
                                     
        }
            
        public virtual void SetRegionsSearch()
        {
                                            
            this.RegionsSearch.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.RegionsSearch.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
                                   
        }
            
        // Get the filters' data for RegionFilter.
                
        protected virtual void PopulateRegionFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.RegionFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_RegionFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_RegionFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.RegionFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "IPv5"), "--ANY--"));
            ...
            if (wc.RunQuery)
            {
                ...
                values = RegionsTable.GetValues(RegionsTable.Region, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( RegionsTable.Region.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = RegionsTable.Region.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.RegionFilter.Items.FindByText(fvalue);
                ...
                this.RegionFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                MiscUtils.SetSelectedValue(this.RegionFilter, selectedValue);
            ...
            if (this.RegionFilter.SelectedValue != null && this.RegionFilter.Items.FindByValue(this.RegionFilter.SelectedValue) == null)
                this.RegionFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_RegionFilter()
        {
            // Create a where clause for the filter RegionFilter.
            // This function is called by the Populate method to load the items 
            // in the RegionFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.RegionFilter, this.RegionFilter.SelectedValue);
                  
            this.SaveToSession(this.RegionsSearch, this.RegionsSearch.Text);
      ...
      this.SaveToSession("RegionFilter_Ajax", this.RegionFilter.SelectedValue);
              
      this.SaveToSession("RegionsSearch_Ajax", this.RegionsSearch.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.RegionFilter);
            this.RemoveFromSession(this.RegionsSearch);
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["RegionsTableControl_OrderBy"];
            ...
            Control Pagination = this.FindControl("RegionsPagination");
            String PaginationType = "";
            if (Pagination != null){
              Control Summary = Pagination.FindControl("_Summary");
              if (Summary != null){
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["RegionsTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetRegionsExportExcelButton()                
        ...
        public virtual void SetRegionsImportButton()                
              
        {
        							
                    this.RegionsImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Regions" ;
                    this.RegionsImportButton.Attributes["onClick"] = "window.open('" + this.Page.EncryptUrlParameter(this.RegionsImportButton.PostBackUrl) + "','importWindow', 'width=700, height=500,top=' +(screen.availHeight-500)/2 + ',left=' + (screen.availWidth-700)/2+ ', resizable=yes, scrollbars=yes,modal=yes'); return false;";
                        
   
        }
            
        public virtual void SetRegionsNewButton()                
        ...
        public virtual void SetRegionsPDFButton()                
        ...
        public virtual void SetRegionsResetButton()                
        ...
        public virtual void SetRegionsSearchButton()                
        ...
        public virtual void SetRegionsWordButton()                
        ...
        public virtual void SetRegionsButtonsButton()                
        ...
        public virtual void SetRegionsFilterButton()                
        ...
        public virtual void SetRegionsFiltersButton()                
              
        {
                
         IThemeButtonWithArrow themeButtonRegionsFiltersButton = (IThemeButtonWithArrow)(MiscUtils.FindControlRecursively(this, "RegionsFiltersButton"));
         themeButtonRegionsFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
    
      
            if (MiscUtils.IsValueSelected(RegionFilter))
                themeButtonRegionsFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        // event handler for ImageButton
        public virtual void RegionsPagination_FirstPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void RegionsPagination_LastPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void RegionsPagination_NextPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for LinkButton
        public virtual void RegionsPagination_PageSizeButton_Click(object sender, EventArgs args)
        {
            ...
            this.PageSize = this.RegionsPagination.GetCurrentPageSize();
      
            this.PageIndex = Convert.ToInt32(this.RegionsPagination.CurrentPage.Text) - 1;
        ...
        // event handler for ImageButton
        public virtual void RegionsPagination_PreviousPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        public virtual void RegionSortLabel_Click(object sender, EventArgs args)
        {
            //Sorts by Region when clicked.
              
            // Get previous sorting state for Region.
        
            OrderByItem sd = this.CurrentSortOrder.Find(RegionsTable.Region);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for Region.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(RegionsTable.Region, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by Region, so just reverse.
                sd.Reverse();
            }
        ...
        // event handler for ImageButton
        public virtual void RegionsExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = RegionsTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
                ...
                BaseColumn[] columns = new BaseColumn[] {
                             RegionsTable.Region,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(RegionsTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(RegionsTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(RegionsTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(RegionsTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(RegionsTable.Region, "Default"));
              ...
              {
                val = RegionsTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        // event handler for ImageButton
        public virtual void RegionsImportButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void RegionsNewButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void RegionsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByRegionsTable.RegionsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Regions";
                // If GroupByRegionsTable.RegionsPDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(RegionsTable.Region.Name, ReportEnum.Align.Left, "${Region}", ReportEnum.Align.Left, 28);
                ...
                ColumnList columns = RegionsTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = RegionsTable.GetRecordCount(joinFilter,whereClause);
                RegionsRecord[] records = null;
                
                do
                {
                    
                    records = RegionsTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( RegionsRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${Region}", record.Format(RegionsTable.Region), ReportEnum.Align.Left, 100);
        ...
        // event handler for ImageButton
        public virtual void RegionsResetButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void RegionsSearchButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void RegionsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByRegionsTable.RegionsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Regions";
                // If GroupByRegionsTable.RegionsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void RegionsButtonsButton_Click(object sender, EventArgs args)
        {
        ...
        // event handler for Button
        public virtual void RegionsFilterButton_Click(object sender, EventArgs args)
        {
        ...
        // event handler for Button
        public virtual void RegionsFiltersButton_Click(object sender, EventArgs args)
        {
        ...
        protected virtual void RegionFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = RegionsTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
                return (this._TotalRecords);
            }
            set {
        ...
        public  RegionsRecord[] DataSource {
            ...
            get {
                return (RegionsRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList RegionFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionFilter");
            }
        }
        
        public System.Web.UI.WebControls.Literal RegionLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionLabel1");
            }
        }
        
        public IPv5.UI.IThemeButtonWithArrow RegionsButtonsButton {
            get {
                return (IPv5.UI.IThemeButtonWithArrow)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsButtonsButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton RegionsExportExcelButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsExportExcelButton");
            }
        }
        
        public IPv5.UI.IThemeButton RegionsFilterButton {
            get {
                return (IPv5.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsFilterButton");
            }
        }
        
        public IPv5.UI.IThemeButtonWithArrow RegionsFiltersButton {
            get {
                return (IPv5.UI.IThemeButtonWithArrow)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsFiltersButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton RegionsImportButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsImportButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton RegionsNewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsNewButton");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton RegionSortLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionSortLabel");
            }
        }
        
        public IPv5.UI.IPaginationModern RegionsPagination {
            get {
                return (IPv5.UI.IPaginationModern)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsPagination");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton RegionsPDFButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsPDFButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton RegionsResetButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsResetButton");
            }
        }
        
        public System.Web.UI.WebControls.TextBox RegionsSearch {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsSearch");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton RegionsSearchButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsSearchButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton RegionsWordButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionsWordButton");
            }
        }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            bool needToProcess = AreAnyUrlParametersForMe(url, arg);
            if (needToProcess) {
                RegionsTableControlRow recCtl = this.GetSelectedRecordControl();
                if (recCtl == null && url.IndexOf("{") >= 0) {
                    // Localization.
                    throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "IPv5"));
                }
        ...
        public virtual RegionsTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual RegionsTableControlRow[] GetSelectedRecordControls()
        {
        
            return (RegionsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByRegionsTable.RegionsTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            RegionsTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "IPv5"));
            }
            
            foreach (RegionsTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    if (!recCtl.IsNewRecord) {
        ...
        public virtual RegionsTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "RegionsTableControlRow");
	          List<RegionsTableControlRow> list = new List<RegionsTableControlRow>();
	          foreach (RegionsTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
