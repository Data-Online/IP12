<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowRegionsGallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowRegionsGallery" %>
...
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowRegionsGallery" Assembly="IPv5" %>
...
<asp:DropDownList runat="server" id="RegionFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("RegionsFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="RegionsTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="RegionsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3">&nbsp;</th></tr><asp:Repeater runat="server" id="RegionsTableControlRepeater">		<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="RegionsTableControlCellRepeater">		<ITEMTEMPLATE>		<IPv5:RegionsTableControlRow runat="server" id="RegionsTableControlRow">
<td class="galleryttc" style="width:33%;"><asp:LinkButton runat="server" id="Region" causesvalidation="False" commandname="Redirect"></asp:LinkButton> <br />
</td></IPv5:RegionsTableControlRow>
</ITEMTEMPLATE>
