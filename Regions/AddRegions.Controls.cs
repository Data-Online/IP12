...
// AddRegions.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.AddRegions
{
...
// Base class for the ContactsTableControlRow control on the AddRegions page.
...
// Base class for the ContactsTableControl control on the AddRegions page.
...
public class BaseContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.AddRegions.RegionsRecordControl regionsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "RegionsRecordControl") as IPv5.UI.Controls.AddRegions.RegionsRecordControl);
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddRegions.ContactsTableControlRow")));
...
// Base class for the PropertiesTableControlRow control on the AddRegions page.
...
// Base class for the PropertiesTableControl control on the AddRegions page.
...
#region "Helper Functions"
        ...
        public virtual PropertiesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertiesTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddRegions.PropertiesTableControlRow")));
...
// Base class for the PropertyContactsTableControlRow control on the AddRegions page.
...
// Base class for the PropertyContactsTableControl control on the AddRegions page.
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddRegions.PropertyContactsTableControlRow")));
...
// Base class for the RegionsRecordControl control on the AddRegions page.
...
public class BaseRegionsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (RegionsRecord)RegionsRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in RegionsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in AddRegions"] = recId;
