...
// This file implements the code-behind class for EditRegionsTable.aspx.
// EditRegionsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditRegionsTable
        : BaseApplicationPage
// Code-behind class for the EditRegionsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditRegionsTable()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditRegionsTable.RegionsTableControl RegionsTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Regions");
    ...
    public static string[] GetAutoCompletionList_RegionsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditRegionsTable.RegionsTableControl control = new IPv5.UI.Controls.EditRegionsTable.RegionsTableControl();
