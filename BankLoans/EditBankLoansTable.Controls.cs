...
// EditBankLoansTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditBankLoansTable
{
...
// Base class for the BankLoansTableControlRow control on the EditBankLoansTable page.
...
public class BaseBankLoansTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.BankLoansRowViewButton.Click += BankLoansRowViewButton_Click;
      ...
      // To customize, override this method in BankLoansTableControlRow.
        ...
        public virtual void SetBankLoansRowViewButton()                
        ...
        BankLoansTableControl tc= ((BankLoansTableControl)MiscUtils.GetParentControlObject(this, "BankLoansTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((BankLoansTableControlRow)this);
                    }
                    this.Visible = false;
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void BankLoansRowViewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../BankLoans/ShowBankLoans.aspx?BankLoans={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.CheckBox BankLoansRecordRowSelection {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BankLoansRecordRowSelection");
            }
        }              
        ...
        public System.Web.UI.WebControls.ImageButton BankLoansRowViewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BankLoansRowViewButton");
            }
        }
...
// Base class for the BankLoansTableControl control on the EditBankLoansTable page.
...
public class BaseBankLoansTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            SaveControlsToSession_Ajax();
              ...
              // Show confirmation message on Click
              this.BankLoansDeleteButton.Attributes.Add("onClick", "return (confirm(\"" + ((BaseApplicationPage)this.Page).GetResourceValue("DeleteConfirm", "IPv5") + "\"));");
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.BankLoansAddButton.Click += BankLoansAddButton_Click;
                        
                    this.BankLoansDeleteButton.Click += BankLoansDeleteButton_Click;
                        
                    this.BankLoansResetButton.Click += BankLoansResetButton_Click;
                        
                    this.BankLoansSaveButton.Click += BankLoansSaveButton_Click;
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetBankLoansAddButton();
              
                SetBankLoansDeleteButton();
              
                SetBankLoansResetButton();
              
                SetBankLoansSaveButton();
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"BankLoansSaveButton"));
      ...
      BankLoansRecord rec = new BankLoansRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.PropertyID)) {
                            rec.Parse(recControl.PropertyID.SelectedItem.Value, BankLoansTable.PropertyID);
                        }
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("BankLoansTableControlRepeater");
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetBankLoansAddButton()                
        ...
        public virtual void SetBankLoansDeleteButton()                
        ...
        public virtual void SetBankLoansSaveButton()                
              
        {
        
                    this.BankLoansSaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.Page.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
        ...
        // event handler for ImageButton
        public virtual void BankLoansAddButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void BankLoansDeleteButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void BankLoansSaveButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton BankLoansAddButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BankLoansAddButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton BankLoansDeleteButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BankLoansDeleteButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton BankLoansSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BankLoansSaveButton");
            }
        }
        ...
        public System.Web.UI.WebControls.CheckBox BankLoansToggleAll {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BankLoansToggleAll");
            }
        }              
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (BankLoansTableControlRow recControl in this.GetRecordControls())
            {
                if (recControl.BankLoansRecordRowSelection.Checked) {
                    return counter;
                }
                counter += 1;
            }
        ...
        {
        BankLoansTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual BankLoansTableControlRow[] GetSelectedRecordControls()
        {
            ...
            foreach (BankLoansTableControlRow recControl in this.GetRecordControls())
            {
                if (recControl.BankLoansRecordRowSelection != null && recControl.BankLoansRecordRowSelection.Checked) {
                    selectedList.Add(recControl);
                }
            }
            return (BankLoansTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditBankLoansTable.BankLoansTableControlRow")));
        ...
        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            ...
            foreach (BankLoansTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    ...
                    recCtl.BankLoansRecordRowSelection.Checked = false;
