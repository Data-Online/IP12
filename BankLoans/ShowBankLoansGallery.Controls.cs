...
// ShowBankLoansGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowBankLoansGallery
{
...
// Base class for the BankLoansTableControlRow control on the ShowBankLoansGallery page.
...
// Base class for the BankLoansTableControl control on the ShowBankLoansGallery page.
...
public class BaseBankLoansTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return BankLoansTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual BankLoansRecord[] CopyArray(int index, BankLoansRecord[,] recs, int columns)
      {
        BankLoansRecord[] recsCopy = new BankLoansRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            BankLoansRecord[,] recs = new BankLoansRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            BankLoansRecord[] HColDataSource = new BankLoansRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              BankLoansRecord[] VColDataSource = new BankLoansRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("BankLoansTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              BankLoansRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                BankLoansTableControlRow recControl = (BankLoansTableControlRow)innerRepItem.FindControl("BankLoansTableControlRow");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void BankLoansPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowBankLoansGallery.BankLoansPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "BankLoans";
                // If ShowBankLoansGallery.BankLoansPDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  BankLoansTable.PropertyID.IsApplyDisplayAs){
                                     ...
                                     report.AddData("${PropertyID}", record.Format(BankLoansTable.PropertyID), ReportEnum.Align.Left, 100);
                                 }
                             }
                             report.AddData("${Description}", record.Format(BankLoansTable.Description), ReportEnum.Align.Left);
        ...
        public virtual void BankLoansWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowBankLoansGallery.BankLoansWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "BankLoans";
                // If ShowBankLoansGallery.BankLoansWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual BankLoansTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (BankLoansTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowBankLoansGallery.BankLoansTableControlRow")));
