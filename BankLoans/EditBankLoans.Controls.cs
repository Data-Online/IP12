...
// EditBankLoans.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditBankLoans
{
...
// Base class for the BankLoansRecordControl control on the EditBankLoans page.
...
public class BaseBankLoansRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in BankLoansRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditBankLoans"] = recId;
