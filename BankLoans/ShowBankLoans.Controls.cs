...
// ShowBankLoans.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowBankLoans
{
...
// Base class for the BankLoansRecordControl control on the ShowBankLoans page.
...
public class BaseBankLoansRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.BankLoansDialogEditButton.Click += BankLoansDialogEditButton_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "BankLoansRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = BankLoansTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in BankLoansRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["BankLoans"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "BankLoans"));
            }
            HttpContext.Current.Session["QueryString in ShowBankLoans"] = recId;
        ...
        public virtual void SetBankLoansDialogEditButton()                
        ...
        public virtual void BankLoansDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={BankLoansRecordControl:FK:FK_BankLoans_Properties}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton BankLoansDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BankLoansDialogEditButton");
            }
        }
