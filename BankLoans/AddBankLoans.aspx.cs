...
// This file implements the code-behind class for AddBankLoans.aspx.
// AddBankLoans.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddBankLoans
        : BaseApplicationPage
// Code-behind class for the AddBankLoans page.
...
public void SetBankLoansRecordControl()
        {
            SetBankLoansRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddBankLoans.BankLoansRecordControl BankLoansRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Bank Loans");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "BankLoansRecordControl":
                 SetBankLoansRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.BankLoansRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetBankLoansRecordControl_Base()           
        
        {        
            if (BankLoansRecordControl.Visible)
            {
                BankLoansRecordControl.LoadData();
                BankLoansRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.BankLoansRecordControl != null && this.BankLoansRecordControl.DataSource != null)
                  {
                        id = this.BankLoansRecordControl.DataSource.GetValue(this.BankLoansRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.BankLoansRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.BankLoansRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.BankLoansRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.BankLoansRecordControl.DataSource.GetValue(this.BankLoansRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
