...
// ShowBankLoansTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowBankLoansTable
{
...
// Base class for the BankLoansTableControlRow control on the ShowBankLoansTable page.
...
public class BaseBankLoansTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.BankLoansRowExpandCollapseRowButton.Click += BankLoansRowExpandCollapseRowButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetBankLoansRowExpandCollapseRowButton();
        ...
        public virtual void SetBankLoansTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "BankLoansTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "BankLoansTabContainer").Visible = false;
      ...
      // To customize, override this method in BankLoansTableControlRow.
        ...
        public virtual void SetBankLoansRowExpandCollapseRowButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void BankLoansRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                BankLoansTableControl panelControl = (MiscUtils.GetParentControlObject(this, "BankLoansTableControl") as BankLoansTableControl);

          BankLoansTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (BankLoansTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "BankLoansTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.BankLoansRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.BankLoansRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.BankLoansRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.BankLoansRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.BankLoansRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.BankLoansRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.BankLoansRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton BankLoansRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BankLoansRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer BankLoansTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BankLoansTabContainer");
            }
        }
...
// Base class for the BankLoansTableControl control on the ShowBankLoansTable page.
...
public class BaseBankLoansTableControl : IPv5.UI.BaseApplicationTableControl
{
       ...
       public BaseBankLoansTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.BankLoansSearch)) 				
                    initialVal = this.GetFromSession(this.BankLoansSearch);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.BankLoansSearch.Text = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.BankLoansSearchButton.Click += BankLoansSearchButton_Click;
         ...
         //' Setup events for others
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "BankLoansSearchSearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + BankLoansSearch.ClientID + "\");", true);
      ...
      public override void DataBind()
      {
        ...
        BankLoansTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "BankLoansTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].BankLoansRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].BankLoansRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].BankLoansRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].BankLoansRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].BankLoansRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].BankLoansRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.BankLoansSearch)) {
                if (this.BankLoansSearch.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.BankLoansSearch.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.BankLoansSearch.Text.StartsWith("...")) {
                      this.BankLoansSearch.Text = this.BankLoansSearch.Text.Substring(3,this.BankLoansSearch.Text.Length-3);
                  }
                  if (this.BankLoansSearch.Text.EndsWith("...")) {
                      this.BankLoansSearch.Text = this.BankLoansSearch.Text.Substring(0,this.BankLoansSearch.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.BankLoansSearch.Text.Length - 1;
                      while (!Char.IsWhiteSpace(BankLoansSearch.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.BankLoansSearch.Text = this.BankLoansSearch.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.BankLoansSearch, this.GetFromSession(this.BankLoansSearch));
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.BankLoansSearch, this.GetFromSession(this.BankLoansSearch)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.PropertyIDFilter)) {
                ...
                wc.iAND(BankLoansTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.PropertyIDFilter, this.GetFromSession(this.PropertyIDFilter)), false, false);
        ...
        public virtual WhereClause CreateWhereClause(String searchText, String fromSearchControl, String AutoTypeAheadSearch, String AutoTypeAheadWordSeparators)
        {
            ...
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "BankLoansSearch") {
      ...
      foreach(BaseColumn col in cols)
      {
            ...
            if (MiscUtils.IsValueSelected(ExpiryDateFromFilterSelectedValue)) {
                ...
                wc.iAND(BankLoansTable.ExpiryDate, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, ExpiryDateFromFilterSelectedValue, false, false);
            ...
            if (MiscUtils.IsValueSelected(ExpiryDateToFilterSelectedValue)) {
                ...
                wc.iAND(BankLoansTable.ExpiryDate, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, ExpiryDateToFilterSelectedValue, false, false);
      ...
      String PropertyIDFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "PropertyIDFilter_Ajax"];
            if (MiscUtils.IsValueSelected(PropertyIDFilterSelectedValue)) {
                ...
                wc.iAND(BankLoansTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, PropertyIDFilterSelectedValue, false, false);
        ...
        public virtual string[] GetAutoCompletionList_BankLoansSearch(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"BankLoansSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
      ...
      BankLoansRecord rec = new BankLoansRecord();
                        ...
                        if (recControl.Description.Text != "") {
                            rec.Parse(recControl.Description.Text, BankLoansTable.Description);
                  }
                
                        if (recControl.ExpiryDate.Text != "") {
                            rec.Parse(recControl.ExpiryDate.Text, BankLoansTable.ExpiryDate);
                  }
        ...
        public virtual void SetBankLoansSearch()
        {
                                            
            this.BankLoansSearch.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.BankLoansSearch.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.BankLoansSearch, this.BankLoansSearch.Text);
      ...
      this.SaveToSession("BankLoansSearch_Ajax", this.BankLoansSearch.Text);
      ...
      this.SaveToSession("PropertyIDFilter_Ajax", this.PropertyIDFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.BankLoansSearch);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetBankLoansSearchButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void BankLoansPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowBankLoansTable.BankLoansPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "BankLoans";
                // If ShowBankLoansTable.BankLoansPDFButton.report specifies a valid report template,
        ...
        // event handler for ImageButton
        public virtual void BankLoansSearchButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        public virtual void BankLoansWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowBankLoansTable.BankLoansWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "BankLoans";
                // If ShowBankLoansTable.BankLoansWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox BankLoansSearch {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BankLoansSearch");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton BankLoansSearchButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BankLoansSearchButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual BankLoansTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (BankLoansTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowBankLoansTable.BankLoansTableControlRow")));
...
// Base class for the PropertiesRecordControl control on the ShowBankLoansTable page.
...
public class BasePropertiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          BankLoansTableControlRow parentCtrl;
      
            parentCtrl = (BankLoansTableControlRow)MiscUtils.GetParentControlObject(this, "BankLoansTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue bankLoansRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = bankLoansRecordObj;
          bankLoansRecordObj = tmp;
        BankLoansTableControlRow bankLoansTableControlObjRow = (MiscUtils.GetParentControlObject(this, "BankLoansTableControlRow") as BankLoansTableControlRow);
          
              if (bankLoansTableControlObjRow != null && bankLoansTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertiesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, bankLoansTableControlObjRow.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInBankLoansTableControl = HttpContext.Current.Session["PropertiesRecordControlWhereClause"] as string;
      
      if (selectedRecordInBankLoansTableControl != null && KeyValue.IsXmlKey(selectedRecordInBankLoansTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInBankLoansTableControl);
