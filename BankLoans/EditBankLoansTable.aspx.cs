...
// This file implements the code-behind class for EditBankLoansTable.aspx.
// EditBankLoansTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditBankLoansTable
        : BaseApplicationPage
// Code-behind class for the EditBankLoansTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditBankLoansTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_BankLoansSearch(string prefixText, int count)
        {
            // GetBankLoansSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_BankLoansSearch_Base()
            // or replace the call to GetAutoCompletionList_BankLoansSearch_Base().
            return GetAutoCompletionList_BankLoansSearch_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditBankLoansTable.BankLoansTableControl BankLoansTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Bank Loans");
      ...
      public void SaveData_Base()
      {
        ...
        this.BankLoansTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_BankLoansSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditBankLoansTable.BankLoansTableControl control = new IPv5.UI.Controls.EditBankLoansTable.BankLoansTableControl();
        
        return control.GetAutoCompletionList_BankLoansSearch(prefixText, count);
        ...
        SetBankLoansTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "BankLoansMenuItem";
                    }
                }
