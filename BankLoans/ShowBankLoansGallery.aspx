...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowBankLoansGallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowBankLoansGallery" %>
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowBankLoansGallery" Assembly="IPv5" %>
...
<asp:DropDownList runat="server" id="PropertyIDFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("BankLoansFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="BankLoansTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="BankLoansTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3">&nbsp;</th></tr><asp:Repeater runat="server" id="BankLoansTableControlRepeater">		<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="BankLoansTableControlCellRepeater">		<ITEMTEMPLATE>		<IPv5:BankLoansTableControlRow runat="server" id="BankLoansTableControlRow">
...
</td></IPv5:BankLoansTableControlRow>
</ITEMTEMPLATE>
