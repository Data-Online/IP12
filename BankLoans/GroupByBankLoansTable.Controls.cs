...
// GroupByBankLoansTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByBankLoansTable
{
...
// Base class for the BankLoansTableControlRow control on the GroupByBankLoansTable page.
...
public class BaseBankLoansTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPropertyID()
        {
            ...
            if (this.DataSource != null && this.DataSource.PropertyIDSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&BankLoansTable.PropertyID.IsApplyDisplayAs)
                     ...
                     formattedValue = BankLoansTable.GetDFKA(this.DataSource.PropertyID.ToString(),BankLoansTable.PropertyID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(BankLoansTable.PropertyID);
              ...
              this.PropertyID.Text = BankLoansTable.PropertyID.Format(BankLoansTable.PropertyID.DefaultValue);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={BankLoansTableControlRow:FK:FK_BankLoans_Properties}";
...
// Base class for the BankLoansTableControl control on the GroupByBankLoansTable page.
...
public class BaseBankLoansTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(BankLoansTable.PropertyID, this.DataSource);
        }
      ...
      BankLoansRecord rec = new BankLoansRecord();
                        ...
                        if (recControl.PropertyID.Text != "") {
                            rec.Parse(recControl.PropertyID.Text, BankLoansTable.PropertyID);
                  }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PropertyIDSortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(BankLoansTable.PropertyID);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(BankLoansTable.PropertyID, OrderByItem.OrderDir.Asc);
        ...
        public virtual void BankLoansExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             data.ColumnList.Add(new ExcelColumn(BankLoansTable.PropertyID, "Default"));
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void BankLoansPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByBankLoansTable.BankLoansPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "BankLoans";
                // If GroupByBankLoansTable.BankLoansPDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(BankLoansTable.PropertyID.Name, ReportEnum.Align.Left, "${PropertyID}", ReportEnum.Align.Left, 28);
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.PropertyID)){
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = BankLoansTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(BankLoansTable.PropertyID);
                                 _DFKA = BankLoansTable.GetDFKA(record.PropertyID.ToString(), BankLoansTable.PropertyID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  BankLoansTable.PropertyID.IsApplyDisplayAs){
                                     report.AddData("${PropertyID}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${PropertyID}", record.Format(BankLoansTable.PropertyID), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void BankLoansWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByBankLoansTable.BankLoansWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "BankLoans";
                // If GroupByBankLoansTable.BankLoansWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual BankLoansTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (BankLoansTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByBankLoansTable.BankLoansTableControlRow")));
