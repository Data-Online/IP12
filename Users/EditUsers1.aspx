...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="PasswordTextBoxMaxLengthValidator" ControlToValidate="Password" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IPv5&quot;).Replace(&quot;{FieldName}&quot;, &quot;Password&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td><td class="tableCellLabel"><asp:CheckBox runat="server" id="PwdExp" visible="False"></asp:CheckBox></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Label runat="server" id="Label" Text="Confirm Password">	</asp:Label></td><td class="tableCellValue"><asp:TextBox runat="server" id="Password2" cssclass="field_input" textmode="Password" width="200px">	</asp:TextBox>
