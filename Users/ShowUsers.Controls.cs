...
namespace IPv5.UI.Controls.ShowUsers
{
...
// Base class for the Users_RolesTableControlRow control on the ShowUsers page.
...
public class BaseUsers_RolesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        UsersRecordControl parentCtrl;
      
            parentCtrl = (UsersRecordControl)this.Page.FindControlRecursively("UsersRecordControl");
...
// Base class for the Users_RolesTableControl control on the ShowUsers page.
...
public class BaseUsers_RolesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.ShowUsers.UsersRecordControl usersRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "UsersRecordControl") as IPv5.UI.Controls.ShowUsers.UsersRecordControl);
          
              if (usersRecordControlObj != null && usersRecordControlObj.GetRecord() != null && usersRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(Users_RolesTable.UserId0, BaseFilter.ComparisonOperator.EqualsTo, usersRecordControlObj.GetRecord().UserId0.ToString());
              selectedRecordKeyValue.AddElement(Users_RolesTable.UserId0.InternalName, usersRecordControlObj.GetRecord().UserId0.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInUsersRecordControl = HttpContext.Current.Session["Users_RolesTableControlWhereClause"] as string;
      
      if (selectedRecordInUsersRecordControl != null && KeyValue.IsXmlKey(selectedRecordInUsersRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInUsersRecordControl);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void Users_RolesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowUsers.Users_RolesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users_Roles";
                // If ShowUsers.Users_RolesPDFButton.report specifies a valid report template,
        ...
        public virtual void Users_RolesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowUsers.Users_RolesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users_Roles";
                // If ShowUsers.Users_RolesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Users_RolesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Users_RolesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowUsers.Users_RolesTableControlRow")));
...
public class BaseUsersRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.UsersDialogEditButton.Click += UsersDialogEditButton_Click;
      ...
      // To customize, override this method in UsersRecordControl.
         ...
         
        {
            ...
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "Users"));
            }
        ...
        public virtual void SetUsersDialogEditButton()                
        ...
        // event handler for ImageButton
        public virtual void UsersDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton UsersDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "UsersDialogEditButton");
            }
        }
