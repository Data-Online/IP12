...
namespace IPv5.UI.Controls.AddUsers
{
...
// Base class for the Users_RolesTableControlRow control on the AddUsers page.
...
// Base class for the Users_RolesTableControl control on the AddUsers page.
...
public class BaseUsers_RolesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.AddUsers.UsersRecordControl usersRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "UsersRecordControl") as IPv5.UI.Controls.AddUsers.UsersRecordControl);
...
#region "Helper Functions"
        ...
        public virtual Users_RolesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Users_RolesTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddUsers.Users_RolesTableControlRow")));
