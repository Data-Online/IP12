...
namespace IPv5.UI.Controls.EditUsers
{
...
// Base class for the Users_RolesTableControlRow control on the EditUsers page.
...
// Base class for the Users_RolesTableControl control on the EditUsers page.
...
public class BaseUsers_RolesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.EditUsers.UsersRecordControl usersRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "UsersRecordControl") as IPv5.UI.Controls.EditUsers.UsersRecordControl);
...
#region "Helper Functions"
        ...
        public virtual Users_RolesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Users_RolesTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditUsers.Users_RolesTableControlRow")));
