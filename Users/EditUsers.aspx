...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="UserName0TextBoxMaxLengthValidator" ControlToValidate="UserName0" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IPv5&quot;).Replace(&quot;{FieldName}&quot;, &quot;User Name&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td><td class="dfv"><asp:Literal runat="server" id="eMailLabel" Text="Email">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
...
</td><td class="dfv"><asp:Literal runat="server" id="ActiveLabel" Text="Active">	</asp:Literal></td><td class="dfv"><asp:CheckBox runat="server" id="Active"></asp:CheckBox></td></tr><tr><td class="fls"><asp:Literal runat="server" id="PasswordLabel" Text="Password">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="PasswordTextBoxMaxLengthValidator" ControlToValidate="Password" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IPv5&quot;).Replace(&quot;{FieldName}&quot;, &quot;Password&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td><td class="dfv"></td><td class="dfv"></td><td class="dfv"><asp:Literal runat="server" id="PwdExpLabel" Text="EvaluateFormula(&quot;= \&quot;Prompt for new Password\&quot;&quot;, true)">	</asp:Literal></td><td class="dfv"><asp:CheckBox runat="server" id="PwdExp"></asp:CheckBox></td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
