...
// This file implements the code-behind class for GroupByVPropertyTermExpiresTable.aspx.
// GroupByVPropertyTermExpiresTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByVPropertyTermExpiresTable
        : BaseApplicationPage
// Code-behind class for the GroupByVPropertyTermExpiresTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByVPropertyTermExpiresTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_VPropertyTermExpiresSearch(string prefixText, int count)
        {
            // GetVPropertyTermExpiresSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_VPropertyTermExpiresSearch_Base()
            // or replace the call to GetAutoCompletionList_VPropertyTermExpiresSearch_Base().
            return GetAutoCompletionList_VPropertyTermExpiresSearch_Base(prefixText, count);
        }
...
public void SetVPropertyTermExpiresTableControl()
        {
            SetVPropertyTermExpiresTableControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButtonWithArrow VPropertyTermExpiresButtonsButton;
                
        public System.Web.UI.WebControls.ImageButton VPropertyTermExpiresExportExcelButton;
        
        public ThemeButton VPropertyTermExpiresFilterButton;
                
        public ThemeButtonWithArrow VPropertyTermExpiresFiltersButton;
                
        public PaginationModern VPropertyTermExpiresPagination;
        ...
        public IPv5.UI.Controls.GroupByVPropertyTermExpiresTable.VPropertyTermExpiresTableControl VPropertyTermExpiresTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = "Property Term Expires";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "VPropertyTermExpiresTableControl":
                 SetVPropertyTermExpiresTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.VPropertyTermExpiresTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_VPropertyTermExpiresSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByVPropertyTermExpiresTable.VPropertyTermExpiresTableControl control = new IPv5.UI.Controls.GroupByVPropertyTermExpiresTable.VPropertyTermExpiresTableControl();
        
        return control.GetAutoCompletionList_VPropertyTermExpiresSearch(prefixText, count);
        ...
        SetVPropertyTermExpiresTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "VPropertyTermExpiresMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVPropertyTermExpiresTableControl_Base()           
        
        {        
            if (VPropertyTermExpiresTableControl.Visible)
            {
                VPropertyTermExpiresTableControl.LoadData();
                VPropertyTermExpiresTableControl.DataBind();
            }
        }
