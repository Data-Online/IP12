...
// This file implements the code-behind class for ShowVPropertyTermExpiresTable.aspx.
// ShowVPropertyTermExpiresTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class ShowVPropertyTermExpiresTable
        : BaseApplicationPage
// Code-behind class for the ShowVPropertyTermExpiresTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public ShowVPropertyTermExpiresTable()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.ShowVPropertyTermExpiresTable.VPropertyTermExpiresTableControl VPropertyTermExpiresTableControl;
    ...
    public static string[] GetAutoCompletionList_VPropertyTermExpiresSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.ShowVPropertyTermExpiresTable.VPropertyTermExpiresTableControl control = new IPv5.UI.Controls.ShowVPropertyTermExpiresTable.VPropertyTermExpiresTableControl();
