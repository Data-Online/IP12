...
// ShowVPropertyTermExpiresGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowVPropertyTermExpiresGallery
{
...
// Base class for the VPropertyTermExpiresTableControlRow control on the ShowVPropertyTermExpiresGallery page.
...
// Base class for the VPropertyTermExpiresTableControl control on the ShowVPropertyTermExpiresGallery page.
...
public class BaseVPropertyTermExpiresTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return VPropertyTermExpiresView.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual VPropertyTermExpiresRecord[] CopyArray(int index, VPropertyTermExpiresRecord[,] recs, int columns)
      {
        VPropertyTermExpiresRecord[] recsCopy = new VPropertyTermExpiresRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            VPropertyTermExpiresRecord[,] recs = new VPropertyTermExpiresRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            VPropertyTermExpiresRecord[] HColDataSource = new VPropertyTermExpiresRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              VPropertyTermExpiresRecord[] VColDataSource = new VPropertyTermExpiresRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("VPropertyTermExpiresTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              VPropertyTermExpiresRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                VPropertyTermExpiresTableControlRow recControl = (VPropertyTermExpiresTableControlRow)innerRepItem.FindControl("VPropertyTermExpiresTableControlRow");
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void VPropertyTermExpiresPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyTermExpiresGallery.VPropertyTermExpiresPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyTermExpires";
                // If ShowVPropertyTermExpiresGallery.VPropertyTermExpiresPDFButton.report specifies a valid report template,
        ...
        public virtual void VPropertyTermExpiresWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyTermExpiresGallery.VPropertyTermExpiresWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyTermExpires";
                // If ShowVPropertyTermExpiresGallery.VPropertyTermExpiresWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual VPropertyTermExpiresTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (VPropertyTermExpiresTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowVPropertyTermExpiresGallery.VPropertyTermExpiresTableControlRow")));
