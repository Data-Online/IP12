...
// ShowVPropertyTermExpiresTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowVPropertyTermExpiresTable
{
...
// Base class for the VPropertyTermExpiresTableControlRow control on the ShowVPropertyTermExpiresTable page.
...
public class BaseVPropertyTermExpiresTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.VPropertyTermExpiresRowExpandCollapseRowButton.Click += VPropertyTermExpiresRowExpandCollapseRowButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetVPropertyTermExpiresTabContainer();
                SetVPropertyTermExpiresRowExpandCollapseRowButton();
        ...
        public virtual void SetVPropertyTermExpiresTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "VPropertyTermExpiresTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "VPropertyTermExpiresTabContainer").Visible = false;
      ...
      // To customize, override this method in VPropertyTermExpiresTableControlRow.
        ...
        public virtual void SetVPropertyTermExpiresRowExpandCollapseRowButton()                
        ...
        public virtual void VPropertyTermExpiresRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                VPropertyTermExpiresTableControl panelControl = (MiscUtils.GetParentControlObject(this, "VPropertyTermExpiresTableControl") as VPropertyTermExpiresTableControl);

          VPropertyTermExpiresTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (VPropertyTermExpiresTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "VPropertyTermExpiresTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.VPropertyTermExpiresRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.VPropertyTermExpiresRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.VPropertyTermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.VPropertyTermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.VPropertyTermExpiresRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.VPropertyTermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.VPropertyTermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton VPropertyTermExpiresRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermExpiresRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer VPropertyTermExpiresTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermExpiresTabContainer");
            }
        }
...
// Base class for the VPropertyTermExpiresTableControl control on the ShowVPropertyTermExpiresTable page.
...
public class BaseVPropertyTermExpiresTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        VPropertyTermExpiresTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "VPropertyTermExpiresTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].VPropertyTermExpiresRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].VPropertyTermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].VPropertyTermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].VPropertyTermExpiresRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].VPropertyTermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].VPropertyTermExpiresRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void VPropertyTermExpiresPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyTermExpiresTable.VPropertyTermExpiresPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyTermExpires";
                // If ShowVPropertyTermExpiresTable.VPropertyTermExpiresPDFButton.report specifies a valid report template,
        ...
        public virtual void VPropertyTermExpiresWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyTermExpiresTable.VPropertyTermExpiresWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyTermExpires";
                // If ShowVPropertyTermExpiresTable.VPropertyTermExpiresWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual VPropertyTermExpiresTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (VPropertyTermExpiresTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowVPropertyTermExpiresTable.VPropertyTermExpiresTableControlRow")));
...
// Base class for the CitiesRecordControl control on the ShowVPropertyTermExpiresTable page.
...
public class BaseCitiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          VPropertyTermExpiresTableControlRow parentCtrl;
      
            parentCtrl = (VPropertyTermExpiresTableControlRow)MiscUtils.GetParentControlObject(this, "VPropertyTermExpiresTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue vPropertyTermExpiresRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = vPropertyTermExpiresRecordObj;
          vPropertyTermExpiresRecordObj = tmp;
        VPropertyTermExpiresTableControlRow vPropertyTermExpiresTableControlObjRow = (MiscUtils.GetParentControlObject(this, "VPropertyTermExpiresTableControlRow") as VPropertyTermExpiresTableControlRow);
          
              if (vPropertyTermExpiresTableControlObjRow != null && vPropertyTermExpiresTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(CitiesTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, vPropertyTermExpiresTableControlObjRow.GetRecord().CityID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInVPropertyTermExpiresTableControl = HttpContext.Current.Session["CitiesRecordControlWhereClause"] as string;
      
      if (selectedRecordInVPropertyTermExpiresTableControl != null && KeyValue.IsXmlKey(selectedRecordInVPropertyTermExpiresTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInVPropertyTermExpiresTableControl);
...
// Base class for the PropertiesRecordControl control on the ShowVPropertyTermExpiresTable page.
...
public class BasePropertiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        VPropertyTermExpiresTableControlRow vPropertyTermExpiresTableControlObjRow = (MiscUtils.GetParentControlObject(this, "VPropertyTermExpiresTableControlRow") as VPropertyTermExpiresTableControlRow);
              ...
              if (vPropertyTermExpiresTableControlObjRow != null && vPropertyTermExpiresTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertiesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, vPropertyTermExpiresTableControlObjRow.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInVPropertyTermExpiresTableControl = HttpContext.Current.Session["PropertiesRecordControlWhereClause"] as string;
...
// Base class for the RegionsRecordControl control on the ShowVPropertyTermExpiresTable page.
...
public class BaseRegionsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        VPropertyTermExpiresTableControlRow vPropertyTermExpiresTableControlObjRow = (MiscUtils.GetParentControlObject(this, "VPropertyTermExpiresTableControlRow") as VPropertyTermExpiresTableControlRow);
              ...
              if (vPropertyTermExpiresTableControlObjRow != null && vPropertyTermExpiresTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(RegionsTable.RegionID, BaseFilter.ComparisonOperator.EqualsTo, vPropertyTermExpiresTableControlObjRow.GetRecord().RegionID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInVPropertyTermExpiresTableControl = HttpContext.Current.Session["RegionsRecordControlWhereClause"] as string;
