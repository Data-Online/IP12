...
// This file implements the code-behind class for ShowVPropertiesPropertyContactsTable.aspx.
// ShowVPropertiesPropertyContactsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class ShowVPropertiesPropertyContactsTable
        : BaseApplicationPage
// Code-behind class for the ShowVPropertiesPropertyContactsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public ShowVPropertiesPropertyContactsTable()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVPropertiesPropertyContactsTableControl()
        {
            SetVPropertiesPropertyContactsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.ShowVPropertiesPropertyContactsTable.VPropertiesPropertyContactsTableControl VPropertiesPropertyContactsTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "VPropertiesPropertyContactsTableControl":
                 SetVPropertiesPropertyContactsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.VPropertiesPropertyContactsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.ShowVPropertiesPropertyContactsTable.VPropertiesPropertyContactsTableControl control = new IPv5.UI.Controls.ShowVPropertiesPropertyContactsTable.VPropertiesPropertyContactsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVPropertiesPropertyContactsTableControl_Base()           
        
        {        
            if (VPropertiesPropertyContactsTableControl.Visible)
            {
                VPropertiesPropertyContactsTableControl.LoadData();
                VPropertiesPropertyContactsTableControl.DataBind();
            }
        }
