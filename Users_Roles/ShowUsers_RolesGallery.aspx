...
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowUsers_RolesGallery" Assembly="IPv5" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowUsers_RolesGallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowUsers_RolesGallery" %>
...
<asp:DropDownList runat="server" id="RoleIDFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("Users_RolesFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="Users_RolesTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="Users_RolesTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3">&nbsp;</th></tr><asp:Repeater runat="server" id="Users_RolesTableControlRepeater">		<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="Users_RolesTableControlCellRepeater">		<ITEMTEMPLATE>		<IPv5:Users_RolesTableControlRow runat="server" id="Users_RolesTableControlRow">
<td class="galleryttc" style="width:33%;"><asp:Literal runat="server" id="UserId0"></asp:Literal> <br />
<asp:LinkButton runat="server" id="RoleID" causesvalidation="False" commandname="Redirect"></asp:LinkButton> <br />
</td></IPv5:Users_RolesTableControlRow>
</ITEMTEMPLATE>
