...
// ShowUsers_RolesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowUsers_RolesTable
{
...
public class RolesRecordControl : BaseRolesRecordControl
{
...
// Base class for the Users_RolesTableControlRow control on the ShowUsers_RolesTable page.
...
public class BaseUsers_RolesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.Users_RolesRowExpandCollapseRowButton.Click += Users_RolesRowExpandCollapseRowButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetUsers_RolesRowExpandCollapseRowButton();
        ...
        public virtual void SetUsers_RolesTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "Users_RolesTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "Users_RolesTabContainer").Visible = false;
         
  
        }      
      
        public virtual void SetRolesRecordControl()           
        
        {        
            if (RolesRecordControl.Visible)
            {
                RolesRecordControl.LoadData();
                RolesRecordControl.DataBind();
            }
        }
      
        public virtual void SetUsersRecordControl()           
        ...
        public virtual void SaveData()
        {
          ...
          RolesRecordControl recRolesRecordControl = (RolesRecordControl)(MiscUtils.FindControlRecursively(this, "RolesRecordControl"));
        recRolesRecordControl.SaveData();
        UsersRecordControl recUsersRecordControl = (UsersRecordControl)(MiscUtils.FindControlRecursively(this, "UsersRecordControl"));
        recUsersRecordControl.SaveData();
      ...
      // To customize, override this method in Users_RolesTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersRolesRecordControl = false;
            hasFiltersRolesRecordControl = hasFiltersRolesRecordControl && false; // suppress warning
        ...
        public virtual void SetUsers_RolesRowExpandCollapseRowButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void Users_RolesRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                Users_RolesTableControl panelControl = (MiscUtils.GetParentControlObject(this, "Users_RolesTableControl") as Users_RolesTableControl);

          Users_RolesTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (Users_RolesTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "Users_RolesTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.Users_RolesRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.Users_RolesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.Users_RolesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.Users_RolesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.Users_RolesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.Users_RolesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.Users_RolesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
...
#region "Helper Properties"
        ...
        public RolesRecordControl RolesRecordControl {
            get {
                return (RolesRecordControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RolesRecordControl");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton Users_RolesRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Users_RolesRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer Users_RolesTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Users_RolesTabContainer");
            }
        }
        
        public UsersRecordControl UsersRecordControl {
            get {
                return (UsersRecordControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "UsersRecordControl");
            }
        }
...
// Base class for the Users_RolesTableControl control on the ShowUsers_RolesTable page.
...
public class BaseUsers_RolesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.Users_RolesExportExcelButton.Click += Users_RolesExportExcelButton_Click;
                        
                    this.Users_RolesImportButton.Click += Users_RolesImportButton_Click;
                        
                    this.Users_RolesNewButton.Click += Users_RolesNewButton_Click;
                        
                    this.Users_RolesPDFButton.Click += Users_RolesPDFButton_Click;
                        
                    this.Users_RolesResetButton.Click += Users_RolesResetButton_Click;
                        
                    this.Users_RolesWordButton.Click += Users_RolesWordButton_Click;
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetUsers_RolesExportExcelButton();
              
                SetUsers_RolesImportButton();
              
                SetUsers_RolesNewButton();
              
                SetUsers_RolesPDFButton();
              
                SetUsers_RolesResetButton();
              
                SetUsers_RolesWordButton();
        ...
        Users_RolesTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "Users_RolesTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].Users_RolesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].Users_RolesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].Users_RolesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].Users_RolesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].Users_RolesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].Users_RolesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        if (this.TotalRecords > 10000)
          this.Users_RolesExportExcelButton.Attributes.Add("onClick", "return (confirm('" + ((BaseApplicationPage)this.Page).GetResourceValue("ExportConfirm", "IPv5") + "'));");
        else
          this.Users_RolesExportExcelButton.Attributes.Remove("onClick");
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"Users_RolesExportExcelButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"Users_RolesPDFButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"Users_RolesWordButton"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetUsers_RolesExportExcelButton()                
        ...
        public virtual void SetUsers_RolesImportButton()                
              
        {
        							
                    this.Users_RolesImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Users_Roles" ;
                    this.Users_RolesImportButton.Attributes["onClick"] = "window.open('" + this.Page.EncryptUrlParameter(this.Users_RolesImportButton.PostBackUrl) + "','importWindow', 'width=700, height=500,top=' +(screen.availHeight-500)/2 + ',left=' + (screen.availWidth-700)/2+ ', resizable=yes, scrollbars=yes,modal=yes'); return false;";
                        
   
        }
            
        public virtual void SetUsers_RolesNewButton()                
        ...
        public virtual void SetUsers_RolesPDFButton()                
        ...
        public virtual void SetUsers_RolesWordButton()                
        ...
        // event handler for ImageButton
        public virtual void Users_RolesExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = Users_RolesTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
                ...
                BaseColumn[] columns = new BaseColumn[] {
                             null};
                ExportDataToCSV exportData = new ExportDataToCSV(Users_RolesTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(Users_RolesTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(Users_RolesTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(Users_RolesTable.Instance, wc, orderBy, null,join);
              ...
              {
                val = Users_RolesTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        // event handler for ImageButton
        public virtual void Users_RolesImportButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void Users_RolesNewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Users_Roles/AddUsers_Roles.aspx";
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void Users_RolesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowUsers_RolesTable.Users_RolesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users_Roles";
                // If ShowUsers_RolesTable.Users_RolesPDFButton.report specifies a valid report template,
                ...
                ColumnList columns = Users_RolesTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = Users_RolesTable.GetRecordCount(joinFilter,whereClause);
                Users_RolesRecord[] records = null;
                
                do
                {
                    
                    records = Users_RolesTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( Users_RolesRecord record in records)
        ...
        // event handler for ImageButton
        public virtual void Users_RolesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowUsers_RolesTable.Users_RolesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users_Roles";
                // If ShowUsers_RolesTable.Users_RolesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton Users_RolesExportExcelButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Users_RolesExportExcelButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton Users_RolesImportButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Users_RolesImportButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton Users_RolesNewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Users_RolesNewButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton Users_RolesPDFButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Users_RolesPDFButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton Users_RolesWordButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Users_RolesWordButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual Users_RolesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Users_RolesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowUsers_RolesTable.Users_RolesTableControlRow")));
...
// Base class for the RolesRecordControl control on the ShowUsers_RolesTable page.
// Do not modify this class. Instead override any method in RolesRecordControl.
public class BaseRolesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        public BaseRolesRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "RolesRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            RolesRecord[] recList = RolesTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = RolesTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void SaveData()
        {
          ...
          Users_RolesTableControlRow parentCtrl;
      
            parentCtrl = (Users_RolesTableControlRow)MiscUtils.GetParentControlObject(this, "Users_RolesTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue users_RolesRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = users_RolesRecordObj;
          users_RolesRecordObj = tmp;
        Users_RolesTableControlRow users_RolesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "Users_RolesTableControlRow") as Users_RolesTableControlRow);
          
              if (users_RolesTableControlObjRow != null && users_RolesTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(RolesTable.RoleID, BaseFilter.ComparisonOperator.EqualsTo, users_RolesTableControlObjRow.GetRecord().RoleID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      HttpContext.Current.Session["RolesRecordControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
      ...
      string selectedRecordInUsers_RolesTableControl = HttpContext.Current.Session["RolesRecordControlWhereClause"] as string;
      
      if (selectedRecordInUsers_RolesTableControl != null && KeyValue.IsXmlKey(selectedRecordInUsers_RolesTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInUsers_RolesTableControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(RolesTable.RoleID))
      {
      wc.iAND(RolesTable.RoleID, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(RolesTable.RoleID).ToString());
      }
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseRolesRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseRolesRecordControl_Rec"] = value;
            }
        }
...
// Base class for the UsersRecordControl control on the ShowUsers_RolesTable page.
// Do not modify this class. Instead override any method in UsersRecordControl.
public class BaseUsersRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        Users_RolesTableControlRow users_RolesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "Users_RolesTableControlRow") as Users_RolesTableControlRow);
              ...
              if (users_RolesTableControlObjRow != null && users_RolesTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(UsersTable.UserId0, BaseFilter.ComparisonOperator.EqualsTo, users_RolesTableControlObjRow.GetRecord().UserId0.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      HttpContext.Current.Session["UsersRecordControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
      ...
      string selectedRecordInUsers_RolesTableControl = HttpContext.Current.Session["UsersRecordControlWhereClause"] as string;
      
      if (selectedRecordInUsers_RolesTableControl != null && KeyValue.IsXmlKey(selectedRecordInUsers_RolesTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInUsers_RolesTableControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(UsersTable.UserId0))
      {
      wc.iAND(UsersTable.UserId0, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(UsersTable.UserId0).ToString());
      }
