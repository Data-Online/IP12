...
// GroupByUsers_RolesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByUsers_RolesTable
{
...
// Base class for the Users_RolesTableControlRow control on the GroupByUsers_RolesTable page.
...
// Base class for the Users_RolesTableControl control on the GroupByUsers_RolesTable page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void Users_RolesExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             data.ColumnList.Add(new ExcelColumn(Users_RolesTable.RoleID, "Default"));
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void Users_RolesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByUsers_RolesTable.Users_RolesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users_Roles";
                // If GroupByUsers_RolesTable.Users_RolesPDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(Users_RolesTable.RoleID.Name, ReportEnum.Align.Left, "${RoleID}", ReportEnum.Align.Left, 28);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.RoleID)){
                                 report.AddData("${RoleID}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = Users_RolesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Users_RolesTable.RoleID);
                                 _DFKA = Users_RolesTable.GetDFKA(record.RoleID.ToString(), Users_RolesTable.RoleID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Users_RolesTable.RoleID.IsApplyDisplayAs){
                                     report.AddData("${RoleID}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${RoleID}", record.Format(Users_RolesTable.RoleID), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void Users_RolesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByUsers_RolesTable.Users_RolesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users_Roles";
                // If GroupByUsers_RolesTable.Users_RolesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Users_RolesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Users_RolesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByUsers_RolesTable.Users_RolesTableControlRow")));
