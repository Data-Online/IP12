...
// EditUsers_Roles.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditUsers_Roles
{
...
// Base class for the Users_RolesRecordControl control on the EditUsers_Roles page.
...
public class BaseUsers_RolesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Users_RolesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditUsers_Roles"] = recId;
