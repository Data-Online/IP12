...
// This file implements the code-behind class for AddUsers_Roles.aspx.
// AddUsers_Roles.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddUsers_Roles
        : BaseApplicationPage
// Code-behind class for the AddUsers_Roles page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public AddUsers_Roles()
        {
            this.Initialize();
...
public void SetUsers_RolesRecordControl()
        {
            SetUsers_RolesRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddUsers_Roles.Users_RolesRecordControl Users_RolesRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Users Roles");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Users_RolesRecordControl":
                 SetUsers_RolesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Users_RolesRecordControl.SaveData();
        ...
        SetUsers_RolesRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "Users_RolesMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetUsers_RolesRecordControl_Base()           
        
        {        
            if (Users_RolesRecordControl.Visible)
            {
                Users_RolesRecordControl.LoadData();
                Users_RolesRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Users_RolesRecordControl != null && this.Users_RolesRecordControl.DataSource != null)
                  {
                        id = this.Users_RolesRecordControl.DataSource.GetValue(this.Users_RolesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Users_RolesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Users_RolesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Users_RolesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Users_RolesRecordControl.DataSource.GetValue(this.Users_RolesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
