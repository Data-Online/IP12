...
// ShowUsers_RolesGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowUsers_RolesGallery
{
...
// Base class for the Users_RolesTableControlRow control on the ShowUsers_RolesGallery page.
...
// Base class for the Users_RolesTableControl control on the ShowUsers_RolesGallery page.
...
public class BaseUsers_RolesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return Users_RolesTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual Users_RolesRecord[] CopyArray(int index, Users_RolesRecord[,] recs, int columns)
      {
        Users_RolesRecord[] recsCopy = new Users_RolesRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            Users_RolesRecord[,] recs = new Users_RolesRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            Users_RolesRecord[] HColDataSource = new Users_RolesRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              Users_RolesRecord[] VColDataSource = new Users_RolesRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("Users_RolesTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              Users_RolesRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                Users_RolesTableControlRow recControl = (Users_RolesTableControlRow)innerRepItem.FindControl("Users_RolesTableControlRow");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void Users_RolesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowUsers_RolesGallery.Users_RolesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users_Roles";
                // If ShowUsers_RolesGallery.Users_RolesPDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 report.AddData("${UserId0}", "",ReportEnum.Align.Left, 100);
                             }else{
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Users_RolesTable.UserId0.IsApplyDisplayAs){
                                     report.AddData("${UserId0}", _DFKA,ReportEnum.Align.Left, 100);
                                 }else{
                                     report.AddData("${UserId0}", record.Format(Users_RolesTable.UserId0), ReportEnum.Align.Left, 100);
                                 }
                             }
        ...
        public virtual void Users_RolesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowUsers_RolesGallery.Users_RolesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users_Roles";
                // If ShowUsers_RolesGallery.Users_RolesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Users_RolesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Users_RolesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowUsers_RolesGallery.Users_RolesTableControlRow")));
