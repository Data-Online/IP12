...
// This file implements the code-behind class for ShowVUserRoleSummaryTable.aspx.
// ShowVUserRoleSummaryTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class ShowVUserRoleSummaryTable
        : BaseApplicationPage
// Code-behind class for the ShowVUserRoleSummaryTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public ShowVUserRoleSummaryTable()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVUserRoleSummaryTableControl()
        {
            SetVUserRoleSummaryTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.ShowVUserRoleSummaryTable.VUserRoleSummaryTableControl VUserRoleSummaryTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "VUserRoleSummaryTableControl":
                 SetVUserRoleSummaryTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.VUserRoleSummaryTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.ShowVUserRoleSummaryTable.VUserRoleSummaryTableControl control = new IPv5.UI.Controls.ShowVUserRoleSummaryTable.VUserRoleSummaryTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVUserRoleSummaryTableControl_Base()           
        
        {        
            if (VUserRoleSummaryTableControl.Visible)
            {
                VUserRoleSummaryTableControl.LoadData();
                VUserRoleSummaryTableControl.DataBind();
            }
        }
