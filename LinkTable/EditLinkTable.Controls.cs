...
// EditLinkTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditLinkTable
{
...
// Base class for the LinkTableRecordControl control on the EditLinkTable page.
...
public class BaseLinkTableRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in LinkTableRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditLinkTable"] = recId;
