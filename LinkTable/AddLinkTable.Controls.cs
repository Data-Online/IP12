...
// AddLinkTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.AddLinkTable
{
...
// Base class for the LinkTableRecordControl control on the AddLinkTable page.
...
public class BaseLinkTableRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (LinkTableRecord)LinkTableRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in LinkTableRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in AddLinkTable"] = recId;
