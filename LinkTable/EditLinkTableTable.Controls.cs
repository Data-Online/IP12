...
// EditLinkTableTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditLinkTableTable
{
...
// Base class for the LinkTableTableControlRow control on the EditLinkTableTable page.
...
public class BaseLinkTableTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.LinkTableRowViewButton.Click += LinkTableRowViewButton_Click;
      ...
      // To customize, override this method in LinkTableTableControlRow.
        ...
        public virtual void SetLinkTableRowViewButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void LinkTableRowViewButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton LinkTableRowViewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LinkTableRowViewButton");
            }
        }
...
// Base class for the LinkTableTableControl control on the EditLinkTableTable page.
...
public class BaseLinkTableTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.LinkTableSaveButton.Click += LinkTableSaveButton_Click;
      ...
      public override void DataBind()
      {
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"LinkTableSaveButton"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetLinkTableSaveButton()                
              
        {
        
                    this.LinkTableSaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.Page.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
        ...
        // event handler for ImageButton
        public virtual void LinkTableSaveButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton LinkTableSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LinkTableSaveButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual LinkTableTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (LinkTableTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditLinkTableTable.LinkTableTableControlRow")));
