...
// ShowLinkTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowLinkTable
{
...
// Base class for the LinkTableRecordControl control on the ShowLinkTable page.
// Do not modify this class. Instead override any method in LinkTableRecordControl.
public class BaseLinkTableRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        public BaseLinkTableRecordControl()
        {
        ...
        // To customize, override this method in LinkTableRecordControl.
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.LinkTableDialogEditButton.Click += LinkTableDialogEditButton_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "LinkTableRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            LinkTableRecord[] recList = LinkTableTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = LinkTableTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in LinkTableRecordControl.
         ...
         
        {
            ...
            bool hasFiltersLinkTableRecordControl = false;
            hasFiltersLinkTableRecordControl = hasFiltersLinkTableRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["LinkTable"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "LinkTable"));
            }
            HttpContext.Current.Session["QueryString in ShowLinkTable"] = recId;
          ...
          wc.iAND(LinkTableTable.LinkID, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(LinkTableTable.LinkID));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(LinkTableTable.LinkID, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public virtual void SetLinkTableDialogEditButton()                
        ...
        public virtual void LinkTableDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ContactID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Contacts/ShowContacts.aspx?Contacts={LinkTableRecordControl:FK:FK_LinkTable_Contacts}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={LinkTableRecordControl:FK:FK_LinkTable_Properties}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseLinkTableRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseLinkTableRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton LinkTableDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LinkTableDialogEditButton");
            }
        }
