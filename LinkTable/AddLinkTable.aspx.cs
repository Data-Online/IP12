...
// This file implements the code-behind class for AddLinkTable.aspx.
// AddLinkTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddLinkTable
        : BaseApplicationPage
// Code-behind class for the AddLinkTable page.
...
public void SetLinkTableRecordControl()
        {
            SetLinkTableRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddLinkTable.LinkTableRecordControl LinkTableRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Link");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "LinkTableRecordControl":
                 SetLinkTableRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.LinkTableRecordControl.SaveData();
        ...
        SetLinkTableRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "LinkTableMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLinkTableRecordControl_Base()           
        
        {        
            if (LinkTableRecordControl.Visible)
            {
                LinkTableRecordControl.LoadData();
                LinkTableRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.LinkTableRecordControl != null && this.LinkTableRecordControl.DataSource != null)
                  {
                        id = this.LinkTableRecordControl.DataSource.GetValue(this.LinkTableRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.LinkTableRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.LinkTableRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.LinkTableRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.LinkTableRecordControl.DataSource.GetValue(this.LinkTableRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
