...
// GroupByLinkTableTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByLinkTableTable
{
...
// Base class for the LinkTableTableControlRow control on the GroupByLinkTableTable page.
...
// Base class for the LinkTableTableControl control on the GroupByLinkTableTable page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void LinkTablePDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByLinkTableTable.LinkTablePDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "LinkTable";
                // If GroupByLinkTableTable.LinkTablePDFButton.report specifies a valid report template,
        ...
        public virtual void LinkTableWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByLinkTableTable.LinkTableWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "LinkTable";
                // If GroupByLinkTableTable.LinkTableWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual LinkTableTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (LinkTableTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByLinkTableTable.LinkTableTableControlRow")));
