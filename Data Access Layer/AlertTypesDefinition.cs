...
/// <see cref="AlertTypesTable">IPv5.AlertTypesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="AlertTypesTable"></seealso>
public class AlertTypesDefinition
{
#region "Definition (XML) for AlertTypesDefinition table"
	//Next 72 lines contain Table Definition (XML) for table "AlertTypesDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>AlertTypesID</columnName>");
         tbf.Append(      @"<columnUIName>Alert Types</columnUIName>");
         ...
         tbf.Append(      @"<columnName>Text</columnName>");
         tbf.Append(      @"<columnUIName>Text</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>AlertTypes</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableCodeName>AlertTypes</TableCodeName>");
         tbf.Append(  @"<TableAliasName>AlertTypes_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>AlertTypes</FolderName>");
         tbf.Append(  @"<MenuName>Alert Types</MenuName>");
         tbf.Append(  @"<QSPath>../AlertTypes/AlertTypesQuickSelector.aspx</QSPath>");
