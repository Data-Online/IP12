...
/// <see cref="RegionsTable">IPv5.RegionsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="RegionsTable"></seealso>
public class RegionsDefinition
{
#region "Definition (XML) for RegionsDefinition table"
	//Next 251 lines contain Table Definition (XML) for table "RegionsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(  @"<TableCodeName>Regions</TableCodeName>");
         tbf.Append(  @"<FolderName>Regions</FolderName>");
         tbf.Append(  @"<MenuName>Regions</MenuName>");
         tbf.Append(  @"<QSPath>../Regions/RegionsQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5Regions</TableStoredProcPrefix>");
