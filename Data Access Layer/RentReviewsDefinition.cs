...
/// <see cref="RentReviewsTable">IPv5.RentReviewsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="RentReviewsTable"></seealso>
public class RentReviewsDefinition
{
#region "Definition (XML) for RentReviewsDefinition table"
	//Next 288 lines contain Table Definition (XML) for table "RentReviewsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>RentReviewID</columnName>");
         tbf.Append(      @"<columnUIName>Rent Review</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_RentReviews_Properties</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>RentReviews</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>RentReviews_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>RentReviews</TableCodeName>");
         tbf.Append(  @"<FolderName>RentReviews</FolderName>");
         tbf.Append(  @"<MenuName>Rent Reviews</MenuName>");
         tbf.Append(  @"<QSPath>../RentReviews/RentReviewsQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5RentReviews</TableStoredProcPrefix>");
