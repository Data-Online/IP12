...
/// <see cref="PropertiesPropertyContactsTable">IPv5.PropertiesPropertyContactsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PropertiesPropertyContactsTable"></seealso>
public class PropertiesPropertyContactsDefinition
{
#region "Definition (XML) for PropertiesPropertyContactsDefinition table"
	//Next 165 lines contain Table Definition (XML) for table "PropertiesPropertyContactsDefinition"
	...
	/// <see cref="PropertiesPropertyContactsTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>FK_PropertiesPropertyContacts_PropertyContacts</columnFKName>");
         tbf.Append(        @"<columnFKTable>IPv5.Business.PropertyContactsTable, IPv5.Business</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>PropertyContactID</columnFKColumn>");
         tbf.Append(        @"<columnFKColumnDisplay>= FirstName + &quot; &quot; + LastName</columnFKColumnDisplay>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_PropertiesPropertyContacts_Properties</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_PropertiesPropertyContacts_ContactTypes</columnFKName>");
         ...
         tbf.Append(      @"<columnName>PropertiesPropertyContactsId</columnName>");
         tbf.Append(      @"<columnUIName>Properties Property Contacts</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>PropertiesPropertyContacts</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>PropertiesPropertyContacts_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>PropertiesPropertyContacts</FolderName>");
         tbf.Append(  @"<MenuName>Properties Property Contacts</MenuName>");
         tbf.Append(  @"<QSPath>../PropertiesPropertyContacts/PropertiesPropertyContactsQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>PropertiesPropertyContacts</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5PropertiesPropertyContacts</TableStoredProcPrefix>");
