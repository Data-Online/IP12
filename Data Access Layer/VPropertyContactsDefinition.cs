...
#region "Definition (XML) for VPropertyContactsDefinition table"
	//Next 887 lines contain Table Definition (XML) for table "VPropertyContactsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5VPropertyContacts</TableStoredProcPrefix>");
