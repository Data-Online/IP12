...
/// <see cref="VPropertyRentReviewsView">IPv5.VPropertyRentReviewsView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="VPropertyRentReviewsView"></seealso>
public class VPropertyRentReviewsDefinition
{
#region "Definition (XML) for VPropertyRentReviewsDefinition table"
	//Next 383 lines contain Table Definition (XML) for table "VPropertyRentReviewsDefinition"
	...
	/// <see cref="VPropertyRentReviewsView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>VFK_vPropertyRentReviews_PropertyID_1</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertyRentReviews_CityID_1</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertyRentReviews_RegionID_1</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertyRentReviews_CountryID_1</columnFKName>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">Rent Review</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>vPropertyRentReviews</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableCodeName>VPropertyRentReviews</TableCodeName>");
         tbf.Append(  @"<TableAliasName>VPropertyRentReviews_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>vPropertyRentReviews</FolderName>");
         tbf.Append(  @"<MenuName>Property Rent Reviews</MenuName>");
         tbf.Append(  @"<QSPath>../vPropertyRentReviews/VPropertyRentReviewsQuickSelector.aspx</QSPath>");
