...
/// <see cref="AlertLevelsTable">IPv5.AlertLevelsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="AlertLevelsTable"></seealso>
public class AlertLevelsDefinition
{
#region "Definition (XML) for AlertLevelsDefinition table"
	//Next 211 lines contain Table Definition (XML) for table "AlertLevelsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>AlertLevelID</columnName>");
         tbf.Append(      @"<columnUIName>Alert Level</columnUIName>");
         ...
         tbf.Append(      @"<columnName>TriggerDays</columnName>");
         tbf.Append(      @"<columnUIName>Trigger Days</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>DueNowColour</columnName>");
         tbf.Append(      @"<columnUIName>Due NOW Colour</columnUIName>");
         ...
         tbf.Append(      @"<columnName>DueSoonColour</columnName>");
         tbf.Append(      @"<columnUIName>Due Soon Colour</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>20</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>OverdueColour</columnName>");
         tbf.Append(      @"<columnUIName>Overdue Colour</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>20</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>OverdueTriggerDays</columnName>");
         tbf.Append(      @"<columnUIName>Overdue Trigger Days</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(        @"<columnFKName>FK_AlertLevels_AlertData</columnFKName>");
         tbf.Append(        @"<columnFKTable>IPv5.Business.AlertDataTable, IPv5.Business</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>AlertDataID</columnFKColumn>");
         tbf.Append(        @"<columnFKColumnDisplay>ViewName</columnFKColumnDisplay>");
         tbf.Append(        @"<foreignKeyType>Explicit</foreignKeyType>");
         tbf.Append(      "</foreignKey>");
         tbf.Append(      @"<applyDFKA>Y</applyDFKA>");
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>AlertLevels</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableCodeName>AlertLevels</TableCodeName>");
         tbf.Append(  @"<TableAliasName>AlertLevels_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>AlertLevels</FolderName>");
         tbf.Append(  @"<MenuName>Alert Levels</MenuName>");
         tbf.Append(  @"<QSPath>../AlertLevels/AlertLevelsQuickSelector.aspx</QSPath>");
