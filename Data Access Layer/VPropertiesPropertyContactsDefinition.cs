...
/// <see cref="VPropertiesPropertyContactsView">IPv5.VPropertiesPropertyContactsView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="VPropertiesPropertyContactsView"></seealso>
public class VPropertiesPropertyContactsDefinition
{
#region "Definition (XML) for VPropertiesPropertyContactsDefinition table"
	//Next 411 lines contain Table Definition (XML) for table "VPropertiesPropertyContactsDefinition"
	...
	/// <see cref="VPropertiesPropertyContactsView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>VFK_vPropertiesPropertyContacts_PropertyId_1</columnFKName>");
         ...
         tbf.Append(      @"<updatingFormula></updatingFormula>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertiesPropertyContacts_ContactTypeId_1</columnFKName>");
         ...
         tbf.Append(        @"<columnFKColumnDisplay>= ContactTypes.ContactType</columnFKColumnDisplay>");
         tbf.Append(        @"<foreignKeyType>Implicit</foreignKeyType>");
         tbf.Append(      "</foreignKey>");
         tbf.Append(    "</Column>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>vPropertiesPropertyContacts</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>vPropertiesPropertyContacts_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>VPropertiesPropertyContacts</TableCodeName>");
         tbf.Append(  @"<FolderName>vPropertiesPropertyContacts</FolderName>");
         tbf.Append(  @"<MenuName>Properties Property Contacts1</MenuName>");
         tbf.Append(  @"<QSPath>../vPropertiesPropertyContacts/VPropertiesPropertyContactsQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5VPropertiesPropertyContacts</TableStoredProcPrefix>");
