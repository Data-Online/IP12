...
/// <see cref="AlertDataTable">IPv5.AlertDataTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="AlertDataTable"></seealso>
public class AlertDataDefinition
{
#region "Definition (XML) for AlertDataDefinition table"
	//Next 98 lines contain Table Definition (XML) for table "AlertDataDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>AlertDataID</columnName>");
         tbf.Append(      @"<columnUIName>Alert Data</columnUIName>");
         ...
         tbf.Append(      @"<columnName>ViewName</columnName>");
         tbf.Append(      @"<columnUIName>View Name</columnUIName>");
         ...
         tbf.Append(      @"<columnName>ViewDescription</columnName>");
         tbf.Append(      @"<columnUIName>View Description</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>50</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>AlertData</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableCodeName>AlertData</TableCodeName>");
         tbf.Append(  @"<TableAliasName>AlertData_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>AlertData</FolderName>");
         tbf.Append(  @"<MenuName>Alert Data</MenuName>");
         tbf.Append(  @"<QSPath>../AlertData/AlertDataQuickSelector.aspx</QSPath>");
