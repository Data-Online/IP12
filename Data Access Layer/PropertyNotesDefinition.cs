...
/// <see cref="PropertyNotesTable">IPv5.PropertyNotesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PropertyNotesTable"></seealso>
public class PropertyNotesDefinition
{
#region "Definition (XML) for PropertyNotesDefinition table"
	//Next 288 lines contain Table Definition (XML) for table "PropertyNotesDefinition"
	...
	/// <see cref="PropertyNotesTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>FK_PropertyNotes_Properties</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>PropertyNotes</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>PropertyNotes_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>PropertyNotes</TableCodeName>");
         tbf.Append(  @"<FolderName>PropertyNotes</FolderName>");
         tbf.Append(  @"<MenuName>Property Notes</MenuName>");
         tbf.Append(  @"<QSPath>../PropertyNotes/PropertyNotesQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5PropertyNotes</TableStoredProcPrefix>");
