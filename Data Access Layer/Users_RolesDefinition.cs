...
/// <see cref="Users_RolesTable">IPv5.Users_RolesTable</see> class
...
#region "Definition (XML) for Users_RolesDefinition table"
	//Next 260 lines contain Table Definition (XML) for table "Users_RolesDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName>Users Role</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_Users_Roles_Users</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_Users_Roles_Roles</columnFKName>");
         tbf.Append(        @"<columnFKTable>IPv5.Business.RolesTable, IPv5.Business</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Users_Roles</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Users_Roles_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Users_Roles</TableCodeName>");
         ...
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5Users_Roles</TableStoredProcPrefix>");
