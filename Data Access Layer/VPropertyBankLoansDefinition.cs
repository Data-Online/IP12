...
/// <see cref="VPropertyBankLoansView">IPv5.VPropertyBankLoansView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="VPropertyBankLoansView"></seealso>
public class VPropertyBankLoansDefinition
{
#region "Definition (XML) for VPropertyBankLoansDefinition table"
	//Next 397 lines contain Table Definition (XML) for table "VPropertyBankLoansDefinition"
	...
	/// <see cref="VPropertyBankLoansView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName Source=""User"">Property</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>VFK_vPropertyBankLoans_PropertyID_1</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertyBankLoans_CityID_1</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertyBankLoans_RegionID_1</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertyBankLoans_CountryID_1</columnFKName>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">Bank Loan</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>vPropertyBankLoans</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableCodeName>VPropertyBankLoans</TableCodeName>");
         tbf.Append(  @"<TableAliasName>VPropertyBankLoans_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>vPropertyBankLoans</FolderName>");
         tbf.Append(  @"<MenuName>Property Bank Loans</MenuName>");
         tbf.Append(  @"<QSPath>../vPropertyBankLoans/VPropertyBankLoansQuickSelector.aspx</QSPath>");
