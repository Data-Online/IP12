...
/// <see cref="CountriesTable">IPv5.CountriesTable</see> class
...
#region "Definition (XML) for CountriesDefinition table"
	//Next 203 lines contain Table Definition (XML) for table "CountriesDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(  @"<QSPath>../Countries/CountriesQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5Countries</TableStoredProcPrefix>");
