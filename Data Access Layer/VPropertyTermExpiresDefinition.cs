...
/// <see cref="VPropertyTermExpiresView">IPv5.VPropertyTermExpiresView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="VPropertyTermExpiresView"></seealso>
public class VPropertyTermExpiresDefinition
{
#region "Definition (XML) for VPropertyTermExpiresDefinition table"
	//Next 383 lines contain Table Definition (XML) for table "VPropertyTermExpiresDefinition"
	...
	/// <see cref="VPropertyTermExpiresView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>VFK_vPropertyTermExpires_PropertyID_1</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertyTermExpires_CityID_1</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertyTermExpires_RegionID_1</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertyTermExpires_CountryID_1</columnFKName>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">Term Expire</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>vPropertyTermExpires</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableCodeName>VPropertyTermExpires</TableCodeName>");
         tbf.Append(  @"<TableAliasName>VPropertyTermExpires_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>vPropertyTermExpires</FolderName>");
         tbf.Append(  @"<MenuName>Property Term Expires</MenuName>");
         tbf.Append(  @"<QSPath>../vPropertyTermExpires/VPropertyTermExpiresQuickSelector.aspx</QSPath>");
