...
/// <see cref="ServiceTypesTable">IPv5.ServiceTypesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ServiceTypesTable"></seealso>
public class ServiceTypesDefinition
{
#region "Definition (XML) for ServiceTypesDefinition table"
	//Next 203 lines contain Table Definition (XML) for table "ServiceTypesDefinition"
	...
	/// <see cref="ServiceTypesTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>ServiceTypes</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>ServiceTypes_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>ServiceTypes</TableCodeName>");
         tbf.Append(  @"<FolderName>ServiceTypes</FolderName>");
         tbf.Append(  @"<MenuName>Service Types</MenuName>");
         tbf.Append(  @"<QSPath>../ServiceTypes/ServiceTypesQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5ServiceTypes</TableStoredProcPrefix>");
