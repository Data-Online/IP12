...
/// <see cref="ContactTypesTable">IPv5.ContactTypesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ContactTypesTable"></seealso>
public class ContactTypesDefinition
{
#region "Definition (XML) for ContactTypesDefinition table"
	//Next 203 lines contain Table Definition (XML) for table "ContactTypesDefinition"
	...
	/// <see cref="ContactTypesTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>ContactType</columnName>");
         tbf.Append(      @"<columnUIName>Contact Type</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>ContactTypes</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>ContactTypes_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>ContactTypes</TableCodeName>");
         tbf.Append(  @"<FolderName>ContactTypes</FolderName>");
         tbf.Append(  @"<MenuName>Contact Types</MenuName>");
         tbf.Append(  @"<QSPath>../ContactTypes/ContactTypesQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5ContactTypes</TableStoredProcPrefix>");
