...
/// <see cref="TermRenewalsTable">IPv5.TermRenewalsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="TermRenewalsTable"></seealso>
public class TermRenewalsDefinition
{
#region "Definition (XML) for TermRenewalsDefinition table"
	//Next 288 lines contain Table Definition (XML) for table "TermRenewalsDefinition"
	...
	/// <see cref="TermRenewalsTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>FK_TermRenewals_Properties</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>TermRenewals</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>TermRenewals_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>TermRenewals</TableCodeName>");
         tbf.Append(  @"<FolderName>TermRenewals</FolderName>");
         tbf.Append(  @"<MenuName>Term Renewals</MenuName>");
         tbf.Append(  @"<QSPath>../TermRenewals/TermRenewalsQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5TermRenewals</TableStoredProcPrefix>");
