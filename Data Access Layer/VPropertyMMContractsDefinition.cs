...
/// <see cref="VPropertyMMContractsView">IPv5.VPropertyMMContractsView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="VPropertyMMContractsView"></seealso>
public class VPropertyMMContractsDefinition
{
#region "Definition (XML) for VPropertyMMContractsDefinition table"
	//Next 383 lines contain Table Definition (XML) for table "VPropertyMMContractsDefinition"
	...
	/// <see cref="VPropertyMMContractsView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>VFK_vPropertyMMContracts_PropertyID_1</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertyMMContracts_CityID_1</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertyMMContracts_RegionID_1</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vPropertyMMContracts_CountryID_1</columnFKName>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">Month Contract</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>vPropertyMMContracts</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableCodeName>VPropertyMMContracts</TableCodeName>");
         tbf.Append(  @"<TableAliasName>VPropertyMMContracts_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>vPropertyMMContracts</FolderName>");
         tbf.Append(  @"<MenuName>Property MM Contracts</MenuName>");
         tbf.Append(  @"<QSPath>../vPropertyMMContracts/VPropertyMMContractsQuickSelector.aspx</QSPath>");
