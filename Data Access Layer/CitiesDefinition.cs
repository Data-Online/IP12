...
/// <see cref="CitiesTable">IPv5.CitiesTable</see> class
...
#region "Definition (XML) for CitiesDefinition table"
	//Next 203 lines contain Table Definition (XML) for table "CitiesDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(  @"<QSPath>../Cities/CitiesQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5Cities</TableStoredProcPrefix>");
