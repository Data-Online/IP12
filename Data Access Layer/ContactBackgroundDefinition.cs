...
/// <see cref="ContactBackgroundTable">IPv5.ContactBackgroundTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ContactBackgroundTable"></seealso>
public class ContactBackgroundDefinition
{
#region "Definition (XML) for ContactBackgroundDefinition table"
	//Next 307 lines contain Table Definition (XML) for table "ContactBackgroundDefinition"
	...
	/// <see cref="ContactBackgroundTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>FK_ContactBackground_Contacts</columnFKName>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">Created By</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_ContactBackground_CreatedBy_2</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>ContactBackground</TableName>");
         tbf.Append(  @"<Version>3</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>ContactBackground_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>ContactBackground</TableCodeName>");
         tbf.Append(  @"<FolderName>ContactBackground</FolderName>");
         tbf.Append(  @"<MenuName>Contact Background</MenuName>");
         tbf.Append(  @"<QSPath>../ContactBackground/ContactBackgroundQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5ContactBackground</TableStoredProcPrefix>");
