...
/// <see cref="BankLoansTable">IPv5.BankLoansTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="BankLoansTable"></seealso>
public class BankLoansDefinition
{
#region "Definition (XML) for BankLoansDefinition table"
	//Next 288 lines contain Table Definition (XML) for table "BankLoansDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>BankLoanID</columnName>");
         tbf.Append(      @"<columnUIName>Bank Loan</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_BankLoans_Properties</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>BankLoans</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>BankLoans_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>BankLoans</TableCodeName>");
         tbf.Append(  @"<FolderName>BankLoans</FolderName>");
         tbf.Append(  @"<MenuName>Bank Loans</MenuName>");
         tbf.Append(  @"<QSPath>../BankLoans/BankLoansQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5BankLoans</TableStoredProcPrefix>");
