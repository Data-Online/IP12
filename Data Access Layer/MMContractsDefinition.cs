...
/// <see cref="MMContractsTable">IPv5.MMContractsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="MMContractsTable"></seealso>
public class MMContractsDefinition
{
#region "Definition (XML) for MMContractsDefinition table"
	//Next 134 lines contain Table Definition (XML) for table "MMContractsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>MMContractID</columnName>");
         tbf.Append(      @"<columnUIName>Month Contract</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_MMContracts_Properties</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>MMContracts</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableCodeName>MMContracts</TableCodeName>");
         tbf.Append(  @"<TableAliasName>MMContracts_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>MMContracts</FolderName>");
         tbf.Append(  @"<MenuName>MM Contracts</MenuName>");
         tbf.Append(  @"<QSPath>../MMContracts/MMContractsQuickSelector.aspx</QSPath>");
