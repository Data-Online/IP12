...
/// <see cref="RolesTable">IPv5.RolesTable</see> class
...
#region "Definition (XML) for RolesDefinition table"
	//Next 203 lines contain Table Definition (XML) for table "RolesDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(  @"<TableCodeName>Roles</TableCodeName>");
         tbf.Append(  @"<FolderName>Roles</FolderName>");
         tbf.Append(  @"<MenuName>Roles</MenuName>");
         tbf.Append(  @"<QSPath>../Roles/RolesQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5Roles</TableStoredProcPrefix>");
