...
/// <see cref="VUserRoleSummaryView">IPv5.VUserRoleSummaryView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="VUserRoleSummaryView"></seealso>
public class VUserRoleSummaryDefinition
{
#region "Definition (XML) for VUserRoleSummaryDefinition table"
	//Next 200 lines contain Table Definition (XML) for table "VUserRoleSummaryDefinition"
	...
	/// <see cref="VUserRoleSummaryView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>vUserRoleSummary</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>vUserRoleSummary_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>VUserRoleSummary</TableCodeName>");
         tbf.Append(  @"<FolderName>vUserRoleSummary</FolderName>");
         tbf.Append(  @"<MenuName>User Role Summary</MenuName>");
         tbf.Append(  @"<QSPath>../vUserRoleSummary/VUserRoleSummaryQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5VUserRoleSummary</TableStoredProcPrefix>");
