...
/// <see cref="TermExpiresTable">IPv5.TermExpiresTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="TermExpiresTable"></seealso>
public class TermExpiresDefinition
{
#region "Definition (XML) for TermExpiresDefinition table"
	//Next 288 lines contain Table Definition (XML) for table "TermExpiresDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>TermExpireID</columnName>");
         tbf.Append(      @"<columnUIName>Term Expire</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_TermExpires_Properties</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>TermExpires</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>TermExpires_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>TermExpires</TableCodeName>");
         tbf.Append(  @"<FolderName>TermExpires</FolderName>");
         tbf.Append(  @"<MenuName>Term Expires</MenuName>");
         tbf.Append(  @"<QSPath>../TermExpires/TermExpiresQuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIPv5TermExpires</TableStoredProcPrefix>");
