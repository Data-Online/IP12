...
/// <see cref="ContractorsTable">IPv5.ContractorsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ContractorsTable"></seealso>
public class ContractorsDefinition
{
#region "Definition (XML) for ContractorsDefinition table"
	//Next 315 lines contain Table Definition (XML) for table "ContractorsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>ContractorID</columnName>");
         ...
         tbf.Append(        @"<columnFKName>FK_Contractors_Cities</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Contractors</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableCodeName>Contractors</TableCodeName>");
         tbf.Append(  @"<TableAliasName>Contractors_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>Contractors</FolderName>");
         tbf.Append(  @"<MenuName>Contractors</MenuName>");
         tbf.Append(  @"<QSPath>../Contractors/ContractorsQuickSelector.aspx</QSPath>");
