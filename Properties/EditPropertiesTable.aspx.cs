...
// This file implements the code-behind class for EditPropertiesTable.aspx.
// EditPropertiesTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditPropertiesTable
        : BaseApplicationPage
// Code-behind class for the EditPropertiesTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditPropertiesTable()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditPropertiesTable.PropertiesTableControl PropertiesTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Properties");
    ...
    public static string[] GetAutoCompletionList_PropertiesSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditPropertiesTable.PropertiesTableControl control = new IPv5.UI.Controls.EditPropertiesTable.PropertiesTableControl();
