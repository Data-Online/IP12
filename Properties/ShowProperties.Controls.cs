...
// ShowProperties.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowProperties
{
...
// Base class for the MMContractsTableControlRow control on the ShowProperties page.
...
public class BaseMMContractsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.MMContractsRowEditButton.Click += MMContractsRowEditButton_Click;
        ...
        PropertiesRecordControl parentCtrl;
      
            parentCtrl = (PropertiesRecordControl)this.Page.FindControlRecursively("PropertiesRecordControl");
      ...
      // To customize, override this method in MMContractsTableControlRow.
        ...
        public virtual void SetMMContractsRowEditButton()                
      ...
      this.Page.CommitTransaction(sender);
        ...
        // event handler for ImageButton
        public virtual void MMContractsRowEditButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton MMContractsRowEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsRowEditButton");
            }
        }
...
// Base class for the MMContractsTableControl control on the ShowProperties page.
...
public class BaseMMContractsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.ExpiryDateSortLabel1.Click += ExpiryDateSortLabel1_Click;
            
            // Setup the button events.
          
                    this.MMContractsExportExcelButton.Click += MMContractsExportExcelButton_Click;
                        
                    this.MMContractsImportButton.Click += MMContractsImportButton_Click;
                        
                    this.MMContractsNewButton.Click += MMContractsNewButton_Click;
                        
                    this.MMContractsPDFButton.Click += MMContractsPDFButton_Click;
                        
                    this.MMContractsWordButton.Click += MMContractsWordButton_Click;
                        
                    this.MMContractsButtonsButton.Button.Click += MMContractsButtonsButton_Click;
                        
                    this.MMContractsFiltersButton.Button.Click += MMContractsFiltersButton_Click;
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetMMContractsExportExcelButton();
              
                SetMMContractsImportButton();
              
                SetMMContractsNewButton();
              
                SetMMContractsPDFButton();
              
                SetMMContractsWordButton();
              
                SetMMContractsButtonsButton();
              
                SetMMContractsFiltersButton();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        if (this.TotalRecords > 10000)
          this.MMContractsExportExcelButton.Attributes.Add("onClick", "return (confirm('" + ((BaseApplicationPage)this.Page).GetResourceValue("ExportConfirm", "IPv5") + "'));");
        else
          this.MMContractsExportExcelButton.Attributes.Remove("onClick");
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"MMContractsExportExcelButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"MMContractsPDFButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"MMContractsWordButton"));
    ...
    IPv5.UI.Controls.ShowProperties.PropertiesRecordControl propertiesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "PropertiesRecordControl") as IPv5.UI.Controls.ShowProperties.PropertiesRecordControl);
          
              if (propertiesRecordControlObj != null && propertiesRecordControlObj.GetRecord() != null && propertiesRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(MMContractsTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, propertiesRecordControlObj.GetRecord().PropertyID.ToString());
              selectedRecordKeyValue.AddElement(MMContractsTable.PropertyID.InternalName, propertiesRecordControlObj.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInPropertiesRecordControl = HttpContext.Current.Session["MMContractsTableControlWhereClause"] as string;
      
      if (selectedRecordInPropertiesRecordControl != null && KeyValue.IsXmlKey(selectedRecordInPropertiesRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInPropertiesRecordControl);
      ...
      MMContractsRecord rec = new MMContractsRecord();
        ...
        public virtual void SetExpiryDateSortLabel1()
                  {
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetMMContractsExportExcelButton()                
        ...
        public virtual void SetMMContractsImportButton()                
              
        {
        							
                    this.MMContractsImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=MMContracts" ;
                    this.MMContractsImportButton.Attributes["onClick"] = "window.open('" + this.Page.EncryptUrlParameter(this.MMContractsImportButton.PostBackUrl) + "','importWindow', 'width=700, height=500,top=' +(screen.availHeight-500)/2 + ',left=' + (screen.availWidth-700)/2+ ', resizable=yes, scrollbars=yes,modal=yes'); return false;";
                        
   
        }
            
        public virtual void SetMMContractsNewButton()                
        ...
        public virtual void SetMMContractsPDFButton()                
        ...
        public virtual void SetMMContractsWordButton()                
        ...
        public virtual void SetMMContractsButtonsButton()                
        ...
        public virtual void SetMMContractsFiltersButton()                
              
        {
                
         IThemeButtonWithArrow themeButtonMMContractsFiltersButton = (IThemeButtonWithArrow)(MiscUtils.FindControlRecursively(this, "MMContractsFiltersButton"));
         themeButtonMMContractsFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
        ...
        public virtual void ExpiryDateSortLabel1_Click(object sender, EventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void MMContractsExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void MMContractsImportButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void MMContractsNewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../MMContracts/AddMMContracts.aspx";
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void MMContractsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowProperties.MMContractsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "MMContracts";
                // If ShowProperties.MMContractsPDFButton.report specifies a valid report template,
        ...
        // event handler for ImageButton
        public virtual void MMContractsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowProperties.MMContractsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "MMContracts";
                // If ShowProperties.MMContractsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void MMContractsButtonsButton_Click(object sender, EventArgs args)
        {
        ...
        // event handler for Button
        public virtual void MMContractsFiltersButton_Click(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton ExpiryDateSortLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ExpiryDateSortLabel1");
            }
        }
        
        public IPv5.UI.IThemeButtonWithArrow MMContractsButtonsButton {
            get {
                return (IPv5.UI.IThemeButtonWithArrow)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsButtonsButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton MMContractsExportExcelButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsExportExcelButton");
            }
        }
        
        public IPv5.UI.IThemeButtonWithArrow MMContractsFiltersButton {
            get {
                return (IPv5.UI.IThemeButtonWithArrow)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsFiltersButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton MMContractsImportButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsImportButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton MMContractsNewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsNewButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton MMContractsPDFButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsPDFButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton MMContractsWordButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsWordButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MMContractsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MMContractsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowProperties.MMContractsTableControlRow")));
...
// Base class for the PropertyNotesTableControlRow control on the ShowProperties page.
...
public class BasePropertyNotesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.PropertyNotesRowEditButton.Click += PropertyNotesRowEditButton_Click;
      ...
      // To customize, override this method in PropertyNotesTableControlRow.
        ...
        public virtual void SetPropertyNotesRowEditButton()                
      ...
      this.Page.CommitTransaction(sender);
        ...
        // event handler for ImageButton
        public virtual void PropertyNotesRowEditButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton PropertyNotesRowEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyNotesRowEditButton");
            }
        }
...
// Base class for the PropertyNotesTableControl control on the ShowProperties page.
...
public class BasePropertyNotesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.ShowProperties.PropertiesRecordControl propertiesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "PropertiesRecordControl") as IPv5.UI.Controls.ShowProperties.PropertiesRecordControl);
              ...
              if (propertiesRecordControlObj != null && propertiesRecordControlObj.GetRecord() != null && propertiesRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(PropertyNotesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, propertiesRecordControlObj.GetRecord().PropertyID.ToString());
              selectedRecordKeyValue.AddElement(PropertyNotesTable.PropertyID.InternalName, propertiesRecordControlObj.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInPropertiesRecordControl = HttpContext.Current.Session["PropertyNotesTableControlWhereClause"] as string;
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void DateRecordedSortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(PropertyNotesTable.DateRecorded);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(PropertyNotesTable.DateRecorded, OrderByItem.OrderDir.Asc);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyNotesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowProperties.PropertyNotesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyNotes";
                // If ShowProperties.PropertyNotesPDFButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.   
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void PropertyNotesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowProperties.PropertyNotesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyNotes";
                // If ShowProperties.PropertyNotesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual PropertyNotesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyNotesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowProperties.PropertyNotesTableControlRow")));
...
// Base class for the TermExpiresTableControlRow control on the ShowProperties page.
...
public class BaseTermExpiresTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.TermExpiresRowEditButton.Click += TermExpiresRowEditButton_Click;
      ...
      // To customize, override this method in TermExpiresTableControlRow.
        ...
        public virtual void SetTermExpiresRowEditButton()                
      ...
      this.Page.CommitTransaction(sender);
        ...
        // event handler for ImageButton
        public virtual void TermExpiresRowEditButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton TermExpiresRowEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresRowEditButton");
            }
        }
...
// Base class for the TermExpiresTableControl control on the ShowProperties page.
...
public class BaseTermExpiresTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.TermExpiresExportExcelButton.Click += TermExpiresExportExcelButton_Click;
                        
                    this.TermExpiresImportButton.Click += TermExpiresImportButton_Click;
                        
                    this.TermExpiresNewButton.Click += TermExpiresNewButton_Click;
                        
                    this.TermExpiresPDFButton.Click += TermExpiresPDFButton_Click;
                        
                    this.TermExpiresWordButton.Click += TermExpiresWordButton_Click;
                        
                    this.TermExpiresButtonsButton.Button.Click += TermExpiresButtonsButton_Click;
                        
                    this.TermExpiresFiltersButton.Button.Click += TermExpiresFiltersButton_Click;
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetTermExpiresExportExcelButton();
              
                SetTermExpiresImportButton();
              
                SetTermExpiresNewButton();
              
                SetTermExpiresPDFButton();
              
                SetTermExpiresWordButton();
              
                SetTermExpiresButtonsButton();
              
                SetTermExpiresFiltersButton();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        if (this.TotalRecords > 10000)
          this.TermExpiresExportExcelButton.Attributes.Add("onClick", "return (confirm('" + ((BaseApplicationPage)this.Page).GetResourceValue("ExportConfirm", "IPv5") + "'));");
        else
          this.TermExpiresExportExcelButton.Attributes.Remove("onClick");
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"TermExpiresExportExcelButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"TermExpiresPDFButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"TermExpiresWordButton"));
    ...
    IPv5.UI.Controls.ShowProperties.PropertiesRecordControl propertiesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "PropertiesRecordControl") as IPv5.UI.Controls.ShowProperties.PropertiesRecordControl);
              ...
              if (propertiesRecordControlObj != null && propertiesRecordControlObj.GetRecord() != null && propertiesRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(TermExpiresTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, propertiesRecordControlObj.GetRecord().PropertyID.ToString());
              selectedRecordKeyValue.AddElement(TermExpiresTable.PropertyID.InternalName, propertiesRecordControlObj.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInPropertiesRecordControl = HttpContext.Current.Session["TermExpiresTableControlWhereClause"] as string;
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetTermExpiresExportExcelButton()                
        ...
        public virtual void SetTermExpiresImportButton()                
              
        {
        							
                    this.TermExpiresImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=TermExpires" ;
                    this.TermExpiresImportButton.Attributes["onClick"] = "window.open('" + this.Page.EncryptUrlParameter(this.TermExpiresImportButton.PostBackUrl) + "','importWindow', 'width=700, height=500,top=' +(screen.availHeight-500)/2 + ',left=' + (screen.availWidth-700)/2+ ', resizable=yes, scrollbars=yes,modal=yes'); return false;";
                        
   
        }
            
        public virtual void SetTermExpiresNewButton()                
        ...
        public virtual void SetTermExpiresPDFButton()                
        ...
        public virtual void SetTermExpiresWordButton()                
        ...
        public virtual void SetTermExpiresButtonsButton()                
        ...
        public virtual void SetTermExpiresFiltersButton()                
              
        {
                
         IThemeButtonWithArrow themeButtonTermExpiresFiltersButton = (IThemeButtonWithArrow)(MiscUtils.FindControlRecursively(this, "TermExpiresFiltersButton"));
         themeButtonTermExpiresFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
        ...
        // event handler for ImageButton
        public virtual void TermExpiresExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void TermExpiresImportButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void TermExpiresNewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../TermExpires/AddTermExpires.aspx";
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void TermExpiresPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowProperties.TermExpiresPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermExpires";
                // If ShowProperties.TermExpiresPDFButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.   
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        // event handler for ImageButton
        public virtual void TermExpiresWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowProperties.TermExpiresWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "TermExpires";
                // If ShowProperties.TermExpiresWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        // event handler for Button
        public virtual void TermExpiresButtonsButton_Click(object sender, EventArgs args)
        {
        ...
        // event handler for Button
        public virtual void TermExpiresFiltersButton_Click(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public IPv5.UI.IThemeButtonWithArrow TermExpiresButtonsButton {
            get {
                return (IPv5.UI.IThemeButtonWithArrow)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresButtonsButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton TermExpiresExportExcelButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresExportExcelButton");
            }
        }
        
        public IPv5.UI.IThemeButtonWithArrow TermExpiresFiltersButton {
            get {
                return (IPv5.UI.IThemeButtonWithArrow)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresFiltersButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton TermExpiresImportButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresImportButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton TermExpiresNewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresNewButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton TermExpiresPDFButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresPDFButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton TermExpiresWordButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermExpiresWordButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual TermExpiresTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TermExpiresTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowProperties.TermExpiresTableControlRow")));
...
// Base class for the PropertiesRecordControl control on the ShowProperties page.
...
public class BasePropertiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.PropertiesDialogEditButton.Click += PropertiesDialogEditButton_Click;
        ...
        public override void DataBind()
        {
            ...
            bool shouldResetControl = false;
            if (shouldResetControl) { }; // prototype usage to void compiler warnings
            MMContractsTableControl recMMContractsTableControl = (MMContractsTableControl)(MiscUtils.FindControlRecursively(this.Page, "MMContractsTableControl"));
        
          if (shouldResetControl || this.Page.IsPageRefresh)
          {
             recMMContractsTableControl.ResetControl();
          }
                  
        this.Page.SetControl("MMContractsTableControl");
        PropertyNotesTableControl recPropertyNotesTableControl = (PropertyNotesTableControl)(MiscUtils.FindControlRecursively(this.Page, "PropertyNotesTableControl"));
        
          if (shouldResetControl || this.Page.IsPageRefresh)
          {
             recPropertyNotesTableControl.ResetControl();
          }
                  
        this.Page.SetControl("PropertyNotesTableControl");
        TermExpiresTableControl recTermExpiresTableControl = (TermExpiresTableControl)(MiscUtils.FindControlRecursively(this.Page, "TermExpiresTableControl"));
        
          if (shouldResetControl || this.Page.IsPageRefresh)
          {
             recTermExpiresTableControl.ResetControl();
          }
                  
        this.Page.SetControl("TermExpiresTableControl");
      ...
      // To customize, override this method in PropertiesRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Properties"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "Properties"));
            }
            HttpContext.Current.Session["QueryString in ShowProperties"] = recId;
          ...
          wc.iAND(PropertiesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(PropertiesTable.PropertyID));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(PropertiesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public virtual void SetPropertiesDialogEditButton()                
        ...
        // event handler for ImageButton
        public virtual void PropertiesDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void CityID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Cities/ShowCities.aspx?Cities={PropertiesRecordControl:FK:FK_Properties_Cities}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void CountryID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Countries/ShowCountries.aspx?Countries={PropertiesRecordControl:FK:FK_Properties_Countries}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void RegionID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Regions/ShowRegions.aspx?Regions={PropertiesRecordControl:FK:FK_Properties_Regions}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton PropertiesDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertiesDialogEditButton");
            }
        }
