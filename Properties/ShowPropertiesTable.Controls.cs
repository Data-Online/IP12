...
// ShowPropertiesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowPropertiesTable
{
...
// Base class for the PropertiesTableControlRow control on the ShowPropertiesTable page.
...
public class BasePropertiesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPropertiesTabContainer()    
...
#region "Helper Properties"
        ...
        public AjaxControlToolkit.TabContainer PropertiesTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertiesTabContainer");
            }
        }
...
// Base class for the PropertiesTableControl control on the ShowPropertiesTable page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertiesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowPropertiesTable.PropertiesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Properties";
                // If ShowPropertiesTable.PropertiesPDFButton.report specifies a valid report template,
        ...
        public virtual void PropertiesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowPropertiesTable.PropertiesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Properties";
                // If ShowPropertiesTable.PropertiesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual PropertiesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertiesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowPropertiesTable.PropertiesTableControlRow")));
...
// Base class for the CitiesRecordControl control on the ShowPropertiesTable page.
...
public class BaseCitiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        PropertiesTableControlRow propertiesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "PropertiesTableControlRow") as PropertiesTableControlRow);
              ...
              {
              wc.iAND(CitiesTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, propertiesTableControlObjRow.GetRecord().CityID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInPropertiesTableControl = HttpContext.Current.Session["CitiesRecordControlWhereClause"] as string;
...
// Base class for the CountriesRecordControl control on the ShowPropertiesTable page.
...
public class BaseCountriesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        PropertiesTableControlRow propertiesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "PropertiesTableControlRow") as PropertiesTableControlRow);
              ...
              if (propertiesTableControlObjRow != null && propertiesTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(CountriesTable.CountryID, BaseFilter.ComparisonOperator.EqualsTo, propertiesTableControlObjRow.GetRecord().CountryID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInPropertiesTableControl = HttpContext.Current.Session["CountriesRecordControlWhereClause"] as string;
...
// Base class for the RegionsRecordControl control on the ShowPropertiesTable page.
...
public class BaseRegionsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        PropertiesTableControlRow propertiesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "PropertiesTableControlRow") as PropertiesTableControlRow);
              ...
              if (propertiesTableControlObjRow != null && propertiesTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(RegionsTable.RegionID, BaseFilter.ComparisonOperator.EqualsTo, propertiesTableControlObjRow.GetRecord().RegionID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInPropertiesTableControl = HttpContext.Current.Session["RegionsRecordControlWhereClause"] as string;
