...
// This file implements the code-behind class for AddProperties.aspx.
// AddProperties.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddProperties
        : BaseApplicationPage
// Code-behind class for the AddProperties page.
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddProperties.PropertyNotesTableControl PropertyNotesTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Properties");
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.PropertiesRecordControl != null && this.PropertiesRecordControl.DataSource != null)
                  {
                        id = this.PropertiesRecordControl.DataSource.GetValue(this.PropertiesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.PropertiesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.PropertiesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.PropertiesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.PropertiesRecordControl.DataSource.GetValue(this.PropertiesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
