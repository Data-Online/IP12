...
// ShowPropertiesGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowPropertiesGallery
{
...
// Base class for the PropertiesTableControlRow control on the ShowPropertiesGallery page.
...
// Base class for the PropertiesTableControl control on the ShowPropertiesGallery page.
...
public class BasePropertiesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return PropertiesTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual PropertiesRecord[] CopyArray(int index, PropertiesRecord[,] recs, int columns)
      {
        PropertiesRecord[] recsCopy = new PropertiesRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            PropertiesRecord[,] recs = new PropertiesRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            PropertiesRecord[] HColDataSource = new PropertiesRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              PropertiesRecord[] VColDataSource = new PropertiesRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("PropertiesTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              PropertiesRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                PropertiesTableControlRow recControl = (PropertiesTableControlRow)innerRepItem.FindControl("PropertiesTableControlRow");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertiesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowPropertiesGallery.PropertiesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Properties";
                // If ShowPropertiesGallery.PropertiesPDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${CompanyName}", record.Format(PropertiesTable.CompanyName), ReportEnum.Align.Left);
        ...
        public virtual void PropertiesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowPropertiesGallery.PropertiesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Properties";
                // If ShowPropertiesGallery.PropertiesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual PropertiesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertiesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowPropertiesGallery.PropertiesTableControlRow")));
