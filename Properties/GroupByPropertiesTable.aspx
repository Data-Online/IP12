...
<asp:DropDownList runat="server" id="ContactIDFilter3" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("LinkTableFilterButton"))%>
                  ...
                  <asp:panel id="LinkTableTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="LinkTableTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thcnb"></th><th class="thcnb"></th><th class="thcnb"></th><th class="thcnb"></th><th class="thcnb"></th><th class="thcnb"></th><th class="thcnb"></th><th class="thcnb"></th><th class="thcnb"></th><th class="thcnb"></th></tr><asp:Repeater runat="server" id="LinkTableTableControlRepeater">		<ITEMTEMPLATE>		<IPv5:LinkTableTableControlRow runat="server" id="LinkTableTableControlRow">
<tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;" colspan="2">
                                  ...
                                  <asp:ImageButton runat="server" id="LinkTableRowDeleteButton" causesvalidation="False" commandname="DeleteRecord" cssclass="button_link" imageurl="../Images/icon_delete.gif" onmouseout="this.src=&#39;../Images/icon_delete.gif&#39;" onmouseover="this.src=&#39;../Images/icon_delete_over.gif&#39;" tooltip="&lt;%# GetResourceValue(&quot;Txt:DeleteRecord&quot;, &quot;IPv5&quot;) %>" visible="False">		
	</asp:ImageButton><br /><br />
                                </td><td class="tableCellLabel" scope="col"></td><td class="tableCellLabel"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("CancelButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("EditButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("OKButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveAndNewButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
<span style="white-space:nowrap;">
<asp:LinkButton runat="server" id="ContactID1" causesvalidation="False" commandname="Redirect" visible="False" width="100px"></asp:LinkButton></span>
...
<IPv5:ContactsRecordControl runat="server" id="ContactsRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td></td><td></td></tr><tr><td></td><td>
                  <asp:panel id="ContactsRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="ContactsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dfv" colspan="3"><asp:Literal runat="server" id="Title0"></asp:Literal> 
<asp:Literal runat="server" id="FirstName1"></asp:Literal> 
<asp:Literal runat="server" id="LastName1"></asp:Literal></td><td class="fls"><asp:Literal runat="server" id="TrustNameLabel" Text="Trust Name">	</asp:Literal></td><td class="dfv" colspan="2"><asp:Literal runat="server" id="TrustName"></asp:Literal></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="FirstName2Label" Text="EvaluateFormula(&quot;= \&quot;Second Contact\&quot;&quot;, true)">	</asp:Literal></td><td class="fls"><asp:Literal runat="server" id="FirstName2"></asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="LastName2"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="eMailLabel" Text="Email">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="eMail1"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="ActiveLabel" Text="Active">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="Active"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="Address1Label2" Text="EvaluateFormula(&quot;= \&quot;Address\&quot;&quot;, true)">	</asp:Literal></td><td class="dfv" colspan="2"><asp:Literal runat="server" id="Address12"></asp:Literal></td><td class="fls"><asp:Literal runat="server" id="PhoneNumberLabel" Text="Phone Number">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="PhoneNumber"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="DateOfBirthLabel" Text="Date Of Birth">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="DateOfBirth"></asp:Literal></span>
</td></tr><tr><td class="fls"></td><td class="dfv" colspan="2"><asp:Literal runat="server" id="Address22"></asp:Literal></td><td class="fls"><asp:Literal runat="server" id="BankAccountLabel" Text="Bank Account">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="BankAccount"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="PlaceOfBirthLabel" Text="Place Of Birth">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="PlaceOfBirth"></asp:Literal></td></tr><tr><td class="fls"></td><td class="dfv" colspan="2"><asp:Literal runat="server" id="Address32"></asp:Literal></td><td class="fls"><asp:Literal runat="server" id="IrdNumberLabel" Text="IRD Number">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="IrdNumber"></asp:Literal> </td><td class="dfv"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="PostCodeLabel1" Text="Post Code">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="PostCode2"></asp:Literal> </td><td class="fls"></td><td class="dfv"></td><td class="dfv"></td><td class="dfv"></td><td class="dfv"></td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
                </td></tr></table>
...
</td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="10">&nbsp;</td></tr></IPv5:LinkTableTableControlRow>
</ITEMTEMPLATE>
