...
namespace IPv5.UI.Controls.EditRoles
{
...
// Base class for the Users_RolesTableControlRow control on the EditRoles page.
...
// Base class for the Users_RolesTableControl control on the EditRoles page.
...
public class BaseUsers_RolesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.EditRoles.RolesRecordControl rolesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "RolesRecordControl") as IPv5.UI.Controls.EditRoles.RolesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual Users_RolesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Users_RolesTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditRoles.Users_RolesTableControlRow")));
