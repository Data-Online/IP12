...
public void SetUsers_RolesTableControl()
        {
            SetUsers_RolesTableControl_Base(); 
        }
public void SetRolesRecordControl()
        {
            SetRolesRecordControl_Base(); 
        }
public void SetRolesTabContainer()
        {
            SetRolesTabContainer_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddRoles.RolesRecordControl RolesRecordControl;
        ...
        public ThemeButtonWithArrow Users_RolesButtonsButton;
                
        public System.Web.UI.WebControls.ImageButton Users_RolesDeleteButton;
        
        public ThemeButtonWithArrow Users_RolesFiltersButton;
                
        public PaginationModern Users_RolesPagination;
                
        public IPv5.UI.Controls.AddRoles.Users_RolesTableControl Users_RolesTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "RolesRecordControl":
                 SetRolesRecordControl();
                 break;
          
              case "Users_RolesTableControl":
      ...
      public void SaveData_Base()
      {
        ...
        this.RolesRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRolesTabContainer_Base()           
        ...
        public void SetRolesRecordControl_Base()           
        ...
        public void SetUsers_RolesTableControl_Base()           
              ...
              
        {
            ...
            if (EvaluateFormula("URL(\"SaveAndNewVisible\")").ToLower() == "true") 
                ...
                MiscUtils.FindControlRecursively(this, "SaveAndNewButton").Visible = false;
                    ...
                    this.SaveAndNewButton.Button.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
              ...
              
        {
                    ...
                    this.SaveButton.Button.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.RolesRecordControl != null && this.RolesRecordControl.DataSource != null)
                  {
                        id = this.RolesRecordControl.DataSource.GetValue(this.RolesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.RolesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.RolesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.RolesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.RolesRecordControl.DataSource.GetValue(this.RolesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
