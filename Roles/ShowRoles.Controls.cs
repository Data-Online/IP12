...
namespace IPv5.UI.Controls.ShowRoles
{
...
// Base class for the Users_RolesTableControlRow control on the ShowRoles page.
...
public class BaseUsers_RolesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        RolesRecordControl parentCtrl;
      
            parentCtrl = (RolesRecordControl)this.Page.FindControlRecursively("RolesRecordControl");
...
// Base class for the Users_RolesTableControl control on the ShowRoles page.
...
public class BaseUsers_RolesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.ShowRoles.RolesRecordControl rolesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "RolesRecordControl") as IPv5.UI.Controls.ShowRoles.RolesRecordControl);
          
              if (rolesRecordControlObj != null && rolesRecordControlObj.GetRecord() != null && rolesRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(Users_RolesTable.RoleID, BaseFilter.ComparisonOperator.EqualsTo, rolesRecordControlObj.GetRecord().RoleID.ToString());
              selectedRecordKeyValue.AddElement(Users_RolesTable.RoleID.InternalName, rolesRecordControlObj.GetRecord().RoleID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInRolesRecordControl = HttpContext.Current.Session["Users_RolesTableControlWhereClause"] as string;
      
      if (selectedRecordInRolesRecordControl != null && KeyValue.IsXmlKey(selectedRecordInRolesRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInRolesRecordControl);
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             null};
              ...
              DataForExport data = new DataForExport(Users_RolesTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(Users_RolesTable.UserId0, "Default"));
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void Users_RolesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRoles.Users_RolesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users_Roles";
                // If ShowRoles.Users_RolesPDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(Users_RolesTable.UserId0.Name, ReportEnum.Align.Left, "${UserId0}", ReportEnum.Align.Left, 28);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = Users_RolesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Users_RolesTable.UserId0);
                                 _DFKA = Users_RolesTable.GetDFKA(record.UserId0.ToString(), Users_RolesTable.UserId0,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Users_RolesTable.UserId0.IsApplyDisplayAs){
                                     report.AddData("${UserId0}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${UserId0}", record.Format(Users_RolesTable.UserId0), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void Users_RolesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRoles.Users_RolesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users_Roles";
                // If ShowRoles.Users_RolesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Users_RolesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Users_RolesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowRoles.Users_RolesTableControlRow")));
...
public class BaseRolesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.RolesDialogEditButton.Click += RolesDialogEditButton_Click;
        ...
        public override void DataBind()
        {
            ...
            bool shouldResetControl = false;
            if (shouldResetControl) { }; // prototype usage to void compiler warnings
            Users_RolesTableControl recUsers_RolesTableControl = (Users_RolesTableControl)(MiscUtils.FindControlRecursively(this.Page, "Users_RolesTableControl"));
        
          if (shouldResetControl || this.Page.IsPageRefresh)
          {
             recUsers_RolesTableControl.ResetControl();
          }
                  
        this.Page.SetControl("Users_RolesTableControl");
      ...
      // To customize, override this method in RolesRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Roles"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "Roles"));
            }
          ...
          wc.iAND(RolesTable.RoleID, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(RolesTable.RoleID));
        ...
        public virtual void SetRolesDialogEditButton()                
        ...
        // event handler for ImageButton
        public virtual void RolesDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton RolesDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RolesDialogEditButton");
            }
        }
