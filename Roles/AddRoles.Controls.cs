...
namespace IPv5.UI.Controls.AddRoles
{
...
// Base class for the Users_RolesTableControlRow control on the AddRoles page.
...
// Base class for the Users_RolesTableControl control on the AddRoles page.
...
public class BaseUsers_RolesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.AddRoles.RolesRecordControl rolesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "RolesRecordControl") as IPv5.UI.Controls.AddRoles.RolesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual Users_RolesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Users_RolesTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddRoles.Users_RolesTableControlRow")));
...
public class BaseRolesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (RolesRecord)RolesRecord.Copy(recList[0], false);
