...
// This file implements the code-behind class for GroupByRolesTable.aspx.
// GroupByRolesTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByRolesTable
        : BaseApplicationPage
// Code-behind class for the GroupByRolesTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByRolesTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_RolesSearch(string prefixText, int count)
        {
            ...
            // Customize by adding code before or after the call to  GetAutoCompletionList_RolesSearch_Base()
            // or replace the call to GetAutoCompletionList_RolesSearch_Base().
...
public void SetRolesTableControl()
        {
            SetRolesTableControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButtonWithArrow RolesButtonsButton;
                
        public System.Web.UI.WebControls.ImageButton RolesExportExcelButton;
        
        public ThemeButton RolesFilterButton;
                
        public ThemeButtonWithArrow RolesFiltersButton;
        ...
        public PaginationModern RolesPagination;
        ...
        public IPv5.UI.Controls.GroupByRolesTable.RolesTableControl RolesTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "RolesTableControl":
                 SetRolesTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.RolesTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_RolesSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByRolesTable.RolesTableControl control = new IPv5.UI.Controls.GroupByRolesTable.RolesTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRolesTableControl_Base()           
        
        {        
            if (RolesTableControl.Visible)
            {
                RolesTableControl.LoadData();
                RolesTableControl.DataBind();
            }
        }
