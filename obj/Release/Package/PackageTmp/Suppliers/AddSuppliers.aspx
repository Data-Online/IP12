<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.AddSuppliers" Assembly="IPv5" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="AddSuppliers.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.AddSuppliers" %>
