...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowVPropertyTermExpiresTable2.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowVPropertyTermExpiresTable2" %>
<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowVPropertyTermExpiresTable2" Assembly="IPv5" %>
...
<asp:DropDownList runat="server" id="CityIDFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("VPropertyTermExpiresFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="VPropertyTermExpiresTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="VPropertyTermExpiresTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th></tr><asp:Repeater runat="server" id="VPropertyTermExpiresTableControlRepeater">		<ITEMTEMPLATE>		<IPv5:VPropertyTermExpiresTableControlRow runat="server" id="VPropertyTermExpiresTableControlRow">
<tr><td class="tableCellLabel" scope="col"><asp:Literal runat="server" id="CompanyNameLabel" Text="Company Name">	</asp:Literal> 
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="CountryID"></asp:Literal> </td></tr><tr><td class="tableRowDivider" colspan="8">&nbsp;</td></tr></IPv5:VPropertyTermExpiresTableControlRow>
</ITEMTEMPLATE>

</asp:Repeater>
<tr summary="Footer"><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td></tr><tr summary="Footer"><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td></tr><tr summary="Footer"><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"><asp:chart id="VPropertyTermExpiresCountChart" AlternateText="Property Term Expires  x  Expiration Date" width="500" height="500" runat="server" enableviewstate="true" /></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td><td class="ttc" scope="row"></td></tr></table>
</td></tr></table>
</asp:panel>
