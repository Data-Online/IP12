<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowVPropertyTermExpiresGallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowVPropertyTermExpiresGallery" %>
...
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowVPropertyTermExpiresGallery" Assembly="IPv5" %>
...
<asp:DropDownList runat="server" id="CityIDFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("VPropertyTermExpiresFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="VPropertyTermExpiresTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="VPropertyTermExpiresTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3">&nbsp;</th></tr><asp:Repeater runat="server" id="VPropertyTermExpiresTableControlRepeater">		<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="VPropertyTermExpiresTableControlCellRepeater">		<ITEMTEMPLATE>		<IPv5:VPropertyTermExpiresTableControlRow runat="server" id="VPropertyTermExpiresTableControlRow">
...
</td></IPv5:VPropertyTermExpiresTableControlRow>
</ITEMTEMPLATE>
