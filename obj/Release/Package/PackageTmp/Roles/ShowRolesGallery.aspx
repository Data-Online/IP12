...
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowRolesGallery" Assembly="IPv5" %>

<%@ Register Tagprefix="Selectors" Namespace="IPv5" Assembly="IPv5" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowRolesGallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowRolesGallery" %>
...
<asp:DropDownList runat="server" id="RoleNameFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("RolesFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="RolesTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="RolesTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3">&nbsp;</th></tr><asp:Repeater runat="server" id="RolesTableControlRepeater">		<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="RolesTableControlCellRepeater">		<ITEMTEMPLATE>		<IPv5:RolesTableControlRow runat="server" id="RolesTableControlRow">
<td class="galleryttc" style="width:33%;"><asp:LinkButton runat="server" id="RoleName" causesvalidation="False" commandname="Redirect"></asp:LinkButton> <br />
</td></IPv5:RolesTableControlRow>
</ITEMTEMPLATE>
