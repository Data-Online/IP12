...
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowVPropertyRentReviewsGallery" Assembly="IPv5" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowVPropertyRentReviewsGallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowVPropertyRentReviewsGallery" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
...
<asp:DropDownList runat="server" id="CityIDFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("VPropertyRentReviewsFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="VPropertyRentReviewsTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="VPropertyRentReviewsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3">&nbsp;</th></tr><asp:Repeater runat="server" id="VPropertyRentReviewsTableControlRepeater">		<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="VPropertyRentReviewsTableControlCellRepeater">		<ITEMTEMPLATE>		<IPv5:VPropertyRentReviewsTableControlRow runat="server" id="VPropertyRentReviewsTableControlRow">
...
</td></IPv5:VPropertyRentReviewsTableControlRow>
</ITEMTEMPLATE>
