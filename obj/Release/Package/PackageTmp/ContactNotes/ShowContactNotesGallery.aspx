...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowContactNotesGallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowContactNotesGallery" %>
<%@ Register Tagprefix="Selectors" Namespace="IPv5" Assembly="IPv5" %>

<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowContactNotesGallery" Assembly="IPv5" %>
...
<asp:DropDownList runat="server" id="NotesFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("ContactNotesFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="ContactNotesTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="ContactNotesTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3">&nbsp;</th></tr><asp:Repeater runat="server" id="ContactNotesTableControlRepeater">		<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="ContactNotesTableControlCellRepeater">		<ITEMTEMPLATE>		<IPv5:ContactNotesTableControlRow runat="server" id="ContactNotesTableControlRow">
<td class="galleryttc" style="width:33%;"><asp:Literal runat="server" id="ContactID"></asp:Literal> <br />
<asp:LinkButton runat="server" id="Notes" causesvalidation="False" commandname="Redirect"></asp:LinkButton> <br />
</td></IPv5:ContactNotesTableControlRow>
</ITEMTEMPLATE>
