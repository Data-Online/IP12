...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowRentReviewsGallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowRentReviewsGallery" %>
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowRentReviewsGallery" Assembly="IPv5" %>
...
<asp:DropDownList runat="server" id="PropertyIDFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("RentReviewsFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="RentReviewsTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="RentReviewsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3">&nbsp;</th></tr><asp:Repeater runat="server" id="RentReviewsTableControlRepeater">		<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="RentReviewsTableControlCellRepeater">		<ITEMTEMPLATE>		<IPv5:RentReviewsTableControlRow runat="server" id="RentReviewsTableControlRow">
...
</td></IPv5:RentReviewsTableControlRow>
</ITEMTEMPLATE>
