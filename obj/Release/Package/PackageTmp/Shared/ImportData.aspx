...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ImportData.aspx.cs" Inherits="IPv5.UI.ImportData" %>
<%@ Register Tagprefix="Selectors" Namespace="IPv5" %>
				...
				<table class="dv" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td class="dBody" style="width:100%; height:100%">			
							...
							<table>
								<tr>
									<td><IPv5:ThemeButton runat="server" id="PreviousButton" Button-Text="&lt;%# GetResourceValue(&quot;Import:Previous&quot;) %>" Button-ToolTip="&lt;%# GetResourceValue(&quot;Import:Previous&quot;, &quot;IPv5&quot;) %>">
		</IPv5:ThemeButton></td>
									<td><IPv5:ThemeButton runat="server" id="ImportButton" Button-Text="&lt;%# GetResourceValue(&quot;Import:Import&quot;) %>" Button-ToolTip="&lt;%# GetResourceValue(&quot;Import:Import&quot;, &quot;IPv5&quot;) %>">
		</IPv5:ThemeButton></td>
								</tr>
							</table>
						</td>
