...
</td><td class="tableCellValue"><asp:Literal runat="server" id="Description"></asp:Literal> </td><td class="tableCellLabel" scope="col"><asp:Literal runat="server" id="PropertyIDLabel" Text="Property">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="PropertyID"></asp:Literal> </td></tr><tr><td class="tableCellLabel" scope="col"><asp:Literal runat="server" id="Address3Label" Text="Address 3">	</asp:Literal> 
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="CountryID"></asp:Literal> </td></tr><tr><td class="tableRowDivider" colspan="9">&nbsp;</td></tr></IPv5:VPropertyTermRenewalsTableControlRow>
</ITEMTEMPLATE>
