...
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.GroupByBankLoansTable" Assembly="IPv5" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="GroupByBankLoansTable.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.GroupByBankLoansTable" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
...
<asp:Literal runat="server" id="ExpiryDate"></asp:Literal></span>
 </td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="11">&nbsp;</td></tr></IPv5:BankLoansTableControlRow>
</ITEMTEMPLATE>
