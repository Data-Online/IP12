...
// This file implements the code-behind class for ShowVPropertyDirectorsTable.aspx.
// ShowVPropertyDirectorsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class ShowVPropertyDirectorsTable
        : BaseApplicationPage
// Code-behind class for the ShowVPropertyDirectorsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public ShowVPropertyDirectorsTable()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVPropertyDirectorsTableControl()
        {
            SetVPropertyDirectorsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.ShowVPropertyDirectorsTable.VPropertyDirectorsTableControl VPropertyDirectorsTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "VPropertyDirectorsTableControl":
                 SetVPropertyDirectorsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.VPropertyDirectorsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.ShowVPropertyDirectorsTable.VPropertyDirectorsTableControl control = new IPv5.UI.Controls.ShowVPropertyDirectorsTable.VPropertyDirectorsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVPropertyDirectorsTableControl_Base()           
        
        {        
            if (VPropertyDirectorsTableControl.Visible)
            {
                VPropertyDirectorsTableControl.LoadData();
                VPropertyDirectorsTableControl.DataBind();
            }
        }
