...
// This file implements the code-behind class for AddDirectors.aspx.
// AddDirectors.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddDirectors
        : BaseApplicationPage
// Code-behind class for the AddDirectors page.
...
public void SetDirectorsRecordControl()
        {
            SetDirectorsRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddDirectors.DirectorsRecordControl DirectorsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Directors");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "DirectorsRecordControl":
                 SetDirectorsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.DirectorsRecordControl.SaveData();
        ...
        SetDirectorsRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "DirectorsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetDirectorsRecordControl_Base()           
        
        {        
            if (DirectorsRecordControl.Visible)
            {
                DirectorsRecordControl.LoadData();
                DirectorsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.DirectorsRecordControl != null && this.DirectorsRecordControl.DataSource != null)
                  {
                        id = this.DirectorsRecordControl.DataSource.GetValue(this.DirectorsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.DirectorsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.DirectorsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.DirectorsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.DirectorsRecordControl.DataSource.GetValue(this.DirectorsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
