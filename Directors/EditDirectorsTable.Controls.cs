...
// EditDirectorsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditDirectorsTable
{
...
// Base class for the DirectorsTableControlRow control on the EditDirectorsTable page.
...
public class BaseDirectorsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.DirectorsRowViewButton.Click += DirectorsRowViewButton_Click;
        ...
        public virtual void SetContactID()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = DirectorsTable.ContactID.DefaultValue;
        ...
        public virtual void GetContactID()
        {
         // Retrieve the value entered by the user on the ContactID ASP:DropDownList, and
            // save it into the ContactID field in DataSource DatabaseMM_IP1%dbo.Directors record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.ContactID), DirectorsTable.ContactID);			
      ...
      // To customize, override this method in DirectorsTableControlRow.
        ...
        public virtual void SetDirectorsRowViewButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void DirectorsRowViewButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton DirectorsRowViewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DirectorsRowViewButton");
            }
        }
...
// Base class for the DirectorsTableControl control on the EditDirectorsTable page.
...
public class BaseDirectorsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.DirectorsSaveButton.Click += DirectorsSaveButton_Click;
      ...
      public override void DataBind()
      {
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"DirectorsSaveButton"));
      ...
      DirectorsRecord rec = new DirectorsRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.ContactID)) {
                            rec.Parse(recControl.ContactID.SelectedItem.Value, DirectorsTable.ContactID);
                        }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetDirectorsSaveButton()                
              
        {
        
                    this.DirectorsSaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.Page.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
        ...
        public virtual void ContactIDSortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(DirectorsTable.ContactID);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(DirectorsTable.ContactID, OrderByItem.OrderDir.Asc);
        ...
        // event handler for ImageButton
        public virtual void DirectorsSaveButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton DirectorsSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DirectorsSaveButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual DirectorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (DirectorsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditDirectorsTable.DirectorsTableControlRow")));
