...
// ShowDirectorsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowDirectorsTable
{
...
// Base class for the DirectorsTableControlRow control on the ShowDirectorsTable page.
...
public class BaseDirectorsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.DirectorsRowExpandCollapseRowButton.Click += DirectorsRowExpandCollapseRowButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetDirectorsRowExpandCollapseRowButton();
        ...
        public virtual void SetDirectorsTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "DirectorsTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "DirectorsTabContainer").Visible = false;
      ...
      // To customize, override this method in DirectorsTableControlRow.
        ...
        public virtual void SetDirectorsRowExpandCollapseRowButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void DirectorsRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                DirectorsTableControl panelControl = (MiscUtils.GetParentControlObject(this, "DirectorsTableControl") as DirectorsTableControl);

          DirectorsTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (DirectorsTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "DirectorsTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.DirectorsRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.DirectorsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.DirectorsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.DirectorsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.DirectorsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.DirectorsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.DirectorsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton DirectorsRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DirectorsRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer DirectorsTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DirectorsTabContainer");
            }
        }
...
// Base class for the DirectorsTableControl control on the ShowDirectorsTable page.
...
public class BaseDirectorsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        DirectorsTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "DirectorsTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].DirectorsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].DirectorsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].DirectorsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].DirectorsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].DirectorsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].DirectorsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.ContactIDFilter)) {
                ...
                wc.iAND(DirectorsTable.ContactID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ContactIDFilter, this.GetFromSession(this.ContactIDFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.PropertyIDFilter)) {
                        
                wc.iAND(DirectorsTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.PropertyIDFilter, this.GetFromSession(this.PropertyIDFilter)), false, false);
      ...
      String ContactIDFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ContactIDFilter_Ajax"];
            if (MiscUtils.IsValueSelected(ContactIDFilterSelectedValue)) {
                ...
                wc.iAND(DirectorsTable.ContactID, BaseFilter.ComparisonOperator.EqualsTo, ContactIDFilterSelectedValue, false, false);
      ...
      String PropertyIDFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "PropertyIDFilter_Ajax"];
            if (MiscUtils.IsValueSelected(PropertyIDFilterSelectedValue)) {
                ...
                wc.iAND(DirectorsTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, PropertyIDFilterSelectedValue, false, false);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void DirectorsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowDirectorsTable.DirectorsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Directors";
                // If ShowDirectorsTable.DirectorsPDFButton.report specifies a valid report template,
        ...
        public virtual void DirectorsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowDirectorsTable.DirectorsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Directors";
                // If ShowDirectorsTable.DirectorsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual DirectorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (DirectorsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowDirectorsTable.DirectorsTableControlRow")));
...
// Base class for the ContactsRecordControl control on the ShowDirectorsTable page.
...
public class BaseContactsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          DirectorsTableControlRow parentCtrl;
      
            parentCtrl = (DirectorsTableControlRow)MiscUtils.GetParentControlObject(this, "DirectorsTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue directorsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = directorsRecordObj;
          directorsRecordObj = tmp;
        DirectorsTableControlRow directorsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "DirectorsTableControlRow") as DirectorsTableControlRow);
          
              if (directorsTableControlObjRow != null && directorsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(ContactsTable.ContactID, BaseFilter.ComparisonOperator.EqualsTo, directorsTableControlObjRow.GetRecord().ContactID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInDirectorsTableControl = HttpContext.Current.Session["ContactsRecordControlWhereClause"] as string;
      
      if (selectedRecordInDirectorsTableControl != null && KeyValue.IsXmlKey(selectedRecordInDirectorsTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInDirectorsTableControl);
...
// Base class for the PropertiesRecordControl control on the ShowDirectorsTable page.
...
public class BasePropertiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        DirectorsTableControlRow directorsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "DirectorsTableControlRow") as DirectorsTableControlRow);
              ...
              if (directorsTableControlObjRow != null && directorsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertiesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, directorsTableControlObjRow.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInDirectorsTableControl = HttpContext.Current.Session["PropertiesRecordControlWhereClause"] as string;
