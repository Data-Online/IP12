...
// ShowDirectorsGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowDirectorsGallery
{
...
// Base class for the DirectorsTableControlRow control on the ShowDirectorsGallery page.
...
// Base class for the DirectorsTableControl control on the ShowDirectorsGallery page.
...
public class BaseDirectorsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return DirectorsTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual DirectorsRecord[] CopyArray(int index, DirectorsRecord[,] recs, int columns)
      {
        DirectorsRecord[] recsCopy = new DirectorsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            DirectorsRecord[,] recs = new DirectorsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            DirectorsRecord[] HColDataSource = new DirectorsRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              DirectorsRecord[] VColDataSource = new DirectorsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("DirectorsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              DirectorsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                DirectorsTableControlRow recControl = (DirectorsTableControlRow)innerRepItem.FindControl("DirectorsTableControlRow");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void DirectorsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowDirectorsGallery.DirectorsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Directors";
                // If ShowDirectorsGallery.DirectorsPDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  DirectorsTable.PropertyID.IsApplyDisplayAs){
                                     ...
                                     report.AddData("${PropertyID}", record.Format(DirectorsTable.PropertyID), ReportEnum.Align.Left, 100);
                                 }
                             }
        ...
        public virtual void DirectorsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowDirectorsGallery.DirectorsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Directors";
                // If ShowDirectorsGallery.DirectorsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual DirectorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (DirectorsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowDirectorsGallery.DirectorsTableControlRow")));
