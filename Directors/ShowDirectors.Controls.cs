...
// ShowDirectors.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowDirectors
{
...
// Base class for the DirectorsRecordControl control on the ShowDirectors page.
// Do not modify this class. Instead override any method in DirectorsRecordControl.
public class BaseDirectorsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        public BaseDirectorsRecordControl()
        {
        ...
        // To customize, override this method in DirectorsRecordControl.
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.DirectorsDialogEditButton.Click += DirectorsDialogEditButton_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "DirectorsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            DirectorsRecord[] recList = DirectorsTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = DirectorsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in DirectorsRecordControl.
         ...
         
        {
            ...
            bool hasFiltersDirectorsRecordControl = false;
            hasFiltersDirectorsRecordControl = hasFiltersDirectorsRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Directors"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "Directors"));
            }
            HttpContext.Current.Session["QueryString in ShowDirectors"] = recId;
          ...
          wc.iAND(DirectorsTable.DirectorID, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(DirectorsTable.DirectorID));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(DirectorsTable.DirectorID, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public virtual void SetDirectorsDialogEditButton()                
        ...
        public virtual void DirectorsDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ContactID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Contacts/ShowContacts.aspx?Contacts={DirectorsRecordControl:FK:FK_Directors_Contacts}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={DirectorsRecordControl:FK:FK_Directors_Properties}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseDirectorsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseDirectorsRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton DirectorsDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DirectorsDialogEditButton");
            }
        }
