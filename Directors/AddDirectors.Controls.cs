...
// AddDirectors.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.AddDirectors
{
...
// Base class for the DirectorsRecordControl control on the AddDirectors page.
...
public class BaseDirectorsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (DirectorsRecord)DirectorsRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in DirectorsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in AddDirectors"] = recId;
