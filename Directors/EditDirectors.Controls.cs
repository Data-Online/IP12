...
// EditDirectors.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditDirectors
{
...
// Base class for the DirectorsRecordControl control on the EditDirectors page.
...
public class BaseDirectorsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in DirectorsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditDirectors"] = recId;
