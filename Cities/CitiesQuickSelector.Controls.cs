...
// CitiesQuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.CitiesQuickSelector
{
...
// Base class for the SelectorTableControlRow control on the CitiesQuickSelector page.
// Do not modify this class. Instead override any method in SelectorTableControlRow.
public class BaseSelectorTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
...
// Base class for the SelectorTableControl control on the CitiesQuickSelector page.
// Do not modify this class. Instead override any method in SelectorTableControl.
public class BaseSelectorTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
            ...
            {
                BaseColumn col = CitiesTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, CitiesTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = CitiesTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = CitiesTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void AddButton_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Cities/AddCities.aspx?TabVisible=False&SaveAndNewVisible=False";
...
#region "Helper Properties"
        ...
        public IPv5.UI.IThemeButton AddButton {
            get {
                return (IPv5.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "AddButton");
            }
        }
        
        public IPv5.UI.IThemeButton ClearButton {
            get {
                return (IPv5.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ClearButton");
            }
        }
        
        public IPv5.UI.IThemeButton CommitButton {
            get {
                return (IPv5.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CommitButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.CitiesQuickSelector.SelectorTableControlRow")));
