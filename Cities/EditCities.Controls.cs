...
// EditCities.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditCities
{
...
// Base class for the ContractorsTableControlRow control on the EditCities page.
...
// Base class for the ContractorsTableControl control on the EditCities page.
...
public class BaseContractorsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.EditCities.CitiesRecordControl citiesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CitiesRecordControl") as IPv5.UI.Controls.EditCities.CitiesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual ContractorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContractorsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditCities.ContractorsTableControlRow")));
...
// Base class for the PropertyContactsTableControlRow control on the EditCities page.
...
// Base class for the PropertyContactsTableControl control on the EditCities page.
        ...
        public virtual void SetAddress1SortLabel1()
                  {
                        ...
                        this.Address1SortLabel1.Text = EvaluateFormula("\"Address\"");
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditCities.PropertyContactsTableControlRow")));
...
// Base class for the SuppliersTableControlRow control on the EditCities page.
...
// Base class for the SuppliersTableControl control on the EditCities page.
...
#region "Helper Functions"
        ...
        public virtual SuppliersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SuppliersTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditCities.SuppliersTableControlRow")));
...
// Base class for the CitiesRecordControl control on the EditCities page.
...
public class BaseCitiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in CitiesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditCities"] = recId;
