...
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowCitiesGallery" Assembly="IPv5" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowCitiesGallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowCitiesGallery" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
...
<asp:DropDownList runat="server" id="CityFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("CitiesFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="CitiesTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="CitiesTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3">&nbsp;</th></tr><asp:Repeater runat="server" id="CitiesTableControlRepeater">		<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="CitiesTableControlCellRepeater">		<ITEMTEMPLATE>		<IPv5:CitiesTableControlRow runat="server" id="CitiesTableControlRow">
<td class="galleryttc" style="width:33%;"><asp:LinkButton runat="server" id="City" causesvalidation="False" commandname="Redirect"></asp:LinkButton> <br />
</td></IPv5:CitiesTableControlRow>
</ITEMTEMPLATE>
