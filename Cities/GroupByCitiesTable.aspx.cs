...
// This file implements the code-behind class for GroupByCitiesTable.aspx.
// GroupByCitiesTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByCitiesTable
        : BaseApplicationPage
// Code-behind class for the GroupByCitiesTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByCitiesTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_CitiesSearch(string prefixText, int count)
        {
            // GetCitiesSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_CitiesSearch_Base()
            // or replace the call to GetAutoCompletionList_CitiesSearch_Base().
            return GetAutoCompletionList_CitiesSearch_Base(prefixText, count);
        }
...
public void SetCitiesTableControl()
        {
            SetCitiesTableControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButtonWithArrow CitiesButtonsButton;
                
        public System.Web.UI.WebControls.ImageButton CitiesExportExcelButton;
        
        public ThemeButton CitiesFilterButton;
                
        public ThemeButtonWithArrow CitiesFiltersButton;
        ...
        public PaginationModern CitiesPagination;
        ...
        public IPv5.UI.Controls.GroupByCitiesTable.CitiesTableControl CitiesTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "CitiesTableControl":
                 SetCitiesTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.CitiesTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_CitiesSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByCitiesTable.CitiesTableControl control = new IPv5.UI.Controls.GroupByCitiesTable.CitiesTableControl();
        
        return control.GetAutoCompletionList_CitiesSearch(prefixText, count);
        ...
        SetCitiesTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "CitiesMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCitiesTableControl_Base()           
        
        {        
            if (CitiesTableControl.Visible)
            {
                CitiesTableControl.LoadData();
                CitiesTableControl.DataBind();
            }
        }
