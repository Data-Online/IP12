...
// This file implements the code-behind class for EditCities.aspx.
// EditCities.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditCities
        : BaseApplicationPage
// Code-behind class for the EditCities page.
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditCities.CitiesRecordControl CitiesRecordControl;
        ...
        public IPv5.UI.Controls.EditCities.ContractorsTableControl ContractorsTableControl;
        ...
        public IPv5.UI.Controls.EditCities.PropertyContactsTableControl PropertyContactsTableControl;
        ...
        public IPv5.UI.Controls.EditCities.SuppliersTableControl SuppliersTableControl;
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.CitiesRecordControl.SaveData();
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.CitiesRecordControl != null && this.CitiesRecordControl.DataSource != null)
                  {
                        id = this.CitiesRecordControl.DataSource.GetValue(this.CitiesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.CitiesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.CitiesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.CitiesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.CitiesRecordControl.DataSource.GetValue(this.CitiesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
