...
// GroupByCitiesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByCitiesTable
{
...
public class CitiesTableControlRow : BaseCitiesTableControlRow
{
      
        // The BaseCitiesTableControlRow implements code for a ROW within the
        // the CitiesTableControl table.  The BaseCitiesTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of CitiesTableControl.
...
public class CitiesTableControl : BaseCitiesTableControl
{
    // The BaseCitiesTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The CitiesTableControlRow class offers another place where you can customize
...
// Base class for the CitiesTableControlRow control on the GroupByCitiesTable page.
// Do not modify this class. Instead override any method in CitiesTableControlRow.
public class BaseCitiesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        public BaseCitiesTableControlRow()
        {
        ...
        // To customize, override this method in CitiesTableControlRow.
        ...
        {      
              ...
              this.CitiesRowDeleteButton.Attributes.Add("onClick", "return (confirm(\"" + ((BaseApplicationPage)this.Page).GetResourceValue("DeleteRecordConfirm", "IPv5") + "\"));");            
        
              // Register the event handlers.

          
                    this.CitiesRowDeleteButton.Click += CitiesRowDeleteButton_Click;
                        
                    this.CitiesRowEditButton.Click += CitiesRowEditButton_Click;
                        
                    this.CitiesRowExpandCollapseRowButton.Click += CitiesRowExpandCollapseRowButton_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            // LoadData method of the BaseCitiesTableControl when the data for the entire
            // table is loaded.
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetCitiesRowDeleteButton();
              
                SetCitiesRowEditButton();
              
                SetCitiesRowExpandCollapseRowButton();
        ...
        public virtual void SetCitiesTabContainer()    
        ...
        public virtual void SetContractorsTableControl()           
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((CitiesTableControl)MiscUtils.GetParentControlObject(this, "CitiesTableControl")).DataChanged = true;
                ((CitiesTableControl)MiscUtils.GetParentControlObject(this, "CitiesTableControl")).ResetData = true;
            }
          ...
          ContractorsTableControl recContractorsTableControl = (ContractorsTableControl)(MiscUtils.FindControlRecursively(this, "ContractorsTableControl"));
      ...
      // To customize, override this method in CitiesTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersCitiesTableControl = false;
            hasFiltersCitiesTableControl = hasFiltersCitiesTableControl && false; // suppress warning
        ...
        public virtual void SetCitiesRowDeleteButton()                
        ...
        public virtual void SetCitiesRowEditButton()                
        ...
        public virtual void SetCitiesRowExpandCollapseRowButton()                
        ...
        public virtual void CitiesRowDeleteButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.CommitTransaction(sender);
        ...
        // event handler for ImageButton
        public virtual void CitiesRowEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void CitiesRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                CitiesTableControl panelControl = (MiscUtils.GetParentControlObject(this, "CitiesTableControl") as CitiesTableControl);

          CitiesTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (CitiesTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "CitiesTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.CitiesRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.CitiesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.CitiesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.CitiesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.CitiesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.CitiesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.CitiesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseCitiesTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseCitiesTableControlRow_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton CitiesRowDeleteButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesRowDeleteButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton CitiesRowEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesRowEditButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton CitiesRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer CitiesTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesTabContainer");
            }
        }
        ...
        public ContractorsTableControl ContractorsTableControl {
            get {
                return (ContractorsTableControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContractorsTableControl");
            }
        }
...
// Base class for the CitiesTableControl control on the GroupByCitiesTable page.
// Do not modify this class. Instead override any method in CitiesTableControl.
public class BaseCitiesTableControl : IPv5.UI.BaseApplicationTableControl
{
         
       public BaseCitiesTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.CitiesSearch)) 				
                    initialVal = this.GetFromSession(this.CitiesSearch);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.CitiesSearch.Text = initialVal;
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.CityFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.CityFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            // Setup the pagination events.
                    ...
                    this.CitiesPagination.FirstPage.Click += CitiesPagination_FirstPage_Click;
                        
                    this.CitiesPagination.LastPage.Click += CitiesPagination_LastPage_Click;
                        
                    this.CitiesPagination.NextPage.Click += CitiesPagination_NextPage_Click;
                        
                    this.CitiesPagination.PageSizeButton.Click += CitiesPagination_PageSizeButton_Click;
                        
                    this.CitiesPagination.PreviousPage.Click += CitiesPagination_PreviousPage_Click;
       ...
       // Setup the sorting events.
              ...
              this.CitySortLabel.Click += CitySortLabel_Click;
            
            // Setup the button events.
          
                    this.CitiesExportExcelButton.Click += CitiesExportExcelButton_Click;
                        
                    this.CitiesImportButton.Click += CitiesImportButton_Click;
                        
                    this.CitiesNewButton.Click += CitiesNewButton_Click;
                        
                    this.CitiesPDFButton.Click += CitiesPDFButton_Click;
                        
                    this.CitiesResetButton.Click += CitiesResetButton_Click;
                        
                    this.CitiesSearchButton.Click += CitiesSearchButton_Click;
                        
                    this.CitiesWordButton.Click += CitiesWordButton_Click;
                        
                    this.CitiesButtonsButton.Button.Click += CitiesButtonsButton_Click;
                        
                    this.CitiesFilterButton.Button.Click += CitiesFilterButton_Click;
                        
                    this.CitiesFiltersButton.Button.Click += CitiesFiltersButton_Click;
                        
            this.CityFilter.SelectedIndexChanged += new EventHandler(CityFilter_SelectedIndexChanged);
                    
        
         //' Setup events for others
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "CitiesSearchSearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + CitiesSearch.ClientID + "\");", true);
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(IPv5.Business.CitiesRecord);
                      this.DataSource = (CitiesRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (CitiesTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(IPv5.Business.CitiesRecord);
                    this.DataSource = (CitiesRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual CitiesRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(CitiesTable.Column1, true);          
            // selCols.Add(CitiesTable.Column2, true);          
            // selCols.Add(CitiesTable.Column3, true);          
                  ...
                  
            {
                ...
                return CitiesTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                CitiesTable databaseTable = new CitiesTable();
                ...
                return (recList.ToArray(typeof(CitiesRecord)) as CitiesRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return CitiesTable.GetRecordCount(join, where);
            else
            {
                CitiesTable databaseTable = new CitiesTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesTableControlRepeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            CitiesTableControlRow recControl = (CitiesTableControlRow)(repItem.FindControl("CitiesTableControlRow"));
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetCityLabel1();
                SetCitySortLabel();
                SetCitiesExportExcelButton();
              
                SetCitiesImportButton();
              
                SetCitiesNewButton();
              
                SetCitiesPDFButton();
              
                SetCitiesResetButton();
              
                SetCitiesSearchButton();
              
                SetCitiesWordButton();
              
                SetCitiesButtonsButton();
              
                SetCitiesFilterButton();
              
                SetCitiesFiltersButton();
              
            // setting the state of expand or collapse alternative rows
      
            bool expandFirstRow = true;
        CitiesTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "CitiesTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].CitiesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].CitiesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].CitiesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].CitiesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].CitiesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].CitiesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        if (this.TotalRecords > 10000)
          this.CitiesExportExcelButton.Attributes.Add("onClick", "return (confirm('" + ((BaseApplicationPage)this.Page).GetResourceValue("ExportConfirm", "IPv5") + "'));");
        else
          this.CitiesExportExcelButton.Attributes.Remove("onClick");
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"CitiesExportExcelButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"CitiesPDFButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"CitiesWordButton"));
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            {
                this.CitiesPagination.CurrentPage.Text = (this.PageIndex + 1).ToString();
            } 
            else
            {
                this.CitiesPagination.CurrentPage.Text = "0";
            }
            this.CitiesPagination.PageSize.Text = this.PageSize.ToString();
    
            // Bind the buttons for CitiesTableControl pagination.
        
            this.CitiesPagination.FirstPage.Enabled = !(this.PageIndex == 0);
            if (this._TotalPages < 0)             // if the total pages is not determined yet, enable last and next buttons
                this.CitiesPagination.LastPage.Enabled = true;
            else if (this._TotalPages == 0)          // if the total pages is determined and it is 0, enable last and next buttons
                this.CitiesPagination.LastPage.Enabled = false;            
            else                                     // if the total pages is the last page, disable last and next buttons
                this.CitiesPagination.LastPage.Enabled = !(this.PageIndex == this.TotalPages - 1);            
          
            if (this._TotalPages < 0)             // if the total pages is not determined yet, enable last and next buttons
                this.CitiesPagination.NextPage.Enabled = true;
            else if (this._TotalPages == 0)          // if the total pages is determined and it is 0, enable last and next buttons
                this.CitiesPagination.NextPage.Enabled = false;            
            else                                     // if the total pages is the last page, disable last and next buttons
                this.CitiesPagination.NextPage.Enabled = !(this.PageIndex == this.TotalPages - 1);            
          
            this.CitiesPagination.PreviousPage.Enabled = !(this.PageIndex == 0);    
        }
        ...
        public virtual void SaveData()
        {
            ...
            foreach (CitiesTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.CitiesSearch)) {
                if (this.CitiesSearch.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.CitiesSearch.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.CitiesSearch.Text.StartsWith("...")) {
                      this.CitiesSearch.Text = this.CitiesSearch.Text.Substring(3,this.CitiesSearch.Text.Length-3);
                  }
                  if (this.CitiesSearch.Text.EndsWith("...")) {
                      this.CitiesSearch.Text = this.CitiesSearch.Text.Substring(0,this.CitiesSearch.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.CitiesSearch.Text.Length - 1;
                      while (!Char.IsWhiteSpace(CitiesSearch.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.CitiesSearch.Text = this.CitiesSearch.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.CitiesSearch, this.GetFromSession(this.CitiesSearch));
      ...
      cols.Add(CitiesTable.City, true);
      
      foreach(BaseColumn col in cols)
      {
      
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.CitiesSearch, this.GetFromSession(this.CitiesSearch)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.CityFilter)) {
                ...
                wc.iAND(CitiesTable.City, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.CityFilter, this.GetFromSession(this.CityFilter)), false, false);
        ...
        public virtual WhereClause CreateWhereClause(String searchText, String fromSearchControl, String AutoTypeAheadSearch, String AutoTypeAheadWordSeparators)
        {
            ...
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "CitiesSearch") {
      ...
      String CityFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CityFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CityFilterSelectedValue)) {
                ...
                wc.iAND(CitiesTable.City, BaseFilter.ComparisonOperator.EqualsTo, CityFilterSelectedValue, false, false);
        ...
        public virtual string[] GetAutoCompletionList_CitiesSearch(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"CitiesSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
            IPv5.Business.CitiesRecord[] recordList  = CitiesTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (CitiesRecord rec in recordList ){
                ...
                resultItem = rec.Format(CitiesTable.City);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(CitiesTable.City.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, CitiesTable.City.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void GetPageSize()
        {
            ...
            if (this.CitiesPagination.PageSize.Text.Length > 0) {
                try {
                    // this.PageSize = Convert.ToInt32(this.CitiesPagination.PageSize.Text);
                } catch (Exception ) {
                }
            }
        }
      ...
      CitiesRecord rec = new CitiesRecord();
        
                        if (recControl.City.Text != "") {
                            rec.Parse(recControl.City.Text, CitiesTable.City);
                  }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new CitiesRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(IPv5.Business.CitiesRecord);
                this.DataSource = (CitiesRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(CitiesTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(CitiesTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual void SetCitySortLabel()
                  {
                  
                    
        }
                
        public virtual void SetCitiesSearch()
        {
                                            
            this.CitiesSearch.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.CitiesSearch.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
        ...
        public virtual void SetCityFilter()
        {
            ...
            this.PopulateCityFilter(MiscUtils.GetSelectedValue(this.CityFilter,  GetFromSession(this.CityFilter)), 500);					
                                     
        }
            
        // Get the filters' data for CityFilter.
                
        protected virtual void PopulateCityFilter(string selectedValue, int maxItems)
                    
        {
            ...
            // Setup the static list items        
                ...
                // Add the All item.
                this.CityFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "IPv5"), "--ANY--"));
            ...
            if (wc.RunQuery)
            {
                ...
                values = CitiesTable.GetValues(CitiesTable.City, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( CitiesTable.City.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = CitiesTable.City.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
            ...
            try
            {
                ...
                MiscUtils.SetSelectedValue(this.CityFilter, selectedValue);
            ...
            if (this.CityFilter.SelectedValue != null && this.CityFilter.Items.FindByValue(this.CityFilter.SelectedValue) == null)
                this.CityFilter.SelectedValue = null;
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.CitiesSearch, this.CitiesSearch.Text);
                  
            this.SaveToSession(this.CityFilter, this.CityFilter.SelectedValue);
      ...
      this.SaveToSession("CitiesSearch_Ajax", this.CitiesSearch.Text);
              
      this.SaveToSession("CityFilter_Ajax", this.CityFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.CitiesSearch);
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["CitiesTableControl_OrderBy"];
            ...
            Control Pagination = this.FindControl("CitiesPagination");
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["CitiesTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetCitiesExportExcelButton()                
        ...
        public virtual void SetCitiesImportButton()                
              
        {
        							
                    this.CitiesImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Cities" ;
                    this.CitiesImportButton.Attributes["onClick"] = "window.open('" + this.Page.EncryptUrlParameter(this.CitiesImportButton.PostBackUrl) + "','importWindow', 'width=700, height=500,top=' +(screen.availHeight-500)/2 + ',left=' + (screen.availWidth-700)/2+ ', resizable=yes, scrollbars=yes,modal=yes'); return false;";
                        
   
        }
            
        public virtual void SetCitiesNewButton()                
        ...
        public virtual void SetCitiesPDFButton()                
        ...
        public virtual void SetCitiesResetButton()                
        ...
        public virtual void SetCitiesSearchButton()                
        ...
        public virtual void SetCitiesWordButton()                
        ...
        public virtual void SetCitiesButtonsButton()                
        ...
        public virtual void SetCitiesFilterButton()                
        ...
        public virtual void SetCitiesFiltersButton()                
              
        {
                
         IThemeButtonWithArrow themeButtonCitiesFiltersButton = (IThemeButtonWithArrow)(MiscUtils.FindControlRecursively(this, "CitiesFiltersButton"));
         themeButtonCitiesFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
    
      
            if (MiscUtils.IsValueSelected(CityFilter))
                themeButtonCitiesFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        // event handler for ImageButton
        public virtual void CitiesPagination_FirstPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void CitiesPagination_LastPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void CitiesPagination_NextPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        public virtual void CitiesPagination_PageSizeButton_Click(object sender, EventArgs args)
        {
            ...
            this.PageSize = this.CitiesPagination.GetCurrentPageSize();
      
            this.PageIndex = Convert.ToInt32(this.CitiesPagination.CurrentPage.Text) - 1;
        ...
        // event handler for ImageButton
        public virtual void CitiesPagination_PreviousPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        public virtual void CitySortLabel_Click(object sender, EventArgs args)
        {
            //Sorts by City when clicked.
              
            // Get previous sorting state for City.
        
            OrderByItem sd = this.CurrentSortOrder.Find(CitiesTable.City);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(CitiesTable.City, OrderByItem.OrderDir.Asc);
        ...
        // event handler for ImageButton
        public virtual void CitiesExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = CitiesTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
                ...
                BaseColumn[] columns = new BaseColumn[] {
                             CitiesTable.City,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(CitiesTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(CitiesTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(CitiesTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(CitiesTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(CitiesTable.City, "Default"));
              ...
              {
                val = CitiesTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        // event handler for ImageButton
        public virtual void CitiesImportButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void CitiesNewButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void CitiesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByCitiesTable.CitiesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Cities";
                // If GroupByCitiesTable.CitiesPDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(CitiesTable.City.Name, ReportEnum.Align.Left, "${City}", ReportEnum.Align.Left, 28);
                ...
                ColumnList columns = CitiesTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = CitiesTable.GetRecordCount(joinFilter,whereClause);
                CitiesRecord[] records = null;
                
                do
                {
                    
                    records = CitiesTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( CitiesRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${City}", record.Format(CitiesTable.City), ReportEnum.Align.Left, 100);
        ...
        // event handler for ImageButton
        public virtual void CitiesResetButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void CitiesSearchButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void CitiesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByCitiesTable.CitiesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Cities";
                // If GroupByCitiesTable.CitiesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void CitiesButtonsButton_Click(object sender, EventArgs args)
        {
        ...
        // event handler for Button
        public virtual void CitiesFilterButton_Click(object sender, EventArgs args)
        {
        ...
        // event handler for Button
        public virtual void CitiesFiltersButton_Click(object sender, EventArgs args)
        {
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = CitiesTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  CitiesRecord[] DataSource {
            ...
            get {
                return (CitiesRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public IPv5.UI.IThemeButtonWithArrow CitiesButtonsButton {
            get {
                return (IPv5.UI.IThemeButtonWithArrow)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesButtonsButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton CitiesExportExcelButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesExportExcelButton");
            }
        }
        
        public IPv5.UI.IThemeButton CitiesFilterButton {
            get {
                return (IPv5.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesFilterButton");
            }
        }
        
        public IPv5.UI.IThemeButtonWithArrow CitiesFiltersButton {
            get {
                return (IPv5.UI.IThemeButtonWithArrow)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesFiltersButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton CitiesImportButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesImportButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton CitiesNewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesNewButton");
            }
        }
        
        public IPv5.UI.IPaginationModern CitiesPagination {
            get {
                return (IPv5.UI.IPaginationModern)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesPagination");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton CitiesPDFButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesPDFButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton CitiesResetButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesResetButton");
            }
        }
        
        public System.Web.UI.WebControls.TextBox CitiesSearch {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesSearch");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton CitiesSearchButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesSearchButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton CitiesWordButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitiesWordButton");
            }
        }
        
        public System.Web.UI.WebControls.DropDownList CityFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CityFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton CitySortLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CitySortLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                CitiesTableControlRow recCtl = this.GetSelectedRecordControl();
        ...
        public virtual CitiesTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual CitiesTableControlRow[] GetSelectedRecordControls()
        {
        
            return (CitiesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByCitiesTable.CitiesTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            CitiesTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "IPv5"));
            }
            
            foreach (CitiesTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual CitiesTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "CitiesTableControlRow");
	          List<CitiesTableControlRow> list = new List<CitiesTableControlRow>();
	          foreach (CitiesTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
...
// Base class for the ContractorsTableControlRow control on the GroupByCitiesTable page.
...
public class BaseContractorsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        CitiesTableControlRow parentCtrl;
      
            parentCtrl = (CitiesTableControlRow)MiscUtils.GetParentControlObject(this, "CitiesTableControlRow");
...
// Base class for the ContractorsTableControl control on the GroupByCitiesTable page.
...
public class BaseContractorsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue citiesRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = citiesRecordObj;
          citiesRecordObj = tmp;
        CitiesTableControlRow citiesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "CitiesTableControlRow") as CitiesTableControlRow);
          
              if (citiesTableControlObjRow != null && citiesTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(ContractorsTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, citiesTableControlObjRow.GetRecord().CityID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInCitiesTableControl = HttpContext.Current.Session["ContractorsTableControlWhereClause"] as string;
      
      if (selectedRecordInCitiesTableControl != null && KeyValue.IsXmlKey(selectedRecordInCitiesTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInCitiesTableControl);
...
#region "Helper Functions"
        ...
        public virtual ContractorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContractorsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByCitiesTable.ContractorsTableControlRow")));
...
// Base class for the PropertyContactsTableControlRow control on the GroupByCitiesTable page.
...
// Base class for the PropertyContactsTableControl control on the GroupByCitiesTable page.
    ...
    // Setup default pagination settings.
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        CitiesTableControlRow citiesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "CitiesTableControlRow") as CitiesTableControlRow);
              ...
              if (citiesTableControlObjRow != null && citiesTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertyContactsTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, citiesTableControlObjRow.GetRecord().CityID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInCitiesTableControl = HttpContext.Current.Session["PropertyContactsTableControlWhereClause"] as string;
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByCitiesTable.PropertyContactsTableControlRow")));
...
// Base class for the SuppliersTableControlRow control on the GroupByCitiesTable page.
...
// Base class for the SuppliersTableControl control on the GroupByCitiesTable page.
    ...
    // Setup default pagination settings.
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        CitiesTableControlRow citiesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "CitiesTableControlRow") as CitiesTableControlRow);
              ...
              if (citiesTableControlObjRow != null && citiesTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(SuppliersTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, citiesTableControlObjRow.GetRecord().CityID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInCitiesTableControl = HttpContext.Current.Session["SuppliersTableControlWhereClause"] as string;
...
#region "Helper Functions"
        ...
        public virtual SuppliersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SuppliersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByCitiesTable.SuppliersTableControlRow")));
