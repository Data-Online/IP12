...
// This file implements the code-behind class for EditPropertyContactsTable.aspx.
// EditPropertyContactsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditPropertyContactsTable
        : BaseApplicationPage
// Code-behind class for the EditPropertyContactsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditPropertyContactsTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_PropertyContactsSearch(string prefixText, int count)
        {
            // GetPropertyContactsSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_PropertyContactsSearch_Base()
            // or replace the call to GetAutoCompletionList_PropertyContactsSearch_Base().
            return GetAutoCompletionList_PropertyContactsSearch_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditPropertyContactsTable.PropertyContactsTableControl PropertyContactsTableControl;
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.PropertyContactsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_PropertyContactsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditPropertyContactsTable.PropertyContactsTableControl control = new IPv5.UI.Controls.EditPropertyContactsTable.PropertyContactsTableControl();
        
        return control.GetAutoCompletionList_PropertyContactsSearch(prefixText, count);
