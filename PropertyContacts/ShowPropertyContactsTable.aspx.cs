...
// This file implements the code-behind class for ShowPropertyContactsTable.aspx.
// ShowPropertyContactsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class ShowPropertyContactsTable
        : BaseApplicationPage
// Code-behind class for the ShowPropertyContactsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public ShowPropertyContactsTable()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.ShowPropertyContactsTable.PropertyContactsTableControl PropertyContactsTableControl;
    ...
    public static string[] GetAutoCompletionList_PropertyContactsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.ShowPropertyContactsTable.PropertyContactsTableControl control = new IPv5.UI.Controls.ShowPropertyContactsTable.PropertyContactsTableControl();
