...
// GroupByPropertyContactsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByPropertyContactsTable
{
...
// Base class for the PropertyContactsTableControlRow control on the GroupByPropertyContactsTable page.
...
// Base class for the PropertyContactsTableControl control on the GroupByPropertyContactsTable page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyContactsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByPropertyContactsTable.PropertyContactsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyContacts";
                // If GroupByPropertyContactsTable.PropertyContactsPDFButton.report specifies a valid report template,
        ...
        public virtual void PropertyContactsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByPropertyContactsTable.PropertyContactsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyContacts";
                // If GroupByPropertyContactsTable.PropertyContactsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByPropertyContactsTable.PropertyContactsTableControlRow")));
