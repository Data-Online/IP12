...
// ShowPropertyContacts.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowPropertyContacts
{
...
// Base class for the PropertyContactsRecordControl control on the ShowPropertyContacts page.
...
public class BasePropertyContactsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.PropertyContactsDialogEditButton.Click += PropertyContactsDialogEditButton_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "PropertyContactsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = PropertyContactsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetTitle();
                SetTitleLabel();
                SetPropertyContactsDialogEditButton();
      ...
      // To customize, override this method in PropertyContactsRecordControl.
         ...
         
        {
            ...
            if (recId == null || recId.Length == 0) {
                ...
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "PropertyContacts"));
            }
            HttpContext.Current.Session["QueryString in ShowPropertyContacts"] = recId;
        ...
        public virtual void SetPropertyContactsDialogEditButton()                
        ...
        public virtual void PropertyContactsDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void CityID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Cities/ShowCities.aspx?Cities={PropertyContactsRecordControl:FK:FK_BillingContact_Cities}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ContactTypeID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../ContactTypes/ShowContactTypes.aspx?ContactTypes={PropertyContactsRecordControl:FK:FK_PropertyContacts_ContactTypes}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void CountryID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Countries/ShowCountries.aspx?Countries={PropertyContactsRecordControl:FK:FK_BillingContact_Countries}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={PropertyContactsRecordControl:FK:FK_BillingContact_Properties}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void RegionID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Regions/ShowRegions.aspx?Regions={PropertyContactsRecordControl:FK:FK_BillingContact_Regions}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton PropertyContactsDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyContactsDialogEditButton");
            }
        }
