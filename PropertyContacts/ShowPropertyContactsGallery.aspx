...
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowPropertyContactsGallery" Assembly="IPv5" %>

<%@ Register Tagprefix="Selectors" Namespace="IPv5" Assembly="IPv5" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowPropertyContactsGallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowPropertyContactsGallery" %>
...
<asp:DropDownList runat="server" id="CityIDFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("PropertyContactsFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="PropertyContactsTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="PropertyContactsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3">&nbsp;</th></tr><asp:Repeater runat="server" id="PropertyContactsTableControlRepeater">		<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="PropertyContactsTableControlCellRepeater">		<ITEMTEMPLATE>		<IPv5:PropertyContactsTableControlRow runat="server" id="PropertyContactsTableControlRow">
<td class="galleryttc" style="width:33%;"><asp:Literal runat="server" id="FirstName"></asp:Literal> <br />
<asp:LinkButton runat="server" id="LastName" causesvalidation="False" commandname="Redirect"></asp:LinkButton> <br />
</td></IPv5:PropertyContactsTableControlRow>
</ITEMTEMPLATE>
