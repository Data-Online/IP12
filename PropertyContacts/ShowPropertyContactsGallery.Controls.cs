...
// ShowPropertyContactsGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowPropertyContactsGallery
{
...
// Base class for the PropertyContactsTableControlRow control on the ShowPropertyContactsGallery page.
...
public class BasePropertyContactsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.LastName.Click += LastName_Click;
        ...
        public virtual void SetLastName()
        {
            ...
            // Set the LastName LinkButton on the webpage with value from the
            // DatabaseMM_IP1%dbo.PropertyContacts database record.

            // this.DataSource is the DatabaseMM_IP1%dbo.PropertyContacts record retrieved from the database.
            // this.LastName is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.LastNameSpecified) {
               ...
               string formattedValue = this.DataSource.Format(PropertyContactsTable.LastName);
                ...
                this.LastName.Text = formattedValue;
                  ...
                  this.LastName.ToolTip = "Go to " + this.LastName.Text.Replace("<wbr/>", "");
...
// Base class for the PropertyContactsTableControl control on the ShowPropertyContactsGallery page.
...
public class BasePropertyContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return PropertyContactsTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual PropertyContactsRecord[] CopyArray(int index, PropertyContactsRecord[,] recs, int columns)
      {
        PropertyContactsRecord[] recsCopy = new PropertyContactsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            PropertyContactsRecord[,] recs = new PropertyContactsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            PropertyContactsRecord[] HColDataSource = new PropertyContactsRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              PropertyContactsRecord[] VColDataSource = new PropertyContactsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("PropertyContactsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              PropertyContactsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                PropertyContactsTableControlRow recControl = (PropertyContactsTableControlRow)innerRepItem.FindControl("PropertyContactsTableControlRow");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyContactsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowPropertyContactsGallery.PropertyContactsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyContacts";
                // If ShowPropertyContactsGallery.PropertyContactsPDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             report.AddData("${LastName}", record.Format(PropertyContactsTable.LastName), ReportEnum.Align.Left);
        ...
        public virtual void PropertyContactsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowPropertyContactsGallery.PropertyContactsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyContacts";
                // If ShowPropertyContactsGallery.PropertyContactsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowPropertyContactsGallery.PropertyContactsTableControlRow")));
