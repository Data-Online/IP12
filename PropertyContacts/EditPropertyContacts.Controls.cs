...
// EditPropertyContacts.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditPropertyContacts
{
...
// Base class for the PropertyContactsRecordControl control on the EditPropertyContacts page.
...
public class BasePropertyContactsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in PropertyContactsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditPropertyContacts"] = recId;
