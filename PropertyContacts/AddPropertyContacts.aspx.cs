...
// This file implements the code-behind class for AddPropertyContacts.aspx.
// AddPropertyContacts.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddPropertyContacts
        : BaseApplicationPage
// Code-behind class for the AddPropertyContacts page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public AddPropertyContacts()
        {
            this.Initialize();
...
public void SetPropertyContactsRecordControl()
        {
            SetPropertyContactsRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddPropertyContacts.PropertyContactsRecordControl PropertyContactsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Property Contacts");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "PropertyContactsRecordControl":
                 SetPropertyContactsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.PropertyContactsRecordControl.SaveData();
        ...
        SetPropertyContactsRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "PropertyContactsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPropertyContactsRecordControl_Base()           
        
        {        
            if (PropertyContactsRecordControl.Visible)
            {
                PropertyContactsRecordControl.LoadData();
                PropertyContactsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.PropertyContactsRecordControl != null && this.PropertyContactsRecordControl.DataSource != null)
                  {
                        id = this.PropertyContactsRecordControl.DataSource.GetValue(this.PropertyContactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.PropertyContactsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.PropertyContactsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.PropertyContactsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.PropertyContactsRecordControl.DataSource.GetValue(this.PropertyContactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
