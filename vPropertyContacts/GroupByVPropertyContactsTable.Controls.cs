...
// GroupByVPropertyContactsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByVPropertyContactsTable
{
...
// Base class for the VPropertyContactsTableControlRow control on the GroupByVPropertyContactsTable page.
        ...
        public virtual void SetContactID()
        {
            ...
            if (this.DataSource != null && this.DataSource.ContactIDSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&VPropertyContactsView.ContactID.IsApplyDisplayAs)
                     ...
                     formattedValue = VPropertyContactsView.GetDFKA(this.DataSource.ContactID.ToString(),VPropertyContactsView.ContactID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(VPropertyContactsView.ContactID);
              ...
              this.ContactID.Text = VPropertyContactsView.ContactID.Format(VPropertyContactsView.ContactID.DefaultValue);
        ...
        public virtual void SetPropertyID()
        {
            ...
            if (this.DataSource != null && this.DataSource.PropertyIDSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&VPropertyContactsView.PropertyID.IsApplyDisplayAs)
                     ...
                     formattedValue = VPropertyContactsView.GetDFKA(this.DataSource.PropertyID.ToString(),VPropertyContactsView.PropertyID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(VPropertyContactsView.PropertyID);
              ...
              this.PropertyID.Text = VPropertyContactsView.PropertyID.Format(VPropertyContactsView.PropertyID.DefaultValue);
...
// Base class for the VPropertyContactsTableControl control on the GroupByVPropertyContactsTable page.
...
public class BaseVPropertyContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(VPropertyContactsView.ContactID, this.DataSource);
            this.Page.PregetDfkaRecords(VPropertyContactsView.PropertyID, this.DataSource);
        }
      ...
      VPropertyContactsRecord rec = new VPropertyContactsRecord();
                        ...
                        if (recControl.ContactID.Text != "") {
                            rec.Parse(recControl.ContactID.Text, VPropertyContactsView.ContactID);
                  }
                        ...
                        if (recControl.PropertyID.Text != "") {
                            rec.Parse(recControl.PropertyID.Text, VPropertyContactsView.PropertyID);
                  }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PropertyIDSortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(VPropertyContactsView.PropertyID);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(VPropertyContactsView.PropertyID, OrderByItem.OrderDir.Asc);
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              if (this.TotalRecords > 10000)
              {
                ...
                BaseColumn[] columns = new BaseColumn[] {
                             VPropertyContactsView.PropertyID,
             ...
             VPropertyContactsView.ContactID,
             ...
             null};
              ...
              DataForExport data = new DataForExport(VPropertyContactsView.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(VPropertyContactsView.PropertyID, "Default"));
             ...
             data.ColumnList.Add(new ExcelColumn(VPropertyContactsView.ContactID, "Default"));
        ...
        public virtual void VPropertyContactsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByVPropertyContactsTable.VPropertyContactsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyContacts";
                // If GroupByVPropertyContactsTable.VPropertyContactsPDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(VPropertyContactsView.PropertyID.Name, ReportEnum.Align.Left, "${PropertyID}", ReportEnum.Align.Left, 28);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = VPropertyContactsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyContactsView.PropertyID);
                                 _DFKA = VPropertyContactsView.GetDFKA(record.PropertyID.ToString(), VPropertyContactsView.PropertyID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  VPropertyContactsView.PropertyID.IsApplyDisplayAs){
                                     report.AddData("${PropertyID}", _DFKA,ReportEnum.Align.Left, 100);
                                 }else{
                                     report.AddData("${PropertyID}", record.Format(VPropertyContactsView.PropertyID), ReportEnum.Align.Left, 100);
                                 }
                             }
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.ContactID)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = VPropertyContactsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyContactsView.ContactID);
                                 _DFKA = VPropertyContactsView.GetDFKA(record.ContactID.ToString(), VPropertyContactsView.ContactID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  VPropertyContactsView.ContactID.IsApplyDisplayAs){
                                     report.AddData("${ContactID}", _DFKA,ReportEnum.Align.Left, 100);
                                 }else{
                                     report.AddData("${ContactID}", record.Format(VPropertyContactsView.ContactID), ReportEnum.Align.Left, 100);
                                 }
                             }
        ...
        public virtual void VPropertyContactsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByVPropertyContactsTable.VPropertyContactsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyContacts";
                // If GroupByVPropertyContactsTable.VPropertyContactsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual VPropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (VPropertyContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByVPropertyContactsTable.VPropertyContactsTableControlRow")));
