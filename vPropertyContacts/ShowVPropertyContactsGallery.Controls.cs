...
// ShowVPropertyContactsGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowVPropertyContactsGallery
{
...
// Base class for the VPropertyContactsTableControlRow control on the ShowVPropertyContactsGallery page.
...
// Base class for the VPropertyContactsTableControl control on the ShowVPropertyContactsGallery page.
...
public class BaseVPropertyContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return VPropertyContactsView.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual VPropertyContactsRecord[] CopyArray(int index, VPropertyContactsRecord[,] recs, int columns)
      {
        VPropertyContactsRecord[] recsCopy = new VPropertyContactsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            VPropertyContactsRecord[,] recs = new VPropertyContactsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            VPropertyContactsRecord[] HColDataSource = new VPropertyContactsRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              VPropertyContactsRecord[] VColDataSource = new VPropertyContactsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("VPropertyContactsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              VPropertyContactsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                VPropertyContactsTableControlRow recControl = (VPropertyContactsTableControlRow)innerRepItem.FindControl("VPropertyContactsTableControlRow");
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void FirstNameSortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(VPropertyContactsView.FirstName);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(VPropertyContactsView.FirstName, OrderByItem.OrderDir.Asc);
        ...
        public virtual void LastNameSortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(VPropertyContactsView.LastName);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(VPropertyContactsView.LastName, OrderByItem.OrderDir.Asc);
        ...
        public virtual void VPropertyContactsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyContactsGallery.VPropertyContactsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyContacts";
                // If ShowVPropertyContactsGallery.VPropertyContactsPDFButton.report specifies a valid report template,
        ...
        public virtual void VPropertyContactsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyContactsGallery.VPropertyContactsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyContacts";
                // If ShowVPropertyContactsGallery.VPropertyContactsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual VPropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (VPropertyContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowVPropertyContactsGallery.VPropertyContactsTableControlRow")));
