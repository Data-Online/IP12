...
// This file implements the code-behind class for GroupByVPropertyContactsTable.aspx.
// GroupByVPropertyContactsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByVPropertyContactsTable
        : BaseApplicationPage
// Code-behind class for the GroupByVPropertyContactsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByVPropertyContactsTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_VPropertyContactsSearch(string prefixText, int count)
        {
            // GetVPropertyContactsSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_VPropertyContactsSearch_Base()
            // or replace the call to GetAutoCompletionList_VPropertyContactsSearch_Base().
            return GetAutoCompletionList_VPropertyContactsSearch_Base(prefixText, count);
        }
...
public void SetVPropertyContactsTableControl()
        {
            SetVPropertyContactsTableControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButtonWithArrow VPropertyContactsButtonsButton;
                
        public System.Web.UI.WebControls.ImageButton VPropertyContactsExportExcelButton;
        
        public ThemeButton VPropertyContactsFilterButton;
                
        public ThemeButtonWithArrow VPropertyContactsFiltersButton;
                
        public PaginationModern VPropertyContactsPagination;
        ...
        public IPv5.UI.Controls.GroupByVPropertyContactsTable.VPropertyContactsTableControl VPropertyContactsTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "VPropertyContactsTableControl":
                 SetVPropertyContactsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.VPropertyContactsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_VPropertyContactsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByVPropertyContactsTable.VPropertyContactsTableControl control = new IPv5.UI.Controls.GroupByVPropertyContactsTable.VPropertyContactsTableControl();
        
        return control.GetAutoCompletionList_VPropertyContactsSearch(prefixText, count);
        ...
        SetVPropertyContactsTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "VPropertyContactsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVPropertyContactsTableControl_Base()           
        
        {        
            if (VPropertyContactsTableControl.Visible)
            {
                VPropertyContactsTableControl.LoadData();
                VPropertyContactsTableControl.DataBind();
            }
        }
