...
// ShowVPropertyRentReviewsGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowVPropertyRentReviewsGallery
{
...
// Base class for the VPropertyRentReviewsTableControlRow control on the ShowVPropertyRentReviewsGallery page.
...
// Base class for the VPropertyRentReviewsTableControl control on the ShowVPropertyRentReviewsGallery page.
...
public class BaseVPropertyRentReviewsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return VPropertyRentReviewsView.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual VPropertyRentReviewsRecord[] CopyArray(int index, VPropertyRentReviewsRecord[,] recs, int columns)
      {
        VPropertyRentReviewsRecord[] recsCopy = new VPropertyRentReviewsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            VPropertyRentReviewsRecord[,] recs = new VPropertyRentReviewsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            VPropertyRentReviewsRecord[] HColDataSource = new VPropertyRentReviewsRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              VPropertyRentReviewsRecord[] VColDataSource = new VPropertyRentReviewsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("VPropertyRentReviewsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              VPropertyRentReviewsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                VPropertyRentReviewsTableControlRow recControl = (VPropertyRentReviewsTableControlRow)innerRepItem.FindControl("VPropertyRentReviewsTableControlRow");
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void VPropertyRentReviewsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyRentReviewsGallery.VPropertyRentReviewsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyRentReviews";
                // If ShowVPropertyRentReviewsGallery.VPropertyRentReviewsPDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  VPropertyRentReviewsView.PropertyID.IsApplyDisplayAs){
                                     ...
                                     report.AddData("${PropertyID}", record.Format(VPropertyRentReviewsView.PropertyID), ReportEnum.Align.Left, 100);
                                 }
                             }
        ...
        public virtual void VPropertyRentReviewsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyRentReviewsGallery.VPropertyRentReviewsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyRentReviews";
                // If ShowVPropertyRentReviewsGallery.VPropertyRentReviewsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual VPropertyRentReviewsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (VPropertyRentReviewsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowVPropertyRentReviewsGallery.VPropertyRentReviewsTableControlRow")));
