...
// This file implements the code-behind class for GroupByVPropertyRentReviewsTable.aspx.
// GroupByVPropertyRentReviewsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByVPropertyRentReviewsTable
        : BaseApplicationPage
// Code-behind class for the GroupByVPropertyRentReviewsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByVPropertyRentReviewsTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_VPropertyRentReviewsSearch(string prefixText, int count)
        {
            // GetVPropertyRentReviewsSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_VPropertyRentReviewsSearch_Base()
            // or replace the call to GetAutoCompletionList_VPropertyRentReviewsSearch_Base().
            return GetAutoCompletionList_VPropertyRentReviewsSearch_Base(prefixText, count);
        }
...
public void SetVPropertyRentReviewsTableControl()
        {
            SetVPropertyRentReviewsTableControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButtonWithArrow VPropertyRentReviewsButtonsButton;
                
        public System.Web.UI.WebControls.ImageButton VPropertyRentReviewsExportExcelButton;
        
        public ThemeButton VPropertyRentReviewsFilterButton;
        ...
        public IPv5.UI.Controls.GroupByVPropertyRentReviewsTable.VPropertyRentReviewsTableControl VPropertyRentReviewsTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = "Property Rent Reviews";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "VPropertyRentReviewsTableControl":
                 SetVPropertyRentReviewsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.VPropertyRentReviewsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_VPropertyRentReviewsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByVPropertyRentReviewsTable.VPropertyRentReviewsTableControl control = new IPv5.UI.Controls.GroupByVPropertyRentReviewsTable.VPropertyRentReviewsTableControl();
        
        return control.GetAutoCompletionList_VPropertyRentReviewsSearch(prefixText, count);
        ...
        SetVPropertyRentReviewsTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "VPropertyRentReviewsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVPropertyRentReviewsTableControl_Base()           
        
        {        
            if (VPropertyRentReviewsTableControl.Visible)
            {
                VPropertyRentReviewsTableControl.LoadData();
                VPropertyRentReviewsTableControl.DataBind();
            }
        }
