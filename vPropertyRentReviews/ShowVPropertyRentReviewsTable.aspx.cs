...
// This file implements the code-behind class for ShowVPropertyRentReviewsTable.aspx.
// ShowVPropertyRentReviewsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class ShowVPropertyRentReviewsTable
        : BaseApplicationPage
// Code-behind class for the ShowVPropertyRentReviewsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public ShowVPropertyRentReviewsTable()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.ShowVPropertyRentReviewsTable.VPropertyRentReviewsTableControl VPropertyRentReviewsTableControl;
    ...
    public static string[] GetAutoCompletionList_VPropertyRentReviewsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.ShowVPropertyRentReviewsTable.VPropertyRentReviewsTableControl control = new IPv5.UI.Controls.ShowVPropertyRentReviewsTable.VPropertyRentReviewsTableControl();
