...
// ShowPropertiesPropertyContacts.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowPropertiesPropertyContacts
{
...
// Base class for the PropertiesPropertyContactsRecordControl control on the ShowPropertiesPropertyContacts page.
...
public class BasePropertiesPropertyContactsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "PropertiesPropertyContactsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = PropertiesPropertyContactsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void SetContactTypeId()
        {
            ...
            if (this.DataSource != null && this.DataSource.ContactTypeIdSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&PropertiesPropertyContactsTable.ContactTypeId.IsApplyDisplayAs)
                     ...
                     formattedValue = PropertiesPropertyContactsTable.GetDFKA(this.DataSource.ContactTypeId.ToString(),PropertiesPropertyContactsTable.ContactTypeId, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(PropertiesPropertyContactsTable.ContactTypeId);
              ...
              this.ContactTypeId.Text = PropertiesPropertyContactsTable.ContactTypeId.Format(PropertiesPropertyContactsTable.ContactTypeId.DefaultValue);
        ...
        public virtual void SetPropertyContactId()
        {
            ...
            if (this.DataSource != null && this.DataSource.PropertyContactIdSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&PropertiesPropertyContactsTable.PropertyContactId.IsApplyDisplayAs)
                     ...
                     formattedValue = PropertiesPropertyContactsTable.GetDFKA(this.DataSource.PropertyContactId.ToString(),PropertiesPropertyContactsTable.PropertyContactId, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(PropertiesPropertyContactsTable.PropertyContactId);
              ...
              this.PropertyContactId.Text = PropertiesPropertyContactsTable.PropertyContactId.Format(PropertiesPropertyContactsTable.PropertyContactId.DefaultValue);
        ...
        public virtual void SetPropertyId()
        {
            ...
            if (this.DataSource != null && this.DataSource.PropertyIdSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&PropertiesPropertyContactsTable.PropertyId.IsApplyDisplayAs)
                     ...
                     formattedValue = PropertiesPropertyContactsTable.GetDFKA(this.DataSource.PropertyId.ToString(),PropertiesPropertyContactsTable.PropertyId, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(PropertiesPropertyContactsTable.PropertyId);
              ...
              this.PropertyId.Text = PropertiesPropertyContactsTable.PropertyId.Format(PropertiesPropertyContactsTable.PropertyId.DefaultValue);
      ...
      // To customize, override this method in PropertiesPropertyContactsRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["PropertiesPropertyContacts"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "PropertiesPropertyContacts"));
            }
            HttpContext.Current.Session["QueryString in ShowPropertiesPropertyContacts"] = recId;
