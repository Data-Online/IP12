...
// This file implements the code-behind class for AddPropertiesPropertyContacts.aspx.
// AddPropertiesPropertyContacts.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddPropertiesPropertyContacts
        : BaseApplicationPage
// Code-behind class for the AddPropertiesPropertyContacts page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public AddPropertiesPropertyContacts()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetPropertiesPropertyContactsRecordControl()
        {
            SetPropertiesPropertyContactsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddPropertiesPropertyContacts.PropertiesPropertyContactsRecordControl PropertiesPropertyContactsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Properties Property Contacts");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "PropertiesPropertyContactsRecordControl":
                 SetPropertiesPropertyContactsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.PropertiesPropertyContactsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPropertiesPropertyContactsRecordControl_Base()           
        
        {        
            if (PropertiesPropertyContactsRecordControl.Visible)
            {
                PropertiesPropertyContactsRecordControl.LoadData();
                PropertiesPropertyContactsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.PropertiesPropertyContactsRecordControl != null && this.PropertiesPropertyContactsRecordControl.DataSource != null)
                  {
                        id = this.PropertiesPropertyContactsRecordControl.DataSource.GetValue(this.PropertiesPropertyContactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.PropertiesPropertyContactsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.PropertiesPropertyContactsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.PropertiesPropertyContactsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.PropertiesPropertyContactsRecordControl.DataSource.GetValue(this.PropertiesPropertyContactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
