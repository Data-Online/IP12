...
// EditPropertiesPropertyContactsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditPropertiesPropertyContactsTable
{
...
public class PropertiesPropertyContactsTableControlRow : BasePropertiesPropertyContactsTableControlRow
{
      
        // The BasePropertiesPropertyContactsTableControlRow implements code for a ROW within the
        // the PropertiesPropertyContactsTableControl table.  The BasePropertiesPropertyContactsTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of PropertiesPropertyContactsTableControl.
...
public class PropertiesPropertyContactsTableControl : BasePropertiesPropertyContactsTableControl
{
    // The BasePropertiesPropertyContactsTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The PropertiesPropertyContactsTableControlRow class offers another place where you can customize
...
// Base class for the PropertiesPropertyContactsTableControlRow control on the EditPropertiesPropertyContactsTable page.
// Do not modify this class. Instead override any method in PropertiesPropertyContactsTableControlRow.
public class BasePropertiesPropertyContactsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        public BasePropertiesPropertyContactsTableControlRow()
        {
        ...
        // To customize, override this method in PropertiesPropertyContactsTableControlRow.
        ...
        public virtual void LoadData()  
        {
            ...
            // LoadData method of the BasePropertiesPropertyContactsTableControl when the data for the entire
            // table is loaded.
        ...
        public virtual void SetContactTypeId()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = PropertiesPropertyContactsTable.ContactTypeId.DefaultValue;
        ...
        public virtual void SetPropertyContactId()
        {
            ...
            // If selection was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.PropertyContactId.ID))
            {
                if (this.PreviousUIData[this.PropertyContactId.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.PropertyContactId.ID].ToString();
            }
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = PropertiesPropertyContactsTable.PropertyContactId.DefaultValue;
        ...
        public virtual void SetPropertyId()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = PropertiesPropertyContactsTable.PropertyId.DefaultValue;
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((PropertiesPropertyContactsTableControl)MiscUtils.GetParentControlObject(this, "PropertiesPropertyContactsTableControl")).DataChanged = true;
                ((PropertiesPropertyContactsTableControl)MiscUtils.GetParentControlObject(this, "PropertiesPropertyContactsTableControl")).ResetData = true;
            }
      ...
      // To customize, override this method in PropertiesPropertyContactsTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersPropertiesPropertyContactsTableControl = false;
            hasFiltersPropertiesPropertyContactsTableControl = hasFiltersPropertiesPropertyContactsTableControl && false; // suppress warning
        ...
        PropertiesPropertyContactsTableControl tc= ((PropertiesPropertyContactsTableControl)MiscUtils.GetParentControlObject(this, "PropertiesPropertyContactsTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((PropertiesPropertyContactsTableControlRow)this);
                    }
                    this.Visible = false;
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../PropertiesPropertyContacts/EditPropertiesPropertyContacts.aspx?PropertiesPropertyContacts={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../PropertiesPropertyContacts/ShowPropertiesPropertyContacts.aspx?PropertiesPropertyContacts={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BasePropertiesPropertyContactsTableControlRow_Rec"];
            }
            set {
                this.ViewState["BasePropertiesPropertyContactsTableControlRow_Rec"] = value;
            }
        }
             ...
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return PropertiesPropertyContactsTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the PropertiesPropertyContactsTableControl control on the EditPropertiesPropertyContactsTable page.
// Do not modify this class. Instead override any method in PropertiesPropertyContactsTableControl.
public class BasePropertiesPropertyContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
         
       public BasePropertiesPropertyContactsTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.PropertyContactIdFilter)) 				
                    initialVal = this.GetFromSession(this.PropertyContactIdFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"PropertyContactId\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.PropertyContactIdFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.PropertyContactIdFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.PropertyContactIdFilter.SelectedIndexChanged += new EventHandler(PropertyContactIdFilter_SelectedIndexChanged);
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(IPv5.Business.PropertiesPropertyContactsRecord);
                      this.DataSource = (PropertiesPropertyContactsRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (PropertiesPropertyContactsTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(IPv5.Business.PropertiesPropertyContactsRecord);
                    this.DataSource = (PropertiesPropertyContactsRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual PropertiesPropertyContactsRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(PropertiesPropertyContactsTable.Column1, true);          
            // selCols.Add(PropertiesPropertyContactsTable.Column2, true);          
            // selCols.Add(PropertiesPropertyContactsTable.Column3, true);          
                  ...
                  
            {
                ...
                return PropertiesPropertyContactsTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                PropertiesPropertyContactsTable databaseTable = new PropertiesPropertyContactsTable();
                ...
                return (recList.ToArray(typeof(PropertiesPropertyContactsRecord)) as PropertiesPropertyContactsRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return PropertiesPropertyContactsTable.GetRecordCount(join, where);
            else
            {
                PropertiesPropertyContactsTable databaseTable = new PropertiesPropertyContactsTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertiesPropertyContactsTableControlRepeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            PropertiesPropertyContactsTableControlRow recControl = (PropertiesPropertyContactsTableControlRow)(repItem.FindControl("PropertiesPropertyContactsTableControlRow"));
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetPropertyContactIdFilter();
                SetPropertyContactIdLabel1();
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(PropertiesPropertyContactsTable.ContactTypeId, this.DataSource);
            this.Page.PregetDfkaRecords(PropertiesPropertyContactsTable.PropertyContactId, this.DataSource);
            this.Page.PregetDfkaRecords(PropertiesPropertyContactsTable.PropertyId, this.DataSource);
        }
        ...
        public virtual void ResetControl()
        {
            ...
            this.PropertyContactIdFilter.ClearSelection();
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for PropertiesPropertyContactsTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (PropertiesPropertyContactsTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.PropertyContactIdFilter)) {
                        
                wc.iAND(PropertiesPropertyContactsTable.PropertyContactId, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.PropertyContactIdFilter, this.GetFromSession(this.PropertyContactIdFilter)), false, false);
      ...
      cols.Add(PropertiesPropertyContactsTable.ContactTypeId, true);
      ...
      String PropertyContactIdFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "PropertyContactIdFilter_Ajax"];
            if (MiscUtils.IsValueSelected(PropertyContactIdFilterSelectedValue)) {

              
                wc.iAND(PropertiesPropertyContactsTable.PropertyContactId, BaseFilter.ComparisonOperator.EqualsTo, PropertyContactIdFilterSelectedValue, false, false);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            IPv5.Business.PropertiesPropertyContactsRecord[] recordList  = PropertiesPropertyContactsTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (PropertiesPropertyContactsRecord rec in recordList ){
                ...
                resultItem = rec.Format(PropertiesPropertyContactsTable.ContactTypeId);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(PropertiesPropertyContactsTable.ContactTypeId.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, PropertiesPropertyContactsTable.ContactTypeId.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      PropertiesPropertyContactsRecord rec = new PropertiesPropertyContactsRecord();
        
                        if (MiscUtils.IsValueSelected(recControl.ContactTypeId)) {
                            rec.Parse(recControl.ContactTypeId.SelectedItem.Value, PropertiesPropertyContactsTable.ContactTypeId);
                        }
                        if (MiscUtils.IsValueSelected(recControl.PropertyContactId)) {
                            rec.Parse(recControl.PropertyContactId.SelectedItem.Value, PropertiesPropertyContactsTable.PropertyContactId);
                        }
                        if (MiscUtils.IsValueSelected(recControl.PropertyId)) {
                            rec.Parse(recControl.PropertyId.SelectedItem.Value, PropertiesPropertyContactsTable.PropertyId);
                        }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new PropertiesPropertyContactsRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(IPv5.Business.PropertiesPropertyContactsRecord);
                this.DataSource = (PropertiesPropertyContactsRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(PropertiesPropertyContactsTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(PropertiesPropertyContactsTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual void SetPropertyContactIdLabel1()
                  {
        ...
        public virtual void SetPropertyContactIdFilter()
        {
            
            this.PopulatePropertyContactIdFilter(MiscUtils.GetSelectedValue(this.PropertyContactIdFilter,  GetFromSession(this.PropertyContactIdFilter)), 500);					
        ...
        // Get the filters' data for PropertyContactIdFilter.
                
        protected virtual void PopulatePropertyContactIdFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.PropertyContactIdFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_PropertyContactIdFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_PropertyContactIdFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.PropertyContactIdFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "IPv5"), "--ANY--"));
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    ...
                    foreach (PropertyContactsRecord itemValue in itemValues) 
                    {
                        ...
                        {
                            cvalue = itemValue.PropertyContactID.ToString();
                            if (counter < maxItems && this.PropertyContactIdFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.PropertyContactIdFilter.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.PropertyContactIdFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.PropertyContactIdFilter, selectedValue);
            ...
            if (this.PropertyContactIdFilter.SelectedValue != null && this.PropertyContactIdFilter.Items.FindByValue(this.PropertyContactIdFilter.SelectedValue) == null)
                this.PropertyContactIdFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_PropertyContactIdFilter()
        {
            // Create a where clause for the filter PropertyContactIdFilter.
            // This function is called by the Populate method to load the items 
            // in the PropertyContactIdFilterDropDownList
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("PropertiesPropertyContactsTableControlRepeater");
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.PropertyContactIdFilter, this.PropertyContactIdFilter.SelectedValue);
      ...
      this.SaveToSession("PropertyContactIdFilter_Ajax", this.PropertyContactIdFilter.SelectedValue);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.PropertyContactIdFilter);
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["PropertiesPropertyContactsTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["PropertiesPropertyContactsTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.SaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.Page.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(PropertyContactIdFilter))
        ...
        protected virtual void SortControl_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in PropertiesPropertyContactsTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(PropertiesPropertyContactsTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (PropertiesPropertyContactsTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && PropertiesPropertyContactsTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(PropertiesPropertyContactsTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(PropertiesPropertyContactsTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        protected virtual void PropertyContactIdFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = PropertiesPropertyContactsTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  PropertiesPropertyContactsRecord[] DataSource {
            ...
            get {
                return (PropertiesPropertyContactsRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList PropertyContactIdFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyContactIdFilter");
            }
        }
        
        public System.Web.UI.WebControls.Literal PropertyContactIdLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyContactIdLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                PropertiesPropertyContactsTableControlRow recCtl = this.GetSelectedRecordControl();
        ...
        {
            int counter = 0;
            foreach (PropertiesPropertyContactsTableControlRow recControl in this.GetRecordControls())
            {
        ...
        public virtual PropertiesPropertyContactsTableControlRow GetSelectedRecordControl()
        {
        PropertiesPropertyContactsTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual PropertiesPropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertiesPropertyContactsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditPropertiesPropertyContactsTable.PropertiesPropertyContactsTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            PropertiesPropertyContactsTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "IPv5"));
            }
            
            foreach (PropertiesPropertyContactsTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual PropertiesPropertyContactsTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "PropertiesPropertyContactsTableControlRow");
	          List<PropertiesPropertyContactsTableControlRow> list = new List<PropertiesPropertyContactsTableControlRow>();
	          foreach (PropertiesPropertyContactsTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
