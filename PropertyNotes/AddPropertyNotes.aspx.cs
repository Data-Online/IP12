...
// This file implements the code-behind class for AddPropertyNotes.aspx.
// AddPropertyNotes.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddPropertyNotes
        : BaseApplicationPage
// Code-behind class for the AddPropertyNotes page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public AddPropertyNotes()
        {
            this.Initialize();
...
public void SetPropertyNotesRecordControl()
        {
            SetPropertyNotesRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddPropertyNotes.PropertyNotesRecordControl PropertyNotesRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Property Notes");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "PropertyNotesRecordControl":
                 SetPropertyNotesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.PropertyNotesRecordControl.SaveData();
        ...
        SetPropertyNotesRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "PropertyNotesMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPropertyNotesRecordControl_Base()           
        
        {        
            if (PropertyNotesRecordControl.Visible)
            {
                PropertyNotesRecordControl.LoadData();
                PropertyNotesRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.PropertyNotesRecordControl != null && this.PropertyNotesRecordControl.DataSource != null)
                  {
                        id = this.PropertyNotesRecordControl.DataSource.GetValue(this.PropertyNotesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.PropertyNotesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.PropertyNotesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.PropertyNotesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.PropertyNotesRecordControl.DataSource.GetValue(this.PropertyNotesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
