...
// GroupByPropertyNotesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByPropertyNotesTable
{
...
// Base class for the PropertyNotesTableControlRow control on the GroupByPropertyNotesTable page.
...
public class BasePropertyNotesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={PropertyNotesTableControlRow:FK:FK_PropertyNotes_Properties}";
...
// Base class for the PropertyNotesTableControl control on the GroupByPropertyNotesTable page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyNotesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByPropertyNotesTable.PropertyNotesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyNotes";
                // If GroupByPropertyNotesTable.PropertyNotesPDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  PropertyNotesTable.PropertyID.IsApplyDisplayAs){
                                     ...
                                     report.AddData("${PropertyID}", record.Format(PropertyNotesTable.PropertyID), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void PropertyNotesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByPropertyNotesTable.PropertyNotesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyNotes";
                // If GroupByPropertyNotesTable.PropertyNotesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual PropertyNotesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyNotesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByPropertyNotesTable.PropertyNotesTableControlRow")));
