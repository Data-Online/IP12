...
// ShowPropertyNotesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowPropertyNotesTable
{
...
// Base class for the PropertyNotesTableControlRow control on the ShowPropertyNotesTable page.
...
public class BasePropertyNotesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.PropertyNotesRowExpandCollapseRowButton.Click += PropertyNotesRowExpandCollapseRowButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetPropertyNotesTabContainer();
                SetPropertyNotesRowDeleteButton();
              
                SetPropertyNotesRowEditButton();
              
                SetPropertyNotesRowExpandCollapseRowButton();
        ...
        public virtual void SetPropertyNotesTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "PropertyNotesTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "PropertyNotesTabContainer").Visible = false;
      ...
      // To customize, override this method in PropertyNotesTableControlRow.
        ...
        public virtual void SetPropertyNotesRowExpandCollapseRowButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void PropertyNotesRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                PropertyNotesTableControl panelControl = (MiscUtils.GetParentControlObject(this, "PropertyNotesTableControl") as PropertyNotesTableControl);

          PropertyNotesTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (PropertyNotesTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "PropertyNotesTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.PropertyNotesRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.PropertyNotesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.PropertyNotesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.PropertyNotesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.PropertyNotesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.PropertyNotesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.PropertyNotesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton PropertyNotesRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyNotesRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer PropertyNotesTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyNotesTabContainer");
            }
        }
...
// Base class for the PropertyNotesTableControl control on the ShowPropertyNotesTable page.
...
public class BasePropertyNotesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        PropertyNotesTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "PropertyNotesTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].PropertyNotesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].PropertyNotesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].PropertyNotesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].PropertyNotesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].PropertyNotesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].PropertyNotesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyNotesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowPropertyNotesTable.PropertyNotesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyNotes";
                // If ShowPropertyNotesTable.PropertyNotesPDFButton.report specifies a valid report template,
        ...
        public virtual void PropertyNotesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowPropertyNotesTable.PropertyNotesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyNotes";
                // If ShowPropertyNotesTable.PropertyNotesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual PropertyNotesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyNotesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowPropertyNotesTable.PropertyNotesTableControlRow")));
...
// Base class for the PropertiesRecordControl control on the ShowPropertyNotesTable page.
...
public class BasePropertiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          PropertyNotesTableControlRow parentCtrl;
      
            parentCtrl = (PropertyNotesTableControlRow)MiscUtils.GetParentControlObject(this, "PropertyNotesTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue propertyNotesRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = propertyNotesRecordObj;
          propertyNotesRecordObj = tmp;
        PropertyNotesTableControlRow propertyNotesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "PropertyNotesTableControlRow") as PropertyNotesTableControlRow);
          
              if (propertyNotesTableControlObjRow != null && propertyNotesTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertiesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, propertyNotesTableControlObjRow.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInPropertyNotesTableControl = HttpContext.Current.Session["PropertiesRecordControlWhereClause"] as string;
      
      if (selectedRecordInPropertyNotesTableControl != null && KeyValue.IsXmlKey(selectedRecordInPropertyNotesTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInPropertyNotesTableControl);
