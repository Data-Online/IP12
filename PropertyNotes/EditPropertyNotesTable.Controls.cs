...
// EditPropertyNotesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditPropertyNotesTable
{
...
// Base class for the PropertyNotesTableControlRow control on the EditPropertyNotesTable page.
...
public class BasePropertyNotesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.PropertyNotesRowViewButton.Click += PropertyNotesRowViewButton_Click;
        ...
        public virtual void SetPropertyID()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = PropertyNotesTable.PropertyID.DefaultValue;
        ...
        public virtual void GetPropertyID()
        {
         // Retrieve the value entered by the user on the PropertyID ASP:DropDownList, and
            // save it into the PropertyID field in DataSource DatabaseMM_IP1%dbo.PropertyNotes record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.PropertyID), PropertyNotesTable.PropertyID);			
      ...
      // To customize, override this method in PropertyNotesTableControlRow.
        ...
        public virtual void SetPropertyNotesRowViewButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void PropertyNotesRowViewButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton PropertyNotesRowViewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyNotesRowViewButton");
            }
        }
...
// Base class for the PropertyNotesTableControl control on the EditPropertyNotesTable page.
...
public class BasePropertyNotesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.PropertyNotesSaveButton.Click += PropertyNotesSaveButton_Click;
      ...
      public override void DataBind()
      {
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"PropertyNotesSaveButton"));
      ...
      PropertyNotesRecord rec = new PropertyNotesRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.PropertyID)) {
                            rec.Parse(recControl.PropertyID.SelectedItem.Value, PropertyNotesTable.PropertyID);
                        }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetPropertyNotesSaveButton()                
              
        {
        
                    this.PropertyNotesSaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.Page.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
        ...
        // event handler for ImageButton
        public virtual void PropertyNotesSaveButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton PropertyNotesSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyNotesSaveButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual PropertyNotesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyNotesTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditPropertyNotesTable.PropertyNotesTableControlRow")));
