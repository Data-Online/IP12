...
// This file implements the code-behind class for EditPropertyNotesTable.aspx.
// EditPropertyNotesTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditPropertyNotesTable
        : BaseApplicationPage
// Code-behind class for the EditPropertyNotesTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditPropertyNotesTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_PropertyNotesSearch(string prefixText, int count)
        {
            // GetPropertyNotesSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_PropertyNotesSearch_Base()
            // or replace the call to GetAutoCompletionList_PropertyNotesSearch_Base().
            return GetAutoCompletionList_PropertyNotesSearch_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButton PropertyNotesFilterButton;
        ...
        public IPv5.UI.Controls.EditPropertyNotesTable.PropertyNotesTableControl PropertyNotesTableControl;
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.PropertyNotesTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_PropertyNotesSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditPropertyNotesTable.PropertyNotesTableControl control = new IPv5.UI.Controls.EditPropertyNotesTable.PropertyNotesTableControl();
        
        return control.GetAutoCompletionList_PropertyNotesSearch(prefixText, count);
