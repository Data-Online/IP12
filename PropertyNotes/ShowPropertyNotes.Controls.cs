...
// ShowPropertyNotes.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowPropertyNotes
{
...
public class PropertyNotesRecordControl : BasePropertyNotesRecordControl
{
      
        // The BasePropertyNotesRecordControl implements the LoadData, DataBind and other
...
// Base class for the PropertyNotesRecordControl control on the ShowPropertyNotes page.
// Do not modify this class. Instead override any method in PropertyNotesRecordControl.
public class BasePropertyNotesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        public BasePropertyNotesRecordControl()
        {
        ...
        // To customize, override this method in PropertyNotesRecordControl.
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.PropertyNotesDialogEditButton.Click += PropertyNotesDialogEditButton_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            PropertyNotesRecord[] recList = PropertyNotesTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetPropertyNotesDialogEditButton();
      ...
      // To customize, override this method in PropertyNotesRecordControl.
         ...
         
        {
            ...
            bool hasFiltersPropertyNotesRecordControl = false;
            hasFiltersPropertyNotesRecordControl = hasFiltersPropertyNotesRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["PropertyNotes"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "PropertyNotes"));
            }
            HttpContext.Current.Session["QueryString in ShowPropertyNotes"] = recId;
        ...
        public virtual void SetPropertyNotesDialogEditButton()                
        ...
        public virtual void PropertyNotesDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={PropertyNotesRecordControl:FK:FK_PropertyNotes_Properties}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BasePropertyNotesRecordControl_Rec"];
            }
            set {
                this.ViewState["BasePropertyNotesRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton PropertyNotesDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyNotesDialogEditButton");
            }
        }
