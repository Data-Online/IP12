...
// EditPropertyNotes.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditPropertyNotes
{
...
// Base class for the PropertyNotesRecordControl control on the EditPropertyNotes page.
...
public class BasePropertyNotesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in PropertyNotesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditPropertyNotes"] = recId;
