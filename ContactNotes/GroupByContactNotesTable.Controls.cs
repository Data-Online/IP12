...
// GroupByContactNotesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByContactNotesTable
{
...
// Base class for the ContactNotesTableControlRow control on the GroupByContactNotesTable page.
...
public class BaseContactNotesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ContactID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Contacts/ShowContacts.aspx?Contacts={ContactNotesTableControlRow:FK:FK_ContactNotes_Contacts}";
...
// Base class for the ContactNotesTableControl control on the GroupByContactNotesTable page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ContactNotesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByContactNotesTable.ContactNotesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "ContactNotes";
                // If GroupByContactNotesTable.ContactNotesPDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  ContactNotesTable.ContactID.IsApplyDisplayAs){
                                     ...
                                     report.AddData("${ContactID}", record.Format(ContactNotesTable.ContactID), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void ContactNotesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByContactNotesTable.ContactNotesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "ContactNotes";
                // If GroupByContactNotesTable.ContactNotesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ContactNotesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactNotesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByContactNotesTable.ContactNotesTableControlRow")));
