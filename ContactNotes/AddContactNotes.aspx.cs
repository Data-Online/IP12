...
// This file implements the code-behind class for AddContactNotes.aspx.
// AddContactNotes.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddContactNotes
        : BaseApplicationPage
// Code-behind class for the AddContactNotes page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public AddContactNotes()
        {
            this.Initialize();
...
public void SetContactNotesRecordControl()
        {
            SetContactNotesRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddContactNotes.ContactNotesRecordControl ContactNotesRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Contact Notes");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "ContactNotesRecordControl":
                 SetContactNotesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.ContactNotesRecordControl.SaveData();
        ...
        SetContactNotesRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "ContactNotesMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetContactNotesRecordControl_Base()           
        
        {        
            if (ContactNotesRecordControl.Visible)
            {
                ContactNotesRecordControl.LoadData();
                ContactNotesRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ContactNotesRecordControl != null && this.ContactNotesRecordControl.DataSource != null)
                  {
                        id = this.ContactNotesRecordControl.DataSource.GetValue(this.ContactNotesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ContactNotesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ContactNotesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ContactNotesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ContactNotesRecordControl.DataSource.GetValue(this.ContactNotesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
