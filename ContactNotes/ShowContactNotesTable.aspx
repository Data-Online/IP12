...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowContactNotesTable.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowContactNotesTable" %>
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowContactNotesTable" Assembly="IPv5" %>
...
<asp:AutoCompleteExtender id="ContactNotesSearchAutoCompleteExtender" runat="server" TargetControlID="ContactNotesSearch" ServiceMethod="GetAutoCompletionList_ContactNotesSearch" MinimumPrefixLength="2" CompletionInterval="700" CompletionSetCount="10" CompletionListCssClass="autotypeahead_completionListElement" CompletionListItemCssClass="autotypeahead_listItem " CompletionListHighlightedItemCssClass="autotypeahead_highlightedListItem">
              ...
              <%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("ContactNotesSearchButton"))%>
                ...
                <asp:ImageButton runat="server" id="ContactNotesSearchButton" causesvalidation="False" commandname="Search" imageurl="../Images/panelSearchButton.png" tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;IPv5&quot;) %>">		
                          ...
                          <table cellpadding="0" cellspacing="0" border="0"><tr><td class="popupTableCellLabel"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td style="text-align: right;" class="popupTableCellValue"><input type="image" src="../Images/closeButton.gif" alt="" onclick="ISD_HidePopupPanel();return false;" align="top" /><br /></td></tr><tr><td class="popupTableCellLabel"><asp:Literal runat="server" id="ContactIDLabel" Text="Contact">	</asp:Literal></td><td colspan="2" class="popupTableCellValue"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("ContactNotesFilterButton"))%>
...
<asp:DropDownList runat="server" id="NotesFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("ContactNotesFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="ContactNotesTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="ContactNotesTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="3" style="display:none"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th><th class="thc" style="display: none">&nbsp;</th></tr><asp:Repeater runat="server" id="ContactNotesTableControlRepeater">		<ITEMTEMPLATE>		<IPv5:ContactNotesTableControlRow runat="server" id="ContactNotesTableControlRow">
...
<BaseClasses:TabContainer runat="server" id="ContactNotesTabContainer" panellayout="Tabbed">
 <BaseClasses:TabPanel runat="server" id="ContactsTabPanel" HeaderText="Contact">	<ContentTemplate>
  <IPv5:ContactsRecordControl runat="server" id="ContactsRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td></td><td></td><td></td></tr><tr><td></td><td>
                  <asp:panel id="ContactsRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="ContactsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fls"><asp:Literal runat="server" id="LastName2Label" Text="Last Name 2">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="LastName2"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="Address1Label" Text="EvaluateFormula(&quot;= \&quot;Address\&quot;&quot;, true)">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="Address1"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="TitleLabel" Text="Title">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="Title"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="PostCodeLabel" Text="Post Code">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="PostCode"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="FirstName2Label" Text="EvaluateFormula(&quot;= \&quot;Second Contact\&quot;&quot;, true)">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="FirstName2"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="Address2Label" Text="Address 2">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="Address2"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="IrdNumberLabel" Text="IRD Number">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="IrdNumber"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="ActiveLabel" Text="Active">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="Active"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="TrustNameLabel" Text="Trust Name">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="TrustName"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="Address3Label" Text="Address 3">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="Address3"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="BankAccountLabel" Text="Bank Account">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="BankAccount"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="LastNameLabel" Text="Last Name">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="LastName"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="FirstNameLabel" Text="First Name">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="FirstName"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="eMailLabel" Text="Email">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="eMail"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="PhoneNumberLabel" Text="Phone Number">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="PhoneNumber"></asp:Literal> </td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
...
</td></tr><tr><td class="tableRowDivider" colspan="11">&nbsp;</td></tr></IPv5:ContactNotesTableControlRow>
</ITEMTEMPLATE>
