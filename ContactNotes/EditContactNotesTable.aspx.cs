...
// This file implements the code-behind class for EditContactNotesTable.aspx.
// EditContactNotesTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditContactNotesTable
        : BaseApplicationPage
// Code-behind class for the EditContactNotesTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditContactNotesTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_ContactNotesSearch(string prefixText, int count)
        {
            // GetContactNotesSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_ContactNotesSearch_Base()
            // or replace the call to GetAutoCompletionList_ContactNotesSearch_Base().
            return GetAutoCompletionList_ContactNotesSearch_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButton ContactNotesFilterButton;
        ...
        public IPv5.UI.Controls.EditContactNotesTable.ContactNotesTableControl ContactNotesTableControl;
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.ContactNotesTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_ContactNotesSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditContactNotesTable.ContactNotesTableControl control = new IPv5.UI.Controls.EditContactNotesTable.ContactNotesTableControl();
        
        return control.GetAutoCompletionList_ContactNotesSearch(prefixText, count);
