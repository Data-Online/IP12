<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Culture="en-US" Inherits="IPv5.UI.BaseApplicationPage" %>
...
<%@ Import Namespace="IPv5.Business" %>
<%@ Import Namespace="IPv5.Data" %>
			...
			<script runat="server">
			    ...
			    Protected Overridable Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			        ...
			        If Not IsNothing(pageType) AndAlso pageType.Equals("aspx", System.StringComparison.InvariantCultureIgnoreCase) Then
						...
						Dim rec() As ContactsRecord = ContactsTable.GetRecords(wc, Nothing, 0, 1)
						If rec.Length > 0 Then
							...
							End If
							pageURL = pageURL & "?" & "Contacts" & "=" & param
						End If
