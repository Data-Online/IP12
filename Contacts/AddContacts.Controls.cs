...
// AddContacts.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.AddContacts
{
...
// Base class for the ContactNotesTableControlRow control on the AddContacts page.
...
public class BaseContactNotesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        ContactsRecordControl parentCtrl;
            ...
            parentCtrl = (ContactsRecordControl)this.Page.FindControlRecursively("ContactsRecordControl");
...
// Base class for the ContactNotesTableControl control on the AddContacts page.
...
public class BaseContactNotesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.AddContacts.ContactsRecordControl contactsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ContactsRecordControl") as IPv5.UI.Controls.AddContacts.ContactsRecordControl);
...
#region "Helper Functions"
        ...
        public virtual ContactNotesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactNotesTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddContacts.ContactNotesTableControlRow")));
...
// Base class for the DirectorsTableControlRow control on the AddContacts page.
...
public class BaseDirectorsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void GetPropertyID()
        {
         // Retrieve the value entered by the user on the PropertyID ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.PropertyID), DirectorsTable.PropertyID);			
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.CheckBox DirectorsRecordRowSelection {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DirectorsRecordRowSelection");
            }
        }              
...
// Base class for the DirectorsTableControl control on the AddContacts page.
...
public class BaseDirectorsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            SaveControlsToSession_Ajax();
              ...
              // Show confirmation message on Click
              this.DirectorsDeleteButton.Attributes.Add("onClick", "return (confirm(\"" + ((BaseApplicationPage)this.Page).GetResourceValue("DeleteConfirm", "IPv5") + "\"));");
            // Setup the pagination events.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.DirectorsAddButton.Click += DirectorsAddButton_Click;
                        
                    this.DirectorsDeleteButton.Click += DirectorsDeleteButton_Click;
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetDirectorsAddButton();
              
                SetDirectorsDeleteButton();
    ...
    IPv5.UI.Controls.AddContacts.ContactsRecordControl contactsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ContactsRecordControl") as IPv5.UI.Controls.AddContacts.ContactsRecordControl);
      ...
      DirectorsRecord rec = new DirectorsRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.PropertyID)) {
                            rec.Parse(recControl.PropertyID.SelectedItem.Value, DirectorsTable.PropertyID);
                        }
              newUIDataList.Add(recControl.PreservedUIData());
              newRecordList.Add(rec);
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetDirectorsAddButton()                
        ...
        public virtual void SetDirectorsDeleteButton()                
        ...
        // event handler for ImageButton
        public virtual void DirectorsAddButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void DirectorsDeleteButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton DirectorsAddButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DirectorsAddButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton DirectorsDeleteButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DirectorsDeleteButton");
            }
        }
        ...
        public System.Web.UI.WebControls.CheckBox DirectorsToggleAll {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DirectorsToggleAll");
            }
        }              
...
#region "Helper Functions"
        ...
        public virtual int GetSelectedRecordIndex()
        {
            ...
            {
                if (recControl.DirectorsRecordRowSelection.Checked) {
                    return counter;
                }
                counter += 1;
            }
        ...
        public virtual DirectorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            foreach (DirectorsTableControlRow recControl in this.GetRecordControls())
            {
                if (recControl.DirectorsRecordRowSelection != null && recControl.DirectorsRecordRowSelection.Checked) {
                    selectedList.Add(recControl);
                }
            }
            return (DirectorsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddContacts.DirectorsTableControlRow")));
        ...
        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            ...
            foreach (DirectorsTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    ...
                    recCtl.DirectorsRecordRowSelection.Checked = false;
...
// Base class for the LinkTableTableControlRow control on the AddContacts page.
...
public class BaseLinkTableTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void GetPropertyID1()
        {
         // Retrieve the value entered by the user on the PropertyID ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.PropertyID1), LinkTableTable.PropertyID);			
      ...
      // To customize, override this method in LinkTableTableControlRow.
              ...
              
        {
              ...
              try
              {
                    ...
                    url = url + "?RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("NewWindow") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(this.PropertyID1.ClientID) + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("CompanyName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("PropertyID");                      
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.CheckBox LinkTableRecordRowSelection {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LinkTableRecordRowSelection");
            }
        }              
...
// Base class for the LinkTableTableControl control on the AddContacts page.
...
public class BaseLinkTableTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            SaveControlsToSession_Ajax();
              ...
              // Show confirmation message on Click
              this.LinkTableDeleteButton.Attributes.Add("onClick", "return (confirm(\"" + ((BaseApplicationPage)this.Page).GetResourceValue("DeleteConfirm", "IPv5") + "\"));");
            // Setup the pagination events.
       ...
       // Setup the sorting events.
              ...
              this.PropertyIDSortLabel1.Click += PropertyIDSortLabel1_Click;
            
            // Setup the button events.
          
                    this.LinkTableAddButton.Click += LinkTableAddButton_Click;
                        
                    this.LinkTableDeleteButton.Click += LinkTableDeleteButton_Click;
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetPropertyIDSortLabel1();
                SetLinkTableAddButton();
              
                SetLinkTableDeleteButton();
    ...
    IPv5.UI.Controls.AddContacts.ContactsRecordControl contactsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ContactsRecordControl") as IPv5.UI.Controls.AddContacts.ContactsRecordControl);
      ...
      LinkTableRecord rec = new LinkTableRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.PropertyID1)) {
                            rec.Parse(recControl.PropertyID1.SelectedItem.Value, LinkTableTable.PropertyID);
                        }
              newUIDataList.Add(recControl.PreservedUIData());
              newRecordList.Add(rec);
            }
        ...
        public virtual void SetPropertyIDSortLabel1()
                  {
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetLinkTableAddButton()                
        ...
        public virtual void SetLinkTableDeleteButton()                
        ...
        public virtual void PropertyIDSortLabel1_Click(object sender, EventArgs args)
        {
            //Sorts by PropertyID when clicked.
        ...
        // event handler for ImageButton
        public virtual void LinkTableAddButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void LinkTableDeleteButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton LinkTableAddButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LinkTableAddButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton LinkTableDeleteButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LinkTableDeleteButton");
            }
        }
        ...
        public System.Web.UI.WebControls.CheckBox LinkTableToggleAll {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LinkTableToggleAll");
            }
        }              
            
        public System.Web.UI.WebControls.LinkButton PropertyIDSortLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyIDSortLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual int GetSelectedRecordIndex()
        {
            ...
            {
                if (recControl.LinkTableRecordRowSelection.Checked) {
                    return counter;
                }
                counter += 1;
            }
        ...
        public virtual LinkTableTableControlRow[] GetSelectedRecordControls()
        {
            ...
            foreach (LinkTableTableControlRow recControl in this.GetRecordControls())
            {
                if (recControl.LinkTableRecordRowSelection != null && recControl.LinkTableRecordRowSelection.Checked) {
                    selectedList.Add(recControl);
                }
            }
            return (LinkTableTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddContacts.LinkTableTableControlRow")));
        ...
        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            ...
            foreach (LinkTableTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    ...
                    recCtl.LinkTableRecordRowSelection.Checked = false;
...
// Base class for the ContactsRecordControl control on the AddContacts page.
...
public class BaseContactsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public override void DataBind()
        {
            ...
            bool shouldResetControl = false;
            if (shouldResetControl) { }; // prototype usage to void compiler warnings
            ContactNotesTableControl recContactNotesTableControl = (ContactNotesTableControl)(MiscUtils.FindControlRecursively(this.Page, "ContactNotesTableControl"));
        
          if (shouldResetControl || this.Page.IsPageRefresh)
          {
             recContactNotesTableControl.ResetControl();
          }
                  
        this.Page.SetControl("ContactNotesTableControl");
        DirectorsTableControl recDirectorsTableControl = (DirectorsTableControl)(MiscUtils.FindControlRecursively(this.Page, "DirectorsTableControl"));
        
          if (shouldResetControl || this.Page.IsPageRefresh)
          {
             recDirectorsTableControl.ResetControl();
          }
                  
        this.Page.SetControl("DirectorsTableControl");
      ...
      // To customize, override this method in ContactsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in AddContacts"] = recId;
