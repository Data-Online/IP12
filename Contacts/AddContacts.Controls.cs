...
// Base class for the ContactNotesTableControl1Row control on the AddContacts page.
...
// Base class for the ContactNotesTableControl1 control on the AddContacts page.
...
#region "Helper Functions"
        ...
        public virtual ContactNotesTableControl1Row[] GetSelectedRecordControls()
        {
            ...
            return (ContactNotesTableControl1Row[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddContacts.ContactNotesTableControl1Row")));
