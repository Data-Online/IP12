...
// Base class for the ContactNotesTableControl1Row control on the EditContacts page.
...
public class BaseContactNotesTableControl1Row : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetNotes1()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.Notes1.ID))
            {
            
                this.Notes1.Text = this.PreviousUIData[this.Notes1.ID].ToString();
            ...
            // this.DataSource is the DatabaseMM_IP1%dbo.ContactNotes record retrieved from the database.
            // this.Notes1 is the ASP:TextBox on the webpage.
      ...
      // To customize, override this method in ContactNotesTableControl1Row.
        ...
        ContactNotesTableControl1 tc= ((ContactNotesTableControl1)MiscUtils.GetParentControlObject(this, "ContactNotesTableControl1"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((ContactNotesTableControl1Row)this);
                    }
                    this.Visible = false;
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox Notes1 {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Notes1");
            }
        }
...
// Base class for the ContactNotesTableControl1 control on the EditContacts page.
    ...
    ContactsRecordControl contactsRecordControlObj = (MiscUtils.GetParentControlObject(this, "ContactsRecordControl") as ContactsRecordControl);
      ...
      ContactNotesRecord rec = new ContactNotesRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("ContactNotesTableControl1Repeater");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (ContactNotesTableControl1Row recControl in this.GetRecordControls())
            {
        ...
        {
        ContactNotesTableControl1Row[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual ContactNotesTableControl1Row[] GetSelectedRecordControls()
        {
            ...
            return (ContactNotesTableControl1Row[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditContacts.ContactNotesTableControl1Row")));
...
public class BaseDirectorsTableControl : IPv5.UI.BaseApplicationTableControl
{
       ...
       public BaseDirectorsTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.PropertyIDFilter2)) 				
                    initialVal = this.GetFromSession(this.PropertyIDFilter2);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.PropertyIDFilter2.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.PropertyIDFilter2.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.PropertyIDFilter2.SelectedIndexChanged += new EventHandler(PropertyIDFilter2_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        public virtual void ResetControl()
        {
            ...
            this.PropertyIDFilter2.ClearSelection();
    ...
    ContactsRecordControl contactsRecordControlObj = (MiscUtils.GetParentControlObject(this, "ContactsRecordControl") as ContactsRecordControl);
      ...
      HttpContext.Current.Session["DirectorsTableControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
            ...
            if (MiscUtils.IsValueSelected(this.PropertyIDFilter2)) {
                        
                wc.iAND(DirectorsTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.PropertyIDFilter2, this.GetFromSession(this.PropertyIDFilter2)), false, false);
      ...
      String PropertyIDFilter2SelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "PropertyIDFilter2_Ajax"];
            if (MiscUtils.IsValueSelected(PropertyIDFilter2SelectedValue)) {

              
                wc.iAND(DirectorsTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, PropertyIDFilter2SelectedValue, false, false);
      ...
      DirectorsRecord rec = new DirectorsRecord();
        ...
        public virtual void SetPropertyIDLabel4()
                  {
        ...
        public virtual void SetPropertyIDFilter2()
        {
            
            this.PopulatePropertyIDFilter2(MiscUtils.GetSelectedValue(this.PropertyIDFilter2,  GetFromSession(this.PropertyIDFilter2)), 500);					
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl2.Items.Add(new ListItem(this.Page.ExpandResourceValue("Property {Txt:Ascending}"), "PropertyID Asc"));
              
                this.SortControl2.Items.Add(new ListItem(this.Page.ExpandResourceValue("Property {Txt:Descending}"), "PropertyID Desc"));
        ...
        // Get the filters' data for PropertyIDFilter2.
                
        protected virtual void PopulatePropertyIDFilter2(string selectedValue, int maxItems)
                    
        {
            ...
            this.PropertyIDFilter2.Items.Clear();
            WhereClause wc = this.CreateWhereClause_PropertyIDFilter2();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_PropertyIDFilter2 function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.PropertyIDFilter2.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "IPv5"), "--ANY--"));
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    ...
                    foreach (PropertiesRecord itemValue in itemValues) 
                    {
                        ...
                        {
                            cvalue = itemValue.PropertyID.ToString();
                            if (counter < maxItems && this.PropertyIDFilter2.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.PropertyIDFilter2.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.PropertyIDFilter2.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.PropertyIDFilter2, selectedValue);
            ...
            if (this.PropertyIDFilter2.SelectedValue != null && this.PropertyIDFilter2.Items.FindByValue(this.PropertyIDFilter2.SelectedValue) == null)
                this.PropertyIDFilter2.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_PropertyIDFilter2()
        {
            // Create a where clause for the filter PropertyIDFilter2.
            // This function is called by the Populate method to load the items 
            // in the PropertyIDFilter2DropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.PropertyIDFilter2, this.PropertyIDFilter2.SelectedValue);
      ...
      this.SaveToSession("PropertyIDFilter2_Ajax", this.PropertyIDFilter2.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.PropertyIDFilter2);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFilters2Button.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(PropertyIDFilter2))
        ...
        protected virtual void SortControl2_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  {
                  SelVal1 = SelVal1.Replace(words1[words1.Length - 1], "").TrimEnd();
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in DirectorsTable.GetColumns())
                  {
                  if (ColumnNam.Name.ToUpper().Equals(SelVal1))
                  {
                  SelVal1 = ColumnNam.InternalName;
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(DirectorsTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (DirectorsTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && DirectorsTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(DirectorsTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(DirectorsTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        // event handler for FieldFilter
        protected virtual void PropertyIDFilter2_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList PropertyIDFilter2 {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyIDFilter2");
            }
        }
        
        public System.Web.UI.WebControls.Literal PropertyIDLabel4 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyIDLabel4");
            }
        }
...
public class BaseLinkTableTableControl : IPv5.UI.BaseApplicationTableControl
{
       ...
       public BaseLinkTableTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.PropertyIDFilter1)) 				
                    initialVal = this.GetFromSession(this.PropertyIDFilter1);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.PropertyIDFilter1.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.PropertyIDFilter1.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.PropertyIDFilter1.SelectedIndexChanged += new EventHandler(PropertyIDFilter1_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        public virtual void ResetControl()
        {
            ...
            this.PropertyIDFilter1.ClearSelection();
    ...
    ContactsRecordControl contactsRecordControlObj = (MiscUtils.GetParentControlObject(this, "ContactsRecordControl") as ContactsRecordControl);
      ...
      HttpContext.Current.Session["LinkTableTableControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
            ...
            if (MiscUtils.IsValueSelected(this.PropertyIDFilter1)) {
                        
                wc.iAND(LinkTableTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.PropertyIDFilter1, this.GetFromSession(this.PropertyIDFilter1)), false, false);
      ...
      String PropertyIDFilter1SelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "PropertyIDFilter1_Ajax"];
            if (MiscUtils.IsValueSelected(PropertyIDFilter1SelectedValue)) {

              
                wc.iAND(LinkTableTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, PropertyIDFilter1SelectedValue, false, false);
      ...
      LinkTableRecord rec = new LinkTableRecord();
        ...
        public virtual void SetPropertyIDFilter1()
        {
            
            this.PopulatePropertyIDFilter1(MiscUtils.GetSelectedValue(this.PropertyIDFilter1,  GetFromSession(this.PropertyIDFilter1)), 500);					
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Property {Txt:Ascending}"), "PropertyID Asc"));
              
                this.SortControl1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Property {Txt:Descending}"), "PropertyID Desc"));
        ...
        // Get the filters' data for PropertyIDFilter1.
                
        protected virtual void PopulatePropertyIDFilter1(string selectedValue, int maxItems)
                    
        {
            ...
            this.PropertyIDFilter1.Items.Clear();
            WhereClause wc = this.CreateWhereClause_PropertyIDFilter1();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_PropertyIDFilter1 function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.PropertyIDFilter1.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "IPv5"), "--ANY--"));
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    ...
                    foreach (PropertiesRecord itemValue in itemValues) 
                    {
                        ...
                        {
                            cvalue = itemValue.PropertyID.ToString();
                            if (counter < maxItems && this.PropertyIDFilter1.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.PropertyIDFilter1.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.PropertyIDFilter1.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.PropertyIDFilter1, selectedValue);
            ...
            if (this.PropertyIDFilter1.SelectedValue != null && this.PropertyIDFilter1.Items.FindByValue(this.PropertyIDFilter1.SelectedValue) == null)
                this.PropertyIDFilter1.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_PropertyIDFilter1()
        {
            // Create a where clause for the filter PropertyIDFilter1.
            // This function is called by the Populate method to load the items 
            // in the PropertyIDFilter1DropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.PropertyIDFilter1, this.PropertyIDFilter1.SelectedValue);
      ...
      this.SaveToSession("PropertyIDFilter1_Ajax", this.PropertyIDFilter1.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.PropertyIDFilter1);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFilters1Button.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(PropertyIDFilter1))
        ...
        protected virtual void SortControl1_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  {
                  SelVal1 = SelVal1.Replace(words1[words1.Length - 1], "").TrimEnd();
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in LinkTableTable.GetColumns())
                  {
                  if (ColumnNam.Name.ToUpper().Equals(SelVal1))
                  {
                  SelVal1 = ColumnNam.InternalName;
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(LinkTableTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (LinkTableTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && LinkTableTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(LinkTableTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(LinkTableTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        // event handler for FieldFilter
        protected virtual void PropertyIDFilter1_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList PropertyIDFilter1 {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PropertyIDFilter1");
            }
        }
...
public class BaseContactsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetCityID()
        {
            ...
            // Set the CityID QuickSelector on the webpage with value from the
            // DatabaseMM_IP1%dbo.Contacts database record.
            
            // this.DataSource is the DatabaseMM_IP1%dbo.Contacts record retrieved from the database.
            // this.CityID is the ASP:QuickSelector on the webpage.
            ...
            if (selectedValue == null || selectedValue == "")
                  MiscUtils.ResetSelectedItem(this.CityID, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "IPv5"), "--PLEASE_SELECT--"));
                        
                  
            // Populate the item(s) to the control
            
            this.CityID.SetFieldMaxLength(50);
                ...
                !MiscUtils.SetSelectedDisplayText(this.CityID, selectedValue))
            {
              ...
              string url = this.ModifyRedirectUrl("../Cities/CitiesQuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.CityID.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("City")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("CityID")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldValueSingleSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.CityID.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(CityID.AutoPostBack).ToLower() + ", event); return false;";
        ...
        {
         // Retrieve the value entered by the user on the CityID ASP:QuickSelector, and
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector CityID {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CityID");
            }
        }              
