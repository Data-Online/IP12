...
// ShowContactsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowContactsTable
{
...
// Base class for the ContactsTableControlRow control on the ShowContactsTable page.
...
// Base class for the ContactsTableControl control on the ShowContactsTable page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ContactsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowContactsTable.ContactsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If ShowContactsTable.ContactsPDFButton.report specifies a valid report template,
        ...
        public virtual void ContactsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowContactsTable.ContactsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If ShowContactsTable.ContactsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowContactsTable.ContactsTableControlRow")));
...
// Base class for the CitiesRecordControl control on the ShowContactsTable page.
...
public class BaseCitiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        ContactsTableControlRow contactsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "ContactsTableControlRow") as ContactsTableControlRow);
              ...
              {
              wc.iAND(CitiesTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, contactsTableControlObjRow.GetRecord().CityID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInContactsTableControl = HttpContext.Current.Session["CitiesRecordControlWhereClause"] as string;
...
// Base class for the CountriesRecordControl control on the ShowContactsTable page.
...
public class BaseCountriesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        ContactsTableControlRow contactsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "ContactsTableControlRow") as ContactsTableControlRow);
              ...
              if (contactsTableControlObjRow != null && contactsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(CountriesTable.CountryID, BaseFilter.ComparisonOperator.EqualsTo, contactsTableControlObjRow.GetRecord().CountryID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInContactsTableControl = HttpContext.Current.Session["CountriesRecordControlWhereClause"] as string;
...
// Base class for the RegionsRecordControl control on the ShowContactsTable page.
...
public class BaseRegionsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        ContactsTableControlRow contactsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "ContactsTableControlRow") as ContactsTableControlRow);
              ...
              if (contactsTableControlObjRow != null && contactsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(RegionsTable.RegionID, BaseFilter.ComparisonOperator.EqualsTo, contactsTableControlObjRow.GetRecord().RegionID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInContactsTableControl = HttpContext.Current.Session["RegionsRecordControlWhereClause"] as string;
