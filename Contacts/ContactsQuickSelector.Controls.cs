...
// ContactsQuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ContactsQuickSelector
{
...
// Base class for the SelectorTableControlRow control on the ContactsQuickSelector page.
...
// Base class for the SelectorTableControl control on the ContactsQuickSelector page.
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ContactsQuickSelector.SelectorTableControlRow")));
