...
// Base class for the ContactBackgroundTableControlRow control on the ShowContacts page.
...
public class BaseContactBackgroundTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetCreatedOn()
        {
            ...
            if (this.DataSource != null && this.DataSource.CreatedOnSpecified) {
              ...
              this.CreatedOn.Text = ContactBackgroundTable.CreatedOn.Format(ContactBackgroundTable.CreatedOn.DefaultValue, @"g");
        ...
        public virtual void SetNotes()
        {
            ...
            if (this.DataSource != null && this.DataSource.NotesSpecified) {
               ...
               string formattedValue = this.DataSource.Format(ContactBackgroundTable.Notes);
                ...
                if(formattedValue != null){
                    ...
                    if (originalLength >= popupThreshold) {
                        String name = HttpUtility.HtmlEncode(ContactBackgroundTable.Notes.Name);
                        ...
                        formattedValue = "<a onclick=\'gPersist=true;\' class=\'truncatedText\' onmouseout=\'detailRolloverPopupClose();\' " +
                            "onmouseover=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"" + "NULL" + "\\\", \\\"IPv5.Business.ContactBackgroundTable, IPv5.Business\\\",\\\"" +
              ...
              this.Notes.Text = ContactBackgroundTable.Notes.Format(ContactBackgroundTable.Notes.DefaultValue);
...
// Base class for the ContactBackgroundTableControl control on the ShowContacts page.
...
public class BaseContactBackgroundTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    ContactsRecordControl contactsRecordControlObj = (MiscUtils.GetParentControlObject(this, "ContactsRecordControl") as ContactsRecordControl);
      ...
      ContactBackgroundRecord rec = new ContactBackgroundRecord();
                        ...
                        if (recControl.CreatedOn.Text != "") {
                            rec.Parse(recControl.CreatedOn.Text, ContactBackgroundTable.CreatedOn);
                  }
                
                        if (recControl.Notes.Text != "") {
                            rec.Parse(recControl.Notes.Text, ContactBackgroundTable.Notes);
                  }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void CreatedOnLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(ContactBackgroundTable.CreatedOn);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(ContactBackgroundTable.CreatedOn, OrderByItem.OrderDir.Asc);
        ...
        public virtual void NotesLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(ContactBackgroundTable.Notes);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(ContactBackgroundTable.Notes, OrderByItem.OrderDir.Asc);
...
#region "Helper Functions"
        ...
        public virtual ContactBackgroundTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactBackgroundTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowContacts.ContactBackgroundTableControlRow")));
...
public class BaseContactNotesTableControl1 : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.CreatedOnLabel1.Click += CreatedOnLabel1_Click;
            
              this.NotesLabel1.Click += NotesLabel1_Click;
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void CreatedOnLabel1_Click(object sender, EventArgs args)
        {
            //Sorts by CreatedOn when clicked.
              
            // Get previous sorting state for CreatedOn.
        
            OrderByItem sd = this.CurrentSortOrder.Find(ContactNotesTable.CreatedOn);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for CreatedOn.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(ContactNotesTable.CreatedOn, OrderByItem.OrderDir.Asc);
        ...
        public virtual void NotesLabel1_Click(object sender, EventArgs args)
        {
            //Sorts by Notes when clicked.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton CreatedOnLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CreatedOnLabel1");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton NotesLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "NotesLabel1");
            }
        }
...
// Base class for the DirectorsTableControlRow control on the ShowContacts page.
...
public class BaseDirectorsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPropertyID1()
        {
            ...
            if (this.DataSource != null && this.DataSource.PropertyIDSpecified) {
              ...
              this.PropertyID1.Text = DirectorsTable.PropertyID.Format(DirectorsTable.PropertyID.DefaultValue);
      ...
      // To customize, override this method in DirectorsTableControlRow.
        ...
        public virtual void PropertyID1_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/GroupByPropertiesTable.aspx?Properties={DirectorsTableControlRow:FK:FK_Directors_Properties}";
...
// Base class for the DirectorsTableControl control on the ShowContacts page.
    ...
    ContactsRecordControl contactsRecordControlObj = (MiscUtils.GetParentControlObject(this, "ContactsRecordControl") as ContactsRecordControl);
      ...
      DirectorsRecord rec = new DirectorsRecord();
                        ...
                        if (recControl.PropertyID1.Text != "") {
                            rec.Parse(recControl.PropertyID1.Text, DirectorsTable.PropertyID);
                  }
...
#region "Helper Functions"
        ...
        public virtual DirectorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (DirectorsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowContacts.DirectorsTableControlRow")));
...
// Base class for the LinkTableTableControlRow control on the ShowContacts page.
...
// Base class for the LinkTableTableControl control on the ShowContacts page.
...
#region "Helper Functions"
        ...
        public virtual LinkTableTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (LinkTableTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowContacts.LinkTableTableControlRow")));
...
public class BaseContactsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetCityID1()
        {
            ...
            // this.DataSource is the DatabaseMM_IP1%dbo.Contacts record retrieved from the database.
            // this.CityID1 is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.CityIDSpecified) {
              ...
              this.CityID1.Text = ContactsTable.CityID.Format(ContactsTable.CityID.DefaultValue);
            		
            }
            
            // If the CityID is NULL or blank, then use the value specified  
            // on Properties.
            if (this.CityID1.Text == null ||
                this.CityID1.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.CityID1.Text = "&nbsp;";
            }
        ...
        public virtual void SetCountryID1()
        {
            ...
            // this.DataSource is the DatabaseMM_IP1%dbo.Contacts record retrieved from the database.
            // this.CountryID1 is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.CountryIDSpecified) {
              ...
              this.CountryID1.Text = ContactsTable.CountryID.Format(ContactsTable.CountryID.DefaultValue);
            		
            }
            
            // If the CountryID is NULL or blank, then use the value specified  
            // on Properties.
            if (this.CountryID1.Text == null ||
                this.CountryID1.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.CountryID1.Text = "&nbsp;";
            }
                                     
        }
                
        public virtual void SetDateOfBirth1()
        {
            ...
            // this.DataSource is the DatabaseMM_IP1%dbo.Contacts record retrieved from the database.
            // this.DateOfBirth1 is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.DateOfBirthSpecified) {
               ...
               string formattedValue = this.DataSource.Format(ContactsTable.DateOfBirth, @"d");
                ...
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.DateOfBirth1.Text = formattedValue;
              ...
              this.DateOfBirth1.Text = ContactsTable.DateOfBirth.Format(ContactsTable.DateOfBirth.DefaultValue, @"d");
            		
            }
            
            // If the DateOfBirth is NULL or blank, then use the value specified  
            // on Properties.
            if (this.DateOfBirth1.Text == null ||
                this.DateOfBirth1.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.DateOfBirth1.Text = "&nbsp;";
            }
        ...
        public virtual void SetPlaceOfBirth1()
        {
            ...
            // this.DataSource is the DatabaseMM_IP1%dbo.Contacts record retrieved from the database.
            // this.PlaceOfBirth1 is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.PlaceOfBirthSpecified) {
               ...
               string formattedValue = this.DataSource.Format(ContactsTable.PlaceOfBirth);
                ...
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.PlaceOfBirth1.Text = formattedValue;
              ...
              this.PlaceOfBirth1.Text = ContactsTable.PlaceOfBirth.Format(ContactsTable.PlaceOfBirth.DefaultValue);
            		
            }
            
            // If the PlaceOfBirth is NULL or blank, then use the value specified  
            // on Properties.
            if (this.PlaceOfBirth1.Text == null ||
                this.PlaceOfBirth1.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.PlaceOfBirth1.Text = "&nbsp;";
            }
        ...
        public virtual void SetRegionID1()
        {
            ...
            // this.DataSource is the DatabaseMM_IP1%dbo.Contacts record retrieved from the database.
            // this.RegionID1 is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.RegionIDSpecified) {
              ...
              this.RegionID1.Text = ContactsTable.RegionID.Format(ContactsTable.RegionID.DefaultValue);
            		
            }
            
            // If the RegionID is NULL or blank, then use the value specified  
            // on Properties.
            if (this.RegionID1.Text == null ||
                this.RegionID1.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.RegionID1.Text = "&nbsp;";
            }
        ...
        public virtual void SetDateOfBirthLabel1()
                  {
        ...
        public virtual void SetIrdNumberLabel2()
                  {
        ...
        public virtual void GetDateOfBirth1()
        {
        ...
        public virtual void GetPlaceOfBirth1()
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal CityID1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CityID1");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal CountryID1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CountryID1");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal DateOfBirth1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DateOfBirth1");
            }
        }
            
        public System.Web.UI.WebControls.Literal DateOfBirthLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DateOfBirthLabel1");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal IrdNumberLabel2 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "IrdNumberLabel2");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal PlaceOfBirth1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PlaceOfBirth1");
            }
        }
            
        public System.Web.UI.WebControls.Literal PlaceOfBirthLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PlaceOfBirthLabel1");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal RegionID1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionID1");
            }
        }
