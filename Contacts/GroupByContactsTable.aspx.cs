...
// This file implements the code-behind class for GroupByContactsTable.aspx.
// GroupByContactsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByContactsTable
        : BaseApplicationPage
// Code-behind class for the GroupByContactsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByContactsTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_ContactsSearch(string prefixText, int count)
        {
            ...
            // Customize by adding code before or after the call to  GetAutoCompletionList_ContactsSearch_Base()
            // or replace the call to GetAutoCompletionList_ContactsSearch_Base().
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButton ContactsFilterButton;
        ...
        public IPv5.UI.Controls.GroupByContactsTable.ContactsTableControl ContactsTableControl;
    ...
    public static string[] GetAutoCompletionList_ContactsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByContactsTable.ContactsTableControl control = new IPv5.UI.Controls.GroupByContactsTable.ContactsTableControl();
