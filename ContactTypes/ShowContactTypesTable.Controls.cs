...
// ShowContactTypesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowContactTypesTable
{
...
// Base class for the ContactTypesTableControlRow control on the ShowContactTypesTable page.
...
// Base class for the ContactTypesTableControl control on the ShowContactTypesTable page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ContactTypesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowContactTypesTable.ContactTypesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "ContactTypes";
                // If ShowContactTypesTable.ContactTypesPDFButton.report specifies a valid report template,
        ...
        public virtual void ContactTypesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowContactTypesTable.ContactTypesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "ContactTypes";
                // If ShowContactTypesTable.ContactTypesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ContactTypesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactTypesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowContactTypesTable.ContactTypesTableControlRow")));
