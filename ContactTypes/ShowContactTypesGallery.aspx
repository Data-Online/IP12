...
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.ShowContactTypesGallery" Assembly="IPv5" %>

<%@ Register Tagprefix="Selectors" Namespace="IPv5" Assembly="IPv5" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowContactTypesGallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.ShowContactTypesGallery" %>
...
<asp:DropDownList runat="server" id="ContactTypeFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("ContactTypesFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="ContactTypesTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="ContactTypesTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3">&nbsp;</th></tr><asp:Repeater runat="server" id="ContactTypesTableControlRepeater">		<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="ContactTypesTableControlCellRepeater">		<ITEMTEMPLATE>		<IPv5:ContactTypesTableControlRow runat="server" id="ContactTypesTableControlRow">
<td class="galleryttc" style="width:33%;"><asp:LinkButton runat="server" id="ContactType" causesvalidation="False" commandname="Redirect"></asp:LinkButton> <br />
</td></IPv5:ContactTypesTableControlRow>
</ITEMTEMPLATE>
