...
// This file implements the code-behind class for EditContactTypes.aspx.
// EditContactTypes.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditContactTypes
        : BaseApplicationPage
// Code-behind class for the EditContactTypes page.
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditContactTypes.ContactTypesRecordControl ContactTypesRecordControl;
        ...
        public IPv5.UI.Controls.EditContactTypes.PropertyContactsTableControl PropertyContactsTableControl;
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.ContactTypesRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        {        
            if (ContactTypesRecordControl.Visible)
            {
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ContactTypesRecordControl != null && this.ContactTypesRecordControl.DataSource != null)
                  {
                        id = this.ContactTypesRecordControl.DataSource.GetValue(this.ContactTypesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ContactTypesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ContactTypesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ContactTypesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ContactTypesRecordControl.DataSource.GetValue(this.ContactTypesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
