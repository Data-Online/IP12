...
// EditContactTypesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditContactTypesTable
{
...
// Base class for the ContactTypesTableControlRow control on the EditContactTypesTable page.
...
public class BaseContactTypesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.ContactTypesRowViewButton.Click += ContactTypesRowViewButton_Click;
                        
              this.ContactType.TextChanged += ContactType_TextChanged;
        ...
        public virtual void SetContactType()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.ContactType.ID))
            {
            
                this.ContactType.Text = this.PreviousUIData[this.ContactType.ID].ToString();
              
                return;
            }
            
                    
            // Set the ContactType TextBox on the webpage with value from the
            ...
            // this.ContactType is the ASP:TextBox on the webpage.
        ...
        public virtual void GetContactType()
        {
            ...
            // Retrieve the value entered by the user on the ContactType ASP:TextBox, and
            // save it into the ContactType field in DataSource DatabaseMM_IP1%dbo.ContactTypes record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.ContactType.Text, ContactTypesTable.ContactType);							
      ...
      // To customize, override this method in ContactTypesTableControlRow.
        ...
        public virtual void SetContactTypesRowViewButton()                
        ...
        ContactTypesTableControl tc= ((ContactTypesTableControl)MiscUtils.GetParentControlObject(this, "ContactTypesTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((ContactTypesTableControlRow)this);
                    }
                    this.Visible = false;
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void ContactTypesRowViewButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void ContactType_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox ContactType {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContactType");
            }
        }
        ...
        public System.Web.UI.WebControls.CheckBox ContactTypesRecordRowSelection {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContactTypesRecordRowSelection");
            }
        }              
        ...
        public System.Web.UI.WebControls.ImageButton ContactTypesRowViewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContactTypesRowViewButton");
            }
        }
...
// Base class for the ContactTypesTableControl control on the EditContactTypesTable page.
...
public class BaseContactTypesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            SaveControlsToSession_Ajax();
              ...
              // Show confirmation message on Click
              this.ContactTypesDeleteButton.Attributes.Add("onClick", "return (confirm(\"" + ((BaseApplicationPage)this.Page).GetResourceValue("DeleteConfirm", "IPv5") + "\"));");
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.ContactTypesAddButton.Click += ContactTypesAddButton_Click;
                        
                    this.ContactTypesDeleteButton.Click += ContactTypesDeleteButton_Click;
                        
                    this.ContactTypesResetButton.Click += ContactTypesResetButton_Click;
                        
                    this.ContactTypesSaveButton.Click += ContactTypesSaveButton_Click;
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetContactTypesAddButton();
              
                SetContactTypesDeleteButton();
              
                SetContactTypesResetButton();
              
                SetContactTypesSaveButton();
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"ContactTypesSaveButton"));
      ...
      ContactTypesRecord rec = new ContactTypesRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("ContactTypesTableControlRepeater");
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetContactTypesAddButton()                
        ...
        public virtual void SetContactTypesDeleteButton()                
        ...
        public virtual void SetContactTypesSaveButton()                
              
        {
        
                    this.ContactTypesSaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.Page.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
        ...
        // event handler for ImageButton
        public virtual void ContactTypesAddButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void ContactTypesDeleteButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void ContactTypesSaveButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton ContactTypesAddButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContactTypesAddButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton ContactTypesDeleteButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContactTypesDeleteButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton ContactTypesSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContactTypesSaveButton");
            }
        }
        ...
        public System.Web.UI.WebControls.CheckBox ContactTypesToggleAll {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContactTypesToggleAll");
            }
        }              
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (ContactTypesTableControlRow recControl in this.GetRecordControls())
            {
                if (recControl.ContactTypesRecordRowSelection.Checked) {
                    return counter;
                }
                counter += 1;
            }
        ...
        {
        ContactTypesTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual ContactTypesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            foreach (ContactTypesTableControlRow recControl in this.GetRecordControls())
            {
                if (recControl.ContactTypesRecordRowSelection != null && recControl.ContactTypesRecordRowSelection.Checked) {
                    selectedList.Add(recControl);
                }
            }
            return (ContactTypesTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditContactTypesTable.ContactTypesTableControlRow")));
        ...
        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            ...
            foreach (ContactTypesTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    ...
                    recCtl.ContactTypesRecordRowSelection.Checked = false;
