...
// AddContactTypes.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.AddContactTypes
{
...
// Base class for the PropertyContactsTableControlRow control on the AddContactTypes page.
...
// Base class for the PropertyContactsTableControl control on the AddContactTypes page.
...
public class BasePropertyContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.AddContactTypes.ContactTypesRecordControl contactTypesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ContactTypesRecordControl") as IPv5.UI.Controls.AddContactTypes.ContactTypesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddContactTypes.PropertyContactsTableControlRow")));
...
// Base class for the ContactTypesRecordControl control on the AddContactTypes page.
...
public class BaseContactTypesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (ContactTypesRecord)ContactTypesRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in ContactTypesRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["ContactTypes"];
            ...
            HttpContext.Current.Session["QueryString in AddContactTypes"] = recId;
