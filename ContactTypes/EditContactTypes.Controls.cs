...
// EditContactTypes.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditContactTypes
{
...
// Base class for the PropertyContactsTableControlRow control on the EditContactTypes page.
...
// Base class for the PropertyContactsTableControl control on the EditContactTypes page.
...
public class BasePropertyContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.EditContactTypes.ContactTypesRecordControl contactTypesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ContactTypesRecordControl") as IPv5.UI.Controls.EditContactTypes.ContactTypesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditContactTypes.PropertyContactsTableControlRow")));
...
// Base class for the ContactTypesRecordControl control on the EditContactTypes page.
...
public class BaseContactTypesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in ContactTypesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditContactTypes"] = recId;
