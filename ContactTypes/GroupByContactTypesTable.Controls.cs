...
// GroupByContactTypesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByContactTypesTable
{
...
// Base class for the ContactTypesTableControlRow control on the GroupByContactTypesTable page.
...
public class BaseContactTypesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.ContactTypesRowDeleteButton.Attributes.Add("onClick", "return (confirm(\"" + ((BaseApplicationPage)this.Page).GetResourceValue("DeleteRecordConfirm", "IPv5") + "\"));");            
        
              // Register the event handlers.

          
                    this.ContactTypesRowDeleteButton.Click += ContactTypesRowDeleteButton_Click;
                        
                    this.ContactTypesRowEditButton.Click += ContactTypesRowEditButton_Click;
                        
                    this.ContactTypesRowExpandCollapseRowButton.Click += ContactTypesRowExpandCollapseRowButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetContactTypesRowDeleteButton();
              
                SetContactTypesRowEditButton();
              
                SetContactTypesRowExpandCollapseRowButton();
        ...
        public virtual void SetContactTypesTabContainer()    
      ...
      // To customize, override this method in ContactTypesTableControlRow.
        ...
        public virtual void SetContactTypesRowDeleteButton()                
        ...
        public virtual void SetContactTypesRowEditButton()                
        ...
        public virtual void SetContactTypesRowExpandCollapseRowButton()                
        ...
        public virtual void ContactTypesRowDeleteButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.CommitTransaction(sender);
        ...
        // event handler for ImageButton
        public virtual void ContactTypesRowEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void ContactTypesRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                ContactTypesTableControl panelControl = (MiscUtils.GetParentControlObject(this, "ContactTypesTableControl") as ContactTypesTableControl);

          ContactTypesTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (ContactTypesTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "ContactTypesTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.ContactTypesRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.ContactTypesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.ContactTypesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.ContactTypesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.ContactTypesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.ContactTypesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.ContactTypesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton ContactTypesRowDeleteButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContactTypesRowDeleteButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton ContactTypesRowEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContactTypesRowEditButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton ContactTypesRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContactTypesRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer ContactTypesTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContactTypesTabContainer");
            }
        }
...
// Base class for the ContactTypesTableControl control on the GroupByContactTypesTable page.
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return ContactTypesTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            ContactTypesTableControlRow recControl = (ContactTypesTableControlRow)(repItem.FindControl("ContactTypesTableControlRow"));
        ...
        ContactTypesTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "ContactTypesTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].ContactTypesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].ContactTypesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].ContactTypesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].ContactTypesRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].ContactTypesRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].ContactTypesRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ContactTypesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByContactTypesTable.ContactTypesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "ContactTypes";
                // If GroupByContactTypesTable.ContactTypesPDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${ContactType}", record.Format(ContactTypesTable.ContactType), ReportEnum.Align.Left, 100);
        ...
        public virtual void ContactTypesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByContactTypesTable.ContactTypesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "ContactTypes";
                // If GroupByContactTypesTable.ContactTypesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ContactTypesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactTypesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByContactTypesTable.ContactTypesTableControlRow")));
...
// Base class for the PropertyContactsTableControlRow control on the GroupByContactTypesTable page.
...
public class BasePropertyContactsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        ContactTypesTableControlRow parentCtrl;
      
            parentCtrl = (ContactTypesTableControlRow)MiscUtils.GetParentControlObject(this, "ContactTypesTableControlRow");
...
// Base class for the PropertyContactsTableControl control on the GroupByContactTypesTable page.
...
public class BasePropertyContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue contactTypesRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = contactTypesRecordObj;
          contactTypesRecordObj = tmp;
        ContactTypesTableControlRow contactTypesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "ContactTypesTableControlRow") as ContactTypesTableControlRow);
          
              if (contactTypesTableControlObjRow != null && contactTypesTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertyContactsTable.ContactTypeID, BaseFilter.ComparisonOperator.EqualsTo, contactTypesTableControlObjRow.GetRecord().ContactTypeID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInContactTypesTableControl = HttpContext.Current.Session["PropertyContactsTableControlWhereClause"] as string;
      
      if (selectedRecordInContactTypesTableControl != null && KeyValue.IsXmlKey(selectedRecordInContactTypesTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInContactTypesTableControl);
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByContactTypesTable.PropertyContactsTableControlRow")));
