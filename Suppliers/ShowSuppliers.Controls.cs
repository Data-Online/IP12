...
// ShowSuppliers.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowSuppliers
{
...
// Base class for the SuppliersRecordControl control on the ShowSuppliers page.
...
public class BaseSuppliersRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.SuppliersDialogEditButton.Click += SuppliersDialogEditButton_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "SuppliersRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = SuppliersTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in SuppliersRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Suppliers"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "Suppliers"));
            }
            HttpContext.Current.Session["QueryString in ShowSuppliers"] = recId;
        ...
        public virtual void SetSuppliersDialogEditButton()                
        ...
        public virtual void SuppliersDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void CityID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Cities/ShowCities.aspx?Cities={SuppliersRecordControl:FK:FK_Suppliers_Cities}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ServiceTypeID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../ServiceTypes/ShowServiceTypes.aspx?ServiceTypes={SuppliersRecordControl:FK:FK_Suppliers_ServiceTypes}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton SuppliersDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SuppliersDialogEditButton");
            }
        }
