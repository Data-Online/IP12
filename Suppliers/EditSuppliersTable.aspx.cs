...
// This file implements the code-behind class for EditSuppliersTable.aspx.
// EditSuppliersTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditSuppliersTable
        : BaseApplicationPage
// Code-behind class for the EditSuppliersTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditSuppliersTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_SuppliersSearch(string prefixText, int count)
        {
            // GetSuppliersSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_SuppliersSearch_Base()
            // or replace the call to GetAutoCompletionList_SuppliersSearch_Base().
            return GetAutoCompletionList_SuppliersSearch_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButton SuppliersFilterButton;
        ...
        public IPv5.UI.Controls.EditSuppliersTable.SuppliersTableControl SuppliersTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Suppliers");
      ...
      public void SaveData_Base()
      {
        ...
        this.SuppliersTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SuppliersSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditSuppliersTable.SuppliersTableControl control = new IPv5.UI.Controls.EditSuppliersTable.SuppliersTableControl();
        
        return control.GetAutoCompletionList_SuppliersSearch(prefixText, count);
        ...
        SetSuppliersTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "SuppliersMenuItem";
                    }
                }
