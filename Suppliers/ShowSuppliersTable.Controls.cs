...
// ShowSuppliersTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowSuppliersTable
{
...
// Base class for the SuppliersTableControlRow control on the ShowSuppliersTable page.
...
public class BaseSuppliersTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.SuppliersRowExpandCollapseRowButton.Click += SuppliersRowExpandCollapseRowButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetSuppliersTabContainer();
                SetSuppliersRowDeleteButton();
              
                SetSuppliersRowEditButton();
              
                SetSuppliersRowExpandCollapseRowButton();
        ...
        public virtual void SetSuppliersTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "SuppliersTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "SuppliersTabContainer").Visible = false;
        ...
        public virtual void SetServiceTypesRecordControl()           
        
        {        
            if (ServiceTypesRecordControl.Visible)
            {
        ...
        ServiceTypesRecordControl recServiceTypesRecordControl = (ServiceTypesRecordControl)(MiscUtils.FindControlRecursively(this, "ServiceTypesRecordControl"));
        recServiceTypesRecordControl.SaveData();
      ...
      // To customize, override this method in SuppliersTableControlRow.
        ...
        public virtual void SetSuppliersRowExpandCollapseRowButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void SuppliersRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                SuppliersTableControl panelControl = (MiscUtils.GetParentControlObject(this, "SuppliersTableControl") as SuppliersTableControl);

          SuppliersTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (SuppliersTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "SuppliersTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.SuppliersRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.SuppliersRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.SuppliersRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.SuppliersRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.SuppliersRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.SuppliersRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.SuppliersRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
...
#region "Helper Properties"
        ...
        public ServiceTypesRecordControl ServiceTypesRecordControl {
            get {
                return (ServiceTypesRecordControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ServiceTypesRecordControl");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton SuppliersRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SuppliersRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer SuppliersTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SuppliersTabContainer");
            }
        }
...
// Base class for the SuppliersTableControl control on the ShowSuppliersTable page.
...
public class BaseSuppliersTableControl : IPv5.UI.BaseApplicationTableControl
{
       ...
       public BaseSuppliersTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.ServiceTypeIDFilter)) 				
                    initialVal = this.GetFromSession(this.ServiceTypeIDFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"ServiceTypeID\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.ServiceTypeIDFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.ServiceTypeIDFilter.SelectedValue = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.SuppliersSearch)) 				
                    initialVal = this.GetFromSession(this.SuppliersSearch);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.SuppliersSearch.Text = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.SuppliersResetButton.Click += SuppliersResetButton_Click;
                        
                    this.SuppliersSearchButton.Click += SuppliersSearchButton_Click;
                    ...
                    this.SuppliersFilterButton.Button.Click += SuppliersFilterButton_Click;
            ...
            this.ServiceTypeIDFilter.SelectedIndexChanged += new EventHandler(ServiceTypeIDFilter_SelectedIndexChanged);
                    
        
         //' Setup events for others
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "SuppliersSearchSearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + SuppliersSearch.ClientID + "\");", true);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetSuppliersResetButton();
              
                SetSuppliersSearchButton();
              
                SetSuppliersWordButton();
              
                SetSuppliersButtonsButton();
              
                SetSuppliersFilterButton();
        ...
        SuppliersTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "SuppliersTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].SuppliersRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].SuppliersRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].SuppliersRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].SuppliersRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].SuppliersRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].SuppliersRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.ServiceTypeIDFilter.ClearSelection();
            
            this.SuppliersSearch.Text = "";
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.CityIDFilter)) {
                ...
                wc.iAND(SuppliersTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.CityIDFilter, this.GetFromSession(this.CityIDFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.ServiceTypeIDFilter)) {
                        
                wc.iAND(SuppliersTable.ServiceTypeID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ServiceTypeIDFilter, this.GetFromSession(this.ServiceTypeIDFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.SuppliersSearch)) {
                if (this.SuppliersSearch.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.SuppliersSearch.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.SuppliersSearch.Text.StartsWith("...")) {
                      this.SuppliersSearch.Text = this.SuppliersSearch.Text.Substring(3,this.SuppliersSearch.Text.Length-3);
                  }
                  if (this.SuppliersSearch.Text.EndsWith("...")) {
                      this.SuppliersSearch.Text = this.SuppliersSearch.Text.Substring(0,this.SuppliersSearch.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.SuppliersSearch.Text.Length - 1;
                      while (!Char.IsWhiteSpace(SuppliersSearch.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.SuppliersSearch.Text = this.SuppliersSearch.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.SuppliersSearch, this.GetFromSession(this.SuppliersSearch));
      ...
      cols.Add(SuppliersTable.CompanyName, true);
      
      cols.Add(SuppliersTable.ContactName, true);
      
      foreach(BaseColumn col in cols)
      {
      
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.SuppliersSearch, this.GetFromSession(this.SuppliersSearch)), true, false);
      ...
      String CityIDFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CityIDFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CityIDFilterSelectedValue)) {
                ...
                wc.iAND(SuppliersTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, CityIDFilterSelectedValue, false, false);
                      
      }
                      
      String ServiceTypeIDFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ServiceTypeIDFilter_Ajax"];
            if (MiscUtils.IsValueSelected(ServiceTypeIDFilterSelectedValue)) {

              
                wc.iAND(SuppliersTable.ServiceTypeID, BaseFilter.ComparisonOperator.EqualsTo, ServiceTypeIDFilterSelectedValue, false, false);
                      
      }
                      
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "SuppliersSearch") {
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SuppliersSearch(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"SuppliersSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
            IPv5.Business.SuppliersRecord[] recordList  = SuppliersTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (SuppliersRecord rec in recordList ){
                ...
                resultItem = rec.Format(SuppliersTable.CompanyName);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(SuppliersTable.CompanyName.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, SuppliersTable.CompanyName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(SuppliersTable.ContactName);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(SuppliersTable.ContactName.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, SuppliersTable.ContactName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      SuppliersRecord rec = new SuppliersRecord();
        ...
        public virtual void SetServiceTypeIDFilter()
        {
            
            this.PopulateServiceTypeIDFilter(MiscUtils.GetSelectedValue(this.ServiceTypeIDFilter,  GetFromSession(this.ServiceTypeIDFilter)), 500);					
                                     
        }
            
        public virtual void SetSuppliersSearch()
        {
                                            
            this.SuppliersSearch.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.SuppliersSearch.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
        ...
        // Get the filters' data for ServiceTypeIDFilter.
                
        protected virtual void PopulateServiceTypeIDFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.ServiceTypeIDFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_ServiceTypeIDFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_ServiceTypeIDFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.ServiceTypeIDFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "IPv5"), "--ANY--"));
                ...
                do
                {
                    ...
                    foreach (ServiceTypesRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.ServiceTypeIDSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.ServiceTypeIDFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.ServiceTypeIDFilter.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.ServiceTypeIDFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.ServiceTypeIDFilter, selectedValue);
            ...
            if (this.ServiceTypeIDFilter.SelectedValue != null && this.ServiceTypeIDFilter.Items.FindByValue(this.ServiceTypeIDFilter.SelectedValue) == null)
                this.ServiceTypeIDFilter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_ServiceTypeIDFilter()
        {
            // Create a where clause for the filter ServiceTypeIDFilter.
            // This function is called by the Populate method to load the items 
            // in the ServiceTypeIDFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.ServiceTypeIDFilter, this.ServiceTypeIDFilter.SelectedValue);
                  
            this.SaveToSession(this.SuppliersSearch, this.SuppliersSearch.Text);
      ...
      this.SaveToSession("ServiceTypeIDFilter_Ajax", this.ServiceTypeIDFilter.SelectedValue);
              
      this.SaveToSession("SuppliersSearch_Ajax", this.SuppliersSearch.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.ServiceTypeIDFilter);
            this.RemoveFromSession(this.SuppliersSearch);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetSuppliersResetButton()                
        ...
        public virtual void SetSuppliersSearchButton()                
        ...
        public virtual void SetSuppliersFilterButton()                
              ...
              
        {
         ...
         themeButtonSuppliersFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(CityIDFilter))
                themeButtonSuppliersFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        
            if (MiscUtils.IsValueSelected(ServiceTypeIDFilter))
                themeButtonSuppliersFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void SuppliersPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowSuppliersTable.SuppliersPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Suppliers";
                // If ShowSuppliersTable.SuppliersPDFButton.report specifies a valid report template,
        ...
        // event handler for ImageButton
        public virtual void SuppliersResetButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void SuppliersSearchButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        public virtual void SuppliersWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowSuppliersTable.SuppliersWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Suppliers";
                // If ShowSuppliersTable.SuppliersWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        // event handler for Button
        public virtual void SuppliersFilterButton_Click(object sender, EventArgs args)
        {
        ...
        // event handler for FieldFilter
        protected virtual void ServiceTypeIDFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList ServiceTypeIDFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ServiceTypeIDFilter");
            }
        }
        ...
        public IPv5.UI.IThemeButton SuppliersFilterButton {
            get {
                return (IPv5.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SuppliersFilterButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton SuppliersResetButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SuppliersResetButton");
            }
        }
        
        public System.Web.UI.WebControls.TextBox SuppliersSearch {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SuppliersSearch");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton SuppliersSearchButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SuppliersSearchButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual SuppliersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SuppliersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowSuppliersTable.SuppliersTableControlRow")));
...
// Base class for the CitiesRecordControl control on the ShowSuppliersTable page.
...
public class BaseCitiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          SuppliersTableControlRow parentCtrl;
      
            parentCtrl = (SuppliersTableControlRow)MiscUtils.GetParentControlObject(this, "SuppliersTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue suppliersRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = suppliersRecordObj;
          suppliersRecordObj = tmp;
        SuppliersTableControlRow suppliersTableControlObjRow = (MiscUtils.GetParentControlObject(this, "SuppliersTableControlRow") as SuppliersTableControlRow);
          
              if (suppliersTableControlObjRow != null && suppliersTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(CitiesTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, suppliersTableControlObjRow.GetRecord().CityID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInSuppliersTableControl = HttpContext.Current.Session["CitiesRecordControlWhereClause"] as string;
      
      if (selectedRecordInSuppliersTableControl != null && KeyValue.IsXmlKey(selectedRecordInSuppliersTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInSuppliersTableControl);
...
// Base class for the ServiceTypesRecordControl control on the ShowSuppliersTable page.
...
public class BaseServiceTypesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "ServiceTypesRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            // Set DataSource based on record retrieved from the database.
            this.DataSource = ServiceTypesTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        SuppliersTableControlRow suppliersTableControlObjRow = (MiscUtils.GetParentControlObject(this, "SuppliersTableControlRow") as SuppliersTableControlRow);
              ...
              if (suppliersTableControlObjRow != null && suppliersTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(ServiceTypesTable.ServiceTypeID, BaseFilter.ComparisonOperator.EqualsTo, suppliersTableControlObjRow.GetRecord().ServiceTypeID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      HttpContext.Current.Session["ServiceTypesRecordControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
      ...
      string selectedRecordInSuppliersTableControl = HttpContext.Current.Session["ServiceTypesRecordControlWhereClause"] as string;
      
      if (selectedRecordInSuppliersTableControl != null && KeyValue.IsXmlKey(selectedRecordInSuppliersTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInSuppliersTableControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(ServiceTypesTable.ServiceTypeID))
      {
      wc.iAND(ServiceTypesTable.ServiceTypeID, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(ServiceTypesTable.ServiceTypeID).ToString());
      }
