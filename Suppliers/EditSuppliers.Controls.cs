...
// EditSuppliers.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditSuppliers
{
...
// Base class for the SuppliersRecordControl control on the EditSuppliers page.
...
public class BaseSuppliersRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in SuppliersRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditSuppliers"] = recId;
