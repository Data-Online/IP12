...
// GroupBySuppliersTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupBySuppliersTable
{
...
// Base class for the SuppliersTableControlRow control on the GroupBySuppliersTable page.
        ...
        public virtual void SetLiteral()
                  {
                        ...
                        this.Literal.Text = EvaluateFormula("IF(LEN(SuppliersTableControlRow.eMail.Text)<>0, \"<a title=\\\"Send eMail\\\" href=\\\"mailto:\" + SuppliersTableControlRow.eMail.Text + \"\\\" id=\\\"mailtolink\\\"></a>\", \"\")");
...
// Base class for the SuppliersTableControl control on the GroupBySuppliersTable page.
...
public class BaseSuppliersTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            this.SuppliersPagination.TotalPages.Text = this.TotalPages.ToString();
      ...
      SuppliersRecord rec = new SuppliersRecord();
        ...
        public virtual void SetServiceTypeIDLabel1()
                  {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void SuppliersPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupBySuppliersTable.SuppliersPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Suppliers";
                // If GroupBySuppliersTable.SuppliersPDFButton.report specifies a valid report template,
        ...
        public virtual void SuppliersWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupBySuppliersTable.SuppliersWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Suppliers";
                // If GroupBySuppliersTable.SuppliersWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal ServiceTypeIDLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ServiceTypeIDLabel1");
            }
        }
        ...
        public IPv5.UI.IPaginationMedium SuppliersPagination {
            get {
                return (IPv5.UI.IPaginationMedium)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SuppliersPagination");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual SuppliersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SuppliersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupBySuppliersTable.SuppliersTableControlRow")));
