...
// ShowSuppliersGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowSuppliersGallery
{
...
// Base class for the SuppliersTableControlRow control on the ShowSuppliersGallery page.
...
public class BaseSuppliersTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.CompanyName.Click += CompanyName_Click;
        ...
        public virtual void SetCompanyName()
        {
            ...
            // Set the CompanyName LinkButton on the webpage with value from the
            // DatabaseMM_IP1%dbo.Suppliers database record.

            // this.DataSource is the DatabaseMM_IP1%dbo.Suppliers record retrieved from the database.
            // this.CompanyName is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.CompanyNameSpecified) {
               ...
               string formattedValue = this.DataSource.Format(SuppliersTable.CompanyName);
                ...
                this.CompanyName.Text = formattedValue;
                  ...
                  this.CompanyName.ToolTip = "Go to " + this.CompanyName.Text.Replace("<wbr/>", "");
      ...
      // To customize, override this method in SuppliersTableControlRow.
        ...
        public virtual void CompanyName_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Suppliers/ShowSuppliers.aspx?Suppliers={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton CompanyName {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CompanyName");
            }
        }
...
// Base class for the SuppliersTableControl control on the ShowSuppliersGallery page.
...
public class BaseSuppliersTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return SuppliersTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual SuppliersRecord[] CopyArray(int index, SuppliersRecord[,] recs, int columns)
      {
        SuppliersRecord[] recsCopy = new SuppliersRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            SuppliersRecord[,] recs = new SuppliersRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            SuppliersRecord[] HColDataSource = new SuppliersRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              SuppliersRecord[] VColDataSource = new SuppliersRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("SuppliersTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              SuppliersRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                SuppliersTableControlRow recControl = (SuppliersTableControlRow)innerRepItem.FindControl("SuppliersTableControlRow");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void SuppliersPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowSuppliersGallery.SuppliersPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Suppliers";
                // If ShowSuppliersGallery.SuppliersPDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${CompanyName}", record.Format(SuppliersTable.CompanyName), ReportEnum.Align.Left);
                             report.AddData("${CityID}", record.Format(SuppliersTable.CityID), ReportEnum.Align.Right, 100);
        ...
        public virtual void SuppliersWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowSuppliersGallery.SuppliersWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Suppliers";
                // If ShowSuppliersGallery.SuppliersWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual SuppliersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SuppliersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowSuppliersGallery.SuppliersTableControlRow")));
