...
// This file implements the code-behind class for AddSuppliers.aspx.
// AddSuppliers.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddSuppliers
        : BaseApplicationPage
// Code-behind class for the AddSuppliers page.
...
public void SetSuppliersRecordControl()
        {
            SetSuppliersRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddSuppliers.SuppliersRecordControl SuppliersRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Suppliers");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "SuppliersRecordControl":
                 SetSuppliersRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.SuppliersRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSuppliersRecordControl_Base()           
        
        {        
            if (SuppliersRecordControl.Visible)
            {
                SuppliersRecordControl.LoadData();
                SuppliersRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.SuppliersRecordControl != null && this.SuppliersRecordControl.DataSource != null)
                  {
                        id = this.SuppliersRecordControl.DataSource.GetValue(this.SuppliersRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.SuppliersRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.SuppliersRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.SuppliersRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.SuppliersRecordControl.DataSource.GetValue(this.SuppliersRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
