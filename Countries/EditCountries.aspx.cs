...
// This file implements the code-behind class for EditCountries.aspx.
// EditCountries.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditCountries
        : BaseApplicationPage
// Code-behind class for the EditCountries page.
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditCountries.ContactsTableControl ContactsTableControl;
        ...
        public IPv5.UI.Controls.EditCountries.CountriesRecordControl CountriesRecordControl;
        ...
        public IPv5.UI.Controls.EditCountries.PropertiesTableControl PropertiesTableControl;
        ...
        public IPv5.UI.Controls.EditCountries.PropertyContactsTableControl PropertyContactsTableControl;
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.CountriesRecordControl.SaveData();
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.CountriesRecordControl != null && this.CountriesRecordControl.DataSource != null)
                  {
                        id = this.CountriesRecordControl.DataSource.GetValue(this.CountriesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.CountriesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.CountriesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.CountriesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.CountriesRecordControl.DataSource.GetValue(this.CountriesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
