...
// EditCountries.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditCountries
{
...
// Base class for the ContactsTableControlRow control on the EditCountries page.
...
public class BaseContactsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.RegionID2AddRecordLink.Click += RegionID2AddRecordLink_Click;
                        
              this.CityID2.SelectedIndexChanged += CityID2_SelectedIndexChanged;
            
              this.RegionID2.SelectedIndexChanged += RegionID2_SelectedIndexChanged;
        ...
        public virtual void SetRegionID2()
        {
            ...
            // If selection was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.RegionID2.ID))
            {
                if (this.PreviousUIData[this.RegionID2.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.RegionID2.ID].ToString();
            }
            ...
            // this.DataSource is the DatabaseMM_IP1%dbo.Contacts record retrieved from the database.
            // this.RegionID2 is the ASP:DropDownList on the webpage.
            ...
            this.PopulateRegionID2DropDownList(selectedValue, 100);              
        ...
        public virtual void GetRegionID2()
        {
         // Retrieve the value entered by the user on the RegionID ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.RegionID2), ContactsTable.RegionID);			
      ...
      // To customize, override this method in ContactsTableControlRow.
        ...
        public virtual void SetRegionID2AddRecordLink()                
              
        {
              ...
              try
              {
                    ...
                    url = url + "?RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("NewWindow") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(this.RegionID2.ClientID) + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("Region")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("RegionID");                      
                              
                string javascriptCall = "";
                
                    javascriptCall = "initializeNewWindow(this, '" + url + "', false, event);";                  
                       
                    this.RegionID2AddRecordLink.Attributes["onClick"] = javascriptCall + "return false;";            
                }
                catch
                {
                    // do nothing.  If the code above fails, server side click event, RegionID2AddRecordLink_ClickRegionID2AddRecordLink_Click will be trigger when user click the button.
                }
        ...
        public virtual WhereClause CreateWhereClause_RegionID2DropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
        ...
        // Fill the RegionID2 list.
        protected virtual void PopulateRegionID2DropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.RegionID2.Items.Clear();
            
            // 1. Setup the static list items        
            
              // Add the Please Select item.
              this.RegionID2.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "IPv5"), "--PLEASE_SELECT--"));
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_RegionID2DropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_RegionID2DropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the RegionID2DropDownList.
                ...
                do
                {
                    ...
                    foreach (RegionsRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.RegionIDSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.RegionID2.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.RegionID2.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.RegionID2.Items.Add(newItem);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.RegionID2, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.RegionID2, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.RegionID2, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void RegionID2AddRecordLink_Click(object sender, ImageClickEventArgs args)
        {
        ...
        if (target == null) target = ""; // avoid warning on VS
            ...
            if (shouldRedirect) {
                ...
                string javascriptCall = "";
                    ...
                    javascriptCall = "initializeNewWindow(this, '" + url + "', false, event);";                  
                AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "RegionID2AddRecordLink_Click", javascriptCall, true);
        ...
        protected virtual void RegionID2_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[RegionID2.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[RegionID2.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.RegionID2.Items.Add(new ListItem(displayText, val));
	            this.RegionID2.SelectedIndex = this.RegionID2.Items.Count - 1;
	            this.Page.Session.Remove(RegionID2.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(RegionID2.ClientID + "_SelectedDisplayText");
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList RegionID2 {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionID2");
            }
        }
            
        public System.Web.UI.WebControls.ImageButton RegionID2AddRecordLink {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionID2AddRecordLink");
            }
        }
...
// Base class for the ContactsTableControl control on the EditCountries page.
...
public class BaseContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.EditCountries.CountriesRecordControl countriesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CountriesRecordControl") as IPv5.UI.Controls.EditCountries.CountriesRecordControl);
          
              if (countriesRecordControlObj != null && countriesRecordControlObj.GetRecord() != null && countriesRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(ContactsTable.CountryID, BaseFilter.ComparisonOperator.EqualsTo, countriesRecordControlObj.GetRecord().CountryID.ToString());
              selectedRecordKeyValue.AddElement(ContactsTable.CountryID.InternalName, countriesRecordControlObj.GetRecord().CountryID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInCountriesRecordControl = HttpContext.Current.Session["ContactsTableControlWhereClause"] as string;
      ...
      ContactsRecord rec = new ContactsRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.RegionID2)) {
                            rec.Parse(recControl.RegionID2.SelectedItem.Value, ContactsTable.RegionID);
                        }
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditCountries.ContactsTableControlRow")));
...
// Base class for the PropertiesTableControlRow control on the EditCountries page.
...
public class BasePropertiesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.RegionID1AddRecordLink.Click += RegionID1AddRecordLink_Click;
                        
              this.CityID1.SelectedIndexChanged += CityID1_SelectedIndexChanged;
            
              this.RegionID1.SelectedIndexChanged += RegionID1_SelectedIndexChanged;
        ...
        public virtual void SetRegionID1()
        {
            ...
            // If selection was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.RegionID1.ID))
            {
                if (this.PreviousUIData[this.RegionID1.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.RegionID1.ID].ToString();
            }
            ...
            // this.DataSource is the DatabaseMM_IP1%dbo.Properties record retrieved from the database.
            // this.RegionID1 is the ASP:DropDownList on the webpage.
            ...
            this.PopulateRegionID1DropDownList(selectedValue, 100);              
        ...
        public virtual void GetRegionID1()
        {
         // Retrieve the value entered by the user on the RegionID ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.RegionID1), PropertiesTable.RegionID);			
      ...
      // To customize, override this method in PropertiesTableControlRow.
        ...
        public virtual void SetRegionID1AddRecordLink()                
              
        {
              ...
              try
              {
                    ...
                    url = url + "?RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("NewWindow") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(this.RegionID1.ClientID) + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("Region")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("RegionID");                      
                              
                string javascriptCall = "";
                
                    javascriptCall = "initializeNewWindow(this, '" + url + "', false, event);";                  
                       
                    this.RegionID1AddRecordLink.Attributes["onClick"] = javascriptCall + "return false;";            
                }
                catch
                {
                    // do nothing.  If the code above fails, server side click event, RegionID1AddRecordLink_ClickRegionID1AddRecordLink_Click will be trigger when user click the button.
                }
        ...
        public virtual WhereClause CreateWhereClause_RegionID1DropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
        ...
        // Fill the RegionID1 list.
        protected virtual void PopulateRegionID1DropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.RegionID1.Items.Clear();
            
            // 1. Setup the static list items        
            
              // Add the Please Select item.
              this.RegionID1.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "IPv5"), "--PLEASE_SELECT--"));
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_RegionID1DropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_RegionID1DropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the RegionID1DropDownList.
            RegionsRecord[] itemValues  = null;
            if (wc.RunQuery)
            {
                int counter = 0;
                ...
                do
                {
                    ...
                    foreach (RegionsRecord itemValue in itemValues) 
                    {
                        ...
                        {
                            cvalue = itemValue.RegionID.ToString().ToString();
                            if (counter < maxItems && this.RegionID1.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.RegionID1.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.RegionID1.Items.Add(newItem);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.RegionID1, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.RegionID1, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.RegionID1, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void RegionID1AddRecordLink_Click(object sender, ImageClickEventArgs args)
        {
        ...
        if (target == null) target = ""; // avoid warning on VS
            ...
            if (shouldRedirect) {
                ...
                string javascriptCall = "";
                    ...
                    javascriptCall = "initializeNewWindow(this, '" + url + "', false, event);";                  
                AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "RegionID1AddRecordLink_Click", javascriptCall, true);
        ...
        protected virtual void RegionID1_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[RegionID1.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[RegionID1.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.RegionID1.Items.Add(new ListItem(displayText, val));
	            this.RegionID1.SelectedIndex = this.RegionID1.Items.Count - 1;
	            this.Page.Session.Remove(RegionID1.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(RegionID1.ClientID + "_SelectedDisplayText");
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList RegionID1 {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionID1");
            }
        }
            
        public System.Web.UI.WebControls.ImageButton RegionID1AddRecordLink {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegionID1AddRecordLink");
            }
        }
...
// Base class for the PropertiesTableControl control on the EditCountries page.
...
public class BasePropertiesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.EditCountries.CountriesRecordControl countriesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CountriesRecordControl") as IPv5.UI.Controls.EditCountries.CountriesRecordControl);
              ...
              if (countriesRecordControlObj != null && countriesRecordControlObj.GetRecord() != null && countriesRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(PropertiesTable.CountryID, BaseFilter.ComparisonOperator.EqualsTo, countriesRecordControlObj.GetRecord().CountryID.ToString());
              selectedRecordKeyValue.AddElement(PropertiesTable.CountryID.InternalName, countriesRecordControlObj.GetRecord().CountryID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInCountriesRecordControl = HttpContext.Current.Session["PropertiesTableControlWhereClause"] as string;
      ...
      PropertiesRecord rec = new PropertiesRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.RegionID1)) {
                            rec.Parse(recControl.RegionID1.SelectedItem.Value, PropertiesTable.RegionID);
                        }
              newUIDataList.Add(recControl.PreservedUIData());
              newRecordList.Add(rec);
            }
...
#region "Helper Functions"
        ...
        public virtual PropertiesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertiesTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditCountries.PropertiesTableControlRow")));
...
// Base class for the PropertyContactsTableControlRow control on the EditCountries page.
...
// Base class for the PropertyContactsTableControl control on the EditCountries page.
...
public class BasePropertyContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.EditCountries.CountriesRecordControl countriesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CountriesRecordControl") as IPv5.UI.Controls.EditCountries.CountriesRecordControl);
              ...
              if (countriesRecordControlObj != null && countriesRecordControlObj.GetRecord() != null && countriesRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(PropertyContactsTable.CountryID, BaseFilter.ComparisonOperator.EqualsTo, countriesRecordControlObj.GetRecord().CountryID.ToString());
              selectedRecordKeyValue.AddElement(PropertyContactsTable.CountryID.InternalName, countriesRecordControlObj.GetRecord().CountryID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInCountriesRecordControl = HttpContext.Current.Session["PropertyContactsTableControlWhereClause"] as string;
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditCountries.PropertyContactsTableControlRow")));
...
// Base class for the CountriesRecordControl control on the EditCountries page.
...
public class BaseCountriesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void GetCountry()
        {
            ...
            // save it into the Country field in DataSource DatabaseMM_IP1%dbo.Countries record.
      ...
      // To customize, override this method in CountriesRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Countries"];
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "Countries"));
            }
            HttpContext.Current.Session["QueryString in EditCountries"] = recId;
          ...
          wc.iAND(CountriesTable.CountryID, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(CountriesTable.CountryID));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(CountriesTable.CountryID, BaseFilter.ComparisonOperator.EqualsTo, recId);
