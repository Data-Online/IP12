...
// ShowCountries.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowCountries
{
...
// Base class for the ContactsTableControlRow control on the ShowCountries page.
...
// Base class for the ContactsTableControl control on the ShowCountries page.
...
public class BaseContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.ShowCountries.CountriesRecordControl countriesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CountriesRecordControl") as IPv5.UI.Controls.ShowCountries.CountriesRecordControl);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ContactsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowCountries.ContactsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If ShowCountries.ContactsPDFButton.report specifies a valid report template,
        ...
        public virtual void ContactsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowCountries.ContactsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If ShowCountries.ContactsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowCountries.ContactsTableControlRow")));
...
// Base class for the PropertiesTableControlRow control on the ShowCountries page.
...
// Base class for the PropertiesTableControl control on the ShowCountries page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertiesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowCountries.PropertiesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Properties";
                // If ShowCountries.PropertiesPDFButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.   
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void PropertiesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowCountries.PropertiesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Properties";
                // If ShowCountries.PropertiesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual PropertiesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertiesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowCountries.PropertiesTableControlRow")));
...
// Base class for the PropertyContactsTableControlRow control on the ShowCountries page.
...
// Base class for the PropertyContactsTableControl control on the ShowCountries page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyContactsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowCountries.PropertyContactsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyContacts";
                // If ShowCountries.PropertyContactsPDFButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.   
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void PropertyContactsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowCountries.PropertyContactsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PropertyContacts";
                // If ShowCountries.PropertyContactsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowCountries.PropertyContactsTableControlRow")));
...
// Base class for the CountriesRecordControl control on the ShowCountries page.
...
public class BaseCountriesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.CountriesDialogEditButton.Click += CountriesDialogEditButton_Click;
      ...
      // To customize, override this method in CountriesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in ShowCountries"] = recId;
        ...
        public virtual void SetCountriesDialogEditButton()                
        ...
        // event handler for ImageButton
        public virtual void CountriesDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton CountriesDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CountriesDialogEditButton");
            }
        }
