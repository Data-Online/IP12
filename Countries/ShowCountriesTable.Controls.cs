...
// ShowCountriesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowCountriesTable
{
...
// Base class for the CountriesTableControlRow control on the ShowCountriesTable page.
...
// Base class for the CountriesTableControl control on the ShowCountriesTable page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void CountriesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowCountriesTable.CountriesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Countries";
                // If ShowCountriesTable.CountriesPDFButton.report specifies a valid report template,
        ...
        public virtual void CountriesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowCountriesTable.CountriesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Countries";
                // If ShowCountriesTable.CountriesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual CountriesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CountriesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowCountriesTable.CountriesTableControlRow")));
