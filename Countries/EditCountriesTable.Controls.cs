...
// EditCountriesTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditCountriesTable
{
...
// Base class for the CountriesTableControlRow control on the EditCountriesTable page.
...
public class BaseCountriesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.CountriesRowViewButton.Click += CountriesRowViewButton_Click;
        ...
        public virtual void SetCountry()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.Country.ID))
            {
            
                this.Country.Text = this.PreviousUIData[this.Country.ID].ToString();
      ...
      // To customize, override this method in CountriesTableControlRow.
        ...
        public virtual void SetCountriesRowViewButton()                
        ...
        CountriesTableControl tc= ((CountriesTableControl)MiscUtils.GetParentControlObject(this, "CountriesTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((CountriesTableControlRow)this);
                    }
                    this.Visible = false;
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void CountriesRowViewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Countries/ShowCountries.aspx?Countries={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.CheckBox CountriesRecordRowSelection {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CountriesRecordRowSelection");
            }
        }              
        ...
        public System.Web.UI.WebControls.ImageButton CountriesRowViewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CountriesRowViewButton");
            }
        }
...
// Base class for the CountriesTableControl control on the EditCountriesTable page.
...
public class BaseCountriesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            SaveControlsToSession_Ajax();
              ...
              // Show confirmation message on Click
              this.CountriesDeleteButton.Attributes.Add("onClick", "return (confirm(\"" + ((BaseApplicationPage)this.Page).GetResourceValue("DeleteConfirm", "IPv5") + "\"));");
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.CountriesAddButton.Click += CountriesAddButton_Click;
                        
                    this.CountriesDeleteButton.Click += CountriesDeleteButton_Click;
                        
                    this.CountriesResetButton.Click += CountriesResetButton_Click;
                        
                    this.CountriesSaveButton.Click += CountriesSaveButton_Click;
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetCountryLabel1();
                SetCountrySortLabel();
                SetCountriesAddButton();
              
                SetCountriesDeleteButton();
              
                SetCountriesResetButton();
              
                SetCountriesSaveButton();
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"CountriesSaveButton"));
      ...
      CountriesRecord rec = new CountriesRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("CountriesTableControlRepeater");
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetCountriesAddButton()                
        ...
        public virtual void SetCountriesDeleteButton()                
        ...
        public virtual void SetCountriesSaveButton()                
              
        {
        
                    this.CountriesSaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.Page.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
        ...
        // event handler for ImageButton
        public virtual void CountriesAddButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void CountriesDeleteButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void CountriesSaveButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton CountriesAddButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CountriesAddButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton CountriesDeleteButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CountriesDeleteButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton CountriesSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CountriesSaveButton");
            }
        }
        ...
        public System.Web.UI.WebControls.CheckBox CountriesToggleAll {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CountriesToggleAll");
            }
        }              
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (CountriesTableControlRow recControl in this.GetRecordControls())
            {
                if (recControl.CountriesRecordRowSelection.Checked) {
                    return counter;
                }
                counter += 1;
            }
        ...
        {
        CountriesTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual CountriesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            foreach (CountriesTableControlRow recControl in this.GetRecordControls())
            {
                if (recControl.CountriesRecordRowSelection != null && recControl.CountriesRecordRowSelection.Checked) {
                    selectedList.Add(recControl);
                }
            }
            return (CountriesTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditCountriesTable.CountriesTableControlRow")));
        ...
        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            ...
            foreach (CountriesTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    ...
                    recCtl.CountriesRecordRowSelection.Checked = false;
