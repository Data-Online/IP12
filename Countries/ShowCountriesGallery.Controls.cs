...
// ShowCountriesGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowCountriesGallery
{
...
// Base class for the CountriesTableControlRow control on the ShowCountriesGallery page.
...
public class BaseCountriesTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.Country.Click += Country_Click;
        ...
        public virtual void SetCountry()
        {
            ...
            // Set the Country LinkButton on the webpage with value from the
            ...
            // this.Country is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.CountrySpecified) {
               ...
               string formattedValue = this.DataSource.Format(CountriesTable.Country);
                ...
                this.Country.Text = formattedValue;
                  ...
                  this.Country.ToolTip = "Go to " + this.Country.Text.Replace("<wbr/>", "");
      ...
      // To customize, override this method in CountriesTableControlRow.
        ...
        public virtual void Country_Click(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton Country {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Country");
            }
        }
...
// Base class for the CountriesTableControl control on the ShowCountriesGallery page.
...
public class BaseCountriesTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return CountriesTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual CountriesRecord[] CopyArray(int index, CountriesRecord[,] recs, int columns)
      {
        CountriesRecord[] recsCopy = new CountriesRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            CountriesRecord[,] recs = new CountriesRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            CountriesRecord[] HColDataSource = new CountriesRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              CountriesRecord[] VColDataSource = new CountriesRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("CountriesTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              CountriesRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                CountriesTableControlRow recControl = (CountriesTableControlRow)innerRepItem.FindControl("CountriesTableControlRow");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void CountriesPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowCountriesGallery.CountriesPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Countries";
                // If ShowCountriesGallery.CountriesPDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${Country}", record.Format(CountriesTable.Country), ReportEnum.Align.Left);
        ...
        public virtual void CountriesWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowCountriesGallery.CountriesWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Countries";
                // If ShowCountriesGallery.CountriesWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual CountriesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CountriesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowCountriesGallery.CountriesTableControlRow")));
