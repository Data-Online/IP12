...
// This file implements the code-behind class for EditCountriesTable.aspx.
// EditCountriesTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditCountriesTable
        : BaseApplicationPage
// Code-behind class for the EditCountriesTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditCountriesTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_CountriesSearch(string prefixText, int count)
        {
            // GetCountriesSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_CountriesSearch_Base()
            // or replace the call to GetAutoCompletionList_CountriesSearch_Base().
            return GetAutoCompletionList_CountriesSearch_Base(prefixText, count);
        }
...
public void SetCountriesTableControl()
        {
            SetCountriesTableControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButtonWithArrow CountriesButtonsButton;
                
        public System.Web.UI.WebControls.ImageButton CountriesDeleteButton;
        
        public ThemeButton CountriesFilterButton;
                
        public ThemeButtonWithArrow CountriesFiltersButton;
                
        public PaginationModern CountriesPagination;
        ...
        public IPv5.UI.Controls.EditCountriesTable.CountriesTableControl CountriesTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Countries");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "CountriesTableControl":
                 SetCountriesTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.CountriesTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_CountriesSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditCountriesTable.CountriesTableControl control = new IPv5.UI.Controls.EditCountriesTable.CountriesTableControl();
        
        return control.GetAutoCompletionList_CountriesSearch(prefixText, count);
        ...
        SetCountriesTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "CountriesMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCountriesTableControl_Base()           
        
        {        
            if (CountriesTableControl.Visible)
            {
                CountriesTableControl.LoadData();
                CountriesTableControl.DataBind();
            }
        }
