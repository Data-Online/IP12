...
// AddCountries.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.AddCountries
{
...
// Base class for the ContactsTableControlRow control on the AddCountries page.
...
// Base class for the ContactsTableControl control on the AddCountries page.
...
public class BaseContactsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    IPv5.UI.Controls.AddCountries.CountriesRecordControl countriesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CountriesRecordControl") as IPv5.UI.Controls.AddCountries.CountriesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddCountries.ContactsTableControlRow")));
...
// Base class for the PropertiesTableControlRow control on the AddCountries page.
...
// Base class for the PropertiesTableControl control on the AddCountries page.
...
#region "Helper Functions"
        ...
        public virtual PropertiesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertiesTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddCountries.PropertiesTableControlRow")));
...
// Base class for the PropertyContactsTableControlRow control on the AddCountries page.
...
// Base class for the PropertyContactsTableControl control on the AddCountries page.
...
#region "Helper Functions"
        ...
        public virtual PropertyContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PropertyContactsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.AddCountries.PropertyContactsTableControlRow")));
...
// Base class for the CountriesRecordControl control on the AddCountries page.
...
public class BaseCountriesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (CountriesRecord)CountriesRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in CountriesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in AddCountries"] = recId;
