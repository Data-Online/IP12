...
public class BaseVPropertyRentReviewsView : PrimaryKeyTable
{
...
#region "Shared helper methods"
    ...
    public static BaseColumn GetColumnByName(string name)
    {
        ...
        public static VPropertyRentReviewsRecord GetRecord(string id, bool bMutable)
        {
            return (VPropertyRentReviewsRecord)VPropertyRentReviewsView.Instance.GetRecordData(id, bMutable);
        }

        //Convenience method for getting a record using a KeyValue record identifier
        public static VPropertyRentReviewsRecord GetRecord(KeyValue id, bool bMutable)
        {
            return (VPropertyRentReviewsRecord)VPropertyRentReviewsView.Instance.GetRecordData(id, bMutable);
        }
        ...
        rec.SetString(RentReviewIDValue, RentReviewIDColumn);
		...
		{
			VPropertyRentReviewsView.Instance.DeleteOneRecord(kv);
		}
		...
		public static bool DoesRecordExist(KeyValue kv)
		{
			...
			try
			{
				VPropertyRentReviewsView.GetRecord(kv, false);
			}
			catch (Exception)
			{
				recordExist = false;
        ...
        {
            if (!(VPropertyRentReviewsView.Instance.TableDefinition.PrimaryKey == null)) 
            {
                return VPropertyRentReviewsView.Instance.TableDefinition.PrimaryKey.Columns;
            }
            else 
            {
                return null;
        ...
        public static KeyValue GetKeyValue(object key) 
        {
            ...
            if (!(VPropertyRentReviewsView.Instance.TableDefinition.PrimaryKey == null)) 
            {
                ...
                isCompositePrimaryKey = VPropertyRentReviewsView.Instance.TableDefinition.PrimaryKey.IsCompositeKey;
                if ((isCompositePrimaryKey && key.GetType().IsArray)) 
                {
                    ...
                    if (!(keyArray == null)) 
                    {
                        ...
                        ColumnList pkColumns = VPropertyRentReviewsView.Instance.TableDefinition.PrimaryKey.Columns;
                        int index = 0;
                        foreach (BaseColumn pkColumn in pkColumns) 
                        {
                            string keyString = ((keyArray.GetValue(index)).ToString());
                            if (VPropertyRentReviewsView.Instance.TableDefinition.TableType == BaseClasses.Data.TableDefinition.TableTypes.Virtual)
                            {
                ...
                else 
                {
                    ...
                    kv = VPropertyRentReviewsView.Instance.TableDefinition.PrimaryKey.ParseValue(((key).ToString()));
                }
            }
            return kv;
        }
