...
// Your customizations should be made in TermRenewalsRecord.cs
...
/// <summary>
/// The generated superclass for the <see cref="TermRenewalsRecord"></see> class.
/// </summary>
/// <remarks>
/// This class is not intended to be instantiated directly.  To obtain an instance of this class, 
/// use the methods of the <see cref="TermRenewalsTable"></see> class.
/// </remarks>
/// <seealso cref="TermRenewalsTable"></seealso>
/// <seealso cref="TermRenewalsRecord"></seealso>
public class BaseTermRenewalsRecord : PrimaryKeyRecord
{

	public readonly static TermRenewalsTable TableUtils = TermRenewalsTable.Instance;

	// Constructors
 
	protected BaseTermRenewalsRecord() : base(TableUtils)
	{
		this.InsertingRecord += 
			new BaseClasses.IRecordWithTriggerEvents.InsertingRecordEventHandler(this.TermRenewalsRecord_InsertingRecord); 
		this.UpdatingRecord += 
			new BaseClasses.IRecordWithTriggerEvents.UpdatingRecordEventHandler(this.TermRenewalsRecord_UpdatingRecord); 
		this.ReadRecord +=
            new BaseClasses.IRecordWithTriggerEvents.ReadRecordEventHandler(this.TermRenewalsRecord_ReadRecord); 
	}

	protected BaseTermRenewalsRecord(PrimaryKeyRecord record) : base(record, TableUtils)
	{
	}
    ...
    protected virtual void TermRenewalsRecord_ReadRecord(Object sender,System.EventArgs e)
    {
        //Apply Initialize->Reading record formula only if validation is successful.
                TermRenewalsRecord TermRenewalsRec = (TermRenewalsRecord)sender;
        if(TermRenewalsRec != null && !TermRenewalsRec.IsReadOnly ){
                }
    
    }
        
	//Evaluates Initialize when->Inserting formulas specified at the data access layer
    protected virtual void TermRenewalsRecord_InsertingRecord(Object sender,System.ComponentModel.CancelEventArgs e)
    {
        //Apply Initialize->Inserting formula only if validation is successful.
                TermRenewalsRecord TermRenewalsRec = (TermRenewalsRecord)sender;
        Validate_Inserting();
        if(TermRenewalsRec != null && !TermRenewalsRec.IsReadOnly ){
               TermRenewalsRec.Parse(EvaluateFormula("UserID()",this,null),TermRenewalsTable.CreatedBy);
       TermRenewalsRec.Parse(EvaluateFormula("Now()",this,null),TermRenewalsTable.CreatedOn);
        }
    
    }
    
    //Evaluates Initialize when->Updating formulas specified at the data access layer
    protected virtual void TermRenewalsRecord_UpdatingRecord(Object sender,System.ComponentModel.CancelEventArgs e)
    {
        //Apply Initialize->Updating formula only if validation is successful.
                TermRenewalsRecord TermRenewalsRec = (TermRenewalsRecord)sender;
        Validate_Updating();
        if(TermRenewalsRec != null && !TermRenewalsRec.IsReadOnly ){
               TermRenewalsRec.Parse(EvaluateFormula("UserID()",this,null),TermRenewalsTable.UpdatedBy);
       TermRenewalsRec.Parse(EvaluateFormula("Now()",this,null),TermRenewalsTable.UpdatedOn);
        }
...
#region "Convenience methods to get/set values of fields"
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's TermRenewals_.TermRenewalID field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's TermRenewals_.PropertyID field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's TermRenewals_.PropertyID field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's TermRenewals_.RenewalDate field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's TermRenewals_.RenewalDate field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's TermRenewals_.Description field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's TermRenewals_.Description field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's TermRenewals_.CreatedBy field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's TermRenewals_.CreatedBy field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's TermRenewals_.UpdatedBy field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's TermRenewals_.UpdatedBy field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's TermRenewals_.CreatedOn field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's TermRenewals_.CreatedOn field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's TermRenewals_.UpdatedOn field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's TermRenewals_.UpdatedOn field.
	/// </summary>
...
#region "Convenience methods to get field names"
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's TermRenewals_.TermRenewalID field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's TermRenewals_.TermRenewalID field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's TermRenewals_.PropertyID field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's TermRenewals_.RenewalDate field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's TermRenewals_.Description field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's TermRenewals_.CreatedBy field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's TermRenewals_.UpdatedBy field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's TermRenewals_.CreatedOn field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's TermRenewals_.UpdatedOn field.
	/// </summary>
