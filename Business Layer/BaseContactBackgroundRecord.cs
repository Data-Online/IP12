...
// Your customizations should be made in ContactBackgroundRecord.cs
...
/// <summary>
/// The generated superclass for the <see cref="ContactBackgroundRecord"></see> class.
/// </summary>
/// <remarks>
/// This class is not intended to be instantiated directly.  To obtain an instance of this class, 
/// use the methods of the <see cref="ContactBackgroundTable"></see> class.
/// </remarks>
/// <seealso cref="ContactBackgroundTable"></seealso>
/// <seealso cref="ContactBackgroundRecord"></seealso>
public class BaseContactBackgroundRecord : PrimaryKeyRecord
{

	public readonly static ContactBackgroundTable TableUtils = ContactBackgroundTable.Instance;

	// Constructors
 
	protected BaseContactBackgroundRecord() : base(TableUtils)
	{
		this.InsertingRecord += 
			new BaseClasses.IRecordWithTriggerEvents.InsertingRecordEventHandler(this.ContactBackgroundRecord_InsertingRecord); 
		this.UpdatingRecord += 
			new BaseClasses.IRecordWithTriggerEvents.UpdatingRecordEventHandler(this.ContactBackgroundRecord_UpdatingRecord); 
		this.ReadRecord +=
            new BaseClasses.IRecordWithTriggerEvents.ReadRecordEventHandler(this.ContactBackgroundRecord_ReadRecord); 
	}

	protected BaseContactBackgroundRecord(PrimaryKeyRecord record) : base(record, TableUtils)
	{
	}
    ...
    protected virtual void ContactBackgroundRecord_ReadRecord(Object sender,System.EventArgs e)
    {
        //Apply Initialize->Reading record formula only if validation is successful.
                ContactBackgroundRecord ContactBackgroundRec = (ContactBackgroundRecord)sender;
        if(ContactBackgroundRec != null && !ContactBackgroundRec.IsReadOnly ){
                }
    
    }
        
	//Evaluates Initialize when->Inserting formulas specified at the data access layer
    protected virtual void ContactBackgroundRecord_InsertingRecord(Object sender,System.ComponentModel.CancelEventArgs e)
    {
        //Apply Initialize->Inserting formula only if validation is successful.
                ContactBackgroundRecord ContactBackgroundRec = (ContactBackgroundRecord)sender;
        Validate_Inserting();
        if(ContactBackgroundRec != null && !ContactBackgroundRec.IsReadOnly ){
               ContactBackgroundRec.Parse(EvaluateFormula("UserID()",this,null),ContactBackgroundTable.CreatedBy);
       ContactBackgroundRec.Parse(EvaluateFormula("Now()",this,null),ContactBackgroundTable.CreatedOn);
        }
    
    }
    
    //Evaluates Initialize when->Updating formulas specified at the data access layer
    protected virtual void ContactBackgroundRecord_UpdatingRecord(Object sender,System.ComponentModel.CancelEventArgs e)
    {
        //Apply Initialize->Updating formula only if validation is successful.
                ContactBackgroundRecord ContactBackgroundRec = (ContactBackgroundRecord)sender;
        Validate_Updating();
        if(ContactBackgroundRec != null && !ContactBackgroundRec.IsReadOnly ){
               ContactBackgroundRec.Parse(EvaluateFormula("UserID()",this,null),ContactBackgroundTable.UpdatedBy);
       ContactBackgroundRec.Parse(EvaluateFormula("Now()",this,null),ContactBackgroundTable.UpdatedOn);
        }
...
#region "Convenience methods to get/set values of fields"
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's ContactBackground_.NoteID field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's ContactBackground_.ContactID field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's ContactBackground_.ContactID field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's ContactBackground_.Notes field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's ContactBackground_.Notes field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's ContactBackground_.NoteType field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's ContactBackground_.NoteType field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's ContactBackground_.CreatedBy field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's ContactBackground_.CreatedBy field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's ContactBackground_.UpdatedBy field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's ContactBackground_.UpdatedBy field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's ContactBackground_.CreatedOn field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's ContactBackground_.CreatedOn field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's ContactBackground_.UpdatedOn field.
	/// </summary>
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's ContactBackground_.UpdatedOn field.
	/// </summary>
...
#region "Convenience methods to get field names"
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's ContactBackground_.NoteID field.
	/// </summary>
	public Int32 NoteID
	{
		get
	...
	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's ContactBackground_.NoteID field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's ContactBackground_.ContactID field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's ContactBackground_.Notes field.
	/// </summary>
	public string Notes
	{
		get
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's ContactBackground_.NoteType field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's ContactBackground_.CreatedBy field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's ContactBackground_.UpdatedBy field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's ContactBackground_.CreatedOn field.
	/// </summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's ContactBackground_.UpdatedOn field.
	/// </summary>
