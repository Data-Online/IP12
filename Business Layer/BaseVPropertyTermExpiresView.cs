...
public class BaseVPropertyTermExpiresView : PrimaryKeyTable
{
...
#region "Shared helper methods"
    ...
    public static BaseColumn GetColumnByName(string name)
    {
        ...
        public static VPropertyTermExpiresRecord GetRecord(string id, bool bMutable)
        {
            return (VPropertyTermExpiresRecord)VPropertyTermExpiresView.Instance.GetRecordData(id, bMutable);
        }

        //Convenience method for getting a record using a KeyValue record identifier
        public static VPropertyTermExpiresRecord GetRecord(KeyValue id, bool bMutable)
        {
            return (VPropertyTermExpiresRecord)VPropertyTermExpiresView.Instance.GetRecordData(id, bMutable);
        }
        ...
        rec.SetString(TermExpireIDValue, TermExpireIDColumn);
		...
		{
			VPropertyTermExpiresView.Instance.DeleteOneRecord(kv);
		}
		...
		public static bool DoesRecordExist(KeyValue kv)
		{
			...
			try
			{
				VPropertyTermExpiresView.GetRecord(kv, false);
			}
			catch (Exception)
			{
				recordExist = false;
        ...
        {
            if (!(VPropertyTermExpiresView.Instance.TableDefinition.PrimaryKey == null)) 
            {
                return VPropertyTermExpiresView.Instance.TableDefinition.PrimaryKey.Columns;
            }
            else 
            {
                return null;
        ...
        public static KeyValue GetKeyValue(object key) 
        {
            ...
            if (!(VPropertyTermExpiresView.Instance.TableDefinition.PrimaryKey == null)) 
            {
                ...
                isCompositePrimaryKey = VPropertyTermExpiresView.Instance.TableDefinition.PrimaryKey.IsCompositeKey;
                if ((isCompositePrimaryKey && key.GetType().IsArray)) 
                {
                    ...
                    if (!(keyArray == null)) 
                    {
                        ...
                        ColumnList pkColumns = VPropertyTermExpiresView.Instance.TableDefinition.PrimaryKey.Columns;
                        int index = 0;
                        foreach (BaseColumn pkColumn in pkColumns) 
                        {
                            string keyString = ((keyArray.GetValue(index)).ToString());
                            if (VPropertyTermExpiresView.Instance.TableDefinition.TableType == BaseClasses.Data.TableDefinition.TableTypes.Virtual)
                            {
                ...
                else 
                {
                    ...
                    kv = VPropertyTermExpiresView.Instance.TableDefinition.PrimaryKey.ParseValue(((key).ToString()));
                }
            }
            return kv;
        }
