...
public class RolesTable : BaseRolesTable, System.Runtime.Serialization.ISerializable, ISingleton
{
...
#region "ISerializable Members"
    ...
    {
        info.SetType(typeof(RolesTable_SerializationHelper)); //No other values need to be added
    }

#region "Class RolesTable_SerializationHelper"

    [SerializableAttribute()]
    private class RolesTable_SerializationHelper: System.Runtime.Serialization.IObjectReference
    {
    ...
    /// </remarks>
    public readonly static RolesTable Instance = new RolesTable();
