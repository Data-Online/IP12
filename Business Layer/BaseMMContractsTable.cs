...
#region "Properties for columns"
    ...
    /// <summary>
    /// This is a convenience property that provides direct access to the table's MMContracts_.CreatedBy column object.
    /// </summary>
    ...
    public static BaseClasses.Data.NumberColumn CreatedBy
    {
        get
        {
            return MMContractsTable.Instance.CreatedByColumn;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's MMContracts_.UpdatedBy column object.
    /// </summary>
    ...
    public static BaseClasses.Data.NumberColumn UpdatedBy
    {
        get
        {
            return MMContractsTable.Instance.UpdatedByColumn;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's MMContracts_.CreatedOn column object.
    /// </summary>
    ...
    public static BaseClasses.Data.DateColumn CreatedOn
    {
        get
        {
            return MMContractsTable.Instance.CreatedOnColumn;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's MMContracts_.UpdatedOn column object.
    /// </summary>
    ...
    public static BaseClasses.Data.DateColumn UpdatedOn
    {
        get
        {
            return MMContractsTable.Instance.UpdatedOnColumn;
        }
    }
