...
public class BaseVPropertyTermRenewalsView : PrimaryKeyTable
{
...
#region "Shared helper methods"
    ...
    public static BaseColumn GetColumnByName(string name)
    {
        ...
        public static VPropertyTermRenewalsRecord GetRecord(string id, bool bMutable)
        {
            return (VPropertyTermRenewalsRecord)VPropertyTermRenewalsView.Instance.GetRecordData(id, bMutable);
        }

        //Convenience method for getting a record using a KeyValue record identifier
        public static VPropertyTermRenewalsRecord GetRecord(KeyValue id, bool bMutable)
        {
            return (VPropertyTermRenewalsRecord)VPropertyTermRenewalsView.Instance.GetRecordData(id, bMutable);
        }
        ...
        rec.SetString(TermRenewalIDValue, TermRenewalIDColumn);
		...
		{
			VPropertyTermRenewalsView.Instance.DeleteOneRecord(kv);
		}
		...
		public static bool DoesRecordExist(KeyValue kv)
		{
			...
			try
			{
				VPropertyTermRenewalsView.GetRecord(kv, false);
			}
			catch (Exception)
			{
				recordExist = false;
        ...
        {
            if (!(VPropertyTermRenewalsView.Instance.TableDefinition.PrimaryKey == null)) 
            {
                return VPropertyTermRenewalsView.Instance.TableDefinition.PrimaryKey.Columns;
            }
            else 
            {
                return null;
        ...
        public static KeyValue GetKeyValue(object key) 
        {
            ...
            if (!(VPropertyTermRenewalsView.Instance.TableDefinition.PrimaryKey == null)) 
            {
                ...
                isCompositePrimaryKey = VPropertyTermRenewalsView.Instance.TableDefinition.PrimaryKey.IsCompositeKey;
                if ((isCompositePrimaryKey && key.GetType().IsArray)) 
                {
                    ...
                    if (!(keyArray == null)) 
                    {
                        ...
                        ColumnList pkColumns = VPropertyTermRenewalsView.Instance.TableDefinition.PrimaryKey.Columns;
                        int index = 0;
                        foreach (BaseColumn pkColumn in pkColumns) 
                        {
                            string keyString = ((keyArray.GetValue(index)).ToString());
                            if (VPropertyTermRenewalsView.Instance.TableDefinition.TableType == BaseClasses.Data.TableDefinition.TableTypes.Virtual)
                            {
                ...
                else 
                {
                    ...
                    kv = VPropertyTermRenewalsView.Instance.TableDefinition.PrimaryKey.ParseValue(((key).ToString()));
                }
            }
            return kv;
        }
