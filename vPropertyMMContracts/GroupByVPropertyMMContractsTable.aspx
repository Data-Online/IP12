...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="GroupByVPropertyMMContractsTable.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IPv5.UI.GroupByVPropertyMMContractsTable" %>
<%@ Register Tagprefix="IPv5" Namespace="IPv5.UI.Controls.GroupByVPropertyMMContractsTable" Assembly="IPv5" %>
...
<asp:DropDownList runat="server" id="CityIDFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("VPropertyMMContractsFilterButton"))%>
                ...
                <%# GetResourceValue("Txt:SortBy", "IPv5") %>
                  ...
                  <asp:panel id="VPropertyMMContractsTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="VPropertyMMContractsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc"><asp:LinkButton runat="server" id="PropertyIDLabel11" tooltip="Sort by Company Name" width="175px" Text="Company Name" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="Address1Label1" enableviewstate="False" tooltip="Sort by Address" Text="Address" CausesValidation="False">	</asp:LinkButton></th><th class="thc"></th><th class="thc"></th><th class="thc"><asp:LinkButton runat="server" id="CityIDLabel11" tooltip="Sort by CityID" Text="City" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="RegionIDLabel" tooltip="Sort by RegionID" Text="Region" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CountryIDLabel" tooltip="Sort by CountryID" Text="Country" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="PostCodeLabel1" tooltip="Sort by PostCode" Text="Post Code" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="ExpiryDateLabel1" tooltip="Sort by ExpiryDate" Text="Expiration Date" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="DescriptionLabel1" tooltip="Sort by Description" width="120px" Text="Description" CausesValidation="False">	</asp:LinkButton></th></tr><asp:Repeater runat="server" id="VPropertyMMContractsTableControlRepeater">		<ITEMTEMPLATE>		<IPv5:VPropertyMMContractsTableControlRow runat="server" id="VPropertyMMContractsTableControlRow">
...
<asp:Literal runat="server" id="ExpiryDate"></asp:Literal></span>
</td><td class="MyTR" scope="server"><asp:Literal runat="server" id="Description"></asp:Literal></td></tr><tr><td class="tableCellLabel" scope="col"></td><td class="tableCellValue"></td><td class="tableCellLabel" scope="col"></td><td class="tableCellValue"></td><td class="tableCellLabel" scope="col"></td><td class="tableCellValue"></td><td class="tableCellLabel" scope="col"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="8">&nbsp;</td><td class="tableRowDivider"></td><td class="tableRowDivider"></td></tr></IPv5:VPropertyMMContractsTableControlRow>
</ITEMTEMPLATE>
                    ...
                    <IPv5:PaginationMedium runat="server" id="VPropertyMMContractsPagination"></IPv5:PaginationMedium>
