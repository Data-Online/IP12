...
// This file implements the code-behind class for GroupByVPropertyMMContractsTable.aspx.
// GroupByVPropertyMMContractsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByVPropertyMMContractsTable
        : BaseApplicationPage
// Code-behind class for the GroupByVPropertyMMContractsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByVPropertyMMContractsTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_VPropertyMMContractsSearch(string prefixText, int count)
        {
            // GetVPropertyMMContractsSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_VPropertyMMContractsSearch_Base()
            // or replace the call to GetAutoCompletionList_VPropertyMMContractsSearch_Base().
            return GetAutoCompletionList_VPropertyMMContractsSearch_Base(prefixText, count);
        }
...
public void SetVPropertyMMContractsTableControl()
        {
            SetVPropertyMMContractsTableControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButtonWithArrow VPropertyMMContractsButtonsButton;
                
        public System.Web.UI.WebControls.ImageButton VPropertyMMContractsExportExcelButton;
        
        public ThemeButton VPropertyMMContractsFilterButton;
                
        public ThemeButtonWithArrow VPropertyMMContractsFiltersButton;
                
        public PaginationModern VPropertyMMContractsPagination;
        ...
        public IPv5.UI.Controls.GroupByVPropertyMMContractsTable.VPropertyMMContractsTableControl VPropertyMMContractsTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = "Property MM Contracts";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "VPropertyMMContractsTableControl":
                 SetVPropertyMMContractsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.VPropertyMMContractsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_VPropertyMMContractsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByVPropertyMMContractsTable.VPropertyMMContractsTableControl control = new IPv5.UI.Controls.GroupByVPropertyMMContractsTable.VPropertyMMContractsTableControl();
        
        return control.GetAutoCompletionList_VPropertyMMContractsSearch(prefixText, count);
        ...
        SetVPropertyMMContractsTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "VPropertyMMContractsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVPropertyMMContractsTableControl_Base()           
        
        {        
            if (VPropertyMMContractsTableControl.Visible)
            {
                VPropertyMMContractsTableControl.LoadData();
                VPropertyMMContractsTableControl.DataBind();
            }
        }
