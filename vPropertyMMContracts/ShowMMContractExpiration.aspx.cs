...
// This file implements the code-behind class for ShowMMContractExpiration.aspx.
// ShowMMContractExpiration.Controls.vb contains the Table, Row and Record control classes
...
public partial class ShowMMContractExpiration
        : BaseApplicationPage
// Code-behind class for the ShowMMContractExpiration page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public ShowMMContractExpiration()
        {
            this.Initialize();
			this.Init += new EventHandler(Expiration_Init);
			this.Load += new EventHandler(Expiration_Load);
        }
...
//        }
      ...
      protected void Expiration_Init(object sender, System.EventArgs e)
      {
          this.Expiration.AutoPostBack = true;
      }

      protected void Expiration_SelectedIndexChanged(object sender, System.EventArgs e)
      {
          LoadGridControl();
      }
...
//    firstParameter = new BaseClasses.Data.StoredProcedureParameter("@alertType", "duenow", System.Data.SqlDbType.NVarChar, System.Data.ParameterDirection.Input);
    firstParameter = new BaseClasses.Data.StoredProcedureParameter("@alertType", this.Expiration.SelectedValue, System.Data.SqlDbType.NVarChar, System.Data.ParameterDirection.Input);
    ...
    myStoredProcedure = new BaseClasses.Data.StoredProcedure("DatabaseMM_IP1", "spSelectAlerts", parameterList);
...
#region "Section 2: Do not modify this section."
        ...
        public System.Web.UI.WebControls.DropDownList Expiration;
        
        public System.Web.UI.WebControls.GridView MyGrid;
