...
// ShowVPropertyMMContractsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowVPropertyMMContractsTable
{
...
// Base class for the VPropertyMMContractsTableControlRow control on the ShowVPropertyMMContractsTable page.
...
public class BaseVPropertyMMContractsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetVPropertyMMContractsTabContainer();
        ...
        public virtual void SetVPropertyMMContractsTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "VPropertyMMContractsTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "VPropertyMMContractsTabContainer").Visible = false;
...
#region "Helper Properties"
        ...
        public AjaxControlToolkit.TabContainer VPropertyMMContractsTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyMMContractsTabContainer");
            }
        }
...
// Base class for the VPropertyMMContractsTableControl control on the ShowVPropertyMMContractsTable page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void VPropertyMMContractsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyMMContractsTable.VPropertyMMContractsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyMMContracts";
                // If ShowVPropertyMMContractsTable.VPropertyMMContractsPDFButton.report specifies a valid report template,
        ...
        public virtual void VPropertyMMContractsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyMMContractsTable.VPropertyMMContractsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyMMContracts";
                // If ShowVPropertyMMContractsTable.VPropertyMMContractsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual VPropertyMMContractsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (VPropertyMMContractsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowVPropertyMMContractsTable.VPropertyMMContractsTableControlRow")));
...
// Base class for the CitiesRecordControl control on the ShowVPropertyMMContractsTable page.
...
public class BaseCitiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          VPropertyMMContractsTableControlRow parentCtrl;
      
            parentCtrl = (VPropertyMMContractsTableControlRow)MiscUtils.GetParentControlObject(this, "VPropertyMMContractsTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue vPropertyMMContractsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = vPropertyMMContractsRecordObj;
          vPropertyMMContractsRecordObj = tmp;
        VPropertyMMContractsTableControlRow vPropertyMMContractsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "VPropertyMMContractsTableControlRow") as VPropertyMMContractsTableControlRow);
          
              if (vPropertyMMContractsTableControlObjRow != null && vPropertyMMContractsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(CitiesTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, vPropertyMMContractsTableControlObjRow.GetRecord().CityID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInVPropertyMMContractsTableControl = HttpContext.Current.Session["CitiesRecordControlWhereClause"] as string;
      
      if (selectedRecordInVPropertyMMContractsTableControl != null && KeyValue.IsXmlKey(selectedRecordInVPropertyMMContractsTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInVPropertyMMContractsTableControl);
...
// Base class for the PropertiesRecordControl control on the ShowVPropertyMMContractsTable page.
...
public class BasePropertiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        VPropertyMMContractsTableControlRow vPropertyMMContractsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "VPropertyMMContractsTableControlRow") as VPropertyMMContractsTableControlRow);
              ...
              if (vPropertyMMContractsTableControlObjRow != null && vPropertyMMContractsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertiesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, vPropertyMMContractsTableControlObjRow.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInVPropertyMMContractsTableControl = HttpContext.Current.Session["PropertiesRecordControlWhereClause"] as string;
...
// Base class for the RegionsRecordControl control on the ShowVPropertyMMContractsTable page.
...
public class BaseRegionsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        VPropertyMMContractsTableControlRow vPropertyMMContractsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "VPropertyMMContractsTableControlRow") as VPropertyMMContractsTableControlRow);
              ...
              if (vPropertyMMContractsTableControlObjRow != null && vPropertyMMContractsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(RegionsTable.RegionID, BaseFilter.ComparisonOperator.EqualsTo, vPropertyMMContractsTableControlObjRow.GetRecord().RegionID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInVPropertyMMContractsTableControl = HttpContext.Current.Session["RegionsRecordControlWhereClause"] as string;
