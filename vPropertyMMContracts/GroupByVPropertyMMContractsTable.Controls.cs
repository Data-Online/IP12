...
// GroupByVPropertyMMContractsTable.aspx page.  The Row or RecordControl classes are the 
    ...
    public class VPropertyMMContractsTableControl : BaseVPropertyMMContractsTableControl
{
    ...
    // The VPropertyMMContractsTableControlRow class offers another place where you can customize
...
// Base class for the VPropertyMMContractsTableControlRow control on the GroupByVPropertyMMContractsTable page.
// Do not modify this class. Instead override any method in VPropertyMMContractsTableControlRow.
public class BaseVPropertyMMContractsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        public BaseVPropertyMMContractsTableControlRow()
        {
        ...
        // To customize, override this method in VPropertyMMContractsTableControlRow.
        ...
        {
            // Load the data from the database into the DataSource DatabaseMM_IP1%dbo.vPropertyMMContracts record.
            ...
            this.DataSource = new VPropertyMMContractsRecord();
        ...
        public virtual void SetAddress1()
        {
            ...
            if (this.DataSource != null && this.DataSource.Address1Specified) {
               ...
               string formattedValue = this.DataSource.Format(VPropertyMMContractsView.Address1);
              ...
              this.Address1.Text = VPropertyMMContractsView.Address1.Format(VPropertyMMContractsView.Address1.DefaultValue);
        ...
        public virtual void SetAddress2()
        {
            ...
            if (this.DataSource != null && this.DataSource.Address2Specified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(VPropertyMMContractsView.Address2);
              ...
              this.Address2.Text = VPropertyMMContractsView.Address2.Format(VPropertyMMContractsView.Address2.DefaultValue);
        ...
        public virtual void SetAddress3()
        {
            ...
            if (this.DataSource != null && this.DataSource.Address3Specified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(VPropertyMMContractsView.Address3);
              ...
              this.Address3.Text = VPropertyMMContractsView.Address3.Format(VPropertyMMContractsView.Address3.DefaultValue);
        ...
        public virtual void SetCityID()
        {
            ...
            if (this.DataSource != null && this.DataSource.CityIDSpecified) {
               ...
               Boolean _isExpandableNonCompositeForeignKey = VPropertyMMContractsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyMMContractsView.CityID);
               if(_isExpandableNonCompositeForeignKey &&VPropertyMMContractsView.CityID.IsApplyDisplayAs)
                                  
                     formattedValue = VPropertyMMContractsView.GetDFKA(this.DataSource.CityID.ToString(),VPropertyMMContractsView.CityID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(VPropertyMMContractsView.CityID);
              ...
              this.CityID.Text = VPropertyMMContractsView.CityID.Format(VPropertyMMContractsView.CityID.DefaultValue);
        ...
        public virtual void SetCountryID()
        {
            ...
            if (this.DataSource != null && this.DataSource.CountryIDSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = VPropertyMMContractsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyMMContractsView.CountryID);
               if(_isExpandableNonCompositeForeignKey &&VPropertyMMContractsView.CountryID.IsApplyDisplayAs)
                                  
                     formattedValue = VPropertyMMContractsView.GetDFKA(this.DataSource.CountryID.ToString(),VPropertyMMContractsView.CountryID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(VPropertyMMContractsView.CountryID);
              ...
              this.CountryID.Text = VPropertyMMContractsView.CountryID.Format(VPropertyMMContractsView.CountryID.DefaultValue);
        ...
        public virtual void SetDescription()
        {
            ...
            if (this.DataSource != null && this.DataSource.DescriptionSpecified) {
              ...
              this.Description.Text = VPropertyMMContractsView.Description.Format(VPropertyMMContractsView.Description.DefaultValue);
        ...
        public virtual void SetExpiryDate()
        {
            ...
            if (this.DataSource != null && this.DataSource.ExpiryDateSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(VPropertyMMContractsView.ExpiryDate, @"d");
              ...
              this.ExpiryDate.Text = VPropertyMMContractsView.ExpiryDate.Format(VPropertyMMContractsView.ExpiryDate.DefaultValue, @"d");
        ...
        public virtual void SetPostCode()
        {
            ...
            if (this.DataSource != null && this.DataSource.PostCodeSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(VPropertyMMContractsView.PostCode);
              ...
              this.PostCode.Text = VPropertyMMContractsView.PostCode.Format(VPropertyMMContractsView.PostCode.DefaultValue);
        ...
        public virtual void SetPropertyID()
        {
            ...
            if (this.DataSource != null && this.DataSource.PropertyIDSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = VPropertyMMContractsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyMMContractsView.PropertyID);
               if(_isExpandableNonCompositeForeignKey &&VPropertyMMContractsView.PropertyID.IsApplyDisplayAs)
                                  
                     formattedValue = VPropertyMMContractsView.GetDFKA(this.DataSource.PropertyID.ToString(),VPropertyMMContractsView.PropertyID, null);
        ...
        public virtual void SetRegionID()
        {
            ...
            if (this.DataSource != null && this.DataSource.RegionIDSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = VPropertyMMContractsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyMMContractsView.RegionID);
               if(_isExpandableNonCompositeForeignKey &&VPropertyMMContractsView.RegionID.IsApplyDisplayAs)
                                  
                     formattedValue = VPropertyMMContractsView.GetDFKA(this.DataSource.RegionID.ToString(),VPropertyMMContractsView.RegionID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(VPropertyMMContractsView.RegionID);
              ...
              this.RegionID.Text = VPropertyMMContractsView.RegionID.Format(VPropertyMMContractsView.RegionID.DefaultValue);
      ...
      // To customize, override this method in VPropertyMMContractsTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersVPropertyMMContractsTableControl = false;
            hasFiltersVPropertyMMContractsTableControl = hasFiltersVPropertyMMContractsTableControl && false; // suppress warning
      ...
      this.Page.Response.Redirect(url);
        ...
        public VPropertyMMContractsRecord DataSource {
            get {
                return (VPropertyMMContractsRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    VPropertyMMContractsRecord rec = null;
        ...
        public virtual VPropertyMMContractsRecord GetRecord()
...
// Base class for the VPropertyMMContractsTableControl control on the GroupByVPropertyMMContractsTable page.
// Do not modify this class. Instead override any method in VPropertyMMContractsTableControl.
public class BaseVPropertyMMContractsTableControl : IPv5.UI.BaseApplicationTableControl
{
         
       public BaseVPropertyMMContractsTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.VPropertyMMContractsSearch)) 				
                    initialVal = this.GetFromSession(this.VPropertyMMContractsSearch);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.VPropertyMMContractsSearch.Text = initialVal;
    ...
    // Setup default pagination settings.
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            // Setup the pagination events.
                    ...
                    this.VPropertyMMContractsPagination.FirstPage.Click += VPropertyMMContractsPagination_FirstPage_Click;
                        
                    this.VPropertyMMContractsPagination.LastPage.Click += VPropertyMMContractsPagination_LastPage_Click;
                        
                    this.VPropertyMMContractsPagination.NextPage.Click += VPropertyMMContractsPagination_NextPage_Click;
                        
                    this.VPropertyMMContractsPagination.PageSizeButton.Click += VPropertyMMContractsPagination_PageSizeButton_Click;
                        
                    this.VPropertyMMContractsPagination.PreviousPage.Click += VPropertyMMContractsPagination_PreviousPage_Click;
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.VPropertyMMContractsExportExcelButton.Click += VPropertyMMContractsExportExcelButton_Click;
                        
                    this.VPropertyMMContractsPDFButton.Click += VPropertyMMContractsPDFButton_Click;
                        
                    this.VPropertyMMContractsResetButton.Click += VPropertyMMContractsResetButton_Click;
                        
                    this.VPropertyMMContractsSearchButton.Click += VPropertyMMContractsSearchButton_Click;
                        
                    this.VPropertyMMContractsWordButton.Click += VPropertyMMContractsWordButton_Click;
                        
                    this.VPropertyMMContractsButtonsButton.Button.Click += VPropertyMMContractsButtonsButton_Click;
                        
                    this.VPropertyMMContractsFilterButton.Button.Click += VPropertyMMContractsFilterButton_Click;
                        
                    this.VPropertyMMContractsFiltersButton.Button.Click += VPropertyMMContractsFiltersButton_Click;
         ...
         //' Setup events for others
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "VPropertyMMContractsSearchSearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + VPropertyMMContractsSearch.ClientID + "\");", true);
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(IPv5.Business.VPropertyMMContractsRecord);
                      this.DataSource = (VPropertyMMContractsRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (VPropertyMMContractsTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(IPv5.Business.VPropertyMMContractsRecord);
                    this.DataSource = (VPropertyMMContractsRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual VPropertyMMContractsRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(VPropertyMMContractsView.Column1, true);          
            // selCols.Add(VPropertyMMContractsView.Column2, true);          
            // selCols.Add(VPropertyMMContractsView.Column3, true);          
                  ...
                  
            {
                ...
                return VPropertyMMContractsView.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                VPropertyMMContractsView databaseTable = new VPropertyMMContractsView();
                ...
                return (recList.ToArray(typeof(VPropertyMMContractsRecord)) as VPropertyMMContractsRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return VPropertyMMContractsView.GetRecordCount(join, where);
            else
            {
                VPropertyMMContractsView databaseTable = new VPropertyMMContractsView();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyMMContractsTableControlRepeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            VPropertyMMContractsTableControlRow recControl = (VPropertyMMContractsTableControlRow)(repItem.FindControl("VPropertyMMContractsTableControlRow"));
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetVPropertyMMContractsSearch();
                
                
                
                
                SetVPropertyMMContractsExportExcelButton();
              
                SetVPropertyMMContractsPDFButton();
              
                SetVPropertyMMContractsResetButton();
              
                SetVPropertyMMContractsSearchButton();
              
                SetVPropertyMMContractsWordButton();
              
                SetVPropertyMMContractsButtonsButton();
              
                SetVPropertyMMContractsFilterButton();
              
                SetVPropertyMMContractsFiltersButton();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        if (this.TotalRecords > 10000)
          this.VPropertyMMContractsExportExcelButton.Attributes.Add("onClick", "return (confirm('" + ((BaseApplicationPage)this.Page).GetResourceValue("ExportConfirm", "IPv5") + "'));");
        else
          this.VPropertyMMContractsExportExcelButton.Attributes.Remove("onClick");
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(VPropertyMMContractsView.CityID, this.DataSource);
            this.Page.PregetDfkaRecords(VPropertyMMContractsView.CountryID, this.DataSource);
            this.Page.PregetDfkaRecords(VPropertyMMContractsView.PropertyID, this.DataSource);
            this.Page.PregetDfkaRecords(VPropertyMMContractsView.RegionID, this.DataSource);
        }
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"VPropertyMMContractsExportExcelButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"VPropertyMMContractsPDFButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"VPropertyMMContractsWordButton"));
        ...
        public virtual void ResetControl()
        {
            ...
            this.VPropertyMMContractsSearch.Text = "";
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            {
                this.VPropertyMMContractsPagination.CurrentPage.Text = (this.PageIndex + 1).ToString();
            } 
            else
            {
            ...
            this.VPropertyMMContractsPagination.FirstPage.Enabled = !(this.PageIndex == 0);
            if (this._TotalPages < 0)             // if the total pages is not determined yet, enable last and next buttons
                this.VPropertyMMContractsPagination.LastPage.Enabled = true;
            else if (this._TotalPages == 0)          // if the total pages is determined and it is 0, enable last and next buttons
                this.VPropertyMMContractsPagination.LastPage.Enabled = false;            
            else                                     // if the total pages is the last page, disable last and next buttons
                this.VPropertyMMContractsPagination.LastPage.Enabled = !(this.PageIndex == this.TotalPages - 1);            
          
            if (this._TotalPages < 0)             // if the total pages is not determined yet, enable last and next buttons
                this.VPropertyMMContractsPagination.NextPage.Enabled = true;
            else if (this._TotalPages == 0)          // if the total pages is determined and it is 0, enable last and next buttons
                this.VPropertyMMContractsPagination.NextPage.Enabled = false;            
            else                                     // if the total pages is the last page, disable last and next buttons
                this.VPropertyMMContractsPagination.NextPage.Enabled = !(this.PageIndex == this.TotalPages - 1);            
          
            this.VPropertyMMContractsPagination.PreviousPage.Enabled = !(this.PageIndex == 0);    
        }
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            VPropertyMMContractsView.Instance.InnerFilter = null;
            ...
            if (MiscUtils.IsValueSelected(this.CityIDFilter)) {
                ...
                wc.iAND(VPropertyMMContractsView.CityID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.CityIDFilter, this.GetFromSession(this.CityIDFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.PropertyIDFilter)) {
                        
                wc.iAND(VPropertyMMContractsView.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.PropertyIDFilter, this.GetFromSession(this.PropertyIDFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.VPropertyMMContractsSearch)) {
                if (this.VPropertyMMContractsSearch.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.VPropertyMMContractsSearch.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.VPropertyMMContractsSearch.Text.StartsWith("...")) {
                      this.VPropertyMMContractsSearch.Text = this.VPropertyMMContractsSearch.Text.Substring(3,this.VPropertyMMContractsSearch.Text.Length-3);
                  }
                  if (this.VPropertyMMContractsSearch.Text.EndsWith("...")) {
                      this.VPropertyMMContractsSearch.Text = this.VPropertyMMContractsSearch.Text.Substring(0,this.VPropertyMMContractsSearch.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.VPropertyMMContractsSearch.Text.Length - 1;
                      while (!Char.IsWhiteSpace(VPropertyMMContractsSearch.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.VPropertyMMContractsSearch.Text = this.VPropertyMMContractsSearch.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.VPropertyMMContractsSearch, this.GetFromSession(this.VPropertyMMContractsSearch));
      ...
      cols.Add(VPropertyMMContractsView.CompanyName, true);
      
      cols.Add(VPropertyMMContractsView.Address1, true);
      
      foreach(BaseColumn col in cols)
      {
      
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.VPropertyMMContractsSearch, this.GetFromSession(this.VPropertyMMContractsSearch)), true, false);
      ...
      String CityIDFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CityIDFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CityIDFilterSelectedValue)) {
                ...
                wc.iAND(VPropertyMMContractsView.CityID, BaseFilter.ComparisonOperator.EqualsTo, CityIDFilterSelectedValue, false, false);
      ...
      String PropertyIDFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "PropertyIDFilter_Ajax"];
            if (MiscUtils.IsValueSelected(PropertyIDFilterSelectedValue)) {
                ...
                wc.iAND(VPropertyMMContractsView.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, PropertyIDFilterSelectedValue, false, false);
                      
      }
                      
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "VPropertyMMContractsSearch") {
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_VPropertyMMContractsSearch(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"VPropertyMMContractsSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
            IPv5.Business.VPropertyMMContractsRecord[] recordList  = VPropertyMMContractsView.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (VPropertyMMContractsRecord rec in recordList ){
                ...
                resultItem = rec.Format(VPropertyMMContractsView.CompanyName);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(VPropertyMMContractsView.CompanyName.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, VPropertyMMContractsView.CompanyName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(VPropertyMMContractsView.Address1);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(VPropertyMMContractsView.Address1.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, VPropertyMMContractsView.Address1.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void GetPageSize()
        {
            ...
            if (this.VPropertyMMContractsPagination.PageSize.Text.Length > 0) {
                try {
                    // this.PageSize = Convert.ToInt32(this.VPropertyMMContractsPagination.PageSize.Text);
                } catch (Exception ) {
                }
            }
        }
      ...
      VPropertyMMContractsRecord rec = new VPropertyMMContractsRecord();
        
                        if (recControl.Address1.Text != "") {
                            rec.Parse(recControl.Address1.Text, VPropertyMMContractsView.Address1);
                  }
                
                        if (recControl.Address2.Text != "") {
                            rec.Parse(recControl.Address2.Text, VPropertyMMContractsView.Address2);
                  }
                
                        if (recControl.Address3.Text != "") {
                            rec.Parse(recControl.Address3.Text, VPropertyMMContractsView.Address3);
                  }
                        ...
                        if (recControl.Description.Text != "") {
                            rec.Parse(recControl.Description.Text, VPropertyMMContractsView.Description);
                  }
                        ...
                        if (recControl.PostCode.Text != "") {
                            rec.Parse(recControl.PostCode.Text, VPropertyMMContractsView.PostCode);
                  }
                
                        if (recControl.PropertyID.Text != "") {
                            rec.Parse(recControl.PropertyID.Text, VPropertyMMContractsView.PropertyID);
                  }
                
                        if (recControl.RegionID.Text != "") {
                            rec.Parse(recControl.RegionID.Text, VPropertyMMContractsView.RegionID);
                  }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new VPropertyMMContractsRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(IPv5.Business.VPropertyMMContractsRecord);
                this.DataSource = (VPropertyMMContractsRecord[])(finalList.ToArray(myrec));
        ...
        public virtual void SetVPropertyMMContractsSearch()
        {
                                            
            this.VPropertyMMContractsSearch.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.VPropertyMMContractsSearch.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
                    ...
                    foreach (CitiesRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.CityIDSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.CityIDFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = VPropertyMMContractsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyMMContractsView.CityID);
                                if(_isExpandableNonCompositeForeignKey && VPropertyMMContractsView.CityID.IsApplyDisplayAs)
                                     fvalue = VPropertyMMContractsView.GetDFKA(itemValue, VPropertyMMContractsView.CityID);
                    ...
                    foreach (PropertiesRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.PropertyIDSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.PropertyIDFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = VPropertyMMContractsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyMMContractsView.PropertyID);
                                if(_isExpandableNonCompositeForeignKey && VPropertyMMContractsView.PropertyID.IsApplyDisplayAs)
                                     fvalue = VPropertyMMContractsView.GetDFKA(itemValue, VPropertyMMContractsView.PropertyID);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.VPropertyMMContractsSearch, this.VPropertyMMContractsSearch.Text);
      ...
      this.SaveToSession("VPropertyMMContractsSearch_Ajax", this.VPropertyMMContractsSearch.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.VPropertyMMContractsSearch);
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["VPropertyMMContractsTableControl_OrderBy"];
            ...
            Control Pagination = this.FindControl("VPropertyMMContractsPagination");
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["VPropertyMMContractsTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetVPropertyMMContractsExportExcelButton()                
        ...
        public virtual void SetVPropertyMMContractsPDFButton()                
        ...
        public virtual void SetVPropertyMMContractsResetButton()                
        ...
        public virtual void SetVPropertyMMContractsSearchButton()                
        ...
        public virtual void SetVPropertyMMContractsWordButton()                
        ...
        public virtual void SetVPropertyMMContractsButtonsButton()                
        ...
        public virtual void SetVPropertyMMContractsFilterButton()                
        ...
        public virtual void SetVPropertyMMContractsFiltersButton()                
              
        {
                
         IThemeButtonWithArrow themeButtonVPropertyMMContractsFiltersButton = (IThemeButtonWithArrow)(MiscUtils.FindControlRecursively(this, "VPropertyMMContractsFiltersButton"));
         themeButtonVPropertyMMContractsFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
    
      
            if (MiscUtils.IsValueSelected(CityIDFilter))
                themeButtonVPropertyMMContractsFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void VPropertyMMContractsPagination_FirstPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void VPropertyMMContractsPagination_LastPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void VPropertyMMContractsPagination_NextPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for LinkButton
        public virtual void VPropertyMMContractsPagination_PageSizeButton_Click(object sender, EventArgs args)
        {
            ...
            this.PageSize = this.VPropertyMMContractsPagination.GetCurrentPageSize();
      
            this.PageIndex = Convert.ToInt32(this.VPropertyMMContractsPagination.CurrentPage.Text) - 1;
        ...
        // event handler for ImageButton
        public virtual void VPropertyMMContractsPagination_PreviousPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        public virtual void Address2SortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(VPropertyMMContractsView.Address2);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(VPropertyMMContractsView.Address2, OrderByItem.OrderDir.Asc);
        ...
        public virtual void Address3SortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(VPropertyMMContractsView.Address3);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(VPropertyMMContractsView.Address3, OrderByItem.OrderDir.Asc);
        ...
        public virtual void CompanyNameSortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(VPropertyMMContractsView.CompanyName);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
        ...
        public virtual void MMContractIDSortLabel_Click(object sender, EventArgs args)
        {
            //Sorts by MMContractID when clicked.
              
            // Get previous sorting state for MMContractID.
        
            OrderByItem sd = this.CurrentSortOrder.Find(VPropertyMMContractsView.MMContractID);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for MMContractID.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(VPropertyMMContractsView.MMContractID, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by MMContractID, so just reverse.
                sd.Reverse();
            }
        ...
        // event handler for ImageButton
        public virtual void VPropertyMMContractsExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = VPropertyMMContractsView.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
             ...
             VPropertyMMContractsView.CityID,
             VPropertyMMContractsView.RegionID,
             VPropertyMMContractsView.CountryID,
             ...
             null};
                ...
                DataForExport dataForCSV = new DataForExport(VPropertyMMContractsView.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(VPropertyMMContractsView.Instance, wc, orderBy);
              // Add each of the columns in order of export.
             ...
             data.ColumnList.Add(new ExcelColumn(VPropertyMMContractsView.CityID, "Default"));
             data.ColumnList.Add(new ExcelColumn(VPropertyMMContractsView.RegionID, "Default"));
             data.ColumnList.Add(new ExcelColumn(VPropertyMMContractsView.CountryID, "Default"));
             ...
             data.ColumnList.Add(new ExcelColumn(VPropertyMMContractsView.Description, "Default"));
              ...
              {
                val = VPropertyMMContractsView.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        // event handler for ImageButton
        public virtual void VPropertyMMContractsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByVPropertyMMContractsTable.VPropertyMMContractsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyMMContracts";
                // If GroupByVPropertyMMContractsTable.VPropertyMMContractsPDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(VPropertyMMContractsView.CityID.Name, ReportEnum.Align.Left, "${CityID}", ReportEnum.Align.Left, 28);
                 report.AddColumn(VPropertyMMContractsView.RegionID.Name, ReportEnum.Align.Left, "${RegionID}", ReportEnum.Align.Left, 28);
                 report.AddColumn(VPropertyMMContractsView.CountryID.Name, ReportEnum.Align.Left, "${CountryID}", ReportEnum.Align.Left, 28);
                ...
                ColumnList columns = VPropertyMMContractsView.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = VPropertyMMContractsView.GetRecordCount(joinFilter,whereClause);
                VPropertyMMContractsRecord[] records = null;
                
                do
                {
                    
                    records = VPropertyMMContractsView.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( VPropertyMMContractsRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.CityID)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = VPropertyMMContractsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyMMContractsView.CityID);
                                 _DFKA = VPropertyMMContractsView.GetDFKA(record.CityID.ToString(), VPropertyMMContractsView.CityID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  VPropertyMMContractsView.CityID.IsApplyDisplayAs){
                                     report.AddData("${CityID}", _DFKA,ReportEnum.Align.Left, 100);
                                 }else{
                                     report.AddData("${CityID}", record.Format(VPropertyMMContractsView.CityID), ReportEnum.Align.Left, 100);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.RegionID)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = VPropertyMMContractsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyMMContractsView.RegionID);
                                 _DFKA = VPropertyMMContractsView.GetDFKA(record.RegionID.ToString(), VPropertyMMContractsView.RegionID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  VPropertyMMContractsView.RegionID.IsApplyDisplayAs){
                                     report.AddData("${RegionID}", _DFKA,ReportEnum.Align.Left, 100);
                                 }else{
                                     report.AddData("${RegionID}", record.Format(VPropertyMMContractsView.RegionID), ReportEnum.Align.Left, 100);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.CountryID)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = VPropertyMMContractsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyMMContractsView.CountryID);
                                 _DFKA = VPropertyMMContractsView.GetDFKA(record.CountryID.ToString(), VPropertyMMContractsView.CountryID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  VPropertyMMContractsView.CountryID.IsApplyDisplayAs){
                                     report.AddData("${CountryID}", _DFKA,ReportEnum.Align.Left, 100);
                                 }else{
                                     report.AddData("${CountryID}", record.Format(VPropertyMMContractsView.CountryID), ReportEnum.Align.Left, 100);
                                 }
                             }
        ...
        // event handler for ImageButton
        public virtual void VPropertyMMContractsResetButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void VPropertyMMContractsSearchButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void VPropertyMMContractsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByVPropertyMMContractsTable.VPropertyMMContractsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyMMContracts";
                // If GroupByVPropertyMMContractsTable.VPropertyMMContractsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void VPropertyMMContractsButtonsButton_Click(object sender, EventArgs args)
        {
        ...
        // event handler for Button
        public virtual void VPropertyMMContractsFilterButton_Click(object sender, EventArgs args)
        {
        ...
        // event handler for Button
        public virtual void VPropertyMMContractsFiltersButton_Click(object sender, EventArgs args)
        {
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = VPropertyMMContractsView.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  VPropertyMMContractsRecord[] DataSource {
            ...
            get {
                return (VPropertyMMContractsRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public IPv5.UI.IThemeButtonWithArrow VPropertyMMContractsButtonsButton {
            get {
                return (IPv5.UI.IThemeButtonWithArrow)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyMMContractsButtonsButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton VPropertyMMContractsExportExcelButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyMMContractsExportExcelButton");
            }
        }
        
        public IPv5.UI.IThemeButton VPropertyMMContractsFilterButton {
            get {
                return (IPv5.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyMMContractsFilterButton");
            }
        }
        
        public IPv5.UI.IThemeButtonWithArrow VPropertyMMContractsFiltersButton {
            get {
                return (IPv5.UI.IThemeButtonWithArrow)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyMMContractsFiltersButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton VPropertyMMContractsPDFButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyMMContractsPDFButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton VPropertyMMContractsResetButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyMMContractsResetButton");
            }
        }
        
        public System.Web.UI.WebControls.TextBox VPropertyMMContractsSearch {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyMMContractsSearch");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton VPropertyMMContractsSearchButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyMMContractsSearchButton");
            }
        }
        
        public System.Web.UI.WebControls.Literal VPropertyMMContractsTitle {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyMMContractsTitle");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton VPropertyMMContractsWordButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyMMContractsWordButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual VPropertyMMContractsTableControlRow[] GetSelectedRecordControls()
        {
        
            return (VPropertyMMContractsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByVPropertyMMContractsTable.VPropertyMMContractsTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            VPropertyMMContractsTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "IPv5"));
            }
            
            foreach (VPropertyMMContractsTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual VPropertyMMContractsTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "VPropertyMMContractsTableControlRow");
	          List<VPropertyMMContractsTableControlRow> list = new List<VPropertyMMContractsTableControlRow>();
	          foreach (VPropertyMMContractsTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
