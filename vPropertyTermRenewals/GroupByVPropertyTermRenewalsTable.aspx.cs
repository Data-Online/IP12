...
// This file implements the code-behind class for GroupByVPropertyTermRenewalsTable.aspx.
// GroupByVPropertyTermRenewalsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByVPropertyTermRenewalsTable
        : BaseApplicationPage
// Code-behind class for the GroupByVPropertyTermRenewalsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByVPropertyTermRenewalsTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_VPropertyTermRenewalsSearch(string prefixText, int count)
        {
            // GetVPropertyTermRenewalsSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_VPropertyTermRenewalsSearch_Base()
            // or replace the call to GetAutoCompletionList_VPropertyTermRenewalsSearch_Base().
            return GetAutoCompletionList_VPropertyTermRenewalsSearch_Base(prefixText, count);
        }
...
public void SetVPropertyTermRenewalsTableControl()
        {
            SetVPropertyTermRenewalsTableControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButtonWithArrow VPropertyTermRenewalsButtonsButton;
                
        public System.Web.UI.WebControls.ImageButton VPropertyTermRenewalsExportExcelButton;
        
        public ThemeButton VPropertyTermRenewalsFilterButton;
                
        public ThemeButtonWithArrow VPropertyTermRenewalsFiltersButton;
                
        public PaginationModern VPropertyTermRenewalsPagination;
        ...
        public IPv5.UI.Controls.GroupByVPropertyTermRenewalsTable.VPropertyTermRenewalsTableControl VPropertyTermRenewalsTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = "Property Term Renewals";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "VPropertyTermRenewalsTableControl":
                 SetVPropertyTermRenewalsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.VPropertyTermRenewalsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_VPropertyTermRenewalsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByVPropertyTermRenewalsTable.VPropertyTermRenewalsTableControl control = new IPv5.UI.Controls.GroupByVPropertyTermRenewalsTable.VPropertyTermRenewalsTableControl();
        
        return control.GetAutoCompletionList_VPropertyTermRenewalsSearch(prefixText, count);
        ...
        SetVPropertyTermRenewalsTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "VPropertyTermRenewalsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVPropertyTermRenewalsTableControl_Base()           
        
        {        
            if (VPropertyTermRenewalsTableControl.Visible)
            {
                VPropertyTermRenewalsTableControl.LoadData();
                VPropertyTermRenewalsTableControl.DataBind();
            }
        }
