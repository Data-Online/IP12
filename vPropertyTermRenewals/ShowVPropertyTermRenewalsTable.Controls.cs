...
// ShowVPropertyTermRenewalsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowVPropertyTermRenewalsTable
{
...
// Base class for the VPropertyTermRenewalsTableControlRow control on the ShowVPropertyTermRenewalsTable page.
...
public class BaseVPropertyTermRenewalsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetVPropertyTermRenewalsTabContainer();
        ...
        public virtual void SetVPropertyTermRenewalsTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsTabContainer").Visible = false;
...
#region "Helper Properties"
        ...
        public AjaxControlToolkit.TabContainer VPropertyTermRenewalsTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsTabContainer");
            }
        }
...
// Base class for the VPropertyTermRenewalsTableControl control on the ShowVPropertyTermRenewalsTable page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void VPropertyTermRenewalsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyTermRenewalsTable.VPropertyTermRenewalsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyTermRenewals";
                // If ShowVPropertyTermRenewalsTable.VPropertyTermRenewalsPDFButton.report specifies a valid report template,
        ...
        public virtual void VPropertyTermRenewalsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyTermRenewalsTable.VPropertyTermRenewalsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyTermRenewals";
                // If ShowVPropertyTermRenewalsTable.VPropertyTermRenewalsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual VPropertyTermRenewalsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (VPropertyTermRenewalsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowVPropertyTermRenewalsTable.VPropertyTermRenewalsTableControlRow")));
...
// Base class for the CitiesRecordControl control on the ShowVPropertyTermRenewalsTable page.
...
public class BaseCitiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          VPropertyTermRenewalsTableControlRow parentCtrl;
      
            parentCtrl = (VPropertyTermRenewalsTableControlRow)MiscUtils.GetParentControlObject(this, "VPropertyTermRenewalsTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue vPropertyTermRenewalsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = vPropertyTermRenewalsRecordObj;
          vPropertyTermRenewalsRecordObj = tmp;
        VPropertyTermRenewalsTableControlRow vPropertyTermRenewalsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "VPropertyTermRenewalsTableControlRow") as VPropertyTermRenewalsTableControlRow);
          
              if (vPropertyTermRenewalsTableControlObjRow != null && vPropertyTermRenewalsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(CitiesTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, vPropertyTermRenewalsTableControlObjRow.GetRecord().CityID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInVPropertyTermRenewalsTableControl = HttpContext.Current.Session["CitiesRecordControlWhereClause"] as string;
      
      if (selectedRecordInVPropertyTermRenewalsTableControl != null && KeyValue.IsXmlKey(selectedRecordInVPropertyTermRenewalsTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInVPropertyTermRenewalsTableControl);
...
// Base class for the CountriesRecordControl control on the ShowVPropertyTermRenewalsTable page.
...
public class BaseCountriesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        VPropertyTermRenewalsTableControlRow vPropertyTermRenewalsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "VPropertyTermRenewalsTableControlRow") as VPropertyTermRenewalsTableControlRow);
              ...
              if (vPropertyTermRenewalsTableControlObjRow != null && vPropertyTermRenewalsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(CountriesTable.CountryID, BaseFilter.ComparisonOperator.EqualsTo, vPropertyTermRenewalsTableControlObjRow.GetRecord().CountryID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInVPropertyTermRenewalsTableControl = HttpContext.Current.Session["CountriesRecordControlWhereClause"] as string;
...
// Base class for the RegionsRecordControl control on the ShowVPropertyTermRenewalsTable page.
...
public class BaseRegionsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        VPropertyTermRenewalsTableControlRow vPropertyTermRenewalsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "VPropertyTermRenewalsTableControlRow") as VPropertyTermRenewalsTableControlRow);
              ...
              if (vPropertyTermRenewalsTableControlObjRow != null && vPropertyTermRenewalsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(RegionsTable.RegionID, BaseFilter.ComparisonOperator.EqualsTo, vPropertyTermRenewalsTableControlObjRow.GetRecord().RegionID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInVPropertyTermRenewalsTableControl = HttpContext.Current.Session["RegionsRecordControlWhereClause"] as string;
