...
// GroupByVPropertyTermRenewalsTable.aspx page.  The Row or RecordControl classes are the 
    ...
    public class VPropertyTermRenewalsTableControl : BaseVPropertyTermRenewalsTableControl
{
    ...
    // The VPropertyTermRenewalsTableControlRow class offers another place where you can customize
...
// Base class for the VPropertyTermRenewalsTableControlRow control on the GroupByVPropertyTermRenewalsTable page.
// Do not modify this class. Instead override any method in VPropertyTermRenewalsTableControlRow.
public class BaseVPropertyTermRenewalsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        public BaseVPropertyTermRenewalsTableControlRow()
        {
        ...
        // To customize, override this method in VPropertyTermRenewalsTableControlRow.
        ...
        {
            // Load the data from the database into the DataSource DatabaseMM_IP1%dbo.vPropertyTermRenewals record.
            ...
            this.DataSource = new VPropertyTermRenewalsRecord();
        ...
        public virtual void SetAddress1()
        {
            ...
            if (this.DataSource != null && this.DataSource.Address1Specified) {
               ...
               string formattedValue = this.DataSource.Format(VPropertyTermRenewalsView.Address1);
              ...
              this.Address1.Text = VPropertyTermRenewalsView.Address1.Format(VPropertyTermRenewalsView.Address1.DefaultValue);
        ...
        public virtual void SetAddress2()
        {
            ...
            if (this.DataSource != null && this.DataSource.Address2Specified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(VPropertyTermRenewalsView.Address2);
              ...
              this.Address2.Text = VPropertyTermRenewalsView.Address2.Format(VPropertyTermRenewalsView.Address2.DefaultValue);
        ...
        public virtual void SetAddress3()
        {
            ...
            if (this.DataSource != null && this.DataSource.Address3Specified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(VPropertyTermRenewalsView.Address3);
              ...
              this.Address3.Text = VPropertyTermRenewalsView.Address3.Format(VPropertyTermRenewalsView.Address3.DefaultValue);
        ...
        public virtual void SetCityID()
        {
            ...
            if (this.DataSource != null && this.DataSource.CityIDSpecified) {
               ...
               Boolean _isExpandableNonCompositeForeignKey = VPropertyTermRenewalsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyTermRenewalsView.CityID);
               if(_isExpandableNonCompositeForeignKey &&VPropertyTermRenewalsView.CityID.IsApplyDisplayAs)
                                  
                     formattedValue = VPropertyTermRenewalsView.GetDFKA(this.DataSource.CityID.ToString(),VPropertyTermRenewalsView.CityID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(VPropertyTermRenewalsView.CityID);
              ...
              this.CityID.Text = VPropertyTermRenewalsView.CityID.Format(VPropertyTermRenewalsView.CityID.DefaultValue);
        ...
        public virtual void SetCountryID()
        {
            ...
            if (this.DataSource != null && this.DataSource.CountryIDSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = VPropertyTermRenewalsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyTermRenewalsView.CountryID);
               if(_isExpandableNonCompositeForeignKey &&VPropertyTermRenewalsView.CountryID.IsApplyDisplayAs)
                                  
                     formattedValue = VPropertyTermRenewalsView.GetDFKA(this.DataSource.CountryID.ToString(),VPropertyTermRenewalsView.CountryID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(VPropertyTermRenewalsView.CountryID);
              ...
              this.CountryID.Text = VPropertyTermRenewalsView.CountryID.Format(VPropertyTermRenewalsView.CountryID.DefaultValue);
        ...
        public virtual void SetDescription()
        {
            ...
            if (this.DataSource != null && this.DataSource.DescriptionSpecified) {
              ...
              this.Description.Text = VPropertyTermRenewalsView.Description.Format(VPropertyTermRenewalsView.Description.DefaultValue);
        ...
        public virtual void SetPostCode()
        {
            ...
            if (this.DataSource != null && this.DataSource.PostCodeSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(VPropertyTermRenewalsView.PostCode);
              ...
              this.PostCode.Text = VPropertyTermRenewalsView.PostCode.Format(VPropertyTermRenewalsView.PostCode.DefaultValue);
        ...
        public virtual void SetPropertyID()
        {
            ...
            if (this.DataSource != null && this.DataSource.PropertyIDSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = VPropertyTermRenewalsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyTermRenewalsView.PropertyID);
               if(_isExpandableNonCompositeForeignKey &&VPropertyTermRenewalsView.PropertyID.IsApplyDisplayAs)
                                  
                     formattedValue = VPropertyTermRenewalsView.GetDFKA(this.DataSource.PropertyID.ToString(),VPropertyTermRenewalsView.PropertyID, null);
        ...
        public virtual void SetRegionID()
        {
            ...
            if (this.DataSource != null && this.DataSource.RegionIDSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = VPropertyTermRenewalsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyTermRenewalsView.RegionID);
               if(_isExpandableNonCompositeForeignKey &&VPropertyTermRenewalsView.RegionID.IsApplyDisplayAs)
                                  
                     formattedValue = VPropertyTermRenewalsView.GetDFKA(this.DataSource.RegionID.ToString(),VPropertyTermRenewalsView.RegionID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(VPropertyTermRenewalsView.RegionID);
              ...
              this.RegionID.Text = VPropertyTermRenewalsView.RegionID.Format(VPropertyTermRenewalsView.RegionID.DefaultValue);
        ...
        public virtual void SetRenewalDate()
        {
            ...
            if (this.DataSource != null && this.DataSource.RenewalDateSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(VPropertyTermRenewalsView.RenewalDate, @"d");
              ...
              this.RenewalDate.Text = VPropertyTermRenewalsView.RenewalDate.Format(VPropertyTermRenewalsView.RenewalDate.DefaultValue, @"d");
      ...
      // To customize, override this method in VPropertyTermRenewalsTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersVPropertyTermRenewalsTableControl = false;
            hasFiltersVPropertyTermRenewalsTableControl = hasFiltersVPropertyTermRenewalsTableControl && false; // suppress warning
      ...
      this.Page.Response.Redirect(url);
        ...
        public VPropertyTermRenewalsRecord DataSource {
            get {
                return (VPropertyTermRenewalsRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    VPropertyTermRenewalsRecord rec = null;
        ...
        public virtual VPropertyTermRenewalsRecord GetRecord()
...
// Base class for the VPropertyTermRenewalsTableControl control on the GroupByVPropertyTermRenewalsTable page.
// Do not modify this class. Instead override any method in VPropertyTermRenewalsTableControl.
public class BaseVPropertyTermRenewalsTableControl : IPv5.UI.BaseApplicationTableControl
{
         
       public BaseVPropertyTermRenewalsTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.VPropertyTermRenewalsSearch)) 				
                    initialVal = this.GetFromSession(this.VPropertyTermRenewalsSearch);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.VPropertyTermRenewalsSearch.Text = initialVal;
    ...
    // Setup default pagination settings.
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            // Setup the pagination events.
                    ...
                    this.VPropertyTermRenewalsPagination.FirstPage.Click += VPropertyTermRenewalsPagination_FirstPage_Click;
                        
                    this.VPropertyTermRenewalsPagination.LastPage.Click += VPropertyTermRenewalsPagination_LastPage_Click;
                        
                    this.VPropertyTermRenewalsPagination.NextPage.Click += VPropertyTermRenewalsPagination_NextPage_Click;
                        
                    this.VPropertyTermRenewalsPagination.PageSizeButton.Click += VPropertyTermRenewalsPagination_PageSizeButton_Click;
                        
                    this.VPropertyTermRenewalsPagination.PreviousPage.Click += VPropertyTermRenewalsPagination_PreviousPage_Click;
       ...
       // Setup the sorting events.
              ...
              this.TermRenewalIDSortLabel.Click += TermRenewalIDSortLabel_Click;
            
            // Setup the button events.
          
                    this.VPropertyTermRenewalsExportExcelButton.Click += VPropertyTermRenewalsExportExcelButton_Click;
                        
                    this.VPropertyTermRenewalsPDFButton.Click += VPropertyTermRenewalsPDFButton_Click;
                        
                    this.VPropertyTermRenewalsResetButton.Click += VPropertyTermRenewalsResetButton_Click;
                        
                    this.VPropertyTermRenewalsSearchButton.Click += VPropertyTermRenewalsSearchButton_Click;
                        
                    this.VPropertyTermRenewalsWordButton.Click += VPropertyTermRenewalsWordButton_Click;
                        
                    this.VPropertyTermRenewalsButtonsButton.Button.Click += VPropertyTermRenewalsButtonsButton_Click;
                        
                    this.VPropertyTermRenewalsFilterButton.Button.Click += VPropertyTermRenewalsFilterButton_Click;
                        
                    this.VPropertyTermRenewalsFiltersButton.Button.Click += VPropertyTermRenewalsFiltersButton_Click;
         ...
         //' Setup events for others
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "VPropertyTermRenewalsSearchSearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + VPropertyTermRenewalsSearch.ClientID + "\");", true);
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(IPv5.Business.VPropertyTermRenewalsRecord);
                      this.DataSource = (VPropertyTermRenewalsRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (VPropertyTermRenewalsTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(IPv5.Business.VPropertyTermRenewalsRecord);
                    this.DataSource = (VPropertyTermRenewalsRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual VPropertyTermRenewalsRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(VPropertyTermRenewalsView.Column1, true);          
            // selCols.Add(VPropertyTermRenewalsView.Column2, true);          
            // selCols.Add(VPropertyTermRenewalsView.Column3, true);          
                  ...
                  
            {
                ...
                return VPropertyTermRenewalsView.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                VPropertyTermRenewalsView databaseTable = new VPropertyTermRenewalsView();
                ...
                return (recList.ToArray(typeof(VPropertyTermRenewalsRecord)) as VPropertyTermRenewalsRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return VPropertyTermRenewalsView.GetRecordCount(join, where);
            else
            {
                VPropertyTermRenewalsView databaseTable = new VPropertyTermRenewalsView();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsTableControlRepeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            VPropertyTermRenewalsTableControlRow recControl = (VPropertyTermRenewalsTableControlRow)(repItem.FindControl("VPropertyTermRenewalsTableControlRow"));
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetVPropertyTermRenewalsSearch();
                
                
                
                
                SetVPropertyTermRenewalsExportExcelButton();
              
                SetVPropertyTermRenewalsPDFButton();
              
                SetVPropertyTermRenewalsResetButton();
              
                SetVPropertyTermRenewalsSearchButton();
              
                SetVPropertyTermRenewalsWordButton();
              
                SetVPropertyTermRenewalsButtonsButton();
              
                SetVPropertyTermRenewalsFilterButton();
              
                SetVPropertyTermRenewalsFiltersButton();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        if (this.TotalRecords > 10000)
          this.VPropertyTermRenewalsExportExcelButton.Attributes.Add("onClick", "return (confirm('" + ((BaseApplicationPage)this.Page).GetResourceValue("ExportConfirm", "IPv5") + "'));");
        else
          this.VPropertyTermRenewalsExportExcelButton.Attributes.Remove("onClick");
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(VPropertyTermRenewalsView.CityID, this.DataSource);
            this.Page.PregetDfkaRecords(VPropertyTermRenewalsView.CountryID, this.DataSource);
            this.Page.PregetDfkaRecords(VPropertyTermRenewalsView.PropertyID, this.DataSource);
            this.Page.PregetDfkaRecords(VPropertyTermRenewalsView.RegionID, this.DataSource);
        }
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"VPropertyTermRenewalsExportExcelButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"VPropertyTermRenewalsPDFButton"));
                        
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"VPropertyTermRenewalsWordButton"));
        ...
        public virtual void ResetControl()
        {
            ...
            this.VPropertyTermRenewalsSearch.Text = "";
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            {
                this.VPropertyTermRenewalsPagination.CurrentPage.Text = (this.PageIndex + 1).ToString();
            } 
            else
            {
            ...
            this.VPropertyTermRenewalsPagination.FirstPage.Enabled = !(this.PageIndex == 0);
            if (this._TotalPages < 0)             // if the total pages is not determined yet, enable last and next buttons
                this.VPropertyTermRenewalsPagination.LastPage.Enabled = true;
            else if (this._TotalPages == 0)          // if the total pages is determined and it is 0, enable last and next buttons
                this.VPropertyTermRenewalsPagination.LastPage.Enabled = false;            
            else                                     // if the total pages is the last page, disable last and next buttons
                this.VPropertyTermRenewalsPagination.LastPage.Enabled = !(this.PageIndex == this.TotalPages - 1);            
          
            if (this._TotalPages < 0)             // if the total pages is not determined yet, enable last and next buttons
                this.VPropertyTermRenewalsPagination.NextPage.Enabled = true;
            else if (this._TotalPages == 0)          // if the total pages is determined and it is 0, enable last and next buttons
                this.VPropertyTermRenewalsPagination.NextPage.Enabled = false;            
            else                                     // if the total pages is the last page, disable last and next buttons
                this.VPropertyTermRenewalsPagination.NextPage.Enabled = !(this.PageIndex == this.TotalPages - 1);            
          
            this.VPropertyTermRenewalsPagination.PreviousPage.Enabled = !(this.PageIndex == 0);    
        }
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            VPropertyTermRenewalsView.Instance.InnerFilter = null;
            ...
            if (MiscUtils.IsValueSelected(this.CityIDFilter)) {
                ...
                wc.iAND(VPropertyTermRenewalsView.CityID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.CityIDFilter, this.GetFromSession(this.CityIDFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.RegionIDFilter)) {
                        
                wc.iAND(VPropertyTermRenewalsView.RegionID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.RegionIDFilter, this.GetFromSession(this.RegionIDFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.VPropertyTermRenewalsSearch)) {
                if (this.VPropertyTermRenewalsSearch.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.VPropertyTermRenewalsSearch.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.VPropertyTermRenewalsSearch.Text.StartsWith("...")) {
                      this.VPropertyTermRenewalsSearch.Text = this.VPropertyTermRenewalsSearch.Text.Substring(3,this.VPropertyTermRenewalsSearch.Text.Length-3);
                  }
                  if (this.VPropertyTermRenewalsSearch.Text.EndsWith("...")) {
                      this.VPropertyTermRenewalsSearch.Text = this.VPropertyTermRenewalsSearch.Text.Substring(0,this.VPropertyTermRenewalsSearch.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.VPropertyTermRenewalsSearch.Text.Length - 1;
                      while (!Char.IsWhiteSpace(VPropertyTermRenewalsSearch.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.VPropertyTermRenewalsSearch.Text = this.VPropertyTermRenewalsSearch.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.VPropertyTermRenewalsSearch, this.GetFromSession(this.VPropertyTermRenewalsSearch));
      ...
      cols.Add(VPropertyTermRenewalsView.CompanyName, true);
      
      cols.Add(VPropertyTermRenewalsView.Address1, true);
      
      foreach(BaseColumn col in cols)
      {
      
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.VPropertyTermRenewalsSearch, this.GetFromSession(this.VPropertyTermRenewalsSearch)), true, false);
      ...
      String CityIDFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CityIDFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CityIDFilterSelectedValue)) {
                ...
                wc.iAND(VPropertyTermRenewalsView.CityID, BaseFilter.ComparisonOperator.EqualsTo, CityIDFilterSelectedValue, false, false);
      ...
      String RegionIDFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "RegionIDFilter_Ajax"];
            if (MiscUtils.IsValueSelected(RegionIDFilterSelectedValue)) {
                ...
                wc.iAND(VPropertyTermRenewalsView.RegionID, BaseFilter.ComparisonOperator.EqualsTo, RegionIDFilterSelectedValue, false, false);
                      
      }
                      
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "VPropertyTermRenewalsSearch") {
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_VPropertyTermRenewalsSearch(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"VPropertyTermRenewalsSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
            IPv5.Business.VPropertyTermRenewalsRecord[] recordList  = VPropertyTermRenewalsView.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (VPropertyTermRenewalsRecord rec in recordList ){
                ...
                resultItem = rec.Format(VPropertyTermRenewalsView.CompanyName);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(VPropertyTermRenewalsView.CompanyName.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, VPropertyTermRenewalsView.CompanyName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(VPropertyTermRenewalsView.Address1);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(VPropertyTermRenewalsView.Address1.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, VPropertyTermRenewalsView.Address1.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void GetPageSize()
        {
            ...
            if (this.VPropertyTermRenewalsPagination.PageSize.Text.Length > 0) {
                try {
                    // this.PageSize = Convert.ToInt32(this.VPropertyTermRenewalsPagination.PageSize.Text);
                } catch (Exception ) {
                }
            }
        }
      ...
      VPropertyTermRenewalsRecord rec = new VPropertyTermRenewalsRecord();
        
                        if (recControl.Address1.Text != "") {
                            rec.Parse(recControl.Address1.Text, VPropertyTermRenewalsView.Address1);
                  }
                
                        if (recControl.Address2.Text != "") {
                            rec.Parse(recControl.Address2.Text, VPropertyTermRenewalsView.Address2);
                  }
                
                        if (recControl.Address3.Text != "") {
                            rec.Parse(recControl.Address3.Text, VPropertyTermRenewalsView.Address3);
                  }
                        ...
                        if (recControl.Description.Text != "") {
                            rec.Parse(recControl.Description.Text, VPropertyTermRenewalsView.Description);
                  }
                
                        if (recControl.PostCode.Text != "") {
                            rec.Parse(recControl.PostCode.Text, VPropertyTermRenewalsView.PostCode);
                  }
                
                        if (recControl.PropertyID.Text != "") {
                            rec.Parse(recControl.PropertyID.Text, VPropertyTermRenewalsView.PropertyID);
                  }
                
                        if (recControl.RegionID.Text != "") {
                            rec.Parse(recControl.RegionID.Text, VPropertyTermRenewalsView.RegionID);
                  }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new VPropertyTermRenewalsRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(IPv5.Business.VPropertyTermRenewalsRecord);
                this.DataSource = (VPropertyTermRenewalsRecord[])(finalList.ToArray(myrec));
        ...
        public virtual void SetRenewalDateSortLabel()
                  {
                  
                    
        }
                
        public virtual void SetTermRenewalIDSortLabel()
                  {
        ...
        public virtual void SetVPropertyTermRenewalsSearch()
        {
                                            
            this.VPropertyTermRenewalsSearch.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.VPropertyTermRenewalsSearch.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
                    ...
                    foreach (CitiesRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.CityIDSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.CityIDFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = VPropertyTermRenewalsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyTermRenewalsView.CityID);
                                if(_isExpandableNonCompositeForeignKey && VPropertyTermRenewalsView.CityID.IsApplyDisplayAs)
                                     fvalue = VPropertyTermRenewalsView.GetDFKA(itemValue, VPropertyTermRenewalsView.CityID);
                    ...
                    foreach (RegionsRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.RegionIDSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.RegionIDFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = VPropertyTermRenewalsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyTermRenewalsView.RegionID);
                                if(_isExpandableNonCompositeForeignKey && VPropertyTermRenewalsView.RegionID.IsApplyDisplayAs)
                                     fvalue = VPropertyTermRenewalsView.GetDFKA(itemValue, VPropertyTermRenewalsView.RegionID);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.VPropertyTermRenewalsSearch, this.VPropertyTermRenewalsSearch.Text);
      ...
      this.SaveToSession("VPropertyTermRenewalsSearch_Ajax", this.VPropertyTermRenewalsSearch.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.VPropertyTermRenewalsSearch);
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["VPropertyTermRenewalsTableControl_OrderBy"];
            ...
            Control Pagination = this.FindControl("VPropertyTermRenewalsPagination");
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["VPropertyTermRenewalsTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetVPropertyTermRenewalsExportExcelButton()                
        ...
        public virtual void SetVPropertyTermRenewalsPDFButton()                
        ...
        public virtual void SetVPropertyTermRenewalsResetButton()                
        ...
        public virtual void SetVPropertyTermRenewalsSearchButton()                
        ...
        public virtual void SetVPropertyTermRenewalsWordButton()                
        ...
        public virtual void SetVPropertyTermRenewalsButtonsButton()                
        ...
        public virtual void SetVPropertyTermRenewalsFilterButton()                
        ...
        public virtual void SetVPropertyTermRenewalsFiltersButton()                
              
        {
                
         IThemeButtonWithArrow themeButtonVPropertyTermRenewalsFiltersButton = (IThemeButtonWithArrow)(MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsFiltersButton"));
         themeButtonVPropertyTermRenewalsFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
    
      
            if (MiscUtils.IsValueSelected(CityIDFilter))
                themeButtonVPropertyTermRenewalsFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void VPropertyTermRenewalsPagination_FirstPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void VPropertyTermRenewalsPagination_LastPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void VPropertyTermRenewalsPagination_NextPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for LinkButton
        public virtual void VPropertyTermRenewalsPagination_PageSizeButton_Click(object sender, EventArgs args)
        {
            ...
            this.PageSize = this.VPropertyTermRenewalsPagination.GetCurrentPageSize();
      
            this.PageIndex = Convert.ToInt32(this.VPropertyTermRenewalsPagination.CurrentPage.Text) - 1;
        ...
        // event handler for ImageButton
        public virtual void VPropertyTermRenewalsPagination_PreviousPage_Click(object sender, ImageClickEventArgs args)
        {
        ...
        public virtual void Address2SortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(VPropertyTermRenewalsView.Address2);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(VPropertyTermRenewalsView.Address2, OrderByItem.OrderDir.Asc);
        ...
        public virtual void Address3SortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(VPropertyTermRenewalsView.Address3);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(VPropertyTermRenewalsView.Address3, OrderByItem.OrderDir.Asc);
        ...
        public virtual void CompanyNameSortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(VPropertyTermRenewalsView.CompanyName);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
        ...
        public virtual void RenewalDateSortLabel_Click(object sender, EventArgs args)
        {
            //Sorts by RenewalDate when clicked.
        ...
        public virtual void TermRenewalIDSortLabel_Click(object sender, EventArgs args)
        {
            //Sorts by TermRenewalID when clicked.
              
            // Get previous sorting state for TermRenewalID.
        
            OrderByItem sd = this.CurrentSortOrder.Find(VPropertyTermRenewalsView.TermRenewalID);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for TermRenewalID.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(VPropertyTermRenewalsView.TermRenewalID, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by TermRenewalID, so just reverse.
                sd.Reverse();
            }
        ...
        // event handler for ImageButton
        public virtual void VPropertyTermRenewalsExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = VPropertyTermRenewalsView.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
             ...
             VPropertyTermRenewalsView.RegionID,
             VPropertyTermRenewalsView.CountryID,
             VPropertyTermRenewalsView.PostCode,
             ...
             null};
                ...
                DataForExport dataForCSV = new DataForExport(VPropertyTermRenewalsView.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(VPropertyTermRenewalsView.Instance, wc, orderBy);
              // Add each of the columns in order of export.
             ...
             data.ColumnList.Add(new ExcelColumn(VPropertyTermRenewalsView.RegionID, "Default"));
             data.ColumnList.Add(new ExcelColumn(VPropertyTermRenewalsView.CountryID, "Default"));
             data.ColumnList.Add(new ExcelColumn(VPropertyTermRenewalsView.PostCode, "Default"));
             ...
             data.ColumnList.Add(new ExcelColumn(VPropertyTermRenewalsView.PropertyID, "Default"));
              ...
              {
                val = VPropertyTermRenewalsView.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        // event handler for ImageButton
        public virtual void VPropertyTermRenewalsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByVPropertyTermRenewalsTable.VPropertyTermRenewalsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyTermRenewals";
                // If GroupByVPropertyTermRenewalsTable.VPropertyTermRenewalsPDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(VPropertyTermRenewalsView.CityID.Name, ReportEnum.Align.Left, "${CityID}", ReportEnum.Align.Left, 28);
                 report.AddColumn(VPropertyTermRenewalsView.RegionID.Name, ReportEnum.Align.Left, "${RegionID}", ReportEnum.Align.Left, 28);
                 report.AddColumn(VPropertyTermRenewalsView.CountryID.Name, ReportEnum.Align.Left, "${CountryID}", ReportEnum.Align.Left, 28);
                 report.AddColumn(VPropertyTermRenewalsView.PostCode.Name, ReportEnum.Align.Left, "${PostCode}", ReportEnum.Align.Left, 24);
                ...
                ColumnList columns = VPropertyTermRenewalsView.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = VPropertyTermRenewalsView.GetRecordCount(joinFilter,whereClause);
                VPropertyTermRenewalsRecord[] records = null;
                
                do
                {
                    
                    records = VPropertyTermRenewalsView.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( VPropertyTermRenewalsRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.CityID)){
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = VPropertyTermRenewalsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyTermRenewalsView.CityID);
                                 _DFKA = VPropertyTermRenewalsView.GetDFKA(record.CityID.ToString(), VPropertyTermRenewalsView.CityID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  VPropertyTermRenewalsView.CityID.IsApplyDisplayAs){
                                     report.AddData("${CityID}", _DFKA,ReportEnum.Align.Left, 100);
                                 }else{
                                     report.AddData("${CityID}", record.Format(VPropertyTermRenewalsView.CityID), ReportEnum.Align.Left, 100);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.RegionID)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = VPropertyTermRenewalsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyTermRenewalsView.RegionID);
                                 _DFKA = VPropertyTermRenewalsView.GetDFKA(record.RegionID.ToString(), VPropertyTermRenewalsView.RegionID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  VPropertyTermRenewalsView.RegionID.IsApplyDisplayAs){
                                     report.AddData("${RegionID}", _DFKA,ReportEnum.Align.Left, 100);
                                 }else{
                                     report.AddData("${RegionID}", record.Format(VPropertyTermRenewalsView.RegionID), ReportEnum.Align.Left, 100);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.CountryID)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = VPropertyTermRenewalsView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(VPropertyTermRenewalsView.CountryID);
                                 _DFKA = VPropertyTermRenewalsView.GetDFKA(record.CountryID.ToString(), VPropertyTermRenewalsView.CountryID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  VPropertyTermRenewalsView.CountryID.IsApplyDisplayAs){
                                     report.AddData("${CountryID}", _DFKA,ReportEnum.Align.Left, 100);
                                 }else{
                                     report.AddData("${CountryID}", record.Format(VPropertyTermRenewalsView.CountryID), ReportEnum.Align.Left, 100);
                                 }
                             }
        ...
        // event handler for ImageButton
        public virtual void VPropertyTermRenewalsResetButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void VPropertyTermRenewalsSearchButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void VPropertyTermRenewalsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByVPropertyTermRenewalsTable.VPropertyTermRenewalsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyTermRenewals";
                // If GroupByVPropertyTermRenewalsTable.VPropertyTermRenewalsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void VPropertyTermRenewalsButtonsButton_Click(object sender, EventArgs args)
        {
        ...
        // event handler for Button
        public virtual void VPropertyTermRenewalsFilterButton_Click(object sender, EventArgs args)
        {
        ...
        // event handler for Button
        public virtual void VPropertyTermRenewalsFiltersButton_Click(object sender, EventArgs args)
        {
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = VPropertyTermRenewalsView.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  VPropertyTermRenewalsRecord[] DataSource {
            ...
            get {
                return (VPropertyTermRenewalsRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton RenewalDateSortLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RenewalDateSortLabel");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton TermRenewalIDSortLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TermRenewalIDSortLabel");
            }
        }
        
        public IPv5.UI.IThemeButtonWithArrow VPropertyTermRenewalsButtonsButton {
            get {
                return (IPv5.UI.IThemeButtonWithArrow)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsButtonsButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton VPropertyTermRenewalsExportExcelButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsExportExcelButton");
            }
        }
        
        public IPv5.UI.IThemeButton VPropertyTermRenewalsFilterButton {
            get {
                return (IPv5.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsFilterButton");
            }
        }
        
        public IPv5.UI.IThemeButtonWithArrow VPropertyTermRenewalsFiltersButton {
            get {
                return (IPv5.UI.IThemeButtonWithArrow)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsFiltersButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton VPropertyTermRenewalsPDFButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsPDFButton");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton VPropertyTermRenewalsResetButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsResetButton");
            }
        }
        
        public System.Web.UI.WebControls.TextBox VPropertyTermRenewalsSearch {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsSearch");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton VPropertyTermRenewalsSearchButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsSearchButton");
            }
        }
        
        public System.Web.UI.WebControls.Literal VPropertyTermRenewalsTitle {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsTitle");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton VPropertyTermRenewalsWordButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyTermRenewalsWordButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual VPropertyTermRenewalsTableControlRow[] GetSelectedRecordControls()
        {
        
            return (VPropertyTermRenewalsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByVPropertyTermRenewalsTable.VPropertyTermRenewalsTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            VPropertyTermRenewalsTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "IPv5"));
            }
            
            foreach (VPropertyTermRenewalsTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual VPropertyTermRenewalsTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "VPropertyTermRenewalsTableControlRow");
	          List<VPropertyTermRenewalsTableControlRow> list = new List<VPropertyTermRenewalsTableControlRow>();
	          foreach (VPropertyTermRenewalsTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
