...
// EditRentReviews.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditRentReviews
{
...
// Base class for the RentReviewsRecordControl control on the EditRentReviews page.
...
public class BaseRentReviewsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in RentReviewsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditRentReviews"] = recId;
