...
// AddRentReviews.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.AddRentReviews
{
...
// Base class for the RentReviewsRecordControl control on the AddRentReviews page.
...
public class BaseRentReviewsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (RentReviewsRecord)RentReviewsRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in RentReviewsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in AddRentReviews"] = recId;
