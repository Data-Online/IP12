...
// ShowRentReviewsGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowRentReviewsGallery
{
...
// Base class for the RentReviewsTableControlRow control on the ShowRentReviewsGallery page.
...
// Base class for the RentReviewsTableControl control on the ShowRentReviewsGallery page.
...
public class BaseRentReviewsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return RentReviewsTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual RentReviewsRecord[] CopyArray(int index, RentReviewsRecord[,] recs, int columns)
      {
        RentReviewsRecord[] recsCopy = new RentReviewsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            RentReviewsRecord[,] recs = new RentReviewsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            RentReviewsRecord[] HColDataSource = new RentReviewsRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              RentReviewsRecord[] VColDataSource = new RentReviewsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("RentReviewsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              RentReviewsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                RentReviewsTableControlRow recControl = (RentReviewsTableControlRow)innerRepItem.FindControl("RentReviewsTableControlRow");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void RentReviewsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRentReviewsGallery.RentReviewsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RentReviews";
                // If ShowRentReviewsGallery.RentReviewsPDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RentReviewsTable.PropertyID.IsApplyDisplayAs){
                                     ...
                                     report.AddData("${PropertyID}", record.Format(RentReviewsTable.PropertyID), ReportEnum.Align.Left, 100);
                                 }
                             }
                             report.AddData("${Description}", record.Format(RentReviewsTable.Description), ReportEnum.Align.Left);
        ...
        public virtual void RentReviewsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRentReviewsGallery.RentReviewsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RentReviews";
                // If ShowRentReviewsGallery.RentReviewsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RentReviewsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RentReviewsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowRentReviewsGallery.RentReviewsTableControlRow")));
