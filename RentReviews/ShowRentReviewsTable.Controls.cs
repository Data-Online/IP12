...
// ShowRentReviewsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowRentReviewsTable
{
...
// Base class for the RentReviewsTableControlRow control on the ShowRentReviewsTable page.
...
public class BaseRentReviewsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.RentReviewsRowExpandCollapseRowButton.Click += RentReviewsRowExpandCollapseRowButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetRentReviewsTabContainer();
                SetRentReviewsRowDeleteButton();
              
                SetRentReviewsRowEditButton();
              
                SetRentReviewsRowExpandCollapseRowButton();
        ...
        public virtual void SetRentReviewsTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "RentReviewsTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "RentReviewsTabContainer").Visible = false;
      ...
      // To customize, override this method in RentReviewsTableControlRow.
        ...
        public virtual void SetRentReviewsRowExpandCollapseRowButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void RentReviewsRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                RentReviewsTableControl panelControl = (MiscUtils.GetParentControlObject(this, "RentReviewsTableControl") as RentReviewsTableControl);

          RentReviewsTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (RentReviewsTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "RentReviewsTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.RentReviewsRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.RentReviewsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.RentReviewsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.RentReviewsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.RentReviewsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.RentReviewsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.RentReviewsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton RentReviewsRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RentReviewsRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer RentReviewsTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RentReviewsTabContainer");
            }
        }
...
// Base class for the RentReviewsTableControl control on the ShowRentReviewsTable page.
...
public class BaseRentReviewsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        RentReviewsTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "RentReviewsTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].RentReviewsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].RentReviewsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].RentReviewsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].RentReviewsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].RentReviewsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].RentReviewsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void RentReviewsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRentReviewsTable.RentReviewsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RentReviews";
                // If ShowRentReviewsTable.RentReviewsPDFButton.report specifies a valid report template,
        ...
        public virtual void RentReviewsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRentReviewsTable.RentReviewsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RentReviews";
                // If ShowRentReviewsTable.RentReviewsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RentReviewsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RentReviewsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowRentReviewsTable.RentReviewsTableControlRow")));
...
// Base class for the PropertiesRecordControl control on the ShowRentReviewsTable page.
...
public class BasePropertiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          RentReviewsTableControlRow parentCtrl;
      
            parentCtrl = (RentReviewsTableControlRow)MiscUtils.GetParentControlObject(this, "RentReviewsTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue rentReviewsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = rentReviewsRecordObj;
          rentReviewsRecordObj = tmp;
        RentReviewsTableControlRow rentReviewsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "RentReviewsTableControlRow") as RentReviewsTableControlRow);
          
              if (rentReviewsTableControlObjRow != null && rentReviewsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertiesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, rentReviewsTableControlObjRow.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInRentReviewsTableControl = HttpContext.Current.Session["PropertiesRecordControlWhereClause"] as string;
      
      if (selectedRecordInRentReviewsTableControl != null && KeyValue.IsXmlKey(selectedRecordInRentReviewsTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInRentReviewsTableControl);
