...
// This file implements the code-behind class for AddRentReviews.aspx.
// AddRentReviews.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddRentReviews
        : BaseApplicationPage
// Code-behind class for the AddRentReviews page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public AddRentReviews()
        {
            this.Initialize();
...
public void SetRentReviewsRecordControl()
        {
            SetRentReviewsRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddRentReviews.RentReviewsRecordControl RentReviewsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Rent Reviews");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "RentReviewsRecordControl":
                 SetRentReviewsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.RentReviewsRecordControl.SaveData();
        ...
        SetRentReviewsRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "RentReviewsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRentReviewsRecordControl_Base()           
        
        {        
            if (RentReviewsRecordControl.Visible)
            {
                RentReviewsRecordControl.LoadData();
                RentReviewsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.RentReviewsRecordControl != null && this.RentReviewsRecordControl.DataSource != null)
                  {
                        id = this.RentReviewsRecordControl.DataSource.GetValue(this.RentReviewsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.RentReviewsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.RentReviewsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.RentReviewsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.RentReviewsRecordControl.DataSource.GetValue(this.RentReviewsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
