...
// GroupByRentReviewsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByRentReviewsTable
{
...
// Base class for the RentReviewsTableControlRow control on the GroupByRentReviewsTable page.
...
public class BaseRentReviewsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPropertyID()
        {
            ...
            if (this.DataSource != null && this.DataSource.PropertyIDSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&RentReviewsTable.PropertyID.IsApplyDisplayAs)
                     ...
                     formattedValue = RentReviewsTable.GetDFKA(this.DataSource.PropertyID.ToString(),RentReviewsTable.PropertyID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(RentReviewsTable.PropertyID);
              ...
              this.PropertyID.Text = RentReviewsTable.PropertyID.Format(RentReviewsTable.PropertyID.DefaultValue);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={RentReviewsTableControlRow:FK:FK_RentReviews_Properties}";
...
// Base class for the RentReviewsTableControl control on the GroupByRentReviewsTable page.
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      RentReviewsRecord rec = new RentReviewsRecord();
                        ...
                        if (recControl.PropertyID.Text != "") {
                            rec.Parse(recControl.PropertyID.Text, RentReviewsTable.PropertyID);
                  }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void RentReviewsExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             data.ColumnList.Add(new ExcelColumn(RentReviewsTable.PropertyID, "Default"));
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void RentReviewsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByRentReviewsTable.RentReviewsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RentReviews";
                // If GroupByRentReviewsTable.RentReviewsPDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(RentReviewsTable.PropertyID.Name, ReportEnum.Align.Left, "${PropertyID}", ReportEnum.Align.Left, 28);
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.PropertyID)){
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = RentReviewsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RentReviewsTable.PropertyID);
                                 _DFKA = RentReviewsTable.GetDFKA(record.PropertyID.ToString(), RentReviewsTable.PropertyID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RentReviewsTable.PropertyID.IsApplyDisplayAs){
                                     report.AddData("${PropertyID}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${PropertyID}", record.Format(RentReviewsTable.PropertyID), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void RentReviewsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByRentReviewsTable.RentReviewsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RentReviews";
                // If GroupByRentReviewsTable.RentReviewsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RentReviewsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RentReviewsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByRentReviewsTable.RentReviewsTableControlRow")));
