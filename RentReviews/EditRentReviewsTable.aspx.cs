...
// This file implements the code-behind class for EditRentReviewsTable.aspx.
// EditRentReviewsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditRentReviewsTable
        : BaseApplicationPage
// Code-behind class for the EditRentReviewsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditRentReviewsTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_RentReviewsSearch(string prefixText, int count)
        {
            // GetRentReviewsSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_RentReviewsSearch_Base()
            // or replace the call to GetAutoCompletionList_RentReviewsSearch_Base().
            return GetAutoCompletionList_RentReviewsSearch_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditRentReviewsTable.RentReviewsTableControl RentReviewsTableControl;
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.RentReviewsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_RentReviewsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditRentReviewsTable.RentReviewsTableControl control = new IPv5.UI.Controls.EditRentReviewsTable.RentReviewsTableControl();
        
        return control.GetAutoCompletionList_RentReviewsSearch(prefixText, count);
