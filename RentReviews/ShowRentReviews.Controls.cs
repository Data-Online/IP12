...
// ShowRentReviews.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowRentReviews
{
...
public class RentReviewsRecordControl : BaseRentReviewsRecordControl
{
      
        // The BaseRentReviewsRecordControl implements the LoadData, DataBind and other
...
// Base class for the RentReviewsRecordControl control on the ShowRentReviews page.
// Do not modify this class. Instead override any method in RentReviewsRecordControl.
public class BaseRentReviewsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        public BaseRentReviewsRecordControl()
        {
        ...
        // To customize, override this method in RentReviewsRecordControl.
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.RentReviewsDialogEditButton.Click += RentReviewsDialogEditButton_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "RentReviewsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            RentReviewsRecord[] recList = RentReviewsTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = RentReviewsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetRentReviewsDialogEditButton();
      ...
      // To customize, override this method in RentReviewsRecordControl.
         ...
         
        {
            ...
            bool hasFiltersRentReviewsRecordControl = false;
            hasFiltersRentReviewsRecordControl = hasFiltersRentReviewsRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["RentReviews"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "RentReviews"));
            }
            HttpContext.Current.Session["QueryString in ShowRentReviews"] = recId;
          ...
          wc.iAND(RentReviewsTable.RentReviewID, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(RentReviewsTable.RentReviewID));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(RentReviewsTable.RentReviewID, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public virtual void SetRentReviewsDialogEditButton()                
        ...
        public virtual void RentReviewsDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={RentReviewsRecordControl:FK:FK_RentReviews_Properties}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseRentReviewsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseRentReviewsRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton RentReviewsDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RentReviewsDialogEditButton");
            }
        }
