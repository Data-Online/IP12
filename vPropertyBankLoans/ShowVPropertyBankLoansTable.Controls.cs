...
// ShowVPropertyBankLoansTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowVPropertyBankLoansTable
{
...
// Base class for the VPropertyBankLoansTableControlRow control on the ShowVPropertyBankLoansTable page.
...
public class BaseVPropertyBankLoansTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetVPropertyBankLoansTabContainer();
        ...
        public virtual void SetVPropertyBankLoansTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "VPropertyBankLoansTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "VPropertyBankLoansTabContainer").Visible = false;
...
#region "Helper Properties"
        ...
        public AjaxControlToolkit.TabContainer VPropertyBankLoansTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPropertyBankLoansTabContainer");
            }
        }
...
// Base class for the VPropertyBankLoansTableControl control on the ShowVPropertyBankLoansTable page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void VPropertyBankLoansPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyBankLoansTable.VPropertyBankLoansPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyBankLoans";
                // If ShowVPropertyBankLoansTable.VPropertyBankLoansPDFButton.report specifies a valid report template,
        ...
        public virtual void VPropertyBankLoansWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyBankLoansTable.VPropertyBankLoansWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyBankLoans";
                // If ShowVPropertyBankLoansTable.VPropertyBankLoansWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual VPropertyBankLoansTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (VPropertyBankLoansTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowVPropertyBankLoansTable.VPropertyBankLoansTableControlRow")));
...
// Base class for the CitiesRecordControl control on the ShowVPropertyBankLoansTable page.
...
public class BaseCitiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          VPropertyBankLoansTableControlRow parentCtrl;
      
            parentCtrl = (VPropertyBankLoansTableControlRow)MiscUtils.GetParentControlObject(this, "VPropertyBankLoansTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue vPropertyBankLoansRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = vPropertyBankLoansRecordObj;
          vPropertyBankLoansRecordObj = tmp;
        VPropertyBankLoansTableControlRow vPropertyBankLoansTableControlObjRow = (MiscUtils.GetParentControlObject(this, "VPropertyBankLoansTableControlRow") as VPropertyBankLoansTableControlRow);
          
              if (vPropertyBankLoansTableControlObjRow != null && vPropertyBankLoansTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(CitiesTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, vPropertyBankLoansTableControlObjRow.GetRecord().CityID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInVPropertyBankLoansTableControl = HttpContext.Current.Session["CitiesRecordControlWhereClause"] as string;
      
      if (selectedRecordInVPropertyBankLoansTableControl != null && KeyValue.IsXmlKey(selectedRecordInVPropertyBankLoansTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInVPropertyBankLoansTableControl);
...
// Base class for the PropertiesRecordControl control on the ShowVPropertyBankLoansTable page.
...
public class BasePropertiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        VPropertyBankLoansTableControlRow vPropertyBankLoansTableControlObjRow = (MiscUtils.GetParentControlObject(this, "VPropertyBankLoansTableControlRow") as VPropertyBankLoansTableControlRow);
              ...
              if (vPropertyBankLoansTableControlObjRow != null && vPropertyBankLoansTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertiesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, vPropertyBankLoansTableControlObjRow.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInVPropertyBankLoansTableControl = HttpContext.Current.Session["PropertiesRecordControlWhereClause"] as string;
...
// Base class for the RegionsRecordControl control on the ShowVPropertyBankLoansTable page.
...
public class BaseRegionsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        VPropertyBankLoansTableControlRow vPropertyBankLoansTableControlObjRow = (MiscUtils.GetParentControlObject(this, "VPropertyBankLoansTableControlRow") as VPropertyBankLoansTableControlRow);
              ...
              if (vPropertyBankLoansTableControlObjRow != null && vPropertyBankLoansTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(RegionsTable.RegionID, BaseFilter.ComparisonOperator.EqualsTo, vPropertyBankLoansTableControlObjRow.GetRecord().RegionID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInVPropertyBankLoansTableControl = HttpContext.Current.Session["RegionsRecordControlWhereClause"] as string;
