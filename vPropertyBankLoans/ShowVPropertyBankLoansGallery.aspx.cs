...
// This file implements the code-behind class for ShowVPropertyBankLoansGallery.aspx.
// ShowVPropertyBankLoansGallery.Controls.vb contains the Table, Row and Record control classes
...
public partial class ShowVPropertyBankLoansGallery
        : BaseApplicationPage
// Code-behind class for the ShowVPropertyBankLoansGallery page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public ShowVPropertyBankLoansGallery()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.ShowVPropertyBankLoansGallery.VPropertyBankLoansTableControl VPropertyBankLoansTableControl;
    ...
    public static string[] GetAutoCompletionList_VPropertyBankLoansSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.ShowVPropertyBankLoansGallery.VPropertyBankLoansTableControl control = new IPv5.UI.Controls.ShowVPropertyBankLoansGallery.VPropertyBankLoansTableControl();
