...
// This file implements the code-behind class for GroupByVPropertyBankLoansTable.aspx.
// GroupByVPropertyBankLoansTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByVPropertyBankLoansTable
        : BaseApplicationPage
// Code-behind class for the GroupByVPropertyBankLoansTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByVPropertyBankLoansTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_VPropertyBankLoansSearch(string prefixText, int count)
        {
            // GetVPropertyBankLoansSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_VPropertyBankLoansSearch_Base()
            // or replace the call to GetAutoCompletionList_VPropertyBankLoansSearch_Base().
            return GetAutoCompletionList_VPropertyBankLoansSearch_Base(prefixText, count);
        }
...
public void SetVPropertyBankLoansTableControl()
        {
            SetVPropertyBankLoansTableControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButtonWithArrow VPropertyBankLoansButtonsButton;
                
        public System.Web.UI.WebControls.ImageButton VPropertyBankLoansExportExcelButton;
        
        public ThemeButton VPropertyBankLoansFilterButton;
                
        public ThemeButtonWithArrow VPropertyBankLoansFiltersButton;
                
        public PaginationModern VPropertyBankLoansPagination;
        ...
        public IPv5.UI.Controls.GroupByVPropertyBankLoansTable.VPropertyBankLoansTableControl VPropertyBankLoansTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = "Property Bank Loans";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "VPropertyBankLoansTableControl":
                 SetVPropertyBankLoansTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.VPropertyBankLoansTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_VPropertyBankLoansSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByVPropertyBankLoansTable.VPropertyBankLoansTableControl control = new IPv5.UI.Controls.GroupByVPropertyBankLoansTable.VPropertyBankLoansTableControl();
        
        return control.GetAutoCompletionList_VPropertyBankLoansSearch(prefixText, count);
        ...
        SetVPropertyBankLoansTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "VPropertyBankLoansMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVPropertyBankLoansTableControl_Base()           
        
        {        
            if (VPropertyBankLoansTableControl.Visible)
            {
                VPropertyBankLoansTableControl.LoadData();
                VPropertyBankLoansTableControl.DataBind();
            }
        }
