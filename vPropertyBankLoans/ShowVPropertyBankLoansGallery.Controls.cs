...
// ShowVPropertyBankLoansGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowVPropertyBankLoansGallery
{
...
// Base class for the VPropertyBankLoansTableControlRow control on the ShowVPropertyBankLoansGallery page.
...
// Base class for the VPropertyBankLoansTableControl control on the ShowVPropertyBankLoansGallery page.
...
public class BaseVPropertyBankLoansTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return VPropertyBankLoansView.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual VPropertyBankLoansRecord[] CopyArray(int index, VPropertyBankLoansRecord[,] recs, int columns)
      {
        VPropertyBankLoansRecord[] recsCopy = new VPropertyBankLoansRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            VPropertyBankLoansRecord[,] recs = new VPropertyBankLoansRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            VPropertyBankLoansRecord[] HColDataSource = new VPropertyBankLoansRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              VPropertyBankLoansRecord[] VColDataSource = new VPropertyBankLoansRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("VPropertyBankLoansTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              VPropertyBankLoansRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                VPropertyBankLoansTableControlRow recControl = (VPropertyBankLoansTableControlRow)innerRepItem.FindControl("VPropertyBankLoansTableControlRow");
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void VPropertyBankLoansPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyBankLoansGallery.VPropertyBankLoansPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyBankLoans";
                // If ShowVPropertyBankLoansGallery.VPropertyBankLoansPDFButton.report specifies a valid report template,
        ...
        public virtual void VPropertyBankLoansWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowVPropertyBankLoansGallery.VPropertyBankLoansWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vPropertyBankLoans";
                // If ShowVPropertyBankLoansGallery.VPropertyBankLoansWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual VPropertyBankLoansTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (VPropertyBankLoansTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowVPropertyBankLoansGallery.VPropertyBankLoansTableControlRow")));
