...
// This file implements the code-behind class for AddMMContracts.aspx.
// AddMMContracts.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddMMContracts
        : BaseApplicationPage
// Code-behind class for the AddMMContracts page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public AddMMContracts()
        {
            this.Initialize();
...
public void SetMMContractsRecordControl()
        {
            SetMMContractsRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddMMContracts.MMContractsRecordControl MMContractsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} MM Contracts");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "MMContractsRecordControl":
                 SetMMContractsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.MMContractsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetMMContractsRecordControl_Base()           
        
        {        
            if (MMContractsRecordControl.Visible)
            {
                MMContractsRecordControl.LoadData();
                MMContractsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.MMContractsRecordControl != null && this.MMContractsRecordControl.DataSource != null)
                  {
                        id = this.MMContractsRecordControl.DataSource.GetValue(this.MMContractsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.MMContractsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.MMContractsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.MMContractsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.MMContractsRecordControl.DataSource.GetValue(this.MMContractsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
