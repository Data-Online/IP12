...
// EditMMContractsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditMMContractsTable
{
...
// Base class for the MMContractsTableControlRow control on the EditMMContractsTable page.
...
public class BaseMMContractsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.MMContractsRowViewButton.Click += MMContractsRowViewButton_Click;
        ...
        public virtual void SetPropertyID()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = MMContractsTable.PropertyID.DefaultValue;
        ...
        public virtual void GetDescription()
        {
            ...
            this.DataSource.Parse(this.Description.Text, MMContractsTable.Description);							
        ...
        public virtual void GetExpiryDate()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.ExpiryDate.Text, MMContractsTable.ExpiryDate);							
        ...
        public virtual void GetPropertyID()
        {
         // Retrieve the value entered by the user on the PropertyID ASP:DropDownList, and
            // save it into the PropertyID field in DataSource DatabaseMM_IP1%dbo.MMContracts record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.PropertyID), MMContractsTable.PropertyID);			
      ...
      // To customize, override this method in MMContractsTableControlRow.
        ...
        public virtual void SetMMContractsRowViewButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void MMContractsRowViewButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton MMContractsRowViewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsRowViewButton");
            }
        }
...
// Base class for the MMContractsTableControl control on the EditMMContractsTable page.
...
public class BaseMMContractsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.MMContractsSaveButton.Click += MMContractsSaveButton_Click;
      ...
      public override void DataBind()
      {
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"MMContractsSaveButton"));
      ...
      MMContractsRecord rec = new MMContractsRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.PropertyID)) {
                            rec.Parse(recControl.PropertyID.SelectedItem.Value, MMContractsTable.PropertyID);
                        }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetMMContractsSaveButton()                
              
        {
        
                    this.MMContractsSaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.Page.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
        ...
        // event handler for ImageButton
        public virtual void MMContractsSaveButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton MMContractsSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsSaveButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MMContractsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MMContractsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditMMContractsTable.MMContractsTableControlRow")));
