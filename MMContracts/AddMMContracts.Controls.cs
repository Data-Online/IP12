...
// AddMMContracts.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.AddMMContracts
{
...
// Base class for the MMContractsRecordControl control on the AddMMContracts page.
...
public class BaseMMContractsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (MMContractsRecord)MMContractsRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in MMContractsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in AddMMContracts"] = recId;
