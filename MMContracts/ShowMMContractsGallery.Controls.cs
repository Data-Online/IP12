...
// ShowMMContractsGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowMMContractsGallery
{
...
// Base class for the MMContractsTableControlRow control on the ShowMMContractsGallery page.
...
public class BaseMMContractsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in MMContractsTableControlRow.
        ...
        public virtual void Description_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../MMContracts/ShowMMContracts.aspx?MMContracts={PK}";
...
// Base class for the MMContractsTableControl control on the ShowMMContractsGallery page.
...
public class BaseMMContractsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return MMContractsTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual MMContractsRecord[] CopyArray(int index, MMContractsRecord[,] recs, int columns)
      {
        MMContractsRecord[] recsCopy = new MMContractsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            MMContractsRecord[,] recs = new MMContractsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            MMContractsRecord[] HColDataSource = new MMContractsRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              MMContractsRecord[] VColDataSource = new MMContractsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("MMContractsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              MMContractsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                MMContractsTableControlRow recControl = (MMContractsTableControlRow)innerRepItem.FindControl("MMContractsTableControlRow");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void MMContractsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowMMContractsGallery.MMContractsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "MMContracts";
                // If ShowMMContractsGallery.MMContractsPDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  MMContractsTable.PropertyID.IsApplyDisplayAs){
                                     ...
                                     report.AddData("${PropertyID}", record.Format(MMContractsTable.PropertyID), ReportEnum.Align.Left, 100);
                                 }
                             }
                             report.AddData("${Description}", record.Format(MMContractsTable.Description), ReportEnum.Align.Left);
        ...
        public virtual void MMContractsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowMMContractsGallery.MMContractsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "MMContracts";
                // If ShowMMContractsGallery.MMContractsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual MMContractsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MMContractsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowMMContractsGallery.MMContractsTableControlRow")));
