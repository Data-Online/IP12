...
// EditMMContracts.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditMMContracts
{
...
// Base class for the MMContractsRecordControl control on the EditMMContracts page.
...
public class BaseMMContractsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in MMContractsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in EditMMContracts"] = recId;
