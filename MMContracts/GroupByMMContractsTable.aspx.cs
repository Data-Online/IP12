...
// This file implements the code-behind class for GroupByMMContractsTable.aspx.
// GroupByMMContractsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class GroupByMMContractsTable
        : BaseApplicationPage
// Code-behind class for the GroupByMMContractsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public GroupByMMContractsTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_MMContractsSearch(string prefixText, int count)
        {
            // GetMMContractsSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_MMContractsSearch_Base()
            // or replace the call to GetAutoCompletionList_MMContractsSearch_Base().
            return GetAutoCompletionList_MMContractsSearch_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButton MMContractsFilterButton;
        ...
        public IPv5.UI.Controls.GroupByMMContractsTable.MMContractsTableControl MMContractsTableControl;
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.MMContractsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_MMContractsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.GroupByMMContractsTable.MMContractsTableControl control = new IPv5.UI.Controls.GroupByMMContractsTable.MMContractsTableControl();
        
        return control.GetAutoCompletionList_MMContractsSearch(prefixText, count);
        ...
        SetMMContractsTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "MMContractsMenuItem";
                    }
                }
