...
// GroupByMMContractsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.GroupByMMContractsTable
{
...
// Base class for the MMContractsTableControlRow control on the GroupByMMContractsTable page.
...
public class BaseMMContractsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPropertyID()
        {
            ...
            if (this.DataSource != null && this.DataSource.PropertyIDSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&MMContractsTable.PropertyID.IsApplyDisplayAs)
                     ...
                     formattedValue = MMContractsTable.GetDFKA(this.DataSource.PropertyID.ToString(),MMContractsTable.PropertyID, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(MMContractsTable.PropertyID);
              ...
              this.PropertyID.Text = MMContractsTable.PropertyID.Format(MMContractsTable.PropertyID.DefaultValue);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={MMContractsTableControlRow:FK:FK_MMContracts_Properties}";
...
// Base class for the MMContractsTableControl control on the GroupByMMContractsTable page.
...
public class BaseMMContractsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(MMContractsTable.PropertyID, this.DataSource);
        }
      ...
      MMContractsRecord rec = new MMContractsRecord();
                        ...
                        if (recControl.PropertyID.Text != "") {
                            rec.Parse(recControl.PropertyID.Text, MMContractsTable.PropertyID);
                  }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PropertyIDSortLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(MMContractsTable.PropertyID);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(MMContractsTable.PropertyID, OrderByItem.OrderDir.Asc);
        ...
        public virtual void MMContractsExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             data.ColumnList.Add(new ExcelColumn(MMContractsTable.PropertyID, "Default"));
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void MMContractsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByMMContractsTable.MMContractsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "MMContracts";
                // If GroupByMMContractsTable.MMContractsPDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(MMContractsTable.PropertyID.Name, ReportEnum.Align.Left, "${PropertyID}", ReportEnum.Align.Left, 28);
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.PropertyID)){
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = MMContractsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(MMContractsTable.PropertyID);
                                 _DFKA = MMContractsTable.GetDFKA(record.PropertyID.ToString(), MMContractsTable.PropertyID,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  MMContractsTable.PropertyID.IsApplyDisplayAs){
                                     report.AddData("${PropertyID}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${PropertyID}", record.Format(MMContractsTable.PropertyID), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void MMContractsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("GroupByMMContractsTable.MMContractsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "MMContracts";
                // If GroupByMMContractsTable.MMContractsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual MMContractsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MMContractsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.GroupByMMContractsTable.MMContractsTableControlRow")));
