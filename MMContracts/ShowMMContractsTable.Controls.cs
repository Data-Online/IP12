...
// ShowMMContractsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowMMContractsTable
{
...
// Base class for the MMContractsTableControlRow control on the ShowMMContractsTable page.
...
public class BaseMMContractsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.MMContractsRowExpandCollapseRowButton.Click += MMContractsRowExpandCollapseRowButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetMMContractsRowExpandCollapseRowButton();
        ...
        public virtual void SetDescription()
        {
            ...
            if (this.DataSource != null && this.DataSource.DescriptionSpecified) {
              ...
              this.Description.Text = MMContractsTable.Description.Format(MMContractsTable.Description.DefaultValue);
        ...
        public virtual void SetExpiryDate()
        {
            ...
            if (this.DataSource != null && this.DataSource.ExpiryDateSpecified) {
              ...
              this.ExpiryDate.Text = MMContractsTable.ExpiryDate.Format(MMContractsTable.ExpiryDate.DefaultValue, @"d");
        ...
        public virtual void SetMMContractsTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "MMContractsTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "MMContractsTabContainer").Visible = false;
      ...
      // To customize, override this method in MMContractsTableControlRow.
        ...
        public virtual void SetMMContractsRowExpandCollapseRowButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void MMContractsRowExpandCollapseRowButton_Click(object sender, ImageClickEventArgs args)
        {
              
            try {
                MMContractsTableControl panelControl = (MiscUtils.GetParentControlObject(this, "MMContractsTableControl") as MMContractsTableControl);

          MMContractsTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (MMContractsTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "MMContractsTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
                  if (sender == repeatedRow.MMContractsRowExpandCollapseRowButton)
                      altRow.Visible = !altRow.Visible;
                  
                  if (altRow.Visible)
                  {
                   
                     repeatedRow.MMContractsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                     repeatedRow.MMContractsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.MMContractsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                           
                  }
                  else
                  {
                   
                     repeatedRow.MMContractsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                     repeatedRow.MMContractsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                     repeatedRow.MMContractsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton MMContractsRowExpandCollapseRowButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsRowExpandCollapseRowButton");
            }
        }
        
        public AjaxControlToolkit.TabContainer MMContractsTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsTabContainer");
            }
        }
...
// Base class for the MMContractsTableControl control on the ShowMMContractsTable page.
...
public class BaseMMContractsTableControl : IPv5.UI.BaseApplicationTableControl
{
       ...
       public BaseMMContractsTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.MMContractsSearch)) 				
                    initialVal = this.GetFromSession(this.MMContractsSearch);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.MMContractsSearch.Text = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.MMContractsResetButton.Click += MMContractsResetButton_Click;
                        
                    this.MMContractsSearchButton.Click += MMContractsSearchButton_Click;
                    ...
                    this.MMContractsFilterButton.Button.Click += MMContractsFilterButton_Click;
         ...
         //' Setup events for others
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "MMContractsSearchSearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + MMContractsSearch.ClientID + "\");", true);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetMMContractsResetButton();
              
                SetMMContractsSearchButton();
              
                SetMMContractsWordButton();
              
                SetMMContractsButtonsButton();
              
                SetMMContractsFilterButton();
        ...
        MMContractsTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "MMContractsTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
                    if (expandFirstRow && i == 0){
                        altRow.Visible = true;
                   
                         recControls[i].MMContractsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif";
                         recControls[i].MMContractsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].MMContractsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
                   
                    }
                    else{
                        altRow.Visible = false;
                   
                         recControls[i].MMContractsRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif";
                         recControls[i].MMContractsRowExpandCollapseRowButton.Attributes.Add("onmouseover", "");
                         recControls[i].MMContractsRowExpandCollapseRowButton.Attributes.Add("onmouseout", "");
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.MMContractsSearch)) {
                if (this.MMContractsSearch.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.MMContractsSearch.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.MMContractsSearch.Text.StartsWith("...")) {
                      this.MMContractsSearch.Text = this.MMContractsSearch.Text.Substring(3,this.MMContractsSearch.Text.Length-3);
                  }
                  if (this.MMContractsSearch.Text.EndsWith("...")) {
                      this.MMContractsSearch.Text = this.MMContractsSearch.Text.Substring(0,this.MMContractsSearch.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.MMContractsSearch.Text.Length - 1;
                      while (!Char.IsWhiteSpace(MMContractsSearch.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.MMContractsSearch.Text = this.MMContractsSearch.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.MMContractsSearch, this.GetFromSession(this.MMContractsSearch));
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.MMContractsSearch, this.GetFromSession(this.MMContractsSearch)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.PropertyIDFilter)) {
                ...
                wc.iAND(MMContractsTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.PropertyIDFilter, this.GetFromSession(this.PropertyIDFilter)), false, false);
        ...
        public virtual WhereClause CreateWhereClause(String searchText, String fromSearchControl, String AutoTypeAheadSearch, String AutoTypeAheadWordSeparators)
        {
            ...
            if (MiscUtils.IsValueSelected(ExpiryDateFromFilterSelectedValue)) {
                ...
                wc.iAND(MMContractsTable.ExpiryDate, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, ExpiryDateFromFilterSelectedValue, false, false);
            ...
            if (MiscUtils.IsValueSelected(ExpiryDateToFilterSelectedValue)) {
                ...
                wc.iAND(MMContractsTable.ExpiryDate, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, ExpiryDateToFilterSelectedValue, false, false);
                    
            }         
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "MMContractsSearch") {
      ...
      String PropertyIDFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "PropertyIDFilter_Ajax"];
            if (MiscUtils.IsValueSelected(PropertyIDFilterSelectedValue)) {
                ...
                wc.iAND(MMContractsTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, PropertyIDFilterSelectedValue, false, false);
        ...
        public virtual string[] GetAutoCompletionList_MMContractsSearch(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"MMContractsSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
      ...
      MMContractsRecord rec = new MMContractsRecord();
                        ...
                        if (recControl.Description.Text != "") {
                            rec.Parse(recControl.Description.Text, MMContractsTable.Description);
                  }
                
                        if (recControl.ExpiryDate.Text != "") {
                            rec.Parse(recControl.ExpiryDate.Text, MMContractsTable.ExpiryDate);
                  }
        ...
        public virtual void SetMMContractsSearch()
        {
                                            
            this.MMContractsSearch.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.MMContractsSearch.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
                    ...
                    foreach (PropertiesRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.PropertyIDSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.PropertyIDFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = MMContractsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(MMContractsTable.PropertyID);
                                if(_isExpandableNonCompositeForeignKey && MMContractsTable.PropertyID.IsApplyDisplayAs)
                                     fvalue = MMContractsTable.GetDFKA(itemValue, MMContractsTable.PropertyID);
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.MMContractsSearch, this.MMContractsSearch.Text);
      ...
      this.SaveToSession("MMContractsSearch_Ajax", this.MMContractsSearch.Text);
      ...
      this.SaveToSession("PropertyIDFilter_Ajax", this.PropertyIDFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.MMContractsSearch);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetMMContractsResetButton()                
        ...
        public virtual void SetMMContractsSearchButton()                
        ...
        public virtual void SetMMContractsFilterButton()                
              ...
              
        {
         ...
         themeButtonMMContractsFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(PropertyIDFilter))
                themeButtonMMContractsFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void MMContractsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowMMContractsTable.MMContractsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "MMContracts";
                // If ShowMMContractsTable.MMContractsPDFButton.report specifies a valid report template,
        ...
        // event handler for ImageButton
        public virtual void MMContractsResetButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void MMContractsSearchButton_Click(object sender, ImageClickEventArgs args)
        {
        ...
        public virtual void MMContractsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowMMContractsTable.MMContractsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "MMContracts";
                // If ShowMMContractsTable.MMContractsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        // event handler for Button
        public virtual void MMContractsFilterButton_Click(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public IPv5.UI.IThemeButton MMContractsFilterButton {
            get {
                return (IPv5.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsFilterButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton MMContractsResetButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsResetButton");
            }
        }
        
        public System.Web.UI.WebControls.TextBox MMContractsSearch {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsSearch");
            }
        }
        
        public System.Web.UI.WebControls.ImageButton MMContractsSearchButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsSearchButton");
            }
        }
        
        public System.Web.UI.WebControls.Literal MMContractsTitle {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsTitle");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MMContractsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MMContractsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowMMContractsTable.MMContractsTableControlRow")));
...
// Base class for the PropertiesRecordControl control on the ShowMMContractsTable page.
...
public class BasePropertiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          MMContractsTableControlRow parentCtrl;
      
            parentCtrl = (MMContractsTableControlRow)MiscUtils.GetParentControlObject(this, "MMContractsTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue mMContractsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = mMContractsRecordObj;
          mMContractsRecordObj = tmp;
        MMContractsTableControlRow mMContractsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "MMContractsTableControlRow") as MMContractsTableControlRow);
          
              if (mMContractsTableControlObjRow != null && mMContractsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(PropertiesTable.PropertyID, BaseFilter.ComparisonOperator.EqualsTo, mMContractsTableControlObjRow.GetRecord().PropertyID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInMMContractsTableControl = HttpContext.Current.Session["PropertiesRecordControlWhereClause"] as string;
      
      if (selectedRecordInMMContractsTableControl != null && KeyValue.IsXmlKey(selectedRecordInMMContractsTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInMMContractsTableControl);
