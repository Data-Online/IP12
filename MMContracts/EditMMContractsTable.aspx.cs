...
// This file implements the code-behind class for EditMMContractsTable.aspx.
// EditMMContractsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditMMContractsTable
        : BaseApplicationPage
// Code-behind class for the EditMMContractsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditMMContractsTable()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.EditMMContractsTable.MMContractsTableControl MMContractsTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} MM Contracts");
    ...
    public static string[] GetAutoCompletionList_MMContractsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditMMContractsTable.MMContractsTableControl control = new IPv5.UI.Controls.EditMMContractsTable.MMContractsTableControl();
