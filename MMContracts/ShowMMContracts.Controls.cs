...
// ShowMMContracts.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowMMContracts
{
...
public class MMContractsRecordControl : BaseMMContractsRecordControl
{
      
        // The BaseMMContractsRecordControl implements the LoadData, DataBind and other
...
// Base class for the MMContractsRecordControl control on the ShowMMContracts page.
// Do not modify this class. Instead override any method in MMContractsRecordControl.
public class BaseMMContractsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        public BaseMMContractsRecordControl()
        {
        ...
        // To customize, override this method in MMContractsRecordControl.
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.MMContractsDialogEditButton.Click += MMContractsDialogEditButton_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "MMContractsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            MMContractsRecord[] recList = MMContractsTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = MMContractsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetPropertyID();
                SetPropertyIDLabel();
                SetMMContractsDialogEditButton();
      ...
      // To customize, override this method in MMContractsRecordControl.
         ...
         
        {
            ...
            bool hasFiltersMMContractsRecordControl = false;
            hasFiltersMMContractsRecordControl = hasFiltersMMContractsRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["MMContracts"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "MMContracts"));
            }
            HttpContext.Current.Session["QueryString in ShowMMContracts"] = recId;
          ...
          wc.iAND(MMContractsTable.MMContractID, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(MMContractsTable.MMContractID));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(MMContractsTable.MMContractID, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public virtual void SetMMContractsDialogEditButton()                
        ...
        public virtual void MMContractsDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PropertyID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Properties/ShowProperties.aspx?Properties={MMContractsRecordControl:FK:FK_MMContracts_Properties}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseMMContractsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseMMContractsRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton MMContractsDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MMContractsDialogEditButton");
            }
        }
