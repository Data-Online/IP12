...
// ShowContractorsGallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowContractorsGallery
{
...
// Base class for the ContractorsTableControlRow control on the ShowContractorsGallery page.
...
// Base class for the ContractorsTableControl control on the ShowContractorsGallery page.
...
public class BaseContractorsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return ContractorsTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual ContractorsRecord[] CopyArray(int index, ContractorsRecord[,] recs, int columns)
      {
        ContractorsRecord[] recsCopy = new ContractorsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            ContractorsRecord[,] recs = new ContractorsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            ContractorsRecord[] HColDataSource = new ContractorsRecord[Convert.ToInt32(rows)];
            ...
            // Bind the repeater with the list of records to expand the UI.
              ...
              ContractorsRecord[] VColDataSource = new ContractorsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("ContractorsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              ContractorsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                ContractorsTableControlRow recControl = (ContractorsTableControlRow)innerRepItem.FindControl("ContractorsTableControlRow");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ContractorsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowContractorsGallery.ContractorsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contractors";
                // If ShowContractorsGallery.ContractorsPDFButton.report specifies a valid report template,
        ...
        public virtual void ContractorsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowContractorsGallery.ContractorsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contractors";
                // If ShowContractorsGallery.ContractorsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ContractorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContractorsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowContractorsGallery.ContractorsTableControlRow")));
