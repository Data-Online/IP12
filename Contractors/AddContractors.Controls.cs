...
// AddContractors.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.AddContractors
{
...
// Base class for the ContractorsRecordControl control on the AddContractors page.
...
public class BaseContractorsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (ContractorsRecord)ContractorsRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in ContractorsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in AddContractors"] = recId;
