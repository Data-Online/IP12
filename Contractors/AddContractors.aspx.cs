...
// This file implements the code-behind class for AddContractors.aspx.
// AddContractors.Controls.vb contains the Table, Row and Record control classes
...
public partial class AddContractors
        : BaseApplicationPage
// Code-behind class for the AddContractors page.
...
public void SetContractorsRecordControl()
        {
            SetContractorsRecordControl_Base(); 
        }
[System.Web.Services.WebMethod()]
        public static object[] GetImage(string contextName,
                                        string tableName,
...
#region "Section 2: Do not modify this section."
        ...
        public IPv5.UI.Controls.AddContractors.ContractorsRecordControl ContractorsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Contractors");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "ContractorsRecordControl":
                 SetContractorsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.ContractorsRecordControl.SaveData();
        ...
        SetContractorsRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "ContractorsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetContractorsRecordControl_Base()           
        
        {        
            if (ContractorsRecordControl.Visible)
            {
                ContractorsRecordControl.LoadData();
                ContractorsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ContractorsRecordControl != null && this.ContractorsRecordControl.DataSource != null)
                  {
                        id = this.ContractorsRecordControl.DataSource.GetValue(this.ContractorsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ContractorsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ContractorsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ContractorsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ContractorsRecordControl.DataSource.GetValue(this.ContractorsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
