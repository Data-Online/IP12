...
// EditContractors.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditContractors
{
...
public class ContractorsRecordControl : BaseContractorsRecordControl
{
      
        // The BaseContractorsRecordControl implements the LoadData, DataBind and other
...
// Base class for the ContractorsRecordControl control on the EditContractors page.
// Do not modify this class. Instead override any method in ContractorsRecordControl.
public class BaseContractorsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        public BaseContractorsRecordControl()
        {
        ...
        // To customize, override this method in ContractorsRecordControl.
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "ContractorsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            ContractorsRecord[] recList = ContractorsTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = ContractorsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in ContractorsRecordControl.
         ...
         
        {
            ...
            bool hasFiltersContractorsRecordControl = false;
            hasFiltersContractorsRecordControl = hasFiltersContractorsRecordControl && false; // suppress warning
            ...
            if (recId == null || recId.Length == 0) {
                ...
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "IPv5").Replace("{URL}", "Contractors"));
            }
            HttpContext.Current.Session["QueryString in EditContractors"] = recId;
          ...
          wc.iAND(ContractorsTable.ContractorID, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(ContractorsTable.ContractorID));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(ContractorsTable.ContractorID, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseContractorsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseContractorsRecordControl_Rec"] = value;
            }
        }
