...
// ShowContractors.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowContractors
{
...
// Base class for the ContractorsRecordControl control on the ShowContractors page.
...
public class BaseContractorsRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.ContractorsDialogEditButton.Click += ContractorsDialogEditButton_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetContractorsDialogEditButton();
      ...
      // To customize, override this method in ContractorsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in ShowContractors"] = recId;
        ...
        public virtual void SetContractorsDialogEditButton()                
        ...
        public virtual void ContractorsDialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void CityID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Cities/ShowCities.aspx?Cities={ContractorsRecordControl:FK:FK_Contractors_Cities}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton ContractorsDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContractorsDialogEditButton");
            }
        }
