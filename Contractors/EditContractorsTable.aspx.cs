...
// This file implements the code-behind class for EditContractorsTable.aspx.
// EditContractorsTable.Controls.vb contains the Table, Row and Record control classes
...
public partial class EditContractorsTable
        : BaseApplicationPage
// Code-behind class for the EditContractorsTable page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public EditContractorsTable()
        {
            this.Initialize();
...
//        }
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_ContractorsSearch(string prefixText, int count)
        {
            // GetContractorsSearchCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_ContractorsSearch_Base()
            // or replace the call to GetAutoCompletionList_ContractorsSearch_Base().
            return GetAutoCompletionList_ContractorsSearch_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
        ...
        public ThemeButton ContractorsFilterButton;
        ...
        public IPv5.UI.Controls.EditContractorsTable.ContractorsTableControl ContractorsTableControl;
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.ContractorsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_ContractorsSearch_Base(string prefixText, int count)
    {
        ...
        IPv5.UI.Controls.EditContractorsTable.ContractorsTableControl control = new IPv5.UI.Controls.EditContractorsTable.ContractorsTableControl();
        
        return control.GetAutoCompletionList_ContractorsSearch(prefixText, count);
