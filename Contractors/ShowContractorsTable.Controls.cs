...
// ShowContractorsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.ShowContractorsTable
{
...
// Base class for the ContractorsTableControlRow control on the ShowContractorsTable page.
...
public class BaseContractorsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetContractorsTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "ContractorsTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "ContractorsTabContainer").Visible = false;
...
#region "Helper Properties"
        ...
        public AjaxControlToolkit.TabContainer ContractorsTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContractorsTabContainer");
            }
        }
...
// Base class for the ContractorsTableControl control on the ShowContractorsTable page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ContractorsPDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowContractorsTable.ContractorsPDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contractors";
                // If ShowContractorsTable.ContractorsPDFButton.report specifies a valid report template,
        ...
        public virtual void ContractorsWordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowContractorsTable.ContractorsWordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contractors";
                // If ShowContractorsTable.ContractorsWordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ContractorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContractorsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IPv5.UI.Controls.ShowContractorsTable.ContractorsTableControlRow")));
...
// Base class for the CitiesRecordControl control on the ShowContractorsTable page.
...
public class BaseCitiesRecordControl : IPv5.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          ContractorsTableControlRow parentCtrl;
      
            parentCtrl = (ContractorsTableControlRow)MiscUtils.GetParentControlObject(this, "ContractorsTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue contractorsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = contractorsRecordObj;
          contractorsRecordObj = tmp;
        ContractorsTableControlRow contractorsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "ContractorsTableControlRow") as ContractorsTableControlRow);
          
              if (contractorsTableControlObjRow != null && contractorsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(CitiesTable.CityID, BaseFilter.ComparisonOperator.EqualsTo, contractorsTableControlObjRow.GetRecord().CityID.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInContractorsTableControl = HttpContext.Current.Session["CitiesRecordControlWhereClause"] as string;
      
      if (selectedRecordInContractorsTableControl != null && KeyValue.IsXmlKey(selectedRecordInContractorsTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInContractorsTableControl);
