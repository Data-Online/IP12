...
// EditContractorsTable.aspx page.  The Row or RecordControl classes are the 
...
namespace IPv5.UI.Controls.EditContractorsTable
{
...
// Base class for the ContractorsTableControlRow control on the EditContractorsTable page.
...
public class BaseContractorsTableControlRow : IPv5.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.ContractorsRowViewButton.Click += ContractorsRowViewButton_Click;
              ...
              this.ServiceTypeID.TextChanged += ServiceTypeID_TextChanged;
        ...
        public virtual void SetCityID()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = ContractorsTable.CityID.DefaultValue;
        ...
        public virtual void SetServiceTypeID()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.ServiceTypeID.ID))
            {
                ...
                this.ServiceTypeID.Text = this.PreviousUIData[this.ServiceTypeID.ID].ToString();
            ...
            // this.DataSource is the DatabaseMM_IP1%dbo.Contractors record retrieved from the database.
            // this.ServiceTypeID is the ASP:TextBox on the webpage.
        ...
        public virtual void GetAddress1()
        {
            ...
            this.DataSource.Parse(this.Address1.Text, ContractorsTable.Address1);							
        ...
        public virtual void GetAddress2()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.Address2.Text, ContractorsTable.Address2);							
        ...
        public virtual void GetCellPhone()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.CellPhone.Text, ContractorsTable.CellPhone);							
        ...
        public virtual void GetCityID()
        {
         // Retrieve the value entered by the user on the CityID ASP:DropDownList, and
            // save it into the CityID field in DataSource DatabaseMM_IP1%dbo.Contractors record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.CityID), ContractorsTable.CityID);			
        ...
        public virtual void GetCompanyName()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.CompanyName.Text, ContractorsTable.CompanyName);							
        ...
        public virtual void GetContactName()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.ContactName.Text, ContractorsTable.ContactName);							
        ...
        public virtual void GeteMail()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.eMail.Text, ContractorsTable.eMail);							
        ...
        public virtual void GetLandPhone()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.LandPhone.Text, ContractorsTable.LandPhone);							
        ...
        public virtual void GetPostCode()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.PostCode.Text, ContractorsTable.PostCode);							
        ...
        public virtual void GetServiceTypeID()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.ServiceTypeID.Text, ContractorsTable.ServiceTypeID);							
      ...
      // To customize, override this method in ContractorsTableControlRow.
        ...
        public virtual void SetContractorsRowViewButton()                
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for ImageButton
        public virtual void ContractorsRowViewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Contractors/ShowContractors.aspx?Contractors={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void ServiceTypeID_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton ContractorsRowViewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContractorsRowViewButton");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox ServiceTypeID {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ServiceTypeID");
            }
        }
...
// Base class for the ContractorsTableControl control on the EditContractorsTable page.
...
public class BaseContractorsTableControl : IPv5.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.ContractorsSaveButton.Click += ContractorsSaveButton_Click;
      ...
      public override void DataBind()
      {
        ...
        public virtual void RegisterPostback()
        {
              ...
              this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"ContractorsSaveButton"));
      ...
      ContractorsRecord rec = new ContractorsRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.CityID)) {
                            rec.Parse(recControl.CityID.SelectedItem.Value, ContractorsTable.CityID);
                        }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void SetContractorsSaveButton()                
              
        {
        
                    this.ContractorsSaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.Page.GetResourceValue("Txt:SaveRecord", "IPv5") + "\");");
        ...
        // event handler for ImageButton
        public virtual void ContractorsSaveButton_Click(object sender, ImageClickEventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton ContractorsSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContractorsSaveButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual ContractorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContractorsTableControlRow[])(selectedList.ToArray(Type.GetType("IPv5.UI.Controls.EditContractorsTable.ContractorsTableControlRow")));
